    ...
    return {
        ...
        saveButton: function (event) {
            ...
            $(self.commentName + ' form').request('onSaveCommentButton', {
                data: {
                    ...
                    'attachment_id': $(self.$attachment_id).val(),
                    'attachment_field': $(self.$attachment_field).val(),
                },
        ...
        addComment: function (content) {
            ...
            if (self.parent_id == null) {
                $('.comments ul:eq(0)').prepend(content);
        ...
        addMessage: function (data) {
            ...
            $.each(data, function (i, item) {
                html.prepend($('<li>').text(item[0]));
            });
            $(self.messageName).html($("<div>").addClass('alert alert-danger').prepend(html));
        },
