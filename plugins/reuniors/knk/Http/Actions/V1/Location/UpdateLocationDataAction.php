...
class UpdateLocationDataAction extends BaseAction {
    public function rules()
    {
        return [
            ...
            'workingTime' => 'array',
            'workingTime.*.time_from_utc' => ['date_format:H:i:s', 'required'],
            'workingTime.*.time_to_utc' => ['date_format:H:i:s', 'required'],
            ...
            'deliveryWorkingTime.*.time_from_utc' => ['date_format:H:i:s', 'required'],
            'deliveryWorkingTime.*.time_to_utc' => ['date_format:H:i:s', 'required'],
