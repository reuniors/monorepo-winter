...
class FoodCategories extends Controller
{
    ...
    {
        parent::__construct();
        BackendMenu::setContext('Reuniors.Knk', 'knk', 'knk-food-category');
    }

    public function relationExtendViewWidget($widget, $field)
    {
        if ($widget->model instanceof \Reuniors\Knk\Models\Food) {
            $widget->model->food_category_id_inject = $this->params[0];
        }
    }
