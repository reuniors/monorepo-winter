<?php namespace Reuniors\Evodic\Http\Actions\V1\User;
...
class LoginAction extends BaseAction {
    ...
    protected function tryToAuthenticate(): User
    {
        /*
         * Validate input
         */
    ...
    public function handle($attributes = [])
    {
        ...
        try {
            $user = $this->tryToAuthenticate();
            $name = array_get($attributes, 'name', 'web');

            $existingAccessToken = $user->tokens()->where('name', $name)->first();
