...
/**
 * Image Update Action (Registry-based)
 * 
 * This action uses the ImageActionRegistry to handle updates for any registered image type.
 */
class ImageUpdateAction extends BaseImageUpdateAction
{
