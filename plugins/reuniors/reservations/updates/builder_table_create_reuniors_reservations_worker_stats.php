...
class BuilderTableCreateReuniorsReservationsWorkerStats extends Migration
{
    public function up()
    {
        Schema::create('reuniors_reservations_worker_stats', function ($table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('reuniors_reservations_worker_stats');
    }
}
