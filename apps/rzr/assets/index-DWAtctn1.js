const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/App-D9vbFQN1.js","assets/vendor_ionic-DxRiTffW.js","assets/vendor_react-Dna2AK9N.js","assets/vendor_leaflet-DNRNsWmZ.js","assets/vendor_leaflet-Bvr-Ab8i.css","assets/vendor_react-Z09ODb1v.css","assets/vendor_ionic-CbIbgj2R.css","assets/vendor_firebase-BjBnt0gj.js","assets/App--SOcKfRT.css"])))=>i.map(i=>d[i]);
var _a;
...
instance.init({
  ...
  backend: {
    loadPath: "".concat("/apps/rzr/", "public/projects/").concat(projectName, "/locales/{{lng}}/{{ns}}.json")
  },
...
const apiUrl = (_a = getInitialData("rzrApiUrl")) != null ? _a : "http://monorepo/api/v1/rzr";
...
const App = reactExports.lazy(() => __vitePreload(() => import("./App-D9vbFQN1.js").then((n) => n.B), true ? __vite__mapDeps([0,1,2,3,4,5,6,7,8]) : void 0));
