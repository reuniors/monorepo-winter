;
(function () {
  System.register(['./vendor_ionic-legacy-DMDRhAuO.js', './vendor_react-legacy-BlcubaNj.js', './vendor_leaflet-legacy-C0625EaZ.js'], function (exports, module) {
    'use strict';

    var __vitePreload, defineCustomElements, instance, Backend, Browser, initReactI18next, fetchBaseQuery, gBase64, createApi, humpsExports, createAction, createSlice, isRejectedWithValue, combineReducers, configureStore, jsxRuntimeExports, persistStore, persistReducer, FLUSH, REHYDRATE, PAUSE, PERSIST, PURGE, REGISTER, storage, reactExports, clientExports, Provider, PersistGate, ErrorBoundary;
    return {
      setters: [module => {
        __vitePreload = module._;
        defineCustomElements = module.d;
      }, module => {
        instance = module.v;
        Backend = module.x;
        Browser = module.y;
      ...
      execute: function () {
        ...
        const apiBaseUrl = "http://monorepo/api/v1";
        ...
        instance.init({
          ...
          backend: {
            loadPath: `${"/apps/rzr/"}public/projects/${projectName}/locales/{{lng}}/{{ns}}.json`
          },
        ...
        var TagId = exports("p", /* @__PURE__ */(TagId2 => {
          TagId2["LIST"] = "LIST";
          return TagId2;
        })(TagId || {}));
        const apiUrl = getInitialData("rzrApiUrl") ?? "http://monorepo/api/v1/rzr";
        ...
        const App = reactExports.lazy(() => __vitePreload(() => module.import('./App-legacy-B_CrLuzT.js').then(n => n.B), false              ? __VITE_PRELOAD__ : void 0));
