  ...
  System.register(['./vendor_ionic-legacy-DMDRhAuO.js', './vendor_react-legacy-BlcubaNj.js', './index-legacy-D4TPg-pG.js', './vendor_firebase-legacy-Cowo1GnG.js'], function (exports, module) {
    ...
    return {
      setters: [module => {
        ...
        funnelOutline = module.S;
        listCircleSharp = module.T;
        IonItemSliding = module.U;
        IonItemOptions = module.V;
        IonThumbnail = module.W;
        IonReorder = module.X;
        menuOutline = module.Y;
        chevronForwardOutline = module.Z;
        IonItemOption = module.$;
        constructOutline = module.a0;
        chevronDownOutline = module.a1;
        checkboxOutline = module.a2;
        squareOutline = module.a3;
        IonActionSheet = module.a4;
        IonReorderGroup = module.a5;
        addOutline = module.a6;
        isPlatform = module.a7;
        icons = module.a8;
        IonTextarea = module.a9;
        IonDatetime = module.aa;
        IonToggle = module.ab;
        __vitePreload = module._;
        calendarOutline = module.ac;
        timeOutline = module.ad;
        IonChip = module.ae;
        useIonToast = module.af;
        ...
        chevronBack = module.aA;
        chevronForward = module.aB;
        IonCard = module.aC;
        IonCardHeader = module.aD;
        IonCardContent = module.aE;
        megaphoneOutline = module.aF;
        cutOutline = module.aG;
        IonSegment = module.aH;
        IonSegmentButton = module.aI;
        IonAvatar = module.aJ;
        IonCardTitle = module.aK;
        checkmarkCircleOutline = module.aL;
        closeCircleOutline = module.aM;
        walletOutline = module.aN;
        refreshOutline = module.aO;
        IonAccordionGroup = module.aP;
        IonAccordion = module.aQ;
        callOutline = module.aR;
        personOutline = module.aS;
        pencilOutline = module.aT;
        notificationsCircle = module.aU;
        peopleOutline = module.aV;
        settingsOutline = module.aW;
        createOutline = module.aX;
        giftOutline = module.aY;
        cashOutline = module.aZ;
        IonTabs = module.a_;
        IonRouterOutlet = module.a$;
        IonTabBar = module.b0;
        IonTabButton = module.b1;
        alarmOutline = module.b2;
        notificationsOutline = module.b3;
        removeOutline = module.b4;
        IonBadge = module.b5;
        calendarClearOutline = module.b6;
        arrowBack = module.b7;
        arrowForward = module.b8;
        useIonViewDidLeave = module.b9;
        pricetagOutline = module.ba;
        alertCircleOutline = module.bb;
        hourglassOutline = module.bc;
        helpOutline = module.bd;
        alertOutline = module.be;
        IonApp = module.bf;
        IonReactRouter = module.bg;
        IonSplitPane = module.bh;
        ...
        setLocale = module.a5;
        useWatch = module.a6;
        DraftExports = module.a7;
        reactDraftWysiwygExports = module.a8;
        draftToHtml = module.a9;
        qr = module.aa;
        Swiper = module.ab;
        ...
        c = module.ad;
        SwiperSlide = module.ae;
        register = module.af;
        V = module.ag;
        arrayMove = module.ah;
        parseISO = module.ai;
        formatInTimeZone = module.aj;
        toZonedTime = module.ak;
        format = module.al;
        isValid = module.am;
        useDispatch = module.an;
        useSelector = module.ao;
        useTranslation = module.ap;
        useHistory = module.aq;
        useGoogleLogin = module.ar;
        GoogleOAuthProvider = module.as;
        ErrorBoundary = module.at;
        Clipboard = module.au;
        Route = module.q;
        buildExports = module.av;
        instance = module.v;
        differenceInCalendarMonths = module.aw;
        getMonth = module.ax;
        startOfMonth = module.ay;
        addDays = module.az;
        endOfMonth = module.aA;
        eachDayOfInterval = module.aB;
        subMonths = module.aC;
        addMonths = module.aD;
        parse = module.aE;
        addMinutes = module.aF;
        isWithinInterval = module.aG;
        differenceInMinutes = module.aH;
        Redirect = module.aI;
      ...
      execute: function () {
        ...
        function PhotoGallery(props, ref) {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
            children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonToolbar, {
              ...
              children: photos.map((photo, index) => /* @__PURE__ */jsxRuntimeExports.jsx(SwiperSlide, {
                children: /* @__PURE__ */jsxRuntimeExports.jsx(IonImg, {
                  src: cropAspectRatio && photo.croppedUrls?.[cropAspectRatioStr] ? photo.croppedUrls?.[cropAspectRatioStr] : photo.url,
                  alt: photo.name,
                  ...bindDouble,
        ...
        function ManageListActions(props) {
          ...
          const listOfActions = props.listOfActions ?? standardListActions;
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
            children: [/* @__PURE__ */jsxRuntimeExports.jsxs(IonToolbar, {
              ...
              buttons: [...listOfActions.map(item => ({
        ...
        function PhotoUploader(props) {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
            children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              ...
              render: ({
                field
              }) => /* @__PURE__ */jsxRuntimeExports.jsx(PhotoEditor$1, {
                ref: photoEditorRef,
                galleryProps: {
                  handleOnManageAction: () => {
        ...
        const ionIconList = [];
        const ionIcons = {};
        const fetchIonIconsList = exports("A", () => {
        ...
        function GalleryArea({
          ...
          const {
            ...
            onError: error2 => {
              ...
              field.onUploadError?.(new Error(errorMessage));
            }
          });
          const {
            deletePhotos
          ...
          const handleReorderImages = reactExports.useCallback(async reorderedPhotos => {
            try {
              if (field.reorderUrl) {
              ...
              field.onReorderSuccess?.(reorderedPhotos);
            } catch (error2) {
        ...
        const ListIonIcons = reactExports.lazy(() => __vitePreload(() => module.import('./ListIonIcons-legacy-CtOq5wl-.js'), false              ? __VITE_PRELOAD__ : void 0));
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs(IonItem, {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonLabel, {
                    ...
                    children: field.value ? /* @__PURE__ */jsxRuntimeExports.jsx(IonText, {
                      color: "medium",
                      children: formatDate$2(field.value)
        ...
        function CommonLoginModal(props) {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(IonModalExtended$1, {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonHeader, {
              ...
              children: /* @__PURE__ */jsxRuntimeExports.jsx(CommonLoginForm, {})
            })]
          });
        }
        const ImageModal = () => {
          ...
          const LoginModalWrapper = reactExports.useMemo(() => {
            if (showLoginModal !== void 0) {
              return /* @__PURE__ */jsxRuntimeExports.jsx(GoogleOAuthProvider, {
                ...
                children: /* @__PURE__ */jsxRuntimeExports.jsx(CommonLoginModal, {
                  showLoginModal,
        ...
        const ShowLoading$1 = exports("S", reactExports.memo(ShowLoading));
        ...
        function LazyLoadImgStandard({
          ...
          preloadImg = preloadImg ?? (preloadRatio === "1-1" ? preloadSquareImg : preloadCoverImg$2);
        ...
        exports("p", useGetFeLocationQuery);
        ...
        function HomePage() {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(LayoutMainPage, {
            title: /* @__PURE__ */jsxRuntimeExports.jsx("h1", {
              className: "text-left",
              children: locationData?.title ?? "Loading..."
            }),
        ...
        function ClientStatistics({
          ...
          const formattedLastVisit = formatDate$1(data.data?.data?.lastVisit);
          const formattedCostSum = formatPrice$2(data.data?.data?.costSum || 0);
          return /* @__PURE__ */jsxRuntimeExports.jsxs(IonCard, {
            children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonCardHeader, {
        ...
        function WorkerStatistics({
          ...
          const formattedCostSum = formatPrice$1(data.data?.data?.costSum || 0);
          return /* @__PURE__ */jsxRuntimeExports.jsxs(IonCard, {
            children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonCardHeader, {
              children: /* @__PURE__ */jsxRuntimeExports.jsx(IonCardTitle, {
                children: /* @__PURE__ */jsxRuntimeExports.jsx("div", {
        ...
        function WorkingDaysPlanCustomTime({
          ...
          const [timeFromUtc, setTimeFromUtc] = reactExports.useState(existingShift1000?.timeFromUtc || DEFAULT_TIME_FROM_UTC);
          const [timeToUtc, setTimeToUtc] = reactExports.useState(existingShift1000?.timeToUtc || DEFAULT_TIME_TO_UTC);
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs(IonRow, {
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs(IonCol, {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                      ...
                      children: fromUtcHM(timeFromUtc)
                    })]
                  }), /* @__PURE__ */jsxRuntimeExports.jsxs(IonCol, {
                    style: {
                      textAlign: "-webkit-center"
        ...
        function WorkingDaysPlanList({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
            children: [/* @__PURE__ */jsxRuntimeExports.jsxs(IonToolbar, {
              ...
              children: listOfDaysInSelectedMonth.map(day => /* @__PURE__ */jsxRuntimeExports.jsx(IonItem, {
                className: day.isLastDayOfWeek ? "border-white border-b-4" : void 0,
                disabled: isLoading && requestedDate?.includes(day.dateUtc) || requestedDate.length > 2,
                children: /* @__PURE__ */jsxRuntimeExports.jsx(IonGrid, {
                  children: /* @__PURE__ */jsxRuntimeExports.jsxs(IonRow, {
                    ...
                    }), getWorkingHoursForDay(day.dateUtc).map(workingHour => /* @__PURE__ */jsxRuntimeExports.jsx(IonCol, {
                      className: "flex justify-center",
                      children: /* @__PURE__ */jsxRuntimeExports.jsxs(IonButton, {
                        ...
                        onClick: handleSelectShift(day.dateUtc, workingHour.shift, isWorkingHourActive(day.dateUtc, workingHour)),
                        children: [formatTime(workingHour.timeFromUtc), " -", " ", formatTime(workingHour.timeToUtc)]
                      })
                    }, workingHour.id)), getWorkingHoursForDay(day.dateUtc).length > 0 && /* @__PURE__ */jsxRuntimeExports.jsx(IonCol, {
                      className: "flex justify-center",
                      children: (() => {
                        ...
                        return /* @__PURE__ */jsxRuntimeExports.jsxs(IonButton, {
                          ...
                          children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonIcon, {
                            icon: timeOutline,
                            className: "mr-2"
                          }), customShift ? `${formatTime(customShift.timeFromUtc)} - ${formatTime(customShift.timeToUtc)}` : t("Izaberi vreme")]
                        });
                      })()
                    })]
                  })
        ...
        function PrepareWorkingDaysShiftsPage() {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(LayoutMainPage, {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsx(SelectWorker, {
              ...
              selectedWorker
            }), selectedWorker && /* @__PURE__ */jsxRuntimeExports.jsx(WorkingDaysPlanList, {
        ...
        function OwnerHomePage() {
          ...
          const handleActionSheetAction = action => {
            ...
            switch (action) {
              case "prepare-day":
                router.push(`${urlPrefix}/t/salon/pripremi`);
                break;
              case "edit-data":
                router.push(`${urlPrefix}/podesavanja/podaci`);
                break;
              case "settings":
                router.push(`${urlPrefix}/podesavanja/generalno`);
                break;
              case "working-hours":
                router.push(`${urlPrefix}/podesavanja/radno-vreme`);
                break;
              case "workers":
                router.push(`${urlPrefix}/podesavanja/radnici`);
                break;
              case "announcements":
                router.push(`${urlPrefix}/podesavanja/vesti`);
                break;
              case "services":
                router.push(`${urlPrefix}/podesavanja/usluge`);
                break;
              case "promo-codes":
                router.push(`${urlPrefix}/podesavanja/promo-kodovi`);
                break;
            }
          };
            ...
            children: /* @__PURE__ */jsxRuntimeExports.jsx(IonToolbar, {
              children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonButton, {
                  ...
                  routerLink: `${urlPrefix}/t/salon/pripremi`,
                  expand: "block",
                  className: "flex-1",
                  color: "dark",
                  fill: "outline",
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(LayoutMainPage, {
            ...
            children: [activeLocation && /* @__PURE__ */jsxRuntimeExports.jsx(LocationStatistics, {
              ...
              buttons: [{
                text: t("Priprema radnih dana"),
                icon: timeOutline,
                handler: () => handleActionSheetAction("prepare-day")
              }, {
                text: t("Izmeni podatke"),
                icon: createOutline,
                ...
                text: t("Opšta podešavanja"),
                icon: settingsOutline,
                handler: () => handleActionSheetAction("settings")
              }, {
                text: t("Podesi radno vreme"),
                icon: timeOutline,
                ...
                text: t("Vesti i važna saopštenja"),
                icon: megaphoneOutline,
        ...
        const MainTabs = ({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(IonTabs, {
            children: [/* @__PURE__ */jsxRuntimeExports.jsxs(IonRouterOutlet, {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs(IonTabButton, {
                tab: "salon",
                href: `${url}/salon`,
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonIcon, {
                  icon: cutOutline
        ...
        function SelectWorkerStep({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
            ...
            }), /* @__PURE__ */jsxRuntimeExports.jsxs(IonGrid, {
              className: "ion-no-padding",
              children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonRow, {
                className: "ion-no-padding",
                children: workers.map(worker => /* @__PURE__ */jsxRuntimeExports.jsx(IonCol, {
                  size: "6",
                  sizeMd: "4",
                  sizeLg: "3",
                  className: "ion-no-padding",
                ...
                children: /* @__PURE__ */jsxRuntimeExports.jsx(IonCol, {
                  children: /* @__PURE__ */jsxRuntimeExports.jsxs(IonItem, {
                    ...
                    children: [t("Bilo ko"), /* @__PURE__ */jsxRuntimeExports.jsx(IonIcon, {
                      slot: "end",
                      icon: chevronForwardOutline
                    })]
                  })
        ...
        exports("s", useGetFeServiceGroupsQuery);
        ...
        function CreateReservationModal({
          ...
          reactExports.useEffect(() => {
            if (createReservationResponse.isSuccess && createReservationResponse.data?.success) {
              ...
              onConfirm?.();
              onCancel();
              push(`${urlPrefix}/r/${data.hash}?backToHome=1`);
        ...
        function CreateAppointmentPage() {
          ...
          reactExports.useEffect(() => {
            ...
            if (step === 0 || step === 1) {
              ...
              setBackButtonUrl(`${urlPrefix}/t/termini`);
            }
          }, []);
          reactExports.useEffect(() => {
            const params = new URLSearchParams(location.search);
        ...
        const PublicProfilePage = reactExports.lazy(() => __vitePreload(() => module.import('./PublicProfilePage-legacy-Cz5JQuVi.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationWorkingTimePage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkingTimePage-legacy-j345NQVQ.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationEditPage-legacy-CiieUpNZ.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationWorkersPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkersPage-legacy-BxlNeIAC.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationSettingsPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationSettingsPage-legacy-Bmx2q5JJ.js'), false              ? __VITE_PRELOAD__ : void 0));
        function LocationSettingsPageWrapper() {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsx(LayoutMainPage, {
            ...
            title: /* @__PURE__ */jsxRuntimeExports.jsx("h1", {
              className: "text-left",
              children: t("Podešavanja lokacije")
            }),
            hasBackButton: true,
        ...
        const ServicesPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServicesPage-legacy-D2PopGsA.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceGroupEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceGroupEditPage-legacy-Clzo0NRr.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceEditPage-legacy-BjRYBtJt.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        exports("v", useUpdateServiceGroupMutation);
        ...
        exports("w", useUpdateServiceMutation);
        ...
        const LocationWorkerCreatePage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkerCreatePage-legacy-BN6DU7d7.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const Menu = reactExports.lazy(() => __vitePreload(() => module.import('./Menu-legacy-B3ZaLW9O.js'), false              ? __VITE_PRELOAD__ : void 0));
        setupIonicReact({
          swipeBackEnabled: isPwa && !isIos,
          animated: !isIos
        });
        const urlPrefix = exports("e", getInitialData("appSlug") ?? "/zakazivanje");
        const preloadedLocationData = exports("q", getInitialData("locationData", true));
        const activeLocation = exports("h", preloadedLocationData?.slug ?? "berbernica-tanja");
        ...
        function App() {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(IonApp, {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsx("swiper-container", {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsx(CommonModalWrappers$1, {}), !isWebView && isPwa && /* @__PURE__ */jsxRuntimeExports.jsx(CommonNotificationWrapper, {}), /* @__PURE__ */jsxRuntimeExports.jsxs(IonSplitPane, {
                contentId: "main",
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(Menu, {}), /* @__PURE__ */jsxRuntimeExports.jsxs(IonRouterOutlet, {
                  id: "main",
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx(Route, {
                    path: `${urlPrefix}/t`,
                    component: MainTabs
