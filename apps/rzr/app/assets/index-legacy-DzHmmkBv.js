;
(function () {
  System.register(['./vendor_ionic-legacy-CtJTU_-p.js', './vendor_react-legacy-CWUgxXrv.js', './vendor_leaflet-legacy-SWrD2G_G.js'], function (exports, module) {
    'use strict';
    ...
    return {
      ...
      execute: function () {
        ...
        const App = reactExports.lazy(() => __vitePreload(() => module.import('./App-legacy-DluTxaR-.js').then(n => n.af), false              ? __VITE_PRELOAD__ : void 0));
