import { e as reactExports, M as useTranslation, j as jsxRuntimeExports, az as parseISO, aC as format, aj as SwiperSlide, a2 as t, a3 as yup, aV as isPast, aW as addMinutes } from "./vendor_react-g1Lb8P9R.js";
import { b as useGetOneFeReservationQuery, c as useUpdateFeReservationMutation } from "./reservation.services-Cm2cQVED.js";
import { n as activeLocation, r as SceletonLoader, A as fromUtcDateTimeToTime, s as getPathBySize, S as SwiperWrapper, x as useFormWithSchema, D as DynamicForm, b as useUser, g as urlPrefix, C as ConditionalComponent, I as IonAlertConfirmation, l as useQueryParamsHook, L as LayoutMainPage } from "./App-BTZwZ6xb.js";
import { r as IonItem, C as IonGrid, D as IonRow, E as IonCol, b as IonIcon, bu as calendarClearOutline, ag as calendarOutline, ah as timeOutline, by as pricetagOutline, h as IonTitle, ba as IonBadge, c as alertCircleOutline, bz as hourglassOutline, bA as helpOutline, d as IonButton, p as IonFooter, f as IonToolbar, b1 as personOutline, bB as closeCircleOutline, bC as personRemoveOutline, b9 as checkmarkCircleOutline, u as useIonToast, ao as useIonRouter } from "./vendor_ionic-XqfGltiy.js";
...
import { a as useGetFeLocationClientsQuery, u as useGetFeClientDataQuery } from "./client.services-CxQTZrpi.js";
import { g as getClientFormFields, a as getAdministrationClientFormFields, C as ClientDataModal } from "./ClientDataModal-DYqXh4eE.js";
...
function ConfirmReservationPage({
  ...
  const handleConfirm = reactExports.useCallback(async () => {
    ...
    try {
      ...
      showSuccessToast({
        message: t2("Greška pri potvrdi rezervacije"),
        duration: 3e3,
        color: "danger"
      });
    } finally {
  ...
  const handleClientModalSave = reactExports.useCallback(
    async (data) => {
      if (isProcessing) {
        return;
      }
