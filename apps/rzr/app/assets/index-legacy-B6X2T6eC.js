;
(function () {
  System.register(['./vendor_ionic-legacy-mZi8EIkK.js', './vendor_react-legacy-DonFScn3.js', './vendor_leaflet-legacy-CSx1IcTV.js'], function (exports, module) {
    'use strict';
    ...
    return {
      ...
      execute: function () {
        ...
        const App = reactExports.lazy(() => __vitePreload(() => module.import('./App-legacy-CxwuunNq.js').then(n => n.ad), false              ? __VITE_PRELOAD__ : void 0));
        initializeTheme();
