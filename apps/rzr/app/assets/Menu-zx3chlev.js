import { M as useTranslation, v as instance, j as jsxRuntimeExports, n as withRouter, aJ as useLocation, e as reactExports } from "./vendor_react-CZodnfjS.js";
import { b as IonIcon, bj as globe, y as IonSelect, z as IonSelectOption, bk as home, b0 as alarmOutline, aR as settingsOutline, bl as IonMenu, k as IonContent, H as IonList, ap as IonListHeader, bm as IonMenuToggle, r as IonItem, bf as shieldCheckmarkOutline, G as IonLabel, aF as logInOutline, bn as powerOutline, p as IonFooter, b1 as personOutline, aU as notificationsOutline } from "./vendor_ionic-DAnbjjdE.js";
import { u as useAppDispatch, a as useAppDispatch$1, b as useUser, c as useAppSelector, d as useRemoveConnectedDeviceMutation, U as UserGroupCode, e as userHasRoles, i as isPwa, f as isIos, g as urlPrefix } from "./App-kfoom-0N.js";
import { s as sharedApi, a as TagType, m as getDeviceData, v as rzrApi, w as TagType$1, l as setShowLoginModal } from "./index-DZE_gcZd.js";
...
const Menu = ({ history }) => {
  ...
  const isAdmin = userData ? userHasRoles(userData, [UserGroupCode.Admin]) : false;
  const filteredAppPages = routes.appPages.filter((page) => {
    if (page.path === "podesavanja") {
    ...
    IonMenu,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(IonContent, { class: "ion-no-padding", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(IonList, { lines: "none", inset: false, className: "mt-0 pt-0", children: renderListItems(filteredAppPages) }),
          isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsxs(IonList, { lines: "none", inset: false, className: "mt-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(IonListHeader, { children: "Admin" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(IonMenuToggle, { "auto-hide": "false", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              IonItem,
              {
                detail: false,
                button: true,
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(IonIcon, { slot: "start", icon: shieldCheckmarkOutline }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(IonLabel, { children: "Admin Panel" })
                ]
              }
            ) })
          ] }),
