;
(function () {
  System.register(['./vendor_react-legacy-BvXhJo_m.js', './App-legacy-CrOJveas.js', './vendor_ionic-legacy-dqJd8vxA.js', './logo-square-legacy-a1ldHo9F.js', './BookingWeekDays-legacy-BdAqGt4L.js', './reservation.services-legacy-5uHLtr6C.js', './client.services-legacy-DP0ZUVHz.js', './UserAvatar-legacy-CLlHjpHm.js', './useQueryParamsHook-legacy-IGoM7uue.js', './vendor_leaflet-legacy-DGSDSOBP.js', './index-legacy-s-zmdzEW.js', './vendor_firebase-legacy-G_df00wk.js', './workingShift.fe-services-legacy-Bwt6G_Xp.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        IonButton = module.d;
        checkmarkCircle = module.bd;
        addOutline = module.a6;
        trashOutline = module.O;
        removeOutline = module.be;
        IonCard = module.aX;
        ...
        IonContent = module.b;
        cashOutline = module.bh;
        IonBadge = module.b0;
        IonFooter = module.o;
        closeOutline = module.m;
        calendarClearOutline = module.bi;
        chevronDownOutline = module.bj;
        chevronUpOutline = module.bk;
        arrowBack = module.bl;
        arrowForward = module.bm;
      }, module => {
