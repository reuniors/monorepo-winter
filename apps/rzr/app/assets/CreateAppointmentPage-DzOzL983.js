...
import { g as generateWeek, h as hasAnySlotsInWeek, a as getDaysWithSlotsSet, B as BookingCalendarHeader, b as BookingWeekDays } from "./BookingWeekDays-B3YS0Zf2.js";
import { r as rzrApi, o as TagType, k as getDeviceData, l as setDeviceData } from "./index-CkdE7eRY.js";
import { u as useCreateFeReservationMutation, a as useGetFePromoCodeDataQuery } from "./reservation.services-BbzrhFaR.js";
import { u as useGetFeClientDataQuery } from "./client.services-DsJtIaUD.js";
...
function BookingSlotsSwiper({
  ...
  const activeSlideIndex = reactExports.useMemo(() => {
    if (isCalendarOpen && currentMonth) {
      if (!monthHasSlots) {
        const emptyWeekIndex = slides.findIndex(
