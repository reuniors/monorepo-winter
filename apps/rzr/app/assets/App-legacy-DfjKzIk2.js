  ...
  System.register(['./vendor_ionic-legacy-DTzAUkB1.js', './vendor_react-legacy-HHx4U8Zg.js', './index-legacy-kz2gdOez.js', './vendor_firebase-legacy-ByYi5ToB.js'], function (exports, module) {
    ...
    return {
      setters: [module => {
        ...
        businessOutline = module.aI;
        IonActionSheet = module.aJ;
        IonTabs = module.aK;
        IonRouterOutlet = module.aL;
        IonTabBar = module.aM;
        IonTabButton = module.aN;
        homeOutline = module.aO;
        alarmOutline = module.aP;
        notificationsOutline = module.aQ;
        personOutline = module.aR;
        useIonViewDidLeave = module.aS;
        IonCard = module.aT;
        IonCardContent = module.aU;
        checkmarkCircleOutline = module.aV;
        IonCardHeader = module.aW;
        IonCardTitle = module.aX;
        IonBadge = module.aY;
        refreshOutline = module.aZ;
        IonApp = module.a_;
        IonReactRouter = module.a$;
        IonSplitPane = module.b0;
        setupIonicReact = module.b1;
      }, module => {
      ...
      execute: function () {
        ...
        const transformPaginationResponseToCamelCase = exports("U", response => humpsExports.camelizeKeys(response.data));
        ...
        const convertEmptyStringToNull = exports("J", value => value === "" || lodashExports.isNumber(value) && isNaN(value) ? null : value);
        const generateSlugForValidation = exports("K", text => {
        ...
        const photosArrayWithIdYup = exports("E", errorMsg => yup.array().nullable().defined().test("all-photos-have-id", "", function (value) {
        ...
        const useConfirmationAlert = exports("g", (callbacks, options) => {
        ...
        const getPathBySize = exports("l", img => {
          if (!img) {
            return "";
          }
          switch (true) {
        ...
        const getAppTimezone = exports("m", () => {
          return appTimezone;
        });
        ...
        const fromUtc = exports("Z", (utcTimeString, tz) => {
          const timezone = getAppTimezone();
        ...
        const useIsBigScreen = exports("p", (breakpoint = 1024) => {
        ...
        const ionIconList = [];
        const ionIcons = {};
        const fetchIonIconsList = exports("a0", () => {
        ...
        const generateSlug = exports("H", str => {
        ...
        const ListIonIcons = reactExports.lazy(() => __vitePreload(() => module.import('./ListIonIcons-legacy-BGBkHM9m.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ShowLoading$1 = exports("Q", reactExports.memo(ShowLoading));
        ...
        const SceletonLoader = exports("k", reactExports.memo(SkeletonLoader));
        ...
        const mainHeaderClasses = exports("O", isWebPlatform ? "max-w-[80vw]" : "");
        ...
        const HomePage = reactExports.lazy(() => __vitePreload(() => module.import('./HomePage-legacy-Tt426kmn.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const AppointmentPage = reactExports.lazy(() => __vitePreload(() => module.import('./AppointmentPage-legacy-D5kX6miV.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ProfilePage = reactExports.lazy(() => __vitePreload(() => module.import('./ProfilePage-legacy-DdXmRcm8.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NotificationPage = reactExports.lazy(() => __vitePreload(() => module.import('./NotificationPage-legacy-CbxFWmdC.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const PrepareWorkingDaysShiftsPage = reactExports.lazy(() => __vitePreload(() => module.import('./PrepareWorkingDaysShiftsPage-legacy-Bur02GjW.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const OwnerHomePage = reactExports.lazy(() => __vitePreload(() => module.import('./OwnerHomePage-legacy-CKi5x3Q4.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const OwnerAppointmentPage = reactExports.lazy(() => __vitePreload(() => module.import('./OwnerAppointmentPage-legacy-EoJFbGHa.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const SettingsPage = reactExports.lazy(() => __vitePreload(() => module.import('./SettingsPage-legacy-xB1SMqKD.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const CreateAppointmentPage = reactExports.lazy(() => __vitePreload(() => module.import('./CreateAppointmentPage-legacy-CpjGZUUQ.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ConfirmReservationPage = reactExports.lazy(() => __vitePreload(() => module.import('./ConfirmReservationPage-legacy-C_KYnfOs.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const PublicProfilePage = reactExports.lazy(() => __vitePreload(() => module.import('./PublicProfilePage-legacy-BdXRWhoz.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NewsListPage = reactExports.lazy(() => __vitePreload(() => module.import('./NewsListPage-legacy-DIX-kO10.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NewsCreatePage = reactExports.lazy(() => __vitePreload(() => module.import('./NewsCreatePage-legacy-xaWZIOvy.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NewsEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./NewsEditPage-legacy-Df_SV--3.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationWorkingTimePage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkingTimePage-legacy-CxOvunMi.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationEditPage-legacy-C5HPqxn8.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationWorkersPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkersPage-legacy-C0yFPaZh.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationSettingsPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationSettingsPage-legacy-DVmig1SH.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServicesPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServicesPage-legacy-lonQvzeO.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceCategoriesPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceCategoriesPage-legacy-CabAUOUs.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceCategoryEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceCategoryEditPage-legacy-CJGXDnva.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceGroupEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceGroupEditPage-legacy-CAZfovzP.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceEditPage-legacy-BamaN3Lb.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        exports("P", useUpdateServiceMutation);
        ...
        const LocationWorkerCreatePage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkerCreatePage-legacy-C2dPry4D.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const Menu = reactExports.lazy(() => __vitePreload(() => module.import('./Menu-legacy-zjqicrNA.js'), false              ? __VITE_PRELOAD__ : void 0));
        setupIonicReact({
        ...
        const preloadedLocationData = exports("x", getInitialData("locationData", true, true));
