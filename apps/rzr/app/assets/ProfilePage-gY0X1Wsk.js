import { e as reactExports, aD as useTranslation, j as jsxRuntimeExports, av as parseISO, ay as format } from "./vendor_react-CkWllzXf.js";
import { u as useClipboard, b as useGetClientProfilesQuery, U as UserAvatar, C as ClientStatistics } from "./client-profile.fe-services-BI_ojIzf.js";
import { n as IonSpinner, aS as IonCard, aU as IonCardHeader, aV as IonCardTitle, aW as IonCardContent, q as IonItem, l as IonIcon, ad as calendarOutline, E as IonLabel, c as IonText, b4 as checkmarkCircleOutline, bk as closeCircleOutline, ae as timeOutline, bs as walletOutline, d as IonButton, bt as refreshOutline, aY as IonAccordionGroup, aZ as IonAccordion, F as IonList, ah as mailOutline, bi as callOutline, aQ as personOutline, bx as pencilOutline } from "./vendor_ionic-DWBJibLm.js";
import { h as activeLocation, f as urlPrefix, b as useUser, a as useAppDispatch, o as useGetFeClientDataQuery, _ as useUpdateFeClientDataMutation, C as ConditionalComponent } from "./App-Bh_O7g2K.js";
import { C as ClientDataModal } from "./ClientDataModal-zZomWRbz.js";
import { a as useGetWorkerStatisticsQuery } from "./statistics.fe-services-BsXKZ4Cn.js";
import { P as Pagination } from "./Pagination-BuxvP6k6.js";
import { j as setShowLoginModal } from "./index-BTCKI7vG.js";
