import { e as reactExports, aD as useTranslation, j as jsxRuntimeExports, ay as format, aw as formatInTimeZone, av as parseISO, R as React, af as SwiperSlide } from "./vendor_react-B_SHD62b.js";
import { aj as useIonRouter, n as IonSpinner, l as IonIcon, a$ as cashOutline, q as IonItem, h as IonHeader, i as IonToolbar, k as IonButtons, d as IonButton, ar as chevronBackOutline, j as IonTitle, $ as chevronForwardOutline } from "./vendor_ionic-DsqPkyBY.js";
import { x as useGetFeWorkersQuery, h as activeLocation, f as urlPrefix, a3 as getAppTimezone, w as fromUtcHM, a5 as useContentRefFunctions, a6 as useGetFeLocationReservationsQuery, a4 as getUtcDateFormattedInTz, a7 as parseUtcDate, a8 as getTimeSlotsForTable, S as SceletonLoader, l as SwiperWrapper, q as useQueryParamsHook, H as useGetFeServiceCategoriesQuery } from "./App-5MUv5Yp_.js";
import { d as useGetFeWorkerWorkingShiftsByDaysQuery } from "./workingShift.fe-services-FJIH8tU1.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-black min-h-screen", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full px-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gray-900 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-gray-800 relative", children: selectedDateSlots.map((timeSlotInfo, index) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(React.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "py-2 transition-colors duration-200 relative ".concat(timeSlotInfo.isPause ? "bg-gray-700 border-l-4 border-gray-500" : reservation ? "hover:bg-gray-800" : "hover:bg-gray-800 cursor-pointer"),
