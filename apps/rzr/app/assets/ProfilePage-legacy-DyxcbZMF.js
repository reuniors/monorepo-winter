  ...
  System.register(['./vendor_react-legacy-3NN3kxAt.js', './UserAvatar-legacy-uHxl9MA-.js', './vendor_ionic-legacy-O-KkNIDb.js', './client-profile.fe-services-legacy-DlMYcCG2.js', './client.services-legacy-DbR95cqe.js', './App-legacy-TNpJykv7.js', './ClientDataModal-legacy-CRVbVl8a.js', './statistics.fe-services-legacy-DxTHNP5Y.js', './Pagination-legacy-D-X_JT-q.js', './index-legacy-C1Ac2ckm.js', './vendor_leaflet-legacy-D7880HPH.js', './vendor_firebase-legacy-PP5vvGhm.js'], function (exports, module) {
    ...
    return {
      setters: [module => {
        ...
        closeCircleOutline = module.bv;
        timeOutline = module.ae;
        walletOutline = module.bA;
        IonButton = module.d;
        ...
        useDeviceNotification = module.aa;
        isPwa = module.i;
        isInstalled = module.ab;
        isWebView = module.ac;
