;
(function () {
  System.register(['./vendor_react-legacy-j-OXaHGn.js', './UserAvatar-legacy-D5EYjyD2.js', './vendor_ionic-legacy-B27OJI2l.js', './client-profile.fe-services-legacy-Cq2zRNKS.js', './client.services-legacy-CgH53VbP.js', './App-legacy-C1PSXo8s.js', './ClientDataModal-legacy-Bt4gOYOl.js', './statistics.fe-services-legacy-D9ZJt6du.js', './Pagination-legacy-h82_810c.js', './index-legacy-DzaXWAZQ.js', './vendor_leaflet-legacy-aVamlEE1.js', './vendor_firebase-legacy-BLL9XPHC.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        closeCircleOutline = module.bo;
        timeOutline = module.ae;
        walletOutline = module.bw;
        IonButton = module.d;
        ...
        callOutline = module.bm;
        personOutline = module.aR;
        pencilOutline = module.bB;
      }, module => {
