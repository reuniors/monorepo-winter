;
(function () {
  System.register(['./vendor_ionic-legacy-qIZJoxql.js', './vendor_react-legacy-J-9YdXs8.js', './vendor_leaflet-legacy-CcTkPRIU.js'], function (exports, module) {
    'use strict';

    var IonPage, IonContent, IonText, IonButton, __vitePreload, defineCustomElements, instance, Backend, Browser, initReactI18next, fetchBaseQuery, gBase64, createApi, createAction, createSlice, humpsExports, isRejectedWithValue, combineReducers, configureStore, jsxRuntimeExports, persistStore, persistReducer, FLUSH, REHYDRATE, PAUSE, PERSIST, PURGE, REGISTER, storage, reactExports, clientExports, Provider, PersistGate, ErrorBoundary;
    return {
      setters: [module => {
        IonPage = module.I;
        IonContent = module.b;
      ...
      execute: function () {
        ...
        const App = reactExports.lazy(() => __vitePreload(() => module.import('./App-legacy-CSGT8g8C.js').then(n => n.ai), false              ? __VITE_PRELOAD__ : void 0));
        initializeTheme();
