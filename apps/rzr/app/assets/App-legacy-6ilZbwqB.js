  ...
  System.register(['./vendor_ionic-legacy-DGRHWrdu.js', './vendor_react-legacy-VZwyi0Js.js', './index-legacy-Blp5H0fR.js', './vendor_firebase-legacy-BVpRmQ4X.js'], function (exports, module) {
    ...
    return {
      setters: [module => {
        ...
        IonSegment = module.aC;
        IonSegmentButton = module.aD;
        createOutline = module.aE;
        giftOutline = module.aF;
        settingsOutline = module.aG;
        peopleOutline = module.aH;
        megaphoneOutline = module.aI;
        useIonViewWillLeave = module.aJ;
        businessOutline = module.aK;
        IonActionSheet = module.aL;
        IonTabs = module.aM;
        IonRouterOutlet = module.aN;
        IonTabBar = module.aO;
        IonTabButton = module.aP;
        homeOutline = module.aQ;
        alarmOutline = module.aR;
        notificationsOutline = module.aS;
        personOutline = module.aT;
        useIonViewDidLeave = module.aU;
        informationCircleOutline = module.aV;
        appsOutline = module.aW;
        IonCard = module.aX;
      ...
      execute: function () {
        ...
        exports({
          D: DynamicForm,
          E: IonAlertConfirmation,
          H: SimpleFormStepperActions,
          K: StepIndicator,
          L: LayoutMainPage,
        ...
        const convertEmptyStringToNull = exports("V", value => value === "" || lodashExports.isNumber(value) && isNaN(value) ? null : value);
        const generateSlugForValidation = exports("W", text => {
        ...
        const photosArrayWithIdYup = exports("J", errorMsg => yup.array().nullable().defined().test("all-photos-have-id", "", function (value) {
        ...
        const getAppTimezone = exports("n", () => {
          return appTimezone;
        });
        ...
        const toUtc = exports("w", (timeString, tz) => {
        ...
        const fromUtc = exports("a5", (utcTimeString, tz) => {
          const timezone = getAppTimezone();
        ...
        const fromUtcHM = exports("o", (utcTimeString, tz) => {
          const timezone = getAppTimezone();
        ...
        const fromUtcDateTimeToTime = exports("B", (utcDateTime, tz) => {
          const timezone = getAppTimezone();
        ...
        const getUtcDateFormattedInTz = exports("a6", (utcDateString, tz) => {
          const timezone = getAppTimezone();
        ...
        const useIsBigScreen = exports("q", (breakpoint = 1024) => {
        ...
        const generateSlug = exports("R", str => {
        ...
        const useShowNotification = exports("G", options => {
        ...
        const ListIonIcons = reactExports.lazy(() => __vitePreload(() => module.import('./ListIonIcons-legacy-CHYMvWNN.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const mainHeaderClasses = exports("X", isWebPlatform ? "max-w-[80vw]" : "");
        ...
        exports("x", useGetFeLocationQuery);
        const HomePage = reactExports.lazy(() => __vitePreload(() => module.import('./HomePage-legacy-BBa448xN.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const AppointmentPage = reactExports.lazy(() => __vitePreload(() => module.import('./AppointmentPage-legacy-CBMZ4FwD.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ProfilePage = reactExports.lazy(() => __vitePreload(() => module.import('./ProfilePage-legacy-2c-pO3Qz.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NotificationPage = reactExports.lazy(() => __vitePreload(() => module.import('./NotificationPage-legacy-D7JxpIFs.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        exports({
          ...
          a2: useCreateWorkerMutation,
          P: useGetAllWorkersQuery
        });
        ...
        const PrepareWorkingDaysShiftsPage = reactExports.lazy(() => __vitePreload(() => module.import('./PrepareWorkingDaysShiftsPage-legacy-C5fgwcRc.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const getSettingsOptions = exports("a4", urlPrefix => [{
        ...
        const OwnerHomePage = reactExports.lazy(() => __vitePreload(() => module.import('./OwnerHomePage-legacy-zxO_fO7g.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const OwnerAppointmentPage = reactExports.lazy(() => __vitePreload(() => module.import('./OwnerAppointmentPage-legacy-BzSVeVcA.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const SettingsPage = reactExports.lazy(() => __vitePreload(() => module.import('./SettingsPage-legacy-DRxNvivi.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const pushDuplicateAndNavigate = exports("v", (router, destination, referrer) => {
        ...
        const CreateAppointmentPage = reactExports.lazy(() => __vitePreload(() => module.import('./CreateAppointmentPage-legacy-t3cXbvRR.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ConfirmReservationPage = reactExports.lazy(() => __vitePreload(() => module.import('./ConfirmReservationPage-legacy-CsPOsfhD.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const PublicProfilePage = reactExports.lazy(() => __vitePreload(() => module.import('./PublicProfilePage-legacy-DVXp_P8y.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NewsListPage = reactExports.lazy(() => __vitePreload(() => module.import('./NewsListPage-legacy-DyxQy3r5.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NewsCreatePage = reactExports.lazy(() => __vitePreload(() => module.import('./NewsCreatePage-legacy-D-sPV8NS.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NewsEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./NewsEditPage-legacy-C20dAyPG.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationWorkingTimePage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkingTimePage-legacy-nGqZcIyM.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationEditPage-legacy-Dm-W-Xf7.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationWorkersPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkersPage-legacy-PmldkA5W.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationSettingsPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationSettingsPage-legacy-Ctz-o6z5.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServicesPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServicesPage-legacy-DAcAIFdu.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceCategoriesPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceCategoriesPage-legacy-CmVCrgt1.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceCategoryEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceCategoryEditPage-legacy-G4v7eXY3.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceGroupEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceGroupEditPage-legacy-Jpeu4Wsf.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        exports("A", useGetFeServiceGroupsQuery);
        const ServiceEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceEditPage-legacy-CXq8faTz.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        exports("Y", useUpdateServiceMutation);
        ...
        const LocationWorkerCreatePage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkerCreatePage-legacy-CRVu6UCX.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        exports({
          z: useGetFeServiceCategoriesQuery,
          Q: useCreateServiceCategoryMutation,
          T: useUpdateServiceCategoryMutation,
          U: useDeleteServiceCategoryMutation
        });
        ...
        const Menu = reactExports.lazy(() => __vitePreload(() => module.import('./Menu-legacy-D5W7Xo2N.js'), false              ? __VITE_PRELOAD__ : void 0));
        setupIonicReact({
        ...
        const preloadedLocationData = exports("y", getInitialData("locationData", true, true));
        ...
        const reservationTimeInterval = exports("r", preloadedLocationData?.timeSlotInterval ?? 30);
