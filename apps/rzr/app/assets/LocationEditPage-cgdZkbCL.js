import { a$ as O, b0 as w, b1 as useMap, e as reactExports, R as React, j as jsxRuntimeExports, b2 as MapContainer, b3 as TileLayer, a0 as t, a3 as Controller, a1 as create$3, aM as create$7, a2 as create$6, aD as useTranslation, aL as create$5, aN as create$2 } from "./vendor_react-DSVIR5Ln.js";
import { f as IonModal, h as IonHeader, i as IonToolbar, j as IonTitle, k as IonButtons, d as IonButton, l as IonIcon, m as closeOutline, b as IonContent, q as IonItem, o as IonFooter, c as IonText, E as IonLabel, r as IonInput, bp as informationCircleOutline, bq as imagesOutline, br as locationOutline, aE as settingsOutline, aj as useIonRouter, n as IonSpinner } from "./vendor_ionic-DMW4l-HL.js";
import { b as useUser, F as FieldType, t as transformStandardResponseToCamelCase, B as useShowNotification, q as useFormWithSchema, D as DynamicForm, E as photosArrayWithIdYup, w as useGetFeLocationQuery, j as activeLocation, x as preloadedLocationData } from "./App-DmsCuVFw.js";
import { r as rzrApi, o as TagType } from "./index-CnRQbzop.js";
import { S as SimpleFormStepperActions } from "./SimpleFormStepperActions-2-db0KiR.js";
import { g as getLocationEditSettingsFormFields } from "./location-settings.data-B6bqPF4P.js";
import { u as usePendingImageUploads, S as StepIndicator, a as SimpleFormStepper } from "./usePendingImageUploads-DmZXwqfj.js";
import { L } from "./vendor_leaflet-6FPNYOO1.js";
...
function LocationBasicInfoStep({
  ...
  const formFields = locationId ? getLocationEditFormFields(locationId) : [];
...
function LocationSettingsStep({
  ...
  const handleSubmit = (formValues) => {
    ...
    return updateLocation({
      locationSlug,
      wifiPassword: (_a2 = formValues.wifiPassword) != null ? _a2 : null,
      pwaMetadata: formValues.pwaMetadata || {
        name: null,
        shortName: null,
        themeColor: null,
        backgroundColor: null,
