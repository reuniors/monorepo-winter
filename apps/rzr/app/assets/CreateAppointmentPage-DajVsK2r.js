import { e as reactExports, j as jsxRuntimeExports, ai as SwiperSlide, aJ as useLocation, ak as useHistory, a3 as useTranslation, R as React, aC as format, aP as startOfMonth, aQ as endOfMonth, aR as startOfWeek, aS as addDays, aT as startOfDay, aB as toZonedTime, a1 as yup, aA as formatInTimeZone, az as parseISO } from "./vendor_react-B3gTLzrh.js";
import { g as useDefaultProps, h as useConfirmationAlert, S as SwiperWrapper, j as useContentRefFunctions, b as useUser, k as useQueryParamsHook, l as useGetFeLocationQuery, m as activeLocation, n as useGetFeServiceCategoriesQuery, o as useGetFeWorkersQuery, q as SceletonLoader, r as getPathBySize, s as fromUtcHM, t as getAppTimezone, F as FieldType, v as useIsBigScreen, w as useFormWithSchema, f as urlPrefix, x as pushDuplicateAndNavigate, I as IonModalExtended, D as DynamicForm, N as NotificationToast, y as useGetFeServiceGroupsQuery } from "./App-DX1X7twZ.js";
import { G as IonList, q as IonItem, be as IonAvatar, l as IonIcon, aM as peopleOutline, F as IonLabel, a1 as chevronForwardOutline, d as IonButton, bf as checkmarkCircle, a7 as addOutline, P as trashOutline, bg as removeOutline, a_ as IonCard, a$ as IonCardContent, ac as IonToggle, bh as IonAccordionGroup, bi as IonAccordion, ad as calendarOutline, c as IonText, n as IonSpinner, al as useIonRouter, u as useIonToast, ai as IonLoading, h as IonHeader, i as IonToolbar, ae as timeOutline, b as IonContent, bj as cashOutline, b3 as IonBadge, o as IonFooter, m as closeOutline, bk as calendarClearOutline, bl as chevronDownOutline, bm as chevronUpOutline, bn as arrowBack, bo as arrowForward } from "./vendor_ionic-Bk4xGa1M.js";
import { L as LazyLoadImgStandard, p as preloadCoverImg } from "./logo-square-C2VfZqwT.js";
import { u as useBookingCalendarContext, W as WeekSwiperWrapper, B as BookingCalendarContext, S as SLOT_SEARCH_TOLERANCE_MINUTES, a as BookingCalendarHeader, b as BookingWeekDays, c as BookingCalendarProvider } from "./WeekSwiperWrapper-WEK6GZsm.js";
import { u as useCreateFeReservationMutation, a as useGetFePromoCodeDataQuery } from "./reservation.services-Bdb2hCHk.js";
import { u as useGetFeClientDataQuery } from "./client.services-CGCoqpnI.js";
import { U as UserAvatar } from "./UserAvatar-yUfK4Qhb.js";
import "./vendor_leaflet-CW_5KyQe.js";
import "./index-DnKyBibG.js";
import "./vendor_firebase-Pt9WfZwV.js";
import "./workingShift.fe-services-BXzva9Pc.js";
...
function useCreateAppointmentSteps({
  ...
  const initialStepFromUrl = parseInt((_a = queryParams["step"]) != null ? _a : "0");
...
function CreateReservationModal({
  ...
  const handleInputFocus = async () => {
    ...
    !isBigScreen && currentBreakpoint2 < 0.8 && ((_c2 = modalRef == null ? void 0 : modalRef.current) == null ? void 0 : _c2.setCurrentBreakpoint(0.8));
  };
  reactExports.useEffect(() => {
    var _a2;
          ...
          isModalBigScreen || isBigScreen ? (
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              SwiperWrapper,
              {
                ...
                className: "pb-4",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SwiperSlide, { style: { width: "auto" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(IonBadge, { className: "p-3", color: "warning", children: [
                  ...
                  selectedServices && selectedServices.length > 0 && selectedServices.map((service) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    SwiperSlide,
                    {
                      style: { width: "auto" },
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        IonBadge,
                        {
                          color: "warning",
