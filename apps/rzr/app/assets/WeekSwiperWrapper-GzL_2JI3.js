import { aT as addDays, b0 as isToday$1, aU as startOfDay, av as parseISO, aW as addMinutes, ax as toZonedTime, az as fromZonedTime, aw as formatInTimeZone, e as reactExports, aQ as startOfMonth, aS as startOfWeek, b1 as endOfWeek, ay as format, b2 as isSameDay, b3 as subMonths, b4 as addMonths, aR as endOfMonth, j as jsxRuntimeExports, b5 as parse, b6 as isWithinInterval, b7 as differenceInMinutes, b8 as isSameMonth, af as SwiperSlide, aD as useTranslation } from "./vendor_react-CCLq7r1n.js";
import { i as IonToolbar, d as IonButton, l as IonIcon, ad as calendarOutline, n as IonSpinner, bm as chevronUpOutline, bl as chevronDownOutline, k as IonButtons, as as chevronBackOutline, $ as chevronForwardOutline } from "./vendor_ionic-CVwFN5FQ.js";
import { r as rzrApi, q as TagType } from "./index-C-L2pUlb.js";
import { B as transformStandardResponseToCamelCase, q as getAppTimezone, j as useGetFeWorkersQuery, X as reservationTimeInterval, Y as getUtcDateFormattedInTz, Z as parseUtcDate, S as SwiperWrapper, o as useContentRefFunctions } from "./App-BtUhbQB_.js";
import { u as useGetFeWorkerWorkingShiftsByDaysQuery } from "./workingShift.fe-services-mxVTkRx-.js";
import { d as useGetFeLocationReservationsQuery } from "./reservation.services-CDni4Vbd.js";
...
function useBookingCalendar({
  ...
  const changeWeek = reactExports.useCallback(
    (week) => {
      setCurrentWeek(week);
      if (!isCalendarOpen) {
  ...
  const changeMonth = reactExports.useCallback(
    (month) => {
