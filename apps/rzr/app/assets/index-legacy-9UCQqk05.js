;
(function () {
  System.register(['./vendor_ionic-legacy-Das9dW4a.js', './vendor_react-legacy-8eT2sGuL.js', './vendor_leaflet-legacy-eQNkinhv.js'], function (exports, module) {
    'use strict';
    ...
    return {
      ...
      execute: function () {
        ...
        const getUiData = exports("t", state => state.ui.data);
        ...
        const App = reactExports.lazy(() => __vitePreload(() => module.import('./App-legacy-CaR2AK6H.js').then(n => n.aa), false              ? __VITE_PRELOAD__ : void 0));
