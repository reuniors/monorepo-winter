;
(function () {
  System.register(['./vendor_react-legacy-BvXhJo_m.js', './App-legacy-CP6iF5LZ.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        useUpdateServiceGroupMutation = module.$;
        useCreateServiceGroupMutation = module.a0;
