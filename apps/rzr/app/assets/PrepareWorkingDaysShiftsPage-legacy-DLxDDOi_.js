;
(function () {
  System.register(['./vendor_react-legacy-B0yst0tN.js', './vendor_ionic-legacy-DYIGQWbn.js', './App-legacy-DELDG8Vs.js', './workingShift.fe-services-legacy-X4aBersi.js', './vendor_leaflet-legacy-DKuaEqMF.js', './index-legacy-CXapdytT.js', './vendor_firebase-legacy-Bicf26rb.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        IonCol = module.C;
        IonIcon = module.l;
        closeCircle = module.bG;
        checkmarkCircle = module.bc;
        IonButton = module.d;
        notificationsOffOutline = module.bH;
