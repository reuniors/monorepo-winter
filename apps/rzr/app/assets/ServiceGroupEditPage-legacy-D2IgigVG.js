;
(function () {
  System.register(['./vendor_react-legacy-j-OXaHGn.js', './vendor_ionic-legacy-B27OJI2l.js', './App-legacy-C1PSXo8s.js', './ServiceGroupBasicInfoStep-legacy-kgJzPGie.js', './SimpleFormStepperActions-legacy-DGghVbL1.js', './usePendingImageUploads-legacy-DfrubukC.js', './vendor_leaflet-legacy-aVamlEE1.js', './index-legacy-DzaXWAZQ.js', './vendor_firebase-legacy-BLL9XPHC.js', './props-legacy-s4OYYZ4Y.js'], function (exports, module) {
    'use strict';

    var useTranslation, reactExports, jsxRuntimeExports, t, create$3, create$2, useLocation, informationCircleOutline, constructOutline, imageOutline, useIonRouter, IonList, IonItem, IonIcon, addOutline, IonLabel, IonText, IonReorderGroup, IonReorder, IonSpinner, useGetFeServiceGroupsQuery, activeLocation, useUpdateServiceMutation, ShowLoading, urlPrefix, FieldType, useFormWithSchema, DynamicForm, ServiceGroupBasicInfoStep, SimpleFormStepperActions, usePendingImageUploads, StepIndicator, SimpleFormStepper;
    return {
      setters: [module => {
