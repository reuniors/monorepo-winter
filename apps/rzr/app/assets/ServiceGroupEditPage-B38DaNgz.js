import { a1 as create$3, aR as create$5, aS as create$7, a2 as create$6, a0 as t, aD as useTranslation, j as jsxRuntimeExports, e as reactExports, aT as create$2 } from "./vendor_react-D2bpVGXr.js";
import { bi as informationCircleOutline, a1 as constructOutline, bn as imageOutline, aj as useIonRouter, E as IonList, o as IonItem, i as IonIcon, a6 as addOutline, D as IonLabel, u as IonText, a4 as IonReorderGroup, Y as IonReorder, l as IonSpinner } from "./vendor_ionic-31A1eU6n.js";
import { O as convertEmptyStringToNull, P as generateSlugForValidation, b as useUser, F as FieldType, m as useFormWithSchema, Q as useUpdateServiceGroupMutation, z as useShowNotification, D as DynamicForm, N as useGetFeServiceGroupsQuery, h as activeLocation, R as useUpdateServiceMutation, T as ShowLoading, f as urlPrefix } from "./App-NJG84E_P.js";
...
const serviceGroupBasicInfoFormSchema = create$3().shape({
  ...
  description: create$6().transform(convertEmptyStringToNull).nullable().optional(),
...
function ServiceGroupBasicInfoStep({
  ...
  const [showSuccessNotification] = useShowNotification({
    message: t2("Podaci o grupi su uspešno sačuvani"),
    color: "success"
  });
