import { M as useTranslation, az as parseISO, aT as startOfDay, bd as differenceInDays, aC as format, j as jsxRuntimeExports, aj as SwiperSlide, e as reactExports } from "./vendor_react-BAn6__hR.js";
import { b as useUser, ab as useGetWorkerNextSlotsQuery, S as SwiperWrapper, n as activeLocation, C as ConditionalComponent, s as getPathBySize, q as useGetFeWorkersQuery, r as SceletonLoader, m as useGetFeLocationQuery, p as preloadedLocationData } from "./App-DgEFOGIF.js";
import { d as IonButton, ao as useIonRouter, o as IonSpinner, b2 as IonCard, b3 as IonCardContent, G as IonLabel, b4 as IonCardHeader } from "./vendor_ionic-BUXN7OTv.js";
import { g as getReservationUrlWithParams } from "./reservation.helpers-CjZfzeFf.js";
import { L as LazyLoadImgStandard, p as preloadCoverImg$1 } from "./logo-square-XFUXPXhS.js";
import { N as NewsChyron } from "./NewsChyron-rLaRZ2nk.js";
import "./vendor_leaflet-DChmu6Ei.js";
import "./index-C-Ek-ef-.js";
import "./vendor_firebase-BU9b2OVt.js";
import "./news.fe-services-CNpSwENq.js";
function WorkerNextSlotItem({ slot, onClick }) {
  ...
  if (daysDiff === 0) {
    ...
    dateLabel = t("weeks.".concat(format(slotDate, "EEE")));
  } else {
...
function WorkerNextSlots({ workerId, locationSlug }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    SwiperWrapper,
    {
      ...
      className: "w-full",
      spaceBetween: 2,
      children: slots.map((slot, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        SwiperSlide,
        {
          style: { width: "auto" },
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(WorkerNextSlotItem, { slot, onClick: handleSlotClick })
        },
...
function WorkerItem({ worker }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(IonCard, { className: "m-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(IonCardContent, { className: "p-4 ion-no-margin !p-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "h2",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block sm:inline", children: worker.fullName }),
              worker.maxDiscountPercent && worker.maxDiscountPercent > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-green-600 ml-1 text-sm block sm:inline", children: [
                "(",
                t("Do"),
                " ",
