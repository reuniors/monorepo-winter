;
(function () {
  System.register(['./vendor_react-legacy-BZeT-WEv.js', './vendor_ionic-legacy-FEPq4Efg.js', './App-legacy-D_TQFFiD.js', './index-legacy-yzMe94ue.js', './SimpleFormStepperActions-legacy-BqGxoEln.js', './location-settings.data-legacy-Ch_3FV-f.js', './usePendingImageUploads-legacy-BYdSANSl.js', './vendor_leaflet-legacy-_lyC0eWM.js', './vendor_firebase-legacy-_Nh6fmKA.js'], function (exports, module) {
    'use strict';

    var O, w, useMap, reactExports, React, jsxRuntimeExports, MapContainer, TileLayer, t, Controller, create$3, create$7, create$6, useTranslation, create$5, create$2, IonModal, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonIcon, closeOutline, IonContent, IonItem, IonFooter, IonText, IonLabel, IonInput, informationCircleOutline, imagesOutline, locationOutline, settingsOutline, useIonRouter, IonSpinner, useUser, FieldType, transformStandardResponseToCamelCase, useShowNotification, useFormWithSchema, DynamicForm, photosArrayWithIdYup, useGetFeLocationQuery, activeLocation, preloadedLocationData, rzrApi, TagType, SimpleFormStepperActions, getLocationEditSettingsFormFields, usePendingImageUploads, StepIndicator, SimpleFormStepper, L;
    return {
      setters: [module => {
        O = module.b2;
        w = module.b3;
        ...
        IonLabel = module.E;
        IonInput = module.r;
        informationCircleOutline = module.bo;
        imagesOutline = module.bp;
        locationOutline = module.bq;
        ...
        photosArrayWithIdYup = module.A;
        useGetFeLocationQuery = module.B;
        activeLocation = module.h;
        preloadedLocationData = module.E;
      }, module => {
        rzrApi = module.r;
        TagType = module.o;
      }, module => {
