import { e as reactExports, M as useTranslation, j as jsxRuntimeExports, az as parseISO, aC as format } from "./vendor_react-g1Lb8P9R.js";
import { U as UserAvatar } from "./UserAvatar-BZvMXROi.js";
import { o as IonSpinner, b5 as IonCard, b7 as IonCardHeader, b8 as IonCardTitle, b6 as IonCardContent, r as IonItem, b as IonIcon, ag as calendarOutline, G as IonLabel, m as IonText, b9 as checkmarkCircleOutline, bB as closeCircleOutline, ah as timeOutline, bJ as walletOutline, d as IonButton, an as refreshOutline, br as IonAccordionGroup, bs as IonAccordion, H as IonList, aj as mailOutline, bD as callOutline, b1 as personOutline, af as IonToggle, y as IonSelect, z as IonSelectOption, Q as useIonAlert, u as useIonToast, bO as pencilOutline } from "./vendor_ionic-XqfGltiy.js";
import { u as useClipboard, b as useGetClientProfilesQuery, C as ClientStatistics } from "./client-profile.fe-services-CwVInECC.js";
import { u as useGetFeClientDataQuery, b as useUpdateFeClientDataMutation } from "./client.services-CxQTZrpi.js";
import { n as activeLocation, g as urlPrefix, P as Pagination, b as useUser, a as useAppDispatch, c as useAppSelector, d as useRemoveConnectedDeviceMutation, ad as useDeviceNotification, i as isPwa, ae as isInstalled, af as isWebView, C as ConditionalComponent } from "./App-BTZwZ6xb.js";
import { C as ClientDataModal } from "./ClientDataModal-DYqXh4eE.js";
import { a as useGetWorkerStatisticsQuery } from "./statistics.fe-services-oaa7ImL1.js";
import { m as getDeviceData, l as setShowLoginModal, D as getSavedTheme, n as setDeviceData, J as saveTheme, F as applyTheme } from "./index-BVYNZAUg.js";
