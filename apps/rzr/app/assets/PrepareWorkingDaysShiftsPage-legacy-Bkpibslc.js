;
(function () {
  System.register(['./vendor_react-legacy-8eT2sGuL.js', './vendor_ionic-legacy-Das9dW4a.js', './App-legacy-CaR2AK6H.js', './workingShift.fe-services-legacy-DWZi7HXl.js', './vendor_leaflet-legacy-eQNkinhv.js', './index-legacy-9UCQqk05.js', './vendor_firebase-legacy-BARrkZ1D.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        differenceInCalendarMonths = module.b1;
        getMonth = module.b2;
        startOfMonth = module.b3;
        addDays = module.aK;
        endOfMonth = module.b4;
        eachDayOfInterval = module.b5;
        format = module.ay;
        subMonths = module.b6;
        addMonths = module.b7;
      }, module => {
        ...
        IonCol = module.C;
        IonIcon = module.l;
        closeCircle = module.bz;
        checkmarkCircle = module.aT;
        IonButton = module.d;
        notificationsOffOutline = module.bA;
        ...
        useGetFeWorkingShiftsByDaysQuery = module.u;
        useGetWorkingHoursQuery = module.a;
        useSetFeWorkingDayShiftMutation = module.b;
        useDeleteFeWorkingDayShiftMutation = module.c;
      }, null, null, null],
      execute: function () {
