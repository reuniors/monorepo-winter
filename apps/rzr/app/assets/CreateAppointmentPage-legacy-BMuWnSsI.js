  ...
  System.register(['./vendor_react-legacy-j-OXaHGn.js', './App-legacy-C1PSXo8s.js', './vendor_ionic-legacy-B27OJI2l.js', './logo-square-legacy-CgijpkVK.js', './service-category.services-legacy-CPqOv5a4.js', './BookingWeekDays-legacy-BAuGiZe6.js', './index-legacy-DzaXWAZQ.js', './reservation.services-legacy-aHhYDCMQ.js', './client.services-legacy-CgH53VbP.js', './UserAvatar-legacy-D5EYjyD2.js', './useQueryParamsHook-legacy-C0RsEtHL.js', './props-legacy-s4OYYZ4Y.js', './vendor_leaflet-legacy-aVamlEE1.js', './vendor_firebase-legacy-BLL9XPHC.js'], function (exports, module) {
    ...
    return {
      setters: [module => {
        ...
        subMonths = module.aV;
        addMonths = module.aW;
        isSameMonth = module.aX;
        startOfDay = module.aY;
        isSameDay = module.aZ;
        yup = module.a4;
