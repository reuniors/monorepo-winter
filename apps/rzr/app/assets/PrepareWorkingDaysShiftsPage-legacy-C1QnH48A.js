;
(function () {
  System.register(['./vendor_react-legacy-BJQu1VnE.js', './vendor_ionic-legacy-C5RSb9DR.js', './App-legacy-DhSLasgw.js', './workingShift.fe-services-legacy-DvurHq5E.js', './vendor_leaflet-legacy-VV-trcYk.js', './index-legacy-CL_X7O6r.js', './vendor_firebase-legacy-BEYs4Jgn.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        differenceInCalendarMonths = module.bc;
        getMonth = module.bd;
        ...
        IonCol = module.D;
        IonIcon = module.l;
        closeCircle = module.bK;
        checkmarkCircle = module.bf;
        IonButton = module.d;
        notificationsOffOutline = module.bL;
