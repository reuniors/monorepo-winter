;
(function () {
  System.register(['./vendor_react-legacy-DX-mYdP5.js', './UserAvatar-legacy-IkOtQzjt.js', './vendor_ionic-legacy-DitOK8Rz.js', './client-profile.fe-services-legacy-CQRGEuO1.js', './client.services-legacy-BBMybAj7.js', './App-legacy-D9i3zTWV.js', './ClientDataModal-legacy-Ca8C1Ecb.js', './statistics.fe-services-legacy-DtC0Lgmo.js', './index-legacy-C1Nz3TCW.js', './vendor_leaflet-legacy-DW0hIt0g.js', './vendor_firebase-legacy-CM5O5LjC.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        useDeviceNotification = module.ad;
        isPwa = module.i;
        isInstalled = module.ae;
        isWebView = module.af;
