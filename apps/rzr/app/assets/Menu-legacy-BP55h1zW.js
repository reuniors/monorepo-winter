  ...
  System.register(['./vendor_react-legacy-J-9YdXs8.js', './vendor_ionic-legacy-qIZJoxql.js', './App-legacy-J1QG38FO.js', './index-legacy-1AgAoADQ.js', './vendor_leaflet-legacy-CcTkPRIU.js', './vendor_firebase-legacy-DUkuu2E4.js'], function (exports, module) {
    ...
    return {
      setters: [module => {
        ...
        IonMenuToggle = module.bd;
        IonItem = module.q;
        logInOutline = module.aC;
        powerOutline = module.be;
        IonFooter = module.o;
        IonLabel = module.F;
