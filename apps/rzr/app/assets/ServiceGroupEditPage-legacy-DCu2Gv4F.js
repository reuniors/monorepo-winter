;
(function () {
  System.register(['./vendor_react-legacy-BZeT-WEv.js', './vendor_ionic-legacy-FEPq4Efg.js', './App-legacy-D_TQFFiD.js', './ServiceGroupBasicInfoStep-legacy-C0eu2eq6.js', './SimpleFormStepperActions-legacy-BqGxoEln.js', './usePendingImageUploads-legacy-BYdSANSl.js', './vendor_leaflet-legacy-_lyC0eWM.js', './index-legacy-yzMe94ue.js', './vendor_firebase-legacy-_Nh6fmKA.js'], function (exports, module) {
    'use strict';

    var useTranslation, reactExports, jsxRuntimeExports, t, create$3, create$2, informationCircleOutline, constructOutline, imageOutline, useIonRouter, IonList, IonItem, IonIcon, addOutline, IonLabel, IonText, IonReorderGroup, IonReorder, IonSpinner, useGetFeServiceGroupsQuery, activeLocation, useUpdateServiceMutation, ShowLoading, urlPrefix, FieldType, useFormWithSchema, DynamicForm, ServiceGroupBasicInfoStep, SimpleFormStepperActions, usePendingImageUploads, StepIndicator, SimpleFormStepper;
    return {
      setters: [module => {
