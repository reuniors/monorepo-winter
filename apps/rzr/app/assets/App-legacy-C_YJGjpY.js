  ...
  System.register(['./vendor_ionic-legacy-Br2UrGvg.js', './vendor_react-legacy-CKjKS6zA.js', './index-legacy-edMTpd93.js', './vendor_firebase-legacy-D-vUgmbk.js'], function (exports, module) {
    ...
    return {
      setters: [module => {
        ...
        IonSegment = module.aJ;
        IonSegmentButton = module.aK;
        createOutline = module.aL;
        gitNetworkOutline = module.aM;
        giftOutline = module.aN;
        settingsOutline = module.aO;
        peopleOutline = module.aP;
        megaphoneOutline = module.aQ;
        notificationsOutline = module.aR;
        businessOutline = module.aS;
        IonActionSheet = module.aT;
        IonTabs = module.aU;
        IonRouterOutlet = module.aV;
        IonTabBar = module.aW;
        IonTabButton = module.aX;
        homeOutline = module.aY;
        alarmOutline = module.aZ;
        personOutline = module.a_;
        useIonViewDidLeave = module.a$;
        informationCircleOutline = module.b0;
        appsOutline = module.b1;
        IonCard = module.b2;
        ...
        IonBadge = module.b7;
        logOutOutline = module.b8;
        IonApp = module.b9;
        IonReactRouter = module.ba;
        IonSplitPane = module.bb;
        setupIonicReact = module.bc;
      }, module => {
        ...
        getInitialData = module.B;
        getSavedTheme = module.C;
        applyTheme = module.D;
        TagId$1 = module.F;
      }, module => {
      ...
      execute: function () {
        ...
        const ListIonIcons = reactExports.lazy(() => __vitePreload(() => module.import('./ListIonIcons-legacy-Z74HkBRx.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const HomePage = reactExports.lazy(() => __vitePreload(() => module.import('./HomePage-legacy-DBR-AOKt.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const AppointmentPage = reactExports.lazy(() => __vitePreload(() => module.import('./AppointmentPage-legacy-odqJBEIB.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ProfilePage = reactExports.lazy(() => __vitePreload(() => module.import('./ProfilePage-legacy-DX1faMWQ.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NotificationPage = reactExports.lazy(() => __vitePreload(() => module.import('./NotificationPage-legacy-DVfyE7qW.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const PrepareWorkingDaysShiftsPage = reactExports.lazy(() => __vitePreload(() => module.import('./PrepareWorkingDaysShiftsPage-legacy-DIo5DPf4.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const OwnerHomePage = reactExports.lazy(() => __vitePreload(() => module.import('./OwnerHomePage-legacy-HGzAma8b.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const OwnerAppointmentPage = reactExports.lazy(() => __vitePreload(() => module.import('./OwnerAppointmentPage-legacy-haHUlMCs.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const SettingsPage = reactExports.lazy(() => __vitePreload(() => module.import('./SettingsPage-legacy-Bb2rhD7t.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const CreateAppointmentPage = reactExports.lazy(() => __vitePreload(() => module.import('./CreateAppointmentPage-legacy-DMay7Chy.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ConfirmReservationPage = reactExports.lazy(() => __vitePreload(() => module.import('./ConfirmReservationPage-legacy-CFH1ILCl.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const PublicProfilePage = reactExports.lazy(() => __vitePreload(() => module.import('./PublicProfilePage-legacy-Oal73Osc.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NewsListPage = reactExports.lazy(() => __vitePreload(() => module.import('./NewsListPage-legacy-JUPm36YV.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NewsCreatePage = reactExports.lazy(() => __vitePreload(() => module.import('./NewsCreatePage-legacy-D4Few0uG.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NewsEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./NewsEditPage-legacy-B92Jj0EY.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationWorkingTimePage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkingTimePage-legacy-DVRjNBX3.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationEditPage-legacy-C8qWSLOU.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationWorkersPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkersPage-legacy-DrFDt_RM.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationSettingsPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationSettingsPage-legacy-Dy5uy6kY.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServicesPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServicesPage-legacy-DYkNgdbM.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceCategoriesPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceCategoriesPage-legacy-ByR9VbGa.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceCategoryEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceCategoryEditPage-legacy-j2RLTIcu.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceGroupEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceGroupEditPage-legacy-D1EPNZ4s.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceEditPage-legacy-CaXZrBFD.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationWorkerCreatePage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkerCreatePage-legacy-CvZyXLia.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const GoogleCalendarSettingsPage = reactExports.lazy(() => __vitePreload(() => module.import('./GoogleCalendarSettingsPage-legacy-DtR56dTv.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const TestNotificationsPage = reactExports.lazy(() => __vitePreload(() => module.import('./TestNotificationsPage-legacy-CfFc8KrJ.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const UserDevicesPage = reactExports.lazy(() => __vitePreload(() => module.import('./UserDevicesPage-legacy-Bw78BEqQ.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const PrivateLocationLandingPage = reactExports.lazy(() => __vitePreload(() => module.import('./PrivateLocationLandingPage-legacy-DqojnG69.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const Menu = reactExports.lazy(() => __vitePreload(() => module.import('./Menu-legacy-DPiuaia3.js'), false              ? __VITE_PRELOAD__ : void 0));
