;
(function () {
  System.register(['./vendor_react-legacy-CX0h95NE.js', './reservation.services-legacy-DiQGIxu2.js', './App-legacy-7OwS84rF.js', './vendor_ionic-legacy-CLGezsbs.js', './appointment.constants-legacy-DGLfwUGc.js', './NewsChyron-legacy-CyzsVD1q.js', './vendor_leaflet-legacy-CiFv5lWM.js', './index-legacy-BIk86z2F.js', './vendor_firebase-legacy-BCi9HsFn.js', './news.fe-services-legacy-hm_hd80g.js'], function (exports, module) {
    'use strict';

    var useTranslation, reactExports, jsxRuntimeExports, format, parseISO, useGetFeLocationClientReservationsQuery, urlPrefix, useUser, activeLocation, useGetFeWorkersQuery, SceletonLoader, Pagination, IonItem, IonIcon, cutOutline, IonLabel, calendarOutline, IonButton, IonList, AppointmentStatus, NewsChyron;
    return {
      setters: [module => {
