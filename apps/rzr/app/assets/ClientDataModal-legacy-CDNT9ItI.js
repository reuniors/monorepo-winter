;
(function () {
  System.register(['./vendor_react-legacy-CX0h95NE.js', './vendor_ionic-legacy-CLGezsbs.js', './App-legacy-7OwS84rF.js', './index-legacy-BIk86z2F.js'], function (exports, module) {
    'use strict';

    var t, instance, reactExports, jsxRuntimeExports, yup, IonContent, IonFooter, IonToolbar, IonButtons, IonButton, FieldType, useFormWithSchema, DynamicForm, IonModalExtended;
    return {
      setters: [module => {
        t = module.a2;
        instance = module.v;
