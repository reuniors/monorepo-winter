;
(function () {
  System.register(['./vendor_react-legacy-CFXrDSu1.js', './vendor_ionic-legacy-kFTPXAWE.js', './App-legacy-DT3CUYN8.js', './usePendingImageUploads-legacy-BMEhJXyl.js', './ServiceGroupCreateModal-legacy-CtwhZlH_.js', './vendor_leaflet-legacy-DzrMDhpu.js', './index-legacy-D7f7Ap3o.js', './vendor_firebase-legacy-BISQ33kA.js', './ServiceGroupBasicInfoStep-legacy-D8YtzcPI.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        FieldType = module.F;
        convertEmptyStringToNull = module.X;
        generateSlugForValidation = module.Y;
        useFormWithSchema = module.w;
        generateSlug = module.T;
        useUpdateServiceCategoryMutation = module.U;
