import { e as reactExports, j as jsxRuntimeExports, aj as SwiperSlide, aJ as useLocation, I as useHistory, M as useTranslation, R as React, aC as format, aA as formatInTimeZone, aP as startOfMonth, aQ as endOfMonth, aR as startOfWeek, aS as addDays, az as parseISO, aB as toZonedTime, aT as startOfDay, a3 as yup, aU as Pagination, aD as fromZonedTime } from "./vendor_react-CZodnfjS.js";
import { h as useDefaultProps, j as useConfirmationAlert, S as SwiperWrapper, k as useContentRefFunctions, b as useUser, l as useQueryParamsHook, m as useGetFeLocationQuery, n as activeLocation, o as useGetFeServiceCategoriesQuery, q as useGetFeWorkersQuery, r as SceletonLoader, s as getPathBySize, t as fromUtcHM, v as getAppTimezone, F as FieldType, D as DynamicForm, w as useIsBigScreen, x as useFormWithSchema, g as urlPrefix, y as pushDuplicateAndNavigate, z as useGetFeServiceGroupsQuery, N as NotificationToast } from "./App-CfzT2S_-.js";
import { H as IonList, r as IonItem, bv as IonAvatar, b as IonIcon, aS as peopleOutline, G as IonLabel, a4 as chevronForwardOutline, d as IonButton, bw as checkmarkCircle, aa as addOutline, S as trashOutline, bx as removeOutline, b5 as IonCard, b6 as IonCardContent, af as IonToggle, by as IonAccordionGroup, bz as IonAccordion, ag as calendarOutline, m as IonText, o as IonSpinner, e as IonHeader, f as IonToolbar, ah as timeOutline, bA as cashOutline, ba as IonBadge, p as IonFooter, j as closeOutline, bB as calendarClearOutline, ao as useIonRouter, u as useIonToast, al as IonLoading, k as IonContent, bC as chevronDownOutline, bD as chevronUpOutline, bc as arrowBack, bE as arrowForward } from "./vendor_ionic-DAnbjjdE.js";
import { L as LazyLoadImgStandard, p as preloadCoverImg } from "./logo-square-DzrSTVKf.js";
import { u as useBookingCalendarContext, W as WeekSwiperWrapper, B as BookingCalendarContext, S as SLOT_SEARCH_TOLERANCE_MINUTES, a as BookingCalendarHeader, b as BookingWeekDays, c as BookingCalendarProvider } from "./WeekSwiperWrapper-CFOTBsp1.js";
import { u as useCreateFeReservationMutation, a as useGetFePromoCodeDataQuery } from "./reservation.services-DMCR6-CB.js";
import { u as useGetFeClientDataQuery } from "./client.services-DjktyCOJ.js";
import { U as UserAvatar } from "./UserAvatar-4SoXBEJN.js";
import { I as IonModalExtended } from "./index-C-uNn__j.js";
import "./vendor_leaflet-DLEgU4Uz.js";
import "./vendor_firebase-CcPbfcOR.js";
import "./workingShift.fe-services-BBrbK35E.js";
          ...
          IonItem,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(IonLabel, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold", children: worker.fullName }),
                worker.maxDiscountPercent && worker.maxDiscountPercent > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-bold text-green-600 mt-1", children: [
                  "Do ",
                  worker.maxDiscountPercent,
                  "% popusta"
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(IonIcon, { slot: "end", icon: chevronForwardOutline })
...
function SelectAppointmentStepV2({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-[80px]", children: [
    selectedWorker && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pt-4 pb-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold dark:text-gray-100", children: selectedWorker.fullName }),
      selectedWorker.maxDiscountPercent && selectedWorker.maxDiscountPercent > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-bold text-green-600 mt-1", children: [
        t("Do"),
        " ",
        selectedWorker.maxDiscountPercent,
        "% ",
        t("popusta")
      ] })
    ] }),
  ...
  reactExports.useEffect(() => {
    if (!hasInitialized.current && workersWithSlots.length > 0) {
      const allValues = workersWithSlots.map(
        (workerSlot) => "worker-".concat(workerSlot.workerId)
      );
    ...
    IonAccordionGroup,
    {
      ...
      children: workersWithSlots.map((workerSlot) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          IonAccordion,
          {
            value: "worker-".concat(workerSlot.workerId),
            children: [
...
function BookingSlotsSwiper({
  ...
  const monthHasSlots = reactExports.useMemo(() => {
    ...
    return daysWithSlots.some(([dateStr]) => {
      const date = parseISO("".concat(dateStr, "T00:00:00"));
  ...
  const slides = reactExports.useMemo(() => {
    ...
    if (isCalendarOpen && currentMonth) {
      ...
      const weekDateStrs = currentWeek.map(
        (d) => formatInTimeZone(d, timezone, "yyyy-MM-dd")
      );
  ...
  const computedFirstAvailableDate = reactExports.useMemo(() => {
    ...
    const date = parseISO("".concat(sorted[0][0], "T00:00:00"));
