;
(function () {
  System.register(['./vendor_react-legacy-VZwyi0Js.js', './reservation.services-legacy-dvwmRcpa.js', './App-legacy-Ca-wFRma.js', './vendor_ionic-legacy-DGRHWrdu.js', './appointment.constants-legacy-DGLfwUGc.js', './logo-square-legacy-CMF14YsM.js', './client.services-legacy-C6vIiYB3.js', './ClientDataModal-legacy-DnuIQOip.js', './useQueryParamsHook-legacy-DUnWRYhF.js', './vendor_leaflet-legacy-CfYyL1ry.js', './index-legacy-Bqvn9yKL.js', './vendor_firebase-legacy-BVpRmQ4X.js'], function (exports, module) {
    'use strict';

    var reactExports, useTranslation, jsxRuntimeExports, parseISO, format, SwiperSlide, t, yup, isPast, addMinutes, useGetOneFeReservationQuery, useUpdateFeReservationMutation, activeLocation, SceletonLoader, fromUtcDateTimeToTime, getPathBySize, SwiperWrapper, useFormWithSchema, DynamicForm, useUser, urlPrefix, ConditionalComponent, IonAlertConfirmation, LayoutMainPage, IonItem, IonGrid, IonRow, IonCol, IonIcon, calendarClearOutline, calendarOutline, timeOutline, pricetagOutline, IonTitle, IonBadge, alertCircleOutline, hourglassOutline, helpOutline, IonButton, IonFooter, personOutline, IonToolbar, useIonToast, useIonRouter, APPOINTMENT_STATUS_LABELS, AppointmentStatus, LazyLoadImgStandard, preloadCoverImg, useGetFeLocationClientsQuery, useGetFeClientDataQuery, getClientFormFields, getAdministrationClientFormFields, ClientDataModal, useQueryParamsHook;
    return {
      setters: [module => {
        ...
        pricetagOutline = module.bm;
        IonTitle = module.j;
        IonBadge = module.b0;
        alertCircleOutline = module.bn;
        hourglassOutline = module.bo;
        helpOutline = module.bp;
        IonButton = module.d;
        IonFooter = module.o;
