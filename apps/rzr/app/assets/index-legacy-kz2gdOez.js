;
(function () {
  System.register(['./vendor_ionic-legacy-DTzAUkB1.js', './vendor_react-legacy-HHx4U8Zg.js', './vendor_leaflet-legacy-DzBkCEej.js'], function (exports, module) {
    'use strict';
    ...
    return {
      ...
      execute: function () {
        ...
        const App = reactExports.lazy(() => __vitePreload(() => module.import('./App-legacy-DfjKzIk2.js').then(n => n.a1), false              ? __VITE_PRELOAD__ : void 0));
        initializeTheme();
