import { a0 as t, a1 as create$3, aM as create$7, a2 as create$6, aD as useTranslation, R as React, j as jsxRuntimeExports, aN as create$2, e as reactExports, aJ as useLocation, aE as useHistory } from "./vendor_react-Be2cnnNd.js";
import { bp as informationCircleOutline, bt as imageOutline, a1 as constructOutline, aj as useIonRouter, F as IonList, q as IonItem, l as IonIcon, a6 as addOutline, E as IonLabel, c as IonText, G as IonCheckbox, d as IonButton, aC as createOutline, n as IonSpinner } from "./vendor_ionic-CEbfXmBJ.js";
import { b as useUpdateServiceCategoryMutation, u as useGetFeServiceCategoriesQuery } from "./service-category.services-I1d17RRX.js";
import { F as FieldType, J as convertEmptyStringToNull, K as generateSlugForValidation, q as useFormWithSchema, H as generateSlug, B as useShowNotification, D as DynamicForm, y as useGetFeServiceGroupsQuery, j as activeLocation, f as urlPrefix, L as LayoutMainPage, O as mainHeaderClasses, s as pushDuplicateAndNavigate } from "./App-DeWcIyVH.js";
import { S as SimpleFormStepperActions } from "./SimpleFormStepperActions-DDO9oWwt.js";
import { u as usePendingImageUploads, S as StepIndicator, a as SimpleFormStepper } from "./usePendingImageUploads-CX-rmsJt.js";
import { S as ServiceGroupCreateModal } from "./ServiceGroupCreateModal-CudsswFx.js";
import "./vendor_leaflet-EfOgX15p.js";
import "./index-gP-eEdFZ.js";
import "./vendor_firebase-CEH7Eikm.js";
import "./props-BnGoNH1d.js";
import "./ServiceGroupBasicInfoStep-BSde2yxY.js";
...
function ServiceCategoryEditPage({
  ...
  reactExports.useEffect(() => {
    ...
    const step = parseInt((_a = params.get("step")) != null ? _a : "0", 10);
  ...
  if (error || !category) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ion-padding ion-text-center", children: t2("Greška pri učitavanju delatnosti") });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    LayoutMainPage,
    {
      headerClasses: mainHeaderClasses,
      title: t2("Uredi delatnost"),
      hasBackButton: true,
      backButtonUrl: useCustomBackHandler ? void 0 : "".concat(urlPrefix, "/podesavanja/delatnosti"),
