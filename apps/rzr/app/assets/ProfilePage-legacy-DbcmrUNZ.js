;
(function () {
  System.register(['./vendor_react-legacy-BZeT-WEv.js', './App-legacy-D_TQFFiD.js', './vendor_ionic-legacy-FEPq4Efg.js', './client-profile.fe-services-legacy-DGfxYmBC.js', './ClientDataModal-legacy-DnVO9GBr.js', './statistics.fe-services-legacy-Bcx1dJ3d.js', './Pagination-legacy-B4CHqP5-.js', './index-legacy-yzMe94ue.js', './vendor_leaflet-legacy-_lyC0eWM.js', './vendor_firebase-legacy-_Nh6fmKA.js'], function (exports, module) {
    'use strict';

    var reactExports, useTranslation, jsxRuntimeExports, parseISO, format, activeLocation, urlPrefix, useUser, useAppDispatch, useGetFeClientDataQuery, useUpdateFeClientDataMutation, UserAvatar, ConditionalComponent, IonSpinner, IonCard, IonCardHeader, IonCardTitle, IonCardContent, IonItem, IonIcon, calendarOutline, IonLabel, IonText, checkmarkCircleOutline, closeCircleOutline, timeOutline, walletOutline, IonButton, refreshOutline, IonAccordionGroup, IonAccordion, IonList, mailOutline, callOutline, personOutline, pencilOutline, useClipboard, useGetClientProfilesQuery, ClientStatistics, ClientDataModal, useGetWorkerStatisticsQuery, Pagination, setShowLoginModal;
    return {
      setters: [module => {
        ...
        callOutline = module.bl;
        personOutline = module.aQ;
        pencilOutline = module.bz;
      }, module => {
