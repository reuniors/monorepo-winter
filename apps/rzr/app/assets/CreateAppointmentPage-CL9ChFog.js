import { e as reactExports, j as jsxRuntimeExports, aj as SwiperSlide, aJ as useLocation, G as useHistory, M as useTranslation, R as React, aC as format, aP as startOfMonth, aQ as endOfMonth, aR as startOfWeek, aS as addDays, aT as startOfDay, aB as toZonedTime, a3 as yup, aA as formatInTimeZone, az as parseISO } from "./vendor_react-qB5C-kEe.js";
import { h as useDefaultProps, j as useConfirmationAlert, S as SwiperWrapper, k as useContentRefFunctions, b as useUser, l as useQueryParamsHook, m as useGetFeLocationQuery, n as activeLocation, o as useGetFeServiceCategoriesQuery, q as useGetFeWorkersQuery, r as SceletonLoader, s as getPathBySize, t as fromUtcHM, v as getAppTimezone, F as FieldType, w as useIsBigScreen, x as useFormWithSchema, g as urlPrefix, y as pushDuplicateAndNavigate, D as DynamicForm, z as useGetFeServiceGroupsQuery, N as NotificationToast } from "./App-CXosnGFT.js";
import { H as IonList, r as IonItem, bi as IonAvatar, b as IonIcon, aP as peopleOutline, G as IonLabel, a4 as chevronForwardOutline, d as IonButton, bj as checkmarkCircle, aa as addOutline, S as trashOutline, bk as removeOutline, b2 as IonCard, b3 as IonCardContent, af as IonToggle, bl as IonAccordionGroup, bm as IonAccordion, ag as calendarOutline, m as IonText, o as IonSpinner, ao as useIonRouter, u as useIonToast, al as IonLoading, e as IonHeader, f as IonToolbar, ah as timeOutline, k as IonContent, bn as cashOutline, b7 as IonBadge, p as IonFooter, j as closeOutline, bo as calendarClearOutline, bp as chevronDownOutline, bq as chevronUpOutline, br as arrowBack, bs as arrowForward } from "./vendor_ionic-Dg_6JWqB.js";
import { L as LazyLoadImgStandard, p as preloadCoverImg } from "./logo-square-BalqtBoM.js";
import { u as useBookingCalendarContext, W as WeekSwiperWrapper, B as BookingCalendarContext, S as SLOT_SEARCH_TOLERANCE_MINUTES, a as BookingCalendarHeader, b as BookingWeekDays, c as BookingCalendarProvider } from "./WeekSwiperWrapper-BLtpoAQn.js";
import { u as useCreateFeReservationMutation, a as useGetFePromoCodeDataQuery } from "./reservation.services-DGN4sV9Q.js";
import { u as useGetFeClientDataQuery } from "./client.services-_1z5vJlG.js";
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              SwiperWrapper,
              {
                ...
                children: [
                  ...
                  selectedServices && selectedServices.length > 0 && selectedServices.map((service, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    SwiperSlide,
                    {
                      style: { width: "auto" },
                      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center py-4", children: [
