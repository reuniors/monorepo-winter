import { e as reactExports, aD as useTranslation, j as jsxRuntimeExports, av as parseISO, ay as format } from "./vendor_react-B_GNTQkY.js";
import { U as UserAvatar } from "./UserAvatar-CmfG0cf_.js";
import { n as IonSpinner, aY as IonCard, a_ as IonCardHeader, a$ as IonCardTitle, aZ as IonCardContent, q as IonItem, l as IonIcon, ad as calendarOutline, E as IonLabel, c as IonText, b0 as checkmarkCircleOutline, bu as closeCircleOutline, ae as timeOutline, bz as walletOutline, d as IonButton, b2 as refreshOutline, bg as IonAccordionGroup, bh as IonAccordion, F as IonList, ah as mailOutline, bs as callOutline, aV as personOutline, ac as IonToggle, w as IonSelect, x as IonSelectOption, M as useIonAlert, a9 as useIonToast, bG as pencilOutline } from "./vendor_ionic-BgkSNDC1.js";
import { u as useClipboard, b as useGetClientProfilesQuery, C as ClientStatistics } from "./client-profile.fe-services-CFwt-fw8.js";
import { u as useGetFeClientDataQuery, b as useUpdateFeClientDataMutation } from "./client.services-DKGuGSor.js";
import { k as activeLocation, f as urlPrefix, b as useUser, a as useAppDispatch, c as useAppSelector, d as useRemoveConnectedDeviceMutation, a8 as useDeviceNotification, i as isPwa, a9 as isInstalled, aa as isWebView, C as ConditionalComponent } from "./App-xTBEfOzf.js";
import { C as ClientDataModal } from "./ClientDataModal-ccRgn0c9.js";
import { a as useGetWorkerStatisticsQuery } from "./statistics.fe-services-CYHYLpDm.js";
import { P as Pagination } from "./Pagination-Bdk0KnEA.js";
import { k as getDeviceData, j as setShowLoginModal, q as getSavedTheme, l as setDeviceData, v as saveTheme, t as applyTheme } from "./index-DfAC4npr.js";
