;
(function () {
  System.register(['./vendor_react-legacy-J-9YdXs8.js', './vendor_ionic-legacy-qIZJoxql.js', './index-legacy-CKc2LGlm.js', './App-legacy-CSGT8g8C.js', './workingShift.fe-services-legacy-DTo1R7aN.js', './reservation.services-legacy-CFWkBjWk.js'], function (exports, module) {
    'use strict';

    var addDays, isToday$1, format, startOfMonth, endOfMonth, eachDayOfInterval, startOfDay, parseISO, addMinutes, toZonedTime, fromZonedTime, formatInTimeZone, reactExports, startOfWeek, endOfWeek, isSameDay, subMonths, addMonths, jsxRuntimeExports, parse, isWithinInterval, differenceInMinutes, isSameMonth, SwiperSlide, useTranslation, IonToolbar, IonButton, IonIcon, calendarOutline, IonSpinner, chevronUpOutline, chevronDownOutline, IonButtons, chevronBackOutline, chevronForwardOutline, rzrApi, TagType, transformStandardResponseToCamelCase, getAppTimezone, useGetFeWorkersQuery, reservationTimeInterval, getUtcDateFormattedInTz, parseUtcDate, SwiperWrapper, useContentRefFunctions, useGetFeWorkerWorkingShiftsByDaysQuery, useGetFeLocationReservationsQuery;
    return {
      setters: [module => {
        addDays = module.aS;
        isToday$1 = module.a$;
      ...
      execute: function () {
        ...
        function useBookingCalendar({
          ...
          }, [currentWeek, currentMonth, isCalendarOpen, daysWithSlots, isLoading, isFetching]);
          return {
            // State
            currentWeek,
            currentMonth,
