;
(function () {
  System.register(['./vendor_react-legacy-yeQ-Nqpl.js', './reservation.services-legacy-DqdYtBVh.js', './App-legacy-DRWtf8eI.js', './vendor_ionic-legacy-DdPNGOLm.js', './appointment.constants-legacy-DGLfwUGc.js', './logo-square-legacy-r7uEZNLo.js', './client.services-legacy-BKXONrn3.js', './ClientDataModal-legacy-Di3nOQ33.js', './useQueryParamsHook-legacy-Bhnvau9I.js', './vendor_leaflet-legacy-Cr0PaNC7.js', './index-legacy-Bog12BrJ.js', './vendor_firebase-legacy-CPHztqRU.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        pricetagOutline = module.bo;
        IonTitle = module.j;
        IonBadge = module.b1;
        alertCircleOutline = module.bp;
        hourglassOutline = module.bq;
        helpOutline = module.br;
        IonButton = module.d;
        IonFooter = module.o;
        IonToolbar = module.i;
