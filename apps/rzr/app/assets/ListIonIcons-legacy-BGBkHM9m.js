;
(function () {
  System.register(['./vendor_react-legacy-HHx4U8Zg.js', './vendor_ionic-legacy-DTzAUkB1.js', './App-legacy-DfjKzIk2.js', './vendor_leaflet-legacy-DzBkCEej.js', './index-legacy-kz2gdOez.js', './vendor_firebase-legacy-ByYi5ToB.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        IonButton = module.d;
        IonIcon = module.l;
        arrowBackOutline = module.bu;
      }, module => {
        fetchIonIconsList = module.a0;
      }, null, null, null],
      execute: function () {
