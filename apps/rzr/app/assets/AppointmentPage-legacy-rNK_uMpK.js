;
(function () {
  System.register(['./vendor_react-legacy-Dr5RK8rs.js', './App-legacy-COHPHKDC.js', './vendor_ionic-legacy-BouRDOo5.js', './appointment.constants-legacy-DGLfwUGc.js', './Pagination-legacy-DSjEne2Z.js', './NewsChyron-legacy-B32JDr3N.js', './vendor_leaflet-legacy-5Hsu9Ykl.js', './index-legacy-BHIGnBEX.js', './vendor_firebase-legacy-DZHWzyZG.js', './news.fe-services-legacy-D3k1ueXh.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        urlPrefix = module.f;
        useUser = module.b;
        useGetFeLocationClientReservationsQuery = module.Z;
