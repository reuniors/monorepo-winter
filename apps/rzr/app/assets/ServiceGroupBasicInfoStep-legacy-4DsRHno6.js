;
(function () {
  System.register(['./vendor_react-legacy-Dr5RK8rs.js', './App-legacy-COHPHKDC.js', './SimpleFormStepperActions-legacy-BrNZrJc8.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        convertEmptyStringToNull = module.P;
        generateSlugForValidation = module.Q;
        useUser = module.b;
        FieldType = module.F;
