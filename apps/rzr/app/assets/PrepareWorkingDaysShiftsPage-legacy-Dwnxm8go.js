;
(function () {
  System.register(['./vendor_react-legacy-DonFScn3.js', './vendor_ionic-legacy-mZi8EIkK.js', './App-legacy-CxwuunNq.js', './workingShift.fe-services-legacy-BSEOE1rh.js', './vendor_leaflet-legacy-CSx1IcTV.js', './index-legacy-B6X2T6eC.js', './vendor_firebase-legacy-BNHQcAgT.js'], function (exports, module) {
    'use strict';

    var useTranslation, jsxRuntimeExports, SwiperSlide, V, reactExports, toZonedTime, differenceInCalendarMonths, getMonth, startOfMonth, addDays, endOfMonth, eachDayOfInterval, format, subMonths, addMonths, IonGrid, IonRow, IonCol, IonIcon, closeCircle, checkmarkCircle, IonButton, notificationsOffOutline, trashOutline, timeOutline, IonHeader, IonToolbar, IonTitle, IonButtons, closeOutline, IonContent, IonDatetime, IonList, IonItem, IonFooter, chevronBackOutline, IonSpinner, chevronForwardOutline, ConditionalComponent, SwiperWrapper, IonModalExtended, fromUtcHM, fromUtc, toUtc, activeLocation, getAppTimezone, getUtcDateFormattedInTz, useGetFeWorkingShiftsByDaysQuery, useGetWorkingHoursQuery, useSetFeWorkingDayShiftMutation, useDeleteFeWorkingDayShiftMutation;
    return {
      setters: [module => {
        ...
        differenceInCalendarMonths = module.bb;
        getMonth = module.bc;
        startOfMonth = module.aQ;
        addDays = module.aT;
        endOfMonth = module.aR;
        eachDayOfInterval = module.bd;
        format = module.aA;
        subMonths = module.b3;
        addMonths = module.b4;
      }, module => {
        ...
        IonCol = module.C;
        IonIcon = module.l;
        closeCircle = module.bJ;
        checkmarkCircle = module.bf;
        IonButton = module.d;
        notificationsOffOutline = module.bK;
        ...
        useGetFeWorkingShiftsByDaysQuery = module.a;
        useGetWorkingHoursQuery = module.b;
        useSetFeWorkingDayShiftMutation = module.c;
        useDeleteFeWorkingDayShiftMutation = module.d;
      }, null, null, null],
      execute: function () {
