;
(function () {
  System.register(['./vendor_react-legacy-yeQ-Nqpl.js', './vendor_ionic-legacy-DdPNGOLm.js', './App-legacy-B88LhG9A.js', './workingShift.fe-services-legacy-oEMM0Jjb.js', './vendor_leaflet-legacy-Cr0PaNC7.js', './index-legacy-CRAhBgCB.js', './vendor_firebase-legacy-CPHztqRU.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        IonCol = module.C;
        IonIcon = module.l;
        closeCircle = module.bI;
        checkmarkCircle = module.be;
        IonButton = module.d;
        notificationsOffOutline = module.bJ;
