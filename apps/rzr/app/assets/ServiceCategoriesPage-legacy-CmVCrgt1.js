;
(function () {
  System.register(['./vendor_react-legacy-VZwyi0Js.js', './vendor_ionic-legacy-DGRHWrdu.js', './App-legacy-6ilZbwqB.js', './vendor_leaflet-legacy-CfYyL1ry.js', './index-legacy-Blp5H0fR.js', './vendor_firebase-legacy-BVpRmQ4X.js'], function (exports, module) {
    'use strict';

    var useTranslation, reactExports, jsxRuntimeExports, IonModal, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonIcon, closeOutline, IonContent, IonItem, IonLabel, IonInput, IonTextarea, IonToggle, IonSpinner, checkmarkOutline, useIonRouter, useIonAlert, IonText, IonCard, IonCardHeader, IonCardTitle, businessOutline, swapVerticalOutline, addOutline, IonCardContent, IonReorderGroup, IonReorder, createOutline, trashOutline, useCreateServiceCategoryMutation, useShowNotification, generateSlug, activeLocation, useGetFeServiceCategoriesQuery, useUpdateServiceCategoryMutation, useDeleteServiceCategoryMutation, urlPrefix;
    return {
      setters: [module => {
        ...
        useCreateServiceCategoryMutation = module.Q;
        useShowNotification = module.G;
        generateSlug = module.R;
        activeLocation = module.k;
        useGetFeServiceCategoriesQuery = module.z;
        useUpdateServiceCategoryMutation = module.T;
        useDeleteServiceCategoryMutation = module.U;
        urlPrefix = module.f;
      }, null, null, null],
      execute: function () {
