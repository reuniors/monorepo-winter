;
(function () {
  System.register(['./vendor_react-legacy-J-9YdXs8.js', './vendor_ionic-legacy-qIZJoxql.js', './App-legacy-J1QG38FO.js'], function (exports, module) {
    'use strict';

    var t, instance, reactExports, jsxRuntimeExports, yup, IonContent, IonFooter, IonToolbar, IonButtons, IonButton, FieldType, useFormWithSchema, IonModalExtended, DynamicForm;
    return {
      setters: [module => {
        t = module.a0;
        instance = module.v;
