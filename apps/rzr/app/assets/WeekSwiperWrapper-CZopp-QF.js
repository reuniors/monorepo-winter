...
import { v as getAppTimezone, H as transformStandardResponseToCamelCase, b as useUser, q as useGetFeWorkersQuery, $ as reservationTimeInterval, a0 as getUtcDateFormattedInTz, a1 as parseUtcDate, S as SwiperWrapper, k as useContentRefFunctions } from "./App-FZ41U8hJ.js";
import { u as useGetFeWorkerWorkingShiftsByDaysQuery } from "./workingShift.fe-services-BcwRfWvz.js";
import { d as useGetFeLocationReservationsQuery } from "./reservation.services-d-x2fu8T.js";
  ...
  reactExports.useEffect(() => {
    if (gapsData == null ? void 0 : gapsData.data) {
      ...
      datesToProcess.forEach((date) => {
        ...
        const workerSlots = [];
        console.log("[useBookingCalendar] dateKeyWithDashes:", {
          dateKeyWithDashes,
          gapsByWorker
        });
