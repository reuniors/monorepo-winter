;
(function () {
  System.register(['./vendor_react-legacy-BaDeiZwt.js', './App-legacy-JMmm2B38.js', './vendor_ionic-legacy-SgrmjcUd.js', './logo-square-legacy-DOL8qLi7.js', './WeekSwiperWrapper-legacy-clz2sYLc.js', './reservation.services-legacy-UefSX0Q4.js', './client.services-legacy-HDIeI-dq.js', './UserAvatar-legacy-jBghRT4j.js', './useQueryParamsHook-legacy-B1GbSu9G.js', './vendor_leaflet-legacy-Copy5_ZC.js', './index-legacy-C6EIpnD8.js', './vendor_firebase-legacy-Dby0Ep9M.js', './workingShift.fe-services-legacy-DM52KikF.js'], function (exports, module) {
    'use strict';

    var reactExports, jsxRuntimeExports, SwiperSlide, useTranslation, React, format, startOfMonth, endOfMonth, startOfWeek, addDays, startOfDay, toZonedTime, yup, formatInTimeZone, parseISO, useLocation, useHistory, useDefaultProps, useConfirmationAlert, SwiperWrapper, useGetFeWorkersQuery, activeLocation, SceletonLoader, getPathBySize, fromUtcHM, useContentRefFunctions, getAppTimezone, FieldType, useUser, useIsBigScreen, useFormWithSchema, urlPrefix, pushDuplicateAndNavigate, IonModalExtended, DynamicForm, toUtc, NotificationToast, useGetFeLocationQuery, useGetFeServiceCategoriesQuery, useGetFeServiceGroupsQuery, IonList, IonItem, IonAvatar, IonIcon, peopleOutline, IonLabel, chevronForwardOutline, IonButton, checkmarkCircle, addOutline, trashOutline, removeOutline, IonCard, IonCardContent, IonToggle, IonAccordionGroup, IonAccordion, calendarOutline, IonText, IonSpinner, useIonRouter, useIonToast, IonLoading, IonHeader, IonToolbar, timeOutline, IonContent, cashOutline, IonBadge, IonFooter, closeOutline, calendarClearOutline, chevronDownOutline, chevronUpOutline, arrowBack, arrowForward, LazyLoadImgStandard, preloadCoverImg, useBookingCalendarContext, WeekSwiperWrapper, BookingCalendarContext, BookingCalendarHeader, BookingWeekDays, BookingCalendarProvider, useCreateFeReservationMutation, useGetFePromoCodeDataQuery, useGetFeClientDataQuery, UserAvatar, useQueryParamsHook;
    return {
      setters: [module => {
