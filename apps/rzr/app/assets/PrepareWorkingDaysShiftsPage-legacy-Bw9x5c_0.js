;
(function () {
  System.register(['./vendor_react-legacy-CFXrDSu1.js', './vendor_ionic-legacy-kFTPXAWE.js', './App-legacy-DT3CUYN8.js', './workingShift.fe-services-legacy-fjbyQavj.js', './vendor_leaflet-legacy-DzrMDhpu.js', './index-legacy-D7f7Ap3o.js', './vendor_firebase-legacy-BISQ33kA.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        differenceInCalendarMonths = module.bd;
        getMonth = module.be;
        ...
        IonCol = module.D;
        IonIcon = module.l;
        closeCircle = module.bL;
        checkmarkCircle = module.bg;
        IonButton = module.d;
        notificationsOffOutline = module.bM;
