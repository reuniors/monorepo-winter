;
(function () {
  System.register(['./vendor_react-legacy-BvXhJo_m.js', './vendor_ionic-legacy-dqJd8vxA.js', './App-legacy-DrR50NXY.js', './index-legacy-Brxa8z6R.js', './location-settings.data-legacy-BZiM4VFf.js', './usePendingImageUploads-legacy-zpHBcGuX.js', './vendor_leaflet-legacy-DGSDSOBP.js', './vendor_firebase-legacy-G_df00wk.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        imagesOutline = module.bu;
        locationOutline = module.bv;
