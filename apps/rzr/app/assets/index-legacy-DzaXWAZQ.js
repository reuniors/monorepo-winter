;
(function () {
  System.register(['./vendor_ionic-legacy-B27OJI2l.js', './vendor_react-legacy-j-OXaHGn.js', './vendor_leaflet-legacy-aVamlEE1.js'], function (exports, module) {
    'use strict';
    ...
    return {
      ...
      execute: function () {
        ...
        const App = reactExports.lazy(() => __vitePreload(() => module.import('./App-legacy-C1PSXo8s.js').then(n => n.a1), false              ? __VITE_PRELOAD__ : void 0));
        initializeTheme();
