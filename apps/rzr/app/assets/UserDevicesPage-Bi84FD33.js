...
import { k as activeLocation } from "./App-1S9VL0F5.js";
import { a as useGetUserConnectedDevicesQuery, b as useSendTestNotificationMutation } from "./test-notification.services-B-z7v432.js";
...
function NotificationForm({ onSubmit, isSubmitting }) {
  const {
    control,
    handleSubmit,
    formState: { errors }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit(onSubmitForm), className: "space-y-4", children: [
...
function UserDevicesPage({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto pb-20", children: [
    ...
    !isLoading && !error && (data == null ? void 0 : data.data) && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      data.data.devices.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(IonText, { color: "medium", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: t("Korisnik nema povezanih uređaja") }) }) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(IonCard, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(IonCardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: formRef, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            NotificationForm,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed bottom-4 left-0 right-0 px-4 z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          IonButton,
          {
            expand: "block",
            color: "primary",
