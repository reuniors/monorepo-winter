;
(function () {
  System.register(['./vendor_react-legacy-B8lcDdWC.js', './App-legacy-Dxsizkch.js', './vendor_ionic-legacy-DHCFIBri.js', './logo-square-legacy-De3UOogg.js', './BookingWeekDays-legacy-CxE27IsI.js', './index-legacy-Yl7KTZ0d.js', './reservation.services-legacy-i4AmBLoN.js', './client.services-legacy-DiFuy1SW.js', './UserAvatar-legacy-QLxVxZew.js', './useQueryParamsHook-legacy-BdCxHN2z.js', './vendor_leaflet-legacy-CM2JtPiy.js', './vendor_firebase-legacy-wVCteeen.js'], function (exports, module) {
    'use strict';

    var reactExports, jsxRuntimeExports, SwiperSlide, useTranslation, React, parseISO, addMinutes, toZonedTime, fromZonedTime, formatInTimeZone, startOfMonth, startOfWeek, endOfMonth, addDays, format, startOfDay, isSameDay, subMonths, addMonths, isSameMonth, yup, useLocation, useHistory, useDefaultProps, useConfirmationAlert, SwiperWrapper, useGetFeWorkersQuery, activeLocation, SceletonLoader, getPathBySize, transformStandardResponseToCamelCase, getAppTimezone, reservationTimeInterval, fromUtcHM, useContentRefFunctions, FieldType, useUser, useIsBigScreen, useFormWithSchema, urlPrefix, pushDuplicateAndNavigate, IonModalExtended, DynamicForm, ConditionalComponent, toUtc, NotificationToast, useGetFeLocationQuery, useGetFeServiceCategoriesQuery, useGetFeServiceGroupsQuery, useAppDispatch, useAppSelector, IonList, IonItem, IonAvatar, IonIcon, peopleOutline, IonLabel, chevronForwardOutline, IonButton, checkmarkCircle, addOutline, trashOutline, removeOutline, IonCard, IonCardContent, IonToggle, IonAccordionGroup, IonAccordion, calendarOutline, IonText, IonSpinner, useIonRouter, useIonToast, IonLoading, IonHeader, IonToolbar, IonTitle, IonContent, IonGrid, IonRow, IonCol, IonBadge, timeOutline, cashOutline, IonFooter, closeOutline, calendarClearOutline, chevronDownOutline, chevronUpOutline, arrowBack, arrowForward, LazyLoadImgStandard, preloadCoverImg, generateWeek, hasAnySlotsInWeek, getDaysWithSlotsSet, BookingCalendarHeader, BookingWeekDays, rzrApi, TagType, getDeviceData, setDeviceData, useCreateFeReservationMutation, useGetFePromoCodeDataQuery, useGetFeClientDataQuery, UserAvatar, useQueryParamsHook;
    return {
      setters: [module => {
