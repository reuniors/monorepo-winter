;
(function () {
  System.register(['./vendor_react-legacy-j-OXaHGn.js', './vendor_ionic-legacy-B27OJI2l.js', './App-legacy-C1PSXo8s.js', './index-legacy-DzaXWAZQ.js', './SimpleFormStepperActions-legacy-DGghVbL1.js', './location-settings.data-legacy-DR5D-Dtm.js', './usePendingImageUploads-legacy-DfrubukC.js', './vendor_leaflet-legacy-aVamlEE1.js', './vendor_firebase-legacy-BLL9XPHC.js', './props-legacy-s4OYYZ4Y.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        imagesOutline = module.bq;
        locationOutline = module.br;
