...
(function () {
  System.register(['./vendor_react-legacy-VZwyi0Js.js', './vendor_ionic-legacy-DGRHWrdu.js', './App-legacy-N9ek9vDT.js', './index-legacy-ZIHaPxgP.js', './vendor_leaflet-legacy-CfYyL1ry.js', './vendor_firebase-legacy-BVpRmQ4X.js'], function (exports, module) {
    ...
    var useTranslation, jsxRuntimeExports, reactExports, IonList, IonItem, IonIcon, IonLabel, businessOutline, IonCard, IonCardHeader, IonCardTitle, settingsOutline, IonCardContent, colorPaletteOutline, IonSelect, IonSelectOption, useGetFeLocationQuery, activeLocation, preloadedLocationData, getSettingsOptions, urlPrefix, getSavedTheme, saveTheme, applyTheme;
    return {
      setters: [module => {
      ...
      execute: function () {
        ...
        function SettingsPage() {
          ...
          const settingsOptions = reactExports.useMemo(() => {
            ...
            return baseOptions;
          }, [urlPrefix, hasMultipleActivities, locationResponse?.data, preloadedLocationData, activeLocation]);
