import { av as parseISO, bb as parse, aQ as addMinutes, bc as isWithinInterval, bd as differenceInMinutes, ay as format, aw as formatInTimeZone, e as reactExports, j as jsxRuntimeExports, af as SwiperSlide, aU as addDays, aD as useTranslation, R as React, aV as startOfDay, ax as toZonedTime, aR as startOfMonth } from "./vendor_react-Be2cnnNd.js";
import { aj as useIonRouter, n as IonSpinner, l as IonIcon, bc as cashOutline, be as chevronDownOutline, bf as chevronUpOutline } from "./vendor_ionic-CEbfXmBJ.js";
import { o as useContentRefFunctions, S as SwiperWrapper, h as useGetFeWorkersQuery, j as activeLocation, f as urlPrefix, m as getAppTimezone, n as fromUtcHM, _ as getUtcDateFormattedInTz, $ as parseUtcDate, k as SceletonLoader } from "./App-DeWcIyVH.js";
import { d as useGetFeWorkerWorkingShiftsByDaysQuery } from "./workingShift.fe-services-BYNCFVbc.js";
import { e as useGetFeLocationReservationsQuery } from "./reservation.services-BhUMx9Xx.js";
import { g as generateWeek, i as isToday, B as BookingCalendarHeader, b as BookingWeekDays } from "./BookingWeekDays-C6Wp6fvm.js";
...
function TableOfReservationsV2({
  ...
  const slides = reactExports.useMemo(() => {
    ...
    const daysInWeekWithSlots = (timeSlots == null ? void 0 : timeSlots.filter((slot) => weekDateStrs.includes(slot.dateFormatted))) || [];
    if (!isFirstWeek) {
    ...
    return slidesList;
  }, [timeSlots, currentWeek, isFirstWeek]);
  ...
  }, [slides, selectedDate, isFirstWeek]);
  ...
  const goToPreviousWeek = () => {
    if (isCalendarOpen) {
      const newMonth = startOfMonth(addDays(currentMonth, -30));
      setCurrentMonth(newMonth);
    } else {
      const newStartDate = addDays(currentWeek[0], -7);
      const newWeek = generateWeek(newStartDate);
      ...
      WeekSwiperWrapper,
      {
        ...
        children: (slide) => {
          if (slide.type === "prev-week") {
            return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-16 min-h-[320px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 dark:text-gray-500 text-sm", children: "Prethodna nedelja..." }) });
          }
          if (slide.type === "next-week") {
            return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-16 min-h-[320px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 dark:text-gray-500 text-sm", children: "Sledeća nedelja..." }) });
          }
