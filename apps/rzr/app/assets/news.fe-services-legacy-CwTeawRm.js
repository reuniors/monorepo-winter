;
(function () {
  System.register(['./index-legacy-CFC1yKwU.js', './vendor_react-legacy-CSf8zLqi.js'], function (exports, module) {
    'use strict';

    var rzrApi, TagType, transformStandardResponseToCamelCase, humpsExports;
    return {
      setters: [module => {
        rzrApi = module.v;
        TagType = module.w;
