;
(function () {
  System.register(['./vendor_react-legacy-DonFScn3.js', './App-legacy-CxwuunNq.js', './vendor_ionic-legacy-mZi8EIkK.js', './logo-square-legacy-CwQ1fdBf.js', './WeekSwiperWrapper-legacy-CkX3aIht.js', './reservation.services-legacy-cv8qPPPU.js', './client.services-legacy-Cbiw13b8.js', './UserAvatar-legacy-l4vNm8LQ.js', './vendor_leaflet-legacy-CSx1IcTV.js', './index-legacy-B6X2T6eC.js', './vendor_firebase-legacy-BNHQcAgT.js', './workingShift.fe-services-legacy-BSEOE1rh.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        React = module.R;
        format = module.aA;
        startOfMonth = module.aQ;
        endOfMonth = module.aR;
        startOfWeek = module.aS;
        addDays = module.aT;
        startOfDay = module.aU;
