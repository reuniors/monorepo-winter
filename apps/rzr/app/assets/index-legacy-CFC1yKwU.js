;
(function () {
  System.register(['./vendor_ionic-legacy-DvZl6sBE.js', './vendor_react-legacy-CSf8zLqi.js', './vendor_leaflet-legacy-DUCVU90d.js'], function (exports, module) {
    'use strict';

    var IonModal, IonIcon, alertCircleOutline, IonButton, IonHeader, IonToolbar, IonTitle, IonButtons, closeOutline, IonContent, IonPage, IonText, __vitePreload, defineCustomElements, instance, Backend, Browser, initReactI18next, fetchBaseQuery, gBase64, createApi, humpsExports, createAction, createSlice, reactExports, useHistory, jsxRuntimeExports, isRejectedWithValue, combineReducers, configureStore, useTranslation, persistStore, persistReducer, FLUSH, REHYDRATE, PAUSE, PERSIST, PURGE, REGISTER, storage, clientExports, Provider, PersistGate, ErrorBoundary;
    return {
      setters: [module => {
        IonModal = module.I;
        IonIcon = module.b;
        alertCircleOutline = module.c;
        IonButton = module.d;
        IonHeader = module.e;
        IonToolbar = module.f;
        IonTitle = module.h;
        ...
        isRejectedWithValue = module.J;
        combineReducers = module.K;
        configureStore = module.L;
        useTranslation = module.M;
        persistStore = module.N;
        persistReducer = module.O;
        FLUSH = module.P;
        REHYDRATE = module.Q;
        PAUSE = module.S;
        PERSIST = module.T;
      ...
      execute: function () {
        ...
        var TagType$1 = exports("a", /* @__PURE__ */(TagType2 => {
        ...
        var TagId$1 = exports("T", /* @__PURE__ */(TagId2 => {
          TagId2["LIST"] = "LIST";
          return TagId2;
        })(TagId$1 || {}));
        const mainBaseQuery = (args, api, extraOptions, baseUrl) => fetchBaseQuery({
          ...
          // paramsSerializer: import.meta.env.VITE_XDEBUG_ENABLED
          //   ? (params) => {
        ...
        const sharedApiPrefix = exports("e", "");
        const sharedApi = exports("s", createApi({
          reducerPath: "sharedApi",
          baseQuery: customBaseQuery(apiBaseUrl),
          tagTypes: [TagType$1.LOCATION, TagType$1.QUESTIONNAIRE, TagType$1.QUESTIONNAIRE_DATA, TagType$1.QUESTIONNAIRE_DATA_DRAFT, TagType$1.QUESTIONNAIRE_RESTAURANT_MENU, TagType$1.TAGS, TagType$1.TAG_GROUPS, TagType$1.QA_QUESTION, TagType$1.USER, TagType$1.APP_LANG, TagType$1.TRANSLATIONS, TagType$1.CHANGE_REQUESTS, TagType$1.USER_ADDRESS, TagType$1.USER_SETTINGS, TagType$1.FOOD_ORDER, TagType$1.ADMIN_USERS, TagType$1.USER_DEVICES],
          endpoints: () => ({})
        }));
        const transformPaginationResponseToCamelCase = exports("x", response => humpsExports.camelizeKeys(response.data));
        const transformStandardResponseToCamelCase = exports("t", response => humpsExports.camelizeKeys(response));
        const transformResponseToCamelCase = response => humpsExports.camelizeKeys(response.data);
        const logoutAction = exports("p", createAction("LOGOUT"));
        ...
        exports({
          b: setUser,
          u: updateUserData,
          d: setShowCompleteProfileModal,
          r: setUserHash
        });
        const getUser = exports("o", state => state.user.user);
        const getUserHash = exports("q", state => state.user.userHash);
        ...
        const getShowLoginModal = exports("i", state => state.ui.data.showLoginModal);
        const getShowImageModal = exports("j", state => state.ui.data.imageModalData?.showModal);
        const getShowNetworkErrorModal = exports("k", state => state.ui.data.showNetworkErrorModal);
        ...
        const uploadSlices = createSlice({
          ...
          reducers: {
            ...
            resetUploadData: () => initialState$3
          }
        });
        const {
          setUploadState,
        ...
        const deviceSlice = createSlice({
          ...
          reducers: {
            ...
            resetDeviceData: () => initialState$1
          },
          extraReducers: builder => {
            builder.addCase(logoutAction, () => initialState$1);
          }
        });
        const getDeviceData = exports("m", state => state.device);
        const {
          setDeviceData,
          resetDeviceData
        } = deviceSlice.actions;
        exports("n", setDeviceData);
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
            children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonIcon, {
                ...
                children: t("Aplikacija je doživela neočekivanu grešku.")
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonButton, {
                  ...
                  children: t("Prikaži grešku")
                }), /* @__PURE__ */jsxRuntimeExports.jsx(IonButton, {
                  color: "primary",
                  onClick: handleReload,
                  children: t("Osveži stranicu")
                })]
              })]
            }), /* @__PURE__ */jsxRuntimeExports.jsxs(IonModalExtended$1, {
              name: "error-modal",
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonHeader, {
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs("h3", {
                    ...
                    children: [t("Tip greške"), ":"]
                  }), /* @__PURE__ */jsxRuntimeExports.jsx("p", {
                    style: {
                      color: "var(--ion-color-dark)",
                      fontFamily: "monospace"
                    },
                    children: error.name || t("Nepoznata greška")
                  })]
                }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  style: {
                    marginBottom: "16px"
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs("h3", {
                    ...
                    children: error.message || t("Nema dodatnih informacija")
                  })]
                }), error.stack && /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  style: {
                    marginBottom: "16px"
                  },
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs("h3", {
        ...
        const ErrorFallback = ({
          ...
          const isChunkError = errorName === "ChunkLoadError" || errorMessage.includes("Failed to fetch dynamically imported module") || errorMessage.includes("Importing a module script failed") || errorMessage.includes("Loading chunk") || errorMessage.includes("Loading CSS chunk");
          if (isChunkError) {
            return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsx("h1", {
                ...
                children: t("Ažuriranje aplikacije...")
              }), /* @__PURE__ */jsxRuntimeExports.jsx("p", {
                style: {
                  color: "var(--ion-color-medium)"
                },
                children: t("Nova verzija aplikacije je dostupna.")
              }), /* @__PURE__ */jsxRuntimeExports.jsx("p", {
                style: {
                  color: "var(--ion-color-medium)"
                },
                children: t("Molimo osvežite stranicu.")
        ...
        const locationSettingsSlice = createSlice({
          ...
          reducers: {
            setLocationSettings: (state, action) => {
              ...
              if (action.payload.locationHash !== void 0) {
                state.locationHash = action.payload.locationHash;
              }
            },
            setLocationHash: (state, action) => {
              state.locationHash = action.payload;
            },
            clearLocationSettings: state => {
              state.activeLocation = null;
              state.settings = null;
              state.locationHash = void 0;
            }
          },
          extraReducers: builder => {
            builder.addCase(logoutAction, state => {});
        ...
        } = locationSettingsSlice.actions;
        exports({
          A: setLocationSettings,
          z: setLocationHash
        });
        const getActiveLocation = exports("B", state => state.locationSettings.activeLocation);
        const getLocationSettings = exports("C", state => state.locationSettings.settings);
        const getLocationHash = exports("y", state => state.locationSettings.locationHash);
        const getPauseBetweenReservations = exports("N", state => state.locationSettings.settings?.pauseBetweenReservations ?? 0);
        const projectName = "rzr";
        const locale = getInitialData("locale");
        const debug = false;
        const fallbackLng = "rs";
        const translationsVersion = parseFloat("1.001");
        instance.init({
          fallbackLng,
          debug,
          returnNull: false,
          ...
          backend: {
            loadPath: `${"/app/"}public/projects/${projectName}/locales/{{lng}}/{{ns}}.json?v=${translationsVersion}`
          },
        ...
        var TagType = exports("w", /* @__PURE__ */(TagType2 => {
          TagType2["LOCATION"] = "location";
        ...
        var TagId = exports("M", /* @__PURE__ */(TagId2 => {
          TagId2["LIST"] = "LIST";
          return TagId2;
        })(TagId || {}));
        const apiUrl$1 = getInitialData("rzrApiUrl") ?? "/api/v1/rzr";
        const rzrApi = exports("v", createApi({
          baseQuery: customBaseQuery(apiUrl$1),
          tagTypes: ["user", "location", "reservation", "client", "clientReservation", "locationWorkers", "locationWorkingHours", "workerWorkingHours", "shift", "shiftByDays", "user", "appLang", "news", "servicesGroups", "services", "locationPromoCodes", "translations", "changeRequests", "AdminUsers", "UserDevices"
          /* USER_DEVICES */],
          endpoints: () => ({})
        }));
        const apiUrl = "/api/v1";
        const administrationApi = createApi({
          ...
          tagTypes: ["AdminLocations", "AdminUsers", "AdminStats"],
          endpoints: builder => ({
            // Statistics
            getAdminStats: builder.query({
              query: () => "/admin/stats",
              transformResponse: response => transformResponseToCamelCase(response),
            ...
            updateLocationStatus: builder.mutation({
              ...
              invalidatesTags: ["AdminLocations", "AdminStats"]
            }),
            // Users
        ...
        exports({
          D: useGetAdminStatsQuery,
          F: useGetAllLocationsQuery,
          G: useUpdateLocationStatusMutation,
          H: useGetAllUsersQuery
        });
        const persistConfig = {
          key: "root",
          storage,
          whitelist: ["user", "device", "ui", "locationSettings"]
          // Add ui to persist theme, locationSettings for location settings
        };
        const rootReducer = combineReducers({
          ...
          ui: uiSlices.reducer,
          device: deviceSlice.reducer,
          locationSettings: locationSettingsSlice.reducer
        });
        ...
        const store = configureStore({
          ...
          }).concat(rzrApi.middleware, sharedApi.middleware, administrationApi.middleware, unauthorizedMiddleware)
        });
        ...
        class ChunkLoadErrorBoundary extends reactExports.Component {
          ...
          static getDerivedStateFromError(error) {
            ...
            const isChunkError = errorName === "ChunkLoadError" || errorMessage.includes("Failed to fetch dynamically imported module") || errorMessage.includes("Importing a module script failed") || errorMessage.includes("Loading chunk") || errorMessage.includes("Loading CSS chunk") || errorStack.includes("Failed to fetch dynamically imported module") || errorStack.includes("chunk") ||
            // Check for Vite-specific chunk errors
            errorMessage.includes("fetch") && errorMessage.includes("module");
            return {
              hasError: true,
              isChunkError
            };
                  ...
                  children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsxs(IonText, {
                      ...
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx("h2", {
                        ...
                        children: "Molimo osvežite stranicu."
                      })]
                    }), /* @__PURE__ */jsxRuntimeExports.jsx(IonButton, {
        ...
        const App = reactExports.lazy(() => __vitePreload(() => module.import('./App-legacy-DtnUlzjS.js').then(n => n.ah), false              ? __VITE_PRELOAD__ : void 0));
        initializeTheme();
