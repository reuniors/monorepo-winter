;
(function () {
  System.register(['./vendor_react-legacy-CFXrDSu1.js', './vendor_ionic-legacy-kFTPXAWE.js', './App-legacy-DT3CUYN8.js', './index-legacy-D7f7Ap3o.js', './vendor_leaflet-legacy-DzrMDhpu.js', './vendor_firebase-legacy-BISQ33kA.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        IonMenuToggle = module.bc;
        IonItem = module.q;
        logInOutline = module.aC;
        powerOutline = module.bd;
        IonFooter = module.o;
        IonLabel = module.F;
        home = module.be;
