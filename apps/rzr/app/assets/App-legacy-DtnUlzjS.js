;
(function () {
  System.register(['./vendor_react-legacy-CSf8zLqi.js', './vendor_ionic-legacy-DvZl6sBE.js', './index-legacy-CFC1yKwU.js', './vendor_firebase-legacy-tNokQwyN.js'], function (exports, module) {
    'use strict';

    var jsxRuntimeExports, humpsExports, useForm, o, t, yup, setLocale, useTranslation, useDispatch, reactExports, useGoogleLogin, create$3, create$6, React, Controller, lodashExports, useWatch, DraftExports, reactDraftWysiwygExports, draftToHtml, qr, Swiper, createSlice, l, combineReducers, configureStore, c, SwiperSlide, register, V, arrayMove, useSensors, useSensor, DndContext, closestCenter, SortableContext, verticalListSortingStrategy, TouchSensor, sortableKeyboardCoordinates, KeyboardSensor, PointerSensor, useSortable, CSS, parseISO, formatInTimeZone, toZonedTime, format, fromZonedTime, isValid, useSelector, GoogleOAuthProvider, ErrorBoundary, Route, useHistory, ErrorBoundary$1, Redirect, useLocation, useParams, create$5, create$7, create$2, GoogleOAuthProvider$1, useIonToast, IonModal, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonIcon, closeOutline, IonContent, IonSpinner, IonFooter, saveOutline, languageOutline, IonItem, IonInput, eye, eyeOff, logoGoogle, IonText, IonSelect, IonSelectOption, videocam, videocamOff, IonGrid, IonRow, IonCol, IonSearchbar, IonLabel, IonList, IonCheckbox, chevronBack, chevronForward, arrowUndoOutline, IonPage, createAnimation, useIonModal, useIonLoading, useIonAlert, useIonActionSheet, trashOutline, IonImg, cropOutline, optionsOutline, cloudUploadOutline, funnelOutline, listCircleSharp, checkmarkOutline, IonItemSliding, IonItemOptions, IonThumbnail, IonReorder, menuOutline, chevronForwardOutline, IonItemOption, constructOutline, checkboxOutline, squareOutline, IonReorderGroup, addOutline, isPlatform, icons, IonTextarea, IonDatetime, IonToggle, __vitePreload, calendarOutline, timeOutline, IonChip, mailOutline, keyOutline, IonLoading, IonToast, refreshOutline, useIonRouter, IonListHeader, IonSkeletonText, exitOutline, logoApple, logoAndroid, IonMenuButton, chevronBackOutline, ellipsisVertical, ellipsisHorizontal, IonRefresher, IonRefresherContent, IonPopover, IonAlert, arrowBackOutline, arrowForwardOutline, lockClosedOutline, logInOutline, useIonViewWillEnter, useIonViewWillLeave, setupConfig, logOutOutline, IonApp, IonReactRouter, IonSegment, IonSegmentButton, createOutline, gitNetworkOutline, giftOutline, settingsOutline, peopleOutline, megaphoneOutline, notificationsOutline, businessOutline, IonActionSheet, IonTabs, IonRouterOutlet, IonTabBar, IonTabButton, homeOutline, alarmOutline, personOutline, useIonViewDidLeave, informationCircleOutline, appsOutline, IonCard, IonCardContent, IonCardHeader, IonCardTitle, checkmarkCircleOutline, IonBadge, IonSplitPane, arrowBack, briefcaseOutline, eyeOutline, shieldCheckmarkOutline, hammerOutline, IonProgressBar, setupIonicReact, sharedApi, TagId, TagType, transformStandardResponseToCamelCase, setUser, setUiData, setShowCompleteProfileModal, IonModalExtended, sharedApiPrefix, UploadType, getImageModalData, closeImageModal, setShowNetworkErrorModal, getShowLoginModal, getShowImageModal, getShowNetworkErrorModal, setShowLoginModal, getDeviceData, setDeviceData, getUser, logoutAction, ErrorDisplay, getUserHash, setUserHash, updateUserData, rzrApi, TagType$1, transformPaginationResponseToCamelCase, getLocationHash, setLocationHash, setLocationSettings, getActiveLocation, getLocationSettings, useGetAdminStatsQuery, useGetAllLocationsQuery, useUpdateLocationStatusMutation, useGetAllUsersQuery, getInitialData, getSavedTheme, applyTheme, TagId$1, initializeApp, getMessagingInWindow, getAnalytics, onMessage, getToken;
    return {
      setters: [module => {
        ...
        useDispatch = module.a5;
        reactExports = module.e;
        useGoogleLogin = module.a6;
        create$3 = module.a7;
        create$6 = module.a8;
        React = module.R;
        Controller = module.a9;
        lodashExports = module.aa;
        useWatch = module.ab;
        DraftExports = module.ac;
        reactDraftWysiwygExports = module.ad;
        draftToHtml = module.ae;
        qr = module.af;
        Swiper = module.ag;
        createSlice = module.G;
        l = module.ah;
        combineReducers = module.K;
        configureStore = module.L;
        c = module.ai;
        SwiperSlide = module.aj;
        register = module.ak;
        V = module.al;
        arrayMove = module.am;
        useSensors = module.an;
        useSensor = module.ao;
        DndContext = module.ap;
        closestCenter = module.aq;
        SortableContext = module.ar;
        verticalListSortingStrategy = module.as;
        TouchSensor = module.at;
        sortableKeyboardCoordinates = module.au;
        KeyboardSensor = module.av;
        PointerSensor = module.aw;
        useSortable = module.ax;
        CSS = module.ay;
        parseISO = module.az;
        ...
        isValid = module.aE;
        useSelector = module.aF;
        GoogleOAuthProvider = module.aG;
        ErrorBoundary = module.aH;
        Route = module.q;
        useHistory = module.I;
        ErrorBoundary$1 = module.$;
        Redirect = module.aI;
        ...
        create$7 = module.aM;
        create$2 = module.aN;
        GoogleOAuthProvider$1 = module.aO;
      }, module => {
        ...
        chevronBack = module.K;
        chevronForward = module.L;
        arrowUndoOutline = module.M;
        IonPage = module.l;
        createAnimation = module.N;
        useIonModal = module.O;
        useIonLoading = module.P;
        useIonAlert = module.Q;
        useIonActionSheet = module.R;
        trashOutline = module.S;
        IonImg = module.T;
        cropOutline = module.U;
        optionsOutline = module.V;
        cloudUploadOutline = module.W;
        funnelOutline = module.X;
        listCircleSharp = module.Y;
        checkmarkOutline = module.Z;
        IonItemSliding = module.$;
        IonItemOptions = module.a0;
        IonThumbnail = module.a1;
        IonReorder = module.a2;
        menuOutline = module.a3;
        chevronForwardOutline = module.a4;
        IonItemOption = module.a5;
        constructOutline = module.a6;
        checkboxOutline = module.a7;
        squareOutline = module.a8;
        IonReorderGroup = module.a9;
        addOutline = module.aa;
        isPlatform = module.ab;
        icons = module.ac;
        IonTextarea = module.ad;
        IonDatetime = module.ae;
        IonToggle = module.af;
        ...
        keyOutline = module.ak;
        IonLoading = module.al;
        IonToast = module.am;
        refreshOutline = module.an;
        useIonRouter = module.ao;
        IonListHeader = module.ap;
        IonSkeletonText = module.aq;
        exitOutline = module.ar;
        logoApple = module.as;
        logoAndroid = module.at;
        IonMenuButton = module.au;
        chevronBackOutline = module.av;
        ellipsisVertical = module.aw;
        ellipsisHorizontal = module.ax;
        IonRefresher = module.ay;
        IonRefresherContent = module.az;
        IonPopover = module.aA;
        IonAlert = module.aB;
        arrowBackOutline = module.aC;
        arrowForwardOutline = module.aD;
        lockClosedOutline = module.aE;
        logInOutline = module.aF;
        useIonViewWillEnter = module.aG;
        useIonViewWillLeave = module.aH;
        setupConfig = module.aI;
        logOutOutline = module.aJ;
        IonApp = module.aK;
        IonReactRouter = module.aL;
        IonSegment = module.aM;
        IonSegmentButton = module.aN;
        createOutline = module.aO;
        gitNetworkOutline = module.aP;
        giftOutline = module.aQ;
        settingsOutline = module.aR;
        peopleOutline = module.aS;
        megaphoneOutline = module.aT;
        notificationsOutline = module.aU;
        businessOutline = module.aV;
        IonActionSheet = module.aW;
        IonTabs = module.aX;
        IonRouterOutlet = module.aY;
        IonTabBar = module.aZ;
        IonTabButton = module.a_;
        homeOutline = module.a$;
        alarmOutline = module.b0;
        personOutline = module.b1;
        useIonViewDidLeave = module.b2;
        informationCircleOutline = module.b3;
        appsOutline = module.b4;
        IonCard = module.b5;
        ...
        IonBadge = module.ba;
        IonSplitPane = module.bb;
        arrowBack = module.bc;
        briefcaseOutline = module.bd;
        eyeOutline = module.be;
        shieldCheckmarkOutline = module.bf;
        hammerOutline = module.bg;
        IonProgressBar = module.bh;
        setupIonicReact = module.bi;
      }, module => {
        sharedApi = module.s;
        TagId = module.T;
        TagType = module.a;
        ...
        setUser = module.b;
        setUiData = module.c;
        setShowCompleteProfileModal = module.d;
        IonModalExtended = module.I;
        sharedApiPrefix = module.e;
        UploadType = module.U;
        getImageModalData = module.g;
        closeImageModal = module.f;
        setShowNetworkErrorModal = module.h;
        getShowLoginModal = module.i;
        getShowImageModal = module.j;
        getShowNetworkErrorModal = module.k;
        setShowLoginModal = module.l;
        getDeviceData = module.m;
        setDeviceData = module.n;
        getUser = module.o;
        logoutAction = module.p;
        ErrorDisplay = module.E;
        getUserHash = module.q;
        setUserHash = module.r;
        updateUserData = module.u;
        rzrApi = module.v;
        TagType$1 = module.w;
        transformPaginationResponseToCamelCase = module.x;
        getLocationHash = module.y;
        setLocationHash = module.z;
        setLocationSettings = module.A;
        getActiveLocation = module.B;
        getLocationSettings = module.C;
        useGetAdminStatsQuery = module.D;
        useGetAllLocationsQuery = module.F;
        useUpdateLocationStatusMutation = module.G;
        useGetAllUsersQuery = module.H;
        getInitialData = module.J;
      ...
      execute: function () {
        ...
        exports({
          ...
          J: SimpleFormStepperActions,
          L: LayoutMainPage,
          M: StepIndicator,
          W: WorkingHoursList,
          a6: ServiceEditForm,
          ab: useDeviceNotification,
          b: useUser,
          h: useDefaultProps,
          k: useContentRefFunctions,
          l: useQueryParamsHook,
          x: useFormWithSchema
        });
        ...
        function getErrorMessage(error) {
          ...
          if (fetchError?.data && typeof fetchError.data === "object" && "data" in fetchError.data && "status" in fetchError.data) {
          ...
          if (fetchError?.data && typeof fetchError.data === "object" && "errors" in fetchError.data) {
        ...
        var UserGroupCode = exports("U", /* @__PURE__ */(UserGroupCode2 => {
        ...
        function useLoginForm({
          ...
          const showNotification = reactExports.useCallback((options, durationSec) => {
            presentToast({
          ...
          const handleSuccessfulLogin = reactExports.useCallback(loginData => {
          ...
          const onSubmit = reactExports.useCallback(data => {
            prepareUser(data);
          }, [prepareUser]);
          reactExports.useEffect(() => {
            ...
            if (isPrepareError) {
              showNotification({
                message: prepareErrorMessage ?? "Unknown error",
                color: "danger"
              }, 1);
              hideLoading();
            }
          }, [isPrepareSuccess, isPrepareError, prepareErrorMessage, showNotification, hideLoading]);
          reactExports.useEffect(() => {
              ...
              if (errorMsg === "Invalid code") {
                setAttempts(prevAttempts => {
                  ...
                  if (newAttempts >= 2) {
                    ...
                    setAttempts(0);
                    showNotification({
                      message: t("Kod nije ispravan. Molimo vas da pokušate ponovo."),
                      color: "danger",
                      position: "bottom"
                    }, 3);
                    return 0;
                  } else {
                    setErrorMessage(t("Kod nije ispravan. Možete još jednom da pokušate."));
                    showNotification({
                      message: t("Kod nije ispravan. Možete još jednom da pokušate."),
                      color: "warning",
                      position: "bottom"
                    }, 3);
                    return newAttempts;
                ...
                setErrorMessage(errorMsg ?? t("Nepoznata greška"));
                showNotification({
          ...
          }, [isLoginWithCodeSuccess, isLoginWithCodeError, loginWithCodeResponse, loginWithCodeError, t, dispatch, handleSuccessfulLogin, prepareResult, hideLoading, showNotification]);
        ...
        function useGoogleLoginAuth({
          ...
          }, [isGoogleLoginSuccess, isGoogleLoginError, googleUserData, onSuccessfulLogin, dispatch]);
          return {
            handleGoogleLogin,
            isGoogleLoginError
          };
        ...
        const convertEmptyStringToNull = exports("a0", value => value === "" || lodashExports.isNumber(value) && isNaN(value) ? null : value);
        const generateSlugForValidation = exports("a1", text => {
        ...
        const photosArrayWithIdYup = exports("K", errorMsg => yup.array().nullable().defined().test("all-photos-have-id", "", function (value) {
        ...
        function SelectAutocomplete(props) {
          ...
          const [filteredItems, setFilteredItems] = reactExports.useState([...displayItems]);
          reactExports.useEffect(() => {
          ...
          }, [searchQuery, currentPage, useServerSideSearch, onServerSideSearch, perPage]);
          reactExports.useEffect(() => {
          ...
          const handleSelected = (item, text) => () => {
            props.onSelectionChange?.(item, text);
          };
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonRow, {
                  ...
                  children: !props.hideSearchbar ? /* @__PURE__ */jsxRuntimeExports.jsxs(IonHeader, {
                    children: [/* @__PURE__ */jsxRuntimeExports.jsxs(IonToolbar, {
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonTitle, {
                        ...
                        slot: "end",
                        children: /* @__PURE__ */jsxRuntimeExports.jsx(IonButton, {
                          onClick: handleSelected(void 0, void 0),
                          children: t("Resetuj")
                        })
                      })]
                    }), /* @__PURE__ */jsxRuntimeExports.jsx(IonToolbar, {
                ...
                children: /* @__PURE__ */jsxRuntimeExports.jsxs(IonCol, {
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs(IonList, {
                    ...
                    }), !isLoading && filteredItems.length === 0 && /* @__PURE__ */jsxRuntimeExports.jsx(IonItem, {
                      children: /* @__PURE__ */jsxRuntimeExports.jsx(IonLabel, {
                        children: /* @__PURE__ */jsxRuntimeExports.jsx(IonText, {
                          color: "medium",
                          children: /* @__PURE__ */jsxRuntimeExports.jsx("p", {
                            children: t("Nema rezultata")
                          })
                        })
                      })
                    }), !isLoading && filteredItems.length > 0 && !useServerSideSearch && /* @__PURE__ */jsxRuntimeExports.jsx(qr, {
                    ...
                    }), !isLoading && filteredItems.length > 0 && useServerSideSearch && filteredItems.map(item => /* @__PURE__ */jsxRuntimeExports.jsx(IonItem, {
                      disabled: props.disabled,
                      onClick: handleSelected(item.value, item.text),
                      button: true,
                      children: /* @__PURE__ */jsxRuntimeExports.jsx(IonLabel, {
                        children: item.childNode ?? item.text
                      })
                    }, item.value))]
                  }), useServerSideSearch && /* @__PURE__ */jsxRuntimeExports.jsx(Pagination, {
                    currentPage,
        ...
        function SelectAutocompleteModal({
          ...
          const [selectedItemText, setSelectedItemText] = reactExports.useState(selectedItemTextProp);
          const modal = reactExports.useRef(null);
          const modalName = `select-autocomplete-${title || "modal"}`;
          const selectedValue = selectedItemValue?.toString();
          reactExports.useEffect(() => {
            if (isNewSelected) {
            ...
            const foundInOptions = options.find(option => option.value == selectedValue);
            if (foundInOptions) {
              setSelectedItemText(foundInOptions.text);
              return;
            }
          }, [selectedValue, options, isNewSelected, useServerSideSearch, onGetItemById]);
          reactExports.useEffect(() => {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
            ...
            }), /* @__PURE__ */jsxRuntimeExports.jsxs(IonModalExtended, {
              ref: modal,
              name: modalName,
              isOpen: showModal,
        ...
        const useConfirmationAlert = exports("j", (callbacks, options) => {
        ...
        function CropViewModal(props, ref) {
          ...
          const handleCropSave = reactExports.useCallback(cropSrc => {
            if (onSave) {
              onSave(cropSrc);
            } else {
              cropViewProps?.onSave?.(cropSrc);
            }
            handleClose();
          }, [onSave, cropViewProps?.onSave, handleClose]);
          const handleApply = reactExports.useCallback(() => {
            cropViewRef.current?.handleSave();
          }, []);
          return /* @__PURE__ */jsxRuntimeExports.jsxs(IonModalExtended, {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonHeader, {
              children: /* @__PURE__ */jsxRuntimeExports.jsxs(IonToolbar, {
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonTitle, {
                  children: aspectRatio && /* @__PURE__ */jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
                    children: [t("Odnos: "), aspectRatio.width, " x ", aspectRatio.height]
                  })
                }), /* @__PURE__ */jsxRuntimeExports.jsx(IonButtons, {
                  slot: "end",
                  children: /* @__PURE__ */jsxRuntimeExports.jsx(IonButton, {
              ...
              children: image && /* @__PURE__ */jsxRuntimeExports.jsx(CropView$1, {
                ...
                onSave: onSave ? handleCropSave : cropViewProps?.onSave || handleCropSave,
                aspectRatio,
                hideActions: true,
                ...cropViewProps
              })
        ...
        const getPathBySize = exports("s", img => {
          if (!img) {
            return "";
          }
          switch (true) {
        ...
        function PhotoEditor(props, ref) {
          ...
          const updateSelectedImage = reactExports.useCallback(async (croppedSrc, removeSelected = true) => {
        ...
        let cachedDate = null;
        let cachedHour = -1;
        const getAppTimezone = exports("v", () => {
          return appTimezone;
        });
        ...
        const toUtc = exports("af", (timeString, tz) => {
        ...
        const fromUtc = exports("ae", (utcTimeString, tz) => {
          const timezone = getAppTimezone();
        ...
        const fromUtcHM = exports("t", (utcTimeString, tz) => {
          const timezone = getAppTimezone();
        ...
        const fromUtcDateTimeToTime = exports("A", (utcDateTime, tz) => {
          const timezone = getAppTimezone();
          const localDate = toZonedTime(utcDateTime, timezone);
          return format(localDate, "HH:mm");
        });
        const parseUtcDate = exports("$", (utcDateString, tz) => {
        ...
        const getUtcDateFormattedInTz = exports("_", (utcDateString, tz) => {
          const timezone = getAppTimezone();
        ...
        const timeToDateTime = utcTimeString => {
          ...
          const utcDate = new Date(Date.UTC(referenceDate.getUTCFullYear(), referenceDate.getUTCMonth(), referenceDate.getUTCDate(), hours, minutes, seconds || 0));
          const localDate = toZonedTime(utcDate, timezone);
        ...
        const isIos = exports("f", isPlatform("ios"));
        const isPwa = exports("i", isPlatform("pwa"));
        const isInstalled = exports("ac", isPlatform("capacitor"));
        const getIsWebview = userAgent => {
          return /webview|wv|ip((?!.*Safari)|(?=.*like Safari))/i.test(userAgent);
        };
        const useIsBigScreen = exports("w", (breakpoint = 1024) => {
        ...
        const isWebView = exports("ad", window?.navigator && window?.navigator?.userAgent ? getIsWebview(window.navigator.userAgent) : true);
        const ionIconList = [];
        const ionIcons = {};
        const fetchIonIconsList = exports("ag", () => {
        ...
        const generateSlug = exports("T", str => {
        ...
        const userHasRoles = exports("e", (user, roles, all = false) => {
        ...
        const useAppSelector$1 = exports("Y", useSelector);
        ...
        const useShowNotification = exports("H", options => {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(IonItemSliding, {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsxs(IonItem, {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonText, {
                ...
                slot: "end",
                children: [fromUtcHM(workingTime.timeFromUtc), " -", " ", fromUtcHM(workingTime.timeToUtc)]
              }), /* @__PURE__ */jsxRuntimeExports.jsx(IonButton, {
                slot: "end",
                color: "default",
        ...
        const ListIonIcons = reactExports.lazy(() => __vitePreload(() => module.import('./ListIonIcons-legacy-BbfYjSfx.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        function ActivationCodeForm({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            ...
            }), (errorMessage || codeValidationError) && /* @__PURE__ */jsxRuntimeExports.jsx(IonText, {
              color: attempts >= 1 ? "warning" : "danger",
              className: "ion-padding-bottom",
              children: /* @__PURE__ */jsxRuntimeExports.jsx("small", {
                children: errorMessage || codeValidationError
              })
            }), /* @__PURE__ */jsxRuntimeExports.jsx(IonButton, {
        ...
        function CommonLoginForm(props) {
          ...
          const {
            ...
            onCodeSubmit: React.useCallback((code, login) => {
              showLoading();
              loginWithCode({
                code,
                login
          ...
          const prevShowConfirmationCodeFieldRef = React.useRef(showConfirmationCodeField);
          const resetFunctionsRef = React.useRef({
            resetCodeForm,
            resetLoginState
          });
          React.useEffect(() => {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            ...
            children: [isLoading && /* @__PURE__ */jsxRuntimeExports.jsx(IonLoading, {
              ...
              duration: showLoadingDuration
            }), showConfirmationCodeField ? /* @__PURE__ */jsxRuntimeExports.jsx(ActivationCodeForm, {
              codeForm,
              codeFields,
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsx(LoginForm, {
                ...
                isPrepareError,
                prepareErrorMessage
              }), /* @__PURE__ */jsxRuntimeExports.jsx(GoogleLoginButton, {
        ...
        function NetworkErrorToast({
          ...
          const handleRetryAction = onRetry ?? defaultRetry;
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsx(IonToast, {
            isOpen,
            message: isChecking ? t("Proveravam konekciju...") : t("Nema interneta. Proveravam konekciju..."),
            duration: void 0,
            position: "top",
            color: "warning",
            buttons: [{
              text: isChecking ? t("Proveravam...") : t("Pokušaj ponovo"),
              icon: refreshOutline,
              handler: () => {
                if (!isChecking) {
                  handleRetry();
        ...
        function CommonModalWrappers() {
          ...
          const NetworkErrorToastWrapper = reactExports.useMemo(() => {
            return /* @__PURE__ */jsxRuntimeExports.jsx(NetworkErrorToast, {
              isOpen: showNetworkErrorModal === true
            });
          }, [showNetworkErrorModal]);
          return /* @__PURE__ */jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
            children: [LoginModalWrapper, ImageModalWrapper, NetworkErrorToastWrapper]
          });
        }
        ...
        function CommonNotificationWrapper({
          ...
          }, [deviceData.notificationsEnabled, deviceData.notificationsToken, deviceNotification, userData, canUsePushOnThisDevice]);
          return null;
        }
        ...
        const ShowLoading$1 = exports("a5", reactExports.memo(ShowLoading));
        ...
        const SceletonLoader = exports("r", reactExports.memo(SkeletonLoader));
        ...
        const fallbackRenderContent = ({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsx(ErrorDisplay, {
            error,
            resetErrorBoundary
          });
        };
        ...
        function LayoutMainPage({
          ...
          const responseNode = /* @__PURE__ */jsxRuntimeExports.jsxs(reactExports.Fragment, {
            children: [swipeBackEnabled !== canGoBack && /* @__PURE__ */jsxRuntimeExports.jsx(SwipeGestureController, {
              enabled: !!canGoBack,
        ...
        const SimpleFormStepper$1 = exports("O", reactExports.memo(reactExports.forwardRef(SimpleFormStepper)));
        function StepItem({
          step,
          index,
          isActive,
        ...
        function SimpleFormStepperActions({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
            children: [isLoading && /* @__PURE__ */jsxRuntimeExports.jsx(IonLoading, {
              ...
              className: "h-20 transparent"
            }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              className: `${className} bottom-0 fixed w-full z-10 bg-white dark:bg-gray-900 left-0 right-0 px-4`,
              style: {
        ...
        const usePing = (types, requestData, onChangeHandler, options) => {
          ...
          const [requestDataState, setRequestDataState] = reactExports.useState({
            ...
            hashes: {
              ...
              ...(persistedUserHash && types.includes(PingType.USERS) ? {
                [PingType.USERS]: persistedUserHash
              } : {})
            }
          });
          ...
          const handleChanges = reactExports.useCallback(changes => {
            ...
            if (types.includes(PingType.USERS) && changes[PingType.USERS]?.hasChanges) {
              dispatch(setUserHash(changes[PingType.USERS]?.hash));
          ...
          }, [data, handleChanges, options?.interval]);
        ...
        const PrivateLocationLandingPage = reactExports.lazy(() => __vitePreload(() => module.import('./PrivateLocationLandingPage-legacy-YcUugWdw.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const {
          ...
          useLazyGetFeLocationQuery
        } = locationApi;
        exports("m", useGetFeLocationQuery);
        const HomePage = reactExports.lazy(() => __vitePreload(() => module.import('./HomePage-legacy-25IKrb_w.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const AppointmentPage = reactExports.lazy(() => __vitePreload(() => module.import('./AppointmentPage-legacy-DGLpcXdm.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ProfilePage = reactExports.lazy(() => __vitePreload(() => module.import('./ProfilePage-legacy-BxNbcGd3.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NotificationPage = reactExports.lazy(() => __vitePreload(() => module.import('./NotificationPage-legacy-mHC3lpDC.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const locationWorkerApi = rzrApi.injectEndpoints({
          endpoints: builder => ({
            ...
            storeWorkerService: builder.mutation({
              ...
              transformResponse: transformStandardResponseToCamelCase,
              invalidatesTags: [TagType$1.LOCATION_WORKERS, TagType$1.SERVICES_GROUPS
            ...
            getWorkerNextSlots: builder.query({
              query: ({
                ...
                url: `locations/workers/${workerId}/next-slots`,
                method: "GET",
                params: {
                  locationSlug,
                  limit
        ...
        exports({
          q: useGetFeWorkersQuery,
          a7: useCreateWorkerMutation,
          Q: useGetAllWorkersQuery,
          aa: useGetWorkerNextSlotsQuery
        });
        ...
        const PrepareWorkingDaysShiftsPage = reactExports.lazy(() => __vitePreload(() => module.import('./PrepareWorkingDaysShiftsPage-legacy-BhcS3mrL.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const getSettingsOptions = exports("a9", urlPrefix => [{
        ...
        const OwnerHomePage = reactExports.lazy(() => __vitePreload(() => module.import('./OwnerHomePage-legacy-B6L0u7ex.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const OwnerAppointmentPage = reactExports.lazy(() => __vitePreload(() => module.import('./OwnerAppointmentPage-legacy-Dhtwxa31.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const SettingsPage = reactExports.lazy(() => __vitePreload(() => module.import('./SettingsPage-legacy-DF6P35m4.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const MainTabs = ({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(IonTabs, {
            children: [/* @__PURE__ */jsxRuntimeExports.jsxs(IonRouterOutlet, {
              ...
              }), hasSettingsAccess && /* @__PURE__ */jsxRuntimeExports.jsx(IonTabButton, {
                tab: "podesavanja",
        ...
        const CreateAppointmentPage = reactExports.lazy(() => __vitePreload(() => module.import('./CreateAppointmentPage-legacy-DXX6Qn2s.js'), false              ? __VITE_PRELOAD__ : void 0));
        function CreateAppointmentPageWrapper() {
          ...
          const handleBackClick = () => {
            router.push(`${urlPrefix}/t/termini`, "back");
          };
          return /* @__PURE__ */jsxRuntimeExports.jsx(LayoutMainPage, {
            title: t("Nov termin"),
            hasBackButton: true,
        ...
        const ConfirmReservationPage = reactExports.lazy(() => __vitePreload(() => module.import('./ConfirmReservationPage-legacy-DTrB_SHS.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const PublicProfilePage = reactExports.lazy(() => __vitePreload(() => module.import('./PublicProfilePage-legacy-BIt0WemQ.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NewsListPage = reactExports.lazy(() => __vitePreload(() => module.import('./NewsListPage-legacy-D6D2FA2c.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NewsCreatePage = reactExports.lazy(() => __vitePreload(() => module.import('./NewsCreatePage-legacy-CGCcin-O.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NewsEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./NewsEditPage-legacy-CiqYV7FA.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationWorkingTimePage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkingTimePage-legacy-CrNAi7_j.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationEditPage-legacy-BtJf4eU6.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationWorkersPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkersPage-legacy-ciPq--wz.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationSettingsPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationSettingsPage-legacy-DxdTNXEF.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServicesPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServicesPage-legacy-BxIIhYJi.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceCategoriesPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceCategoriesPage-legacy-B7yE_lI2.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        exports({
          o: useGetFeServiceCategoriesQuery,
          R: useCreateServiceCategoryMutation,
          V: useUpdateServiceCategoryMutation,
          X: useDeleteServiceCategoryMutation
        });
        const pushDuplicateAndNavigate = exports("y", (router, destination, referrer) => {
        ...
        const ServiceCategoryEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceCategoryEditPage-legacy-CxTAsqPf.js'), false              ? __VITE_PRELOAD__ : void 0));
        function ServiceCategoryEditPageWrapper() {
          ...
          const category = categoriesResponse?.data.find(c => c.id === parseInt(categoryId || "0"));
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsx(LayoutMainPage, {
            headerClasses: mainHeaderClasses,
            title: isLoading ? t("Učitavanje...") : error || !category ? t("Greška") : t("Uredi delatnost"),
            hasBackButton: true,
            backButtonUrl: !isLoading && !error && category && !useCustomBackHandler ? `${urlPrefix}/podesavanja/delatnosti` : void 0,
            ...
            children: /* @__PURE__ */jsxRuntimeExports.jsx(ConditionalComponent, {
              ...
              renderElse: () => /* @__PURE__ */jsxRuntimeExports.jsx(ConditionalComponent, {
                ...
                renderElse: () => /* @__PURE__ */jsxRuntimeExports.jsx(ServiceCategoryEditPage, {
                  category
                })
              })
            })
        ...
        const ServiceGroupEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceGroupEditPage-legacy-DlRlqp2T.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        exports("z", useGetFeServiceGroupsQuery);
        const ServiceEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceEditPage-legacy-Bz0PsbwV.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        exports({
          a2: useUpdateServiceGroupMutation,
          a3: useCreateServiceGroupMutation
        });
        ...
        exports("a4", useUpdateServiceMutation);
        ...
        const LocationWorkerCreatePage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkerCreatePage-legacy-C8TLbgfe.js'), false              ? __VITE_PRELOAD__ : void 0));
            ...
            try {
              ...
              if (checked) {
                ...
                if (refetchResult.data?.data) {
                  const servicesMap = /* @__PURE__ */new Map();
                  refetchResult.data.data.forEach(workerService => {
                    servicesMap.set(workerService.serviceId, {
                      serviceId: workerService.serviceId,
                      price: workerService.price,
                      duration: workerService.duration,
        ...
        const getWorkerEditFormFields = (users, workerId, initialValues, onAvatarUploadSuccess, worker, isOwnerFieldEnabled = false, onServerSideUserSearch, onGetUserById) => {
          const userData = worker?.userData || null;
        ...
        const WorkerForm = exports("a8", ({
          ...
          const workerUserData = worker?.userData || null;
          const isOwner = workerUserData ? userHasRoles(workerUserData, [UserGroupCode.Owner]) : null;
          const isMainOwner = currentUser?.id && locationData?.mainOwnerId ? currentUser.id === locationData.mainOwnerId : false;
          ...
          const handleServerSideUserSearch = reactExports.useCallback(async (search, page, perPage) => {
            try {
              const result = await dispatch(userApi.endpoints.userSearch.initiate({
          ...
          const handleGetUserById = reactExports.useCallback(async userId => {
            if (worker?.userData && worker.userData.id.toString() === userId) {
              return {
          ...
          initialValues?.id, initialValues, onAvatarUploadSuccess,
        ...
        const workingHoursApi = rzrApi.injectEndpoints({
          endpoints: builder => ({
            ...
            updateLocationWorkingHours: builder.mutation({
              query: body => ({
                url: `location-admin/working-hours/${body.id}`,
                method: "PUT",
                body: humpsExports.decamelizeKeys(body)
              }),
              transformResponse: transformStandardResponseToCamelCase,
            ...
            deleteLocationWorkingHours: builder.mutation({
              query: ({
                ...
                url: `location-admin/working-hours/${id}`,
                method: "DELETE",
                params: {
            ...
            updateWorkerWorkingHours: builder.mutation({
              query: body => ({
                url: `worker-admin/working-hours/${body.id}`,
                method: "PUT",
                body: humpsExports.decamelizeKeys(body)
              }),
              transformResponse: transformStandardResponseToCamelCase,
            ...
            deleteWorkerWorkingHours: builder.mutation({
              query: ({
                ...
                url: `worker-admin/working-hours/${id}`,
                method: "DELETE",
                params: {
                  worker_id: workerId,
                  id
        ...
        exports({
          B: useGetLocationWorkingHoursQuery,
          G: useGetWorkerWorkingHoursQuery
        });
        const DAYS_OF_WEEK = [{
          code: "mon",
          name: "Ponedeljak",
        ...
        const DayChip = ({
          ...
          const firstDay = DAYS_OF_WEEK.find(d => d.code === orderedCodes[0])?.short;
          if (orderedCodes.length === 1) {
            return /* @__PURE__ */jsxRuntimeExports.jsx("div", {
              className: "flex flex-col items-center justify-center w-20 h-16 text-white bg-gray-700 rounded-lg",
          ...
          const lastDay = DAYS_OF_WEEK.find(d => d.code === orderedCodes[orderedCodes.length - 1])?.short;
          ...
          if (orderedCodes.length === 2) {
            return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              className: "flex items-center justify-center w-20 h-16 text-white bg-gray-700 rounded-lg",
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            className: "flex items-center justify-center w-24 h-16 text-white bg-gray-700 rounded-lg",
            children: [/* @__PURE__ */jsxRuntimeExports.jsxs("span", {
              className: "font-bold",
              children: [firstDay, ", ...,"]
            }), /* @__PURE__ */jsxRuntimeExports.jsx("span", {
        ...
        function WorkingHoursList({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsx(IonList, {
            children: workingHours.map(shift => /* @__PURE__ */jsxRuntimeExports.jsxs(IonItem, {
              className: "mb-2 border-0 rounded-lg",
              lines: "none",
              onClick: () => onEdit(shift),
              button: true,
              children: [/* @__PURE__ */jsxRuntimeExports.jsx(DayChip, {
                codes: shift.daysCodes
              }), /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                className: "flex flex-col py-2",
                slot: "end",
                children: /* @__PURE__ */jsxRuntimeExports.jsxs(IonLabel, {
                  className: "text-lg font-semibold text-white",
                  children: [fromUtcHM(shift.timeFromUtc), " - ", fromUtcHM(shift.timeToUtc)]
                })
              })]
            }, shift.id))
          });
        ...
        const workingHoursFormSchema = create$3().shape({
          ...
          pausesUtc: create$2().of(create$3().shape({
            timeFromUtc: create$6().required(t("Polje je obavezno")),
            timeToUtc: create$6().required(t("Polje je obavezno")),
            daysCodes: create$2().of(create$6().required()).min(1, t("Morate izabrati bar jedan dan")).required()
          }))
        ...
        function WorkingHoursForm({
          ...
          const dynamicSchema = reactExports.useMemo(() => {
            return workingHoursFormSchema.shape({
              workerId: isWorkerSegment ? create$6().required(t("Polje je obavezno")) : create$6()
            });
          }, [isWorkerSegment, t]);
          const {
            data: workersData
          ...
          const form = useForm({
            ...
            defaultValues: {
              workerId: activeWorkerId?.toString() || "",
              workingTime,
              pausesUtc: workingTime?.pausesUtc || [],
              active: workingTime?.active ?? true,
              shift: workingTime?.shift ?? 1
            }
          });
          const fields = reactExports.useMemo(() => getWorkingHoursFormFields(workersData?.data || [], isWorkerSegment), [workersData, form.getValues, isWorkerSegment]);
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(IonModalExtended, {
            ...
            isOpen,
            onClose: handleClose,
            title: isEditMode ? t("Izmeni radno vreme") : t("Dodaj radno vreme"),
            children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonContent, {
              className: "ion-no-padding",
              ...
              children: /* @__PURE__ */jsxRuntimeExports.jsx(ModalActionButtons, {
                onSave: form.handleSubmit(onSubmit),
        ...
        function WorkerWorkingHoursStep({
          ...
          const workerData = workersResponse?.data?.find(w => w.id === worker.id);
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            ...
            }, `${worker.id}-${activeWorkingTime?.id}`), /* @__PURE__ */jsxRuntimeExports.jsx(SimpleFormStepperActions, {
              onBack,
              onExit,
              onAction: isLastPage ? onExit : void 0,
              actionText: isLastPage ? t("Izađi") : void 0,
              isBackDisabled,
              isLastPage,
        ...
        const LocationWorkerEditPage = ({
          ...
          const renderSteps = _stepProps => {
            ...
            stepComponents.push(/* @__PURE__ */jsxRuntimeExports.jsx(WorkerWorkingHoursStep, {
              worker,
              locationSlug,
              onBack: handleBack,
              onExit: handleExit,
        ...
        const GoogleCalendarSettingsPage = reactExports.lazy(() => __vitePreload(() => module.import('./GoogleCalendarSettingsPage-legacy-CfVY3znf.js'), false              ? __VITE_PRELOAD__ : void 0));
        const GoogleCalendarSettingsPageWrapper = () => {
          const {
            t
          } = useTranslation();
          const googleApiKey = "528191814583-ovprc30ec231gtc7t24apkep4kqo7npo.apps.googleusercontent.com";
          const pageContent = /* @__PURE__ */jsxRuntimeExports.jsx(GoogleOAuthProvider$1, {
            clientId: googleApiKey,
            children: /* @__PURE__ */jsxRuntimeExports.jsx(GoogleCalendarSettingsPage, {})
          });
          return /* @__PURE__ */jsxRuntimeExports.jsx(LayoutMainPage, {
            headerClasses: mainHeaderClasses,
            title: t("Google Calendar podešavanja"),
            hasBackButton: true,
            backButtonUrl: `${urlPrefix}/podesavanja`,
        ...
        const TestNotificationsPage = reactExports.lazy(() => __vitePreload(() => module.import('./TestNotificationsPage-legacy-BuvbDOrT.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const UserDevicesPage = reactExports.lazy(() => __vitePreload(() => module.import('./UserDevicesPage-legacy-DpzzG8Aa.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        function Routes() {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(IonRouterOutlet, {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsx(Route, {
              ...
              path: `${urlPrefix}/podesavanja/delatnosti/edit/:categoryId`,
        ...
        const useRzrLocationPing = () => {
          ...
          const handleLocationChanges = reactExports.useCallback(changes => {
            if (changes[PingType.LOCATIONS]?.hasChanges && changes[PingType.LOCATIONS]?.data) {
              dispatch(setLocationHash(changes[PingType.LOCATIONS]?.hash));
              const locationData = changes[PingType.LOCATIONS]?.data;
              if (locationData?.slug) {
                const settings = locationData.settings ?? {};
                dispatch(setLocationSettings({
                  ...
                  locationHash: changes[PingType.LOCATIONS]?.hash
                }));
              }
            }
          }, [dispatch]);
        ...
        function Ping() {
          ...
          const activeLocation = persistedActiveLocation ?? preloadedLocationData?.slug ?? envActiveLocation$1;
          const [getFeLocation, {
            isLoading: isFetchingLocation
          }] = useLazyGetFeLocationQuery();
          reactExports.useEffect(() => {
            if (!persistedLocationSettings && activeLocation) {
              getFeLocation({
                slug: activeLocation
          ...
          }, [dispatch, persistedLocationSettings, activeLocation, getFeLocation]);
          reactExports.useEffect(() => {
            if (persistedLocationSettings?.timezone && persistedLocationSettings.timezone !== getAppTimezone()) ;
          }, [persistedLocationSettings]);
          const handleAllChanges = reactExports.useCallback(changes => {
          ...
          usePing([PingType.RESERVATIONS, PingType.NOTIFICATIONS, PingType.USERS, PingType.LOCATIONS],
          // , PingType.WORKERS, PingType.SERVICES, PingType.WORKING_HOURS
          requestData, handleAllChanges, pingOptions);
          return null;
        }
        const Ping$1 = reactExports.memo(Ping);
        const Menu = reactExports.lazy(() => __vitePreload(() => module.import('./Menu-legacy-BBtjENQp.js'), false              ? __VITE_PRELOAD__ : void 0));
        const PublicApp = () => {
          const {
            userData
          } = useUser();
          ...
          const activeLocation = envActiveLocation;
          const appKey = userData?.id ?? "no-user";
        ...
        const AdministrationLayout = ({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(IonPage, {
            children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonHeader, {
              children: /* @__PURE__ */jsxRuntimeExports.jsxs(IonToolbar, {
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs(IonButtons, {
                  slot: "start",
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonMenuButton, {}), showBackButton && /* @__PURE__ */jsxRuntimeExports.jsx(IonButton, {
        ...
        const AdministrationDashboardPage = () => {
          ...
          if (error) {
            ...
            return /* @__PURE__ */jsxRuntimeExports.jsx(AdministrationLayout, {
              title: "RZR Admin Dashboard",
              children: /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                className: "p-4 text-center text-red-500",
                children: "Error loading statistics. Please check your permissions."
              })
            });
          }
          return /* @__PURE__ */jsxRuntimeExports.jsx(AdministrationLayout, {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs(IonCard, {
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonCardHeader, {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                    ...
                    children: stats?.totalLocations || 0
                  }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    className: "text-sm text-gray-500 mt-2",
                    children: [stats?.activeLocations || 0, " active • ", stats?.inactiveLocations || 0, " inactive"]
                  })]
                })]
              }), /* @__PURE__ */jsxRuntimeExports.jsxs(IonCard, {
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonCardHeader, {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                    ...
                    className: "text-sm text-gray-500 mt-2",
                    children: ["+", stats?.newUsersThisMonth || 0, " this month"]
                  })]
                })]
              }), /* @__PURE__ */jsxRuntimeExports.jsxs(IonCard, {
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonCardHeader, {
                  children: /* @__PURE__ */jsxRuntimeExports.jsx(IonCardTitle, {
                    children: "Reservations Today"
                  })
                }), /* @__PURE__ */jsxRuntimeExports.jsxs(IonCardContent, {
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                    className: "text-4xl font-bold",
                    children: stats?.reservationsToday || 0
                  }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    className: "text-sm text-gray-500 mt-2",
                    children: [stats?.reservationsThisMonth || 0, " this month"]
                  })]
                })]
              }), /* @__PURE__ */jsxRuntimeExports.jsxs(IonCard, {
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonCardHeader, {
                  children: /* @__PURE__ */jsxRuntimeExports.jsx(IonCardTitle, {
                    children: "New Locations"
                  })
                }), /* @__PURE__ */jsxRuntimeExports.jsxs(IonCardContent, {
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                    className: "text-4xl font-bold",
                    children: stats?.newLocationsThisMonth || 0
                  }), /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                    className: "text-sm text-gray-500 mt-2",
                    children: "This month"
                  })]
        ...
        const AdministrationLocationsPage = () => {
          ...
          const confirmStatusChange = async () => {
            ...
            try {
              await updateStatus({
                ...
                active: newStatus,
                reason: `Status changed to ${newStatus ? "active" : "inactive"} by admin`
              }).unwrap();
              refetch();
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(AdministrationLayout, {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              ...
              }), data && /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                className: "mb-4 text-sm text-gray-600",
                children: ["Showing ", data.data.length, " of ", data.total, " locations (Page ", data.currentPage, " of ", data.lastPage, ")"]
              }), isLoading && /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                className: "flex justify-center py-8",
                children: /* @__PURE__ */jsxRuntimeExports.jsx(IonSpinner, {})
              }), !isLoading && data && /* @__PURE__ */jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
                children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                  ...
                  children: /* @__PURE__ */jsxRuntimeExports.jsxs("table", {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx("thead", {
                      ...
                      children: data.data.map(location => /* @__PURE__ */jsxRuntimeExports.jsxs("tr", {
                        ...
                        children: [/* @__PURE__ */jsxRuntimeExports.jsx("td", {
                          ...
                          children: /* @__PURE__ */jsxRuntimeExports.jsx(IonChip, {
                            className: "text-xs",
                            children: getTypeLabel(location.type)
                          })
                        }), /* @__PURE__ */jsxRuntimeExports.jsx("td", {
                          className: "px-4 py-4 text-sm text-gray-500",
                          children: location.city?.name || "N/A"
                        }), /* @__PURE__ */jsxRuntimeExports.jsx("td", {
                          className: "px-4 py-4",
                          children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                ...
                }), data.lastPage > 1 && /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonButton, {
                    ...
                    children: ["Page ", page, " of ", data.lastPage]
                  }), /* @__PURE__ */jsxRuntimeExports.jsx(IonButton, {
              ...
              message: `Are you sure you want to ${newStatus ? "activate" : "deactivate"} ${selectedLocation?.name}?`,
              buttons: [{
                text: "Cancel",
                role: "cancel"
              }, {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsx(AdministrationLayout, {
            ...
            children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                ...
                className: "mb-4 text-sm text-gray-600",
                children: ["Showing ", data.data.length, " of ", data.total, " users (Page ", data.currentPage, " of ", data.lastPage, ")"]
              }), isLoading && /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                className: "flex justify-center py-8",
                children: /* @__PURE__ */jsxRuntimeExports.jsx(IonSpinner, {})
              }), !isLoading && data && /* @__PURE__ */jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
                children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                  ...
                  children: /* @__PURE__ */jsxRuntimeExports.jsxs("table", {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx("thead", {
                      ...
                      className: "divide-y divide-gray-200",
                      children: data.data.map(user => /* @__PURE__ */jsxRuntimeExports.jsxs("tr", {
                        className: "hover:bg-gray-50",
                        children: [/* @__PURE__ */jsxRuntimeExports.jsx("td", {
                          className: "px-4 py-4",
                          children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                            ...
                            children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                              ...
                              children: user.avatar_url ? /* @__PURE__ */jsxRuntimeExports.jsx("img", {
                                src: user.avatar_url,
                                alt: user.name,
                          ...
                          children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                            ...
                            children: [user.groups?.map(group => /* @__PURE__ */jsxRuntimeExports.jsxs(IonBadge, {
                            ...
                            }, group.id)), (!user.groups || user.groups.length === 0) && /* @__PURE__ */jsxRuntimeExports.jsx(IonBadge, {
                              color: "medium",
                              children: "No groups"
                            })]
                          })
        ...
        const AdministrationWorkInProgressPage = ({
          title,
            ...
            children: /* @__PURE__ */jsxRuntimeExports.jsx("div", {
              ...
              children: /* @__PURE__ */jsxRuntimeExports.jsx(IonCard, {
                ...
                children: /* @__PURE__ */jsxRuntimeExports.jsxs(IonCardContent, {
                  ...
                  }), /* @__PURE__ */jsxRuntimeExports.jsx(IonProgressBar, {
                    value: 0.45,
                    className: "rounded",
                    color: "warning"
                  }), /* @__PURE__ */jsxRuntimeExports.jsx("p", {
        ...
        const AdministrationWizardsPageWrapper = () => {
          return /* @__PURE__ */jsxRuntimeExports.jsx(AdministrationWorkInProgressPage, {
        ...
        const AdministrationStatisticsPageWrapper = () => {
          return /* @__PURE__ */jsxRuntimeExports.jsx(AdministrationComingSoonPage, {
        ...
        const AdministrationRoutes = () => {
          return /* @__PURE__ */jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
            children: [/* @__PURE__ */jsxRuntimeExports.jsx(Route, {
              ...
              component: AdministrationDashboardPageWrapper,
              exact: true
            }), /* @__PURE__ */jsxRuntimeExports.jsx(Route, {
              path: "/admin/locations",
              component: AdministrationLocationsPageWrapper,
              exact: true
            }), /* @__PURE__ */jsxRuntimeExports.jsx(Route, {
              path: "/admin/users",
              component: AdministrationUsersPageWrapper,
              exact: true
            }), /* @__PURE__ */jsxRuntimeExports.jsx(Route, {
              path: "/admin/wizards",
              component: AdministrationWizardsPageWrapper,
              exact: true
            }), /* @__PURE__ */jsxRuntimeExports.jsx(Route, {
              path: "/admin/questionnaires",
              component: AdministrationQuestionnairesPageWrapper,
              exact: true
            }), /* @__PURE__ */jsxRuntimeExports.jsx(Route, {
              path: "/admin/statistics",
              component: AdministrationStatisticsPageWrapper,
              exact: true
            }), /* @__PURE__ */jsxRuntimeExports.jsx(Route, {
              path: "/admin/settings",
              component: AdministrationSettingsPageWrapper,
              exact: true
            })]
          });
        };
        const AdministrationSidebar = reactExports.lazy(() => __vitePreload(() => module.import('./AdministrationSidebar-legacy-DIMPdEIu.js'), false              ? __VITE_PRELOAD__ : void 0));
        const AdministrationApp = () => {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsx(IonApp, {
            className: "administration-app select-none",
            children: /* @__PURE__ */jsxRuntimeExports.jsx(IonReactRouter, {
              children: /* @__PURE__ */jsxRuntimeExports.jsxs(IonSplitPane, {
                contentId: "admin-main",
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(reactExports.Suspense, {
                  fallback: null,
                  children: /* @__PURE__ */jsxRuntimeExports.jsx(AdministrationSidebar, {})
                }), /* @__PURE__ */jsxRuntimeExports.jsx(IonRouterOutlet, {
                  id: "admin-main",
                  children: /* @__PURE__ */jsxRuntimeExports.jsx(reactExports.Suspense, {
                    fallback: /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                      children: "Loading Admin..."
                    }),
                    children: /* @__PURE__ */jsxRuntimeExports.jsx(AdministrationRoutes, {})
                  })
                })]
              })
            })
        ...
        const urlPrefix = exports("g", getInitialData("appSlug") ?? "/zakazivanje" ?? "/zakazivanje");
        const envActiveLocation = "berbernica-tanja";
        const envIsPrivate = parseInt("0");
        const preloadedLocationData = exports("p", getInitialData("locationData", true, true));
        const activeLocation = exports("n", preloadedLocationData?.slug ?? envActiveLocation);
        const isPrivate = preloadedLocationData?.isPrivate ?? envIsPrivate;
        const reservationTimeInterval = exports("Z", preloadedLocationData?.timeSlotInterval ?? 30);
