;
(function () {
  System.register(['./vendor_ionic-legacy-Br2UrGvg.js', './vendor_react-legacy-CKjKS6zA.js', './vendor_leaflet-legacy-Dzs4-G2p.js'], function (exports, module) {
    'use strict';
    ...
    return {
      ...
      execute: function () {
        ...
        const getPauseBetweenReservations = exports("G", state => state.locationSettings.settings?.pauseBetweenReservations ?? 0);
        ...
        var TagId = exports("F", /* @__PURE__ */(TagId2 => {
          TagId2["LIST"] = "LIST";
          return TagId2;
        })(TagId || {}));
        ...
        const App = reactExports.lazy(() => __vitePreload(() => module.import('./App-legacy-C_YJGjpY.js').then(n => n.aj), false              ? __VITE_PRELOAD__ : void 0));
        initializeTheme();
