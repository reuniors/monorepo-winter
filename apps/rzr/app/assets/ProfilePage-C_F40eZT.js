import { e as reactExports, a3 as useTranslation, j as jsxRuntimeExports, az as parseISO, aC as format } from "./vendor_react-LOGlbA9o.js";
import { U as UserAvatar } from "./UserAvatar-DJ-AMlBc.js";
import { n as IonSpinner, a$ as IonCard, b1 as IonCardHeader, b2 as IonCardTitle, b0 as IonCardContent, q as IonItem, l as IonIcon, ad as calendarOutline, F as IonLabel, c as IonText, b3 as checkmarkCircleOutline, bu as closeCircleOutline, ae as timeOutline, bC as walletOutline, d as IonButton, ak as refreshOutline, bi as IonAccordionGroup, bj as IonAccordion, G as IonList, ag as mailOutline, bw as callOutline, aX as personOutline, ac as IonToggle, x as IonSelect, y as IonSelectOption, N as useIonAlert, u as useIonToast, bJ as pencilOutline } from "./vendor_ionic-D94VuZ44.js";
import { u as useClipboard, b as useGetClientProfilesQuery, C as ClientStatistics } from "./client-profile.fe-services-B93uvK9a.js";
import { u as useGetFeClientDataQuery, b as useUpdateFeClientDataMutation } from "./client.services-sbiA3V1F.js";
import { m as activeLocation, f as urlPrefix, b as useUser, a as useAppDispatch, c as useAppSelector, d as useRemoveConnectedDeviceMutation, ab as useDeviceNotification, i as isPwa, ac as isInstalled, ad as isWebView, C as ConditionalComponent } from "./App-Byz-BlJA.js";
import { C as ClientDataModal } from "./ClientDataModal-fdN-bbNi.js";
import { a as useGetWorkerStatisticsQuery } from "./statistics.fe-services-BANMerLP.js";
import { P as Pagination } from "./Pagination-CTyTKUPM.js";
import { m as getDeviceData, l as setShowLoginModal, x as getSavedTheme, n as setDeviceData, A as saveTheme, y as applyTheme } from "./index-DB6rcYif.js";
