;
(function () {
  System.register(['./vendor_react-legacy-DX-mYdP5.js', './vendor_ionic-legacy-DitOK8Rz.js', './App-legacy-D9i3zTWV.js', './workingShift.fe-services-legacy-BfOAaRTH.js', './index-legacy-C1Nz3TCW.js', './vendor_leaflet-legacy-DW0hIt0g.js', './vendor_firebase-legacy-CM5O5LjC.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        IonCol = module.E;
        IonIcon = module.b;
        closeCircle = module.bQ;
        checkmarkCircle = module.bp;
        IonButton = module.d;
        notificationsOffOutline = module.bR;
