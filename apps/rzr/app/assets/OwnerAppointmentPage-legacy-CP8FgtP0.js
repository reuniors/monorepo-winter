;
(function () {
  System.register(['./vendor_react-legacy-BaDeiZwt.js', './vendor_ionic-legacy-SgrmjcUd.js', './WeekSwiperWrapper-legacy-clz2sYLc.js', './App-legacy-JMmm2B38.js', './appointment.constants-legacy-DGLfwUGc.js', './reservation.helpers-legacy-BDNPjUsI.js', './useQueryParamsHook-legacy-B1GbSu9G.js', './vendor_leaflet-legacy-Copy5_ZC.js', './index-legacy-C6EIpnD8.js', './workingShift.fe-services-legacy-DM52KikF.js', './reservation.services-legacy-UefSX0Q4.js', './vendor_firebase-legacy-Dby0Ep9M.js'], function (exports, module) {
    'use strict';

    var reactExports, useTranslation, jsxRuntimeExports, format, formatInTimeZone, parseISO, React, startOfMonth, endOfMonth, startOfWeek, addDays, useIonRouter, IonSpinner, IonIcon, cashOutline, chevronDownOutline, chevronUpOutline, useReservationCalendarContext, BookingCalendarHeader, BookingWeekDays, WeekSwiperWrapper, ReservationCalendarProvider, useGetFeWorkersQuery, activeLocation, urlPrefix, getAppTimezone, fromUtcHM, useContentRefFunctions, SceletonLoader, useGetFeServiceCategoriesQuery, AppointmentStatus, getReservationUrlWithSlot, useQueryParamsHook;
    return {
      setters: [module => {
