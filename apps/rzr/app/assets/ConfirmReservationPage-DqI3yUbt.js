import { e as reactExports, aD as useTranslation, j as jsxRuntimeExports, av as parseISO, ay as format, af as SwiperSlide, a0 as t, a4 as yup, aV as isPast, aW as addMinutes } from "./vendor_react-CCLq7r1n.js";
import { b as useGetOneFeReservationQuery, c as useUpdateFeReservationMutation } from "./reservation.services-CDni4Vbd.js";
import { k as activeLocation, l as SceletonLoader, z as fromUtcDateTimeToTime, m as getPathBySize, S as SwiperWrapper, s as useFormWithSchema, D as DynamicForm, b as useUser, f as urlPrefix, C as ConditionalComponent, A as IonAlertConfirmation, L as LayoutMainPage } from "./App-BtUhbQB_.js";
import { q as IonItem, A as IonGrid, B as IonRow, C as IonCol, l as IonIcon, bk as calendarClearOutline, ad as calendarOutline, ae as timeOutline, bp as pricetagOutline, j as IonTitle, b3 as IonBadge, bq as alertCircleOutline, br as hourglassOutline, bs as helpOutline, d as IonButton, o as IonFooter, i as IonToolbar, aX as personOutline, a9 as useIonToast, al as useIonRouter } from "./vendor_ionic-CVwFN5FQ.js";
import { A as APPOINTMENT_STATUS_LABELS, a as AppointmentStatus } from "./appointment.constants-BtYyqQzh.js";
import { L as LazyLoadImgStandard, p as preloadCoverImg } from "./logo-square-BGDltrfO.js";
import { a as useGetFeLocationClientsQuery, u as useGetFeClientDataQuery } from "./client.services-BiY-JYai.js";
import { g as getClientFormFields, a as getAdministrationClientFormFields, C as ClientDataModal } from "./ClientDataModal-B7mKpMQL.js";
import { u as useQueryParamsHook } from "./useQueryParamsHook-DzFp0oq5.js";
