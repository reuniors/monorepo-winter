;
(function () {
  System.register(['./vendor_ionic-legacy-DYIGQWbn.js', './vendor_react-legacy-B0yst0tN.js', './vendor_leaflet-legacy-DKuaEqMF.js'], function (exports, module) {
    'use strict';
    ...
    return {
      ...
      execute: function () {
        ...
        const App = reactExports.lazy(() => __vitePreload(() => module.import('./App-legacy-CrNw61cU.js').then(n => n.aa), false              ? __VITE_PRELOAD__ : void 0));
        initializeTheme();
