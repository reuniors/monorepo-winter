;
(function () {
  System.register(['./vendor_react-legacy-CX0h95NE.js', './vendor_ionic-legacy-CLGezsbs.js', './App-legacy-7OwS84rF.js', './index-legacy-BIk86z2F.js', './vendor_leaflet-legacy-CiFv5lWM.js', './vendor_firebase-legacy-BCi9HsFn.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        IonMenuToggle = module.bg;
        IonItem = module.r;
        logInOutline = module.aF;
        powerOutline = module.bh;
        IonFooter = module.p;
        IonLabel = module.G;
