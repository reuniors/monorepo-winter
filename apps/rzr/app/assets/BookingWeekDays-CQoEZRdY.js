import { aT as addDays, b2 as isToday$1, aU as startOfDay, av as parseISO, aY as addMinutes, ax as toZonedTime, az as fromZonedTime, aw as formatInTimeZone, e as reactExports, aQ as startOfMonth, aS as startOfWeek, b3 as endOfWeek, ay as format, b4 as isSameDay, aV as subMonths, aW as addMonths, aR as endOfMonth, j as jsxRuntimeExports, b5 as parse, b6 as isWithinInterval, b7 as differenceInMinutes, b8 as isSameMonth, af as SwiperSlide, aD as useTranslation } from "./vendor_react-AVDGa64O.js";
import { i as IonToolbar, d as IonButton, l as IonIcon, ad as calendarOutline, n as IonSpinner, bk as chevronUpOutline, bj as chevronDownOutline, k as IonButtons, ar as chevronBackOutline, $ as chevronForwardOutline } from "./vendor_ionic-DxHtCw90.js";
import { r as rzrApi, o as TagType } from "./index-B9Vob7XV.js";
import { B as transformStandardResponseToCamelCase, q as getAppTimezone, j as useGetFeWorkersQuery, X as reservationTimeInterval, Y as getUtcDateFormattedInTz, Z as parseUtcDate, S as SwiperWrapper } from "./App-McS3GyVa.js";
import { u as useGetFeWorkerWorkingShiftsByDaysQuery } from "./workingShift.fe-services-e8hWnX3E.js";
import { d as useGetFeLocationReservationsQuery } from "./reservation.services-CbOBHitB.js";
...
function WeekView({
  ...
  reactExports.useEffect(() => {
    var _a;
    if (((_a = swiperRef.current) == null ? void 0 : _a.swiper) && currentWeekIndex >= 0) {
...
function MonthView({
  ...
  reactExports.useEffect(() => {
    var _a;
    if (((_a = monthSwiperRef.current) == null ? void 0 : _a.swiper) && currentMonthIndex >= 0) {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SwiperWrapper,
      {
        ...
        children: monthsForSwiper.map((month) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsx(SwiperSlide, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-2 pb-3", children: monthWeeks.map((week, weekIndex) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-7 gap-1", children: week.map(
            (date, dayIndex) => date ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              DayButton,
              {
                date,
                selectedDate,
              ...
              "empty-".concat(weekIndex, "-").concat(dayIndex)
            )
...
export {
  BookingCalendarHeader as B,
  ReservationCalendarProvider as R,
  BookingWeekDays as a,
  BookingCalendarProvider as b,
  useReservationCalendarContext as c,
  generateWeek as g,
