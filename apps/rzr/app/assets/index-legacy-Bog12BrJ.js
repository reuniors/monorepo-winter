;
(function () {
  System.register(['./vendor_ionic-legacy-DdPNGOLm.js', './vendor_react-legacy-yeQ-Nqpl.js', './vendor_leaflet-legacy-Cr0PaNC7.js'], function (exports, module) {
    'use strict';
    ...
    return {
      ...
      execute: function () {
        ...
        const App = reactExports.lazy(() => __vitePreload(() => module.import('./App-legacy-DRWtf8eI.js').then(n => n.ad), false              ? __VITE_PRELOAD__ : void 0));
        initializeTheme();
