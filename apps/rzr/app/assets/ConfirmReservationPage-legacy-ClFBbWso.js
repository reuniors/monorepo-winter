;
(function () {
  System.register(['./vendor_react-legacy-DX-mYdP5.js', './reservation.services-legacy-CxArC9AZ.js', './App-legacy-D9i3zTWV.js', './vendor_ionic-legacy-DitOK8Rz.js', './appointment.constants-legacy-DGLfwUGc.js', './logo-square-legacy-BYAGju9l.js', './client.services-legacy-BBMybAj7.js', './ClientDataModal-legacy-Ca8C1Ecb.js', './vendor_leaflet-legacy-DW0hIt0g.js', './index-legacy-C1Nz3TCW.js', './vendor_firebase-legacy-CM5O5LjC.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        pricetagOutline = module.by;
        IonTitle = module.h;
        IonBadge = module.ba;
        alertCircleOutline = module.c;
        hourglassOutline = module.bz;
        helpOutline = module.bA;
        IonButton = module.d;
        IonFooter = module.p;
        IonToolbar = module.f;
        personOutline = module.b1;
        closeCircleOutline = module.bB;
        personRemoveOutline = module.bC;
