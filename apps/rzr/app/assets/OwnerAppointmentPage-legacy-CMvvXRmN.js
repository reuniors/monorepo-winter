;
(function () {
  System.register(['./vendor_react-legacy-j-OXaHGn.js', './vendor_ionic-legacy-B27OJI2l.js', './App-legacy-C1PSXo8s.js', './workingShift.fe-services-legacy-HZ8rgG4j.js', './reservation.services-legacy-aHhYDCMQ.js', './BookingWeekDays-legacy-BAuGiZe6.js', './appointment.constants-legacy-DGLfwUGc.js', './reservation.helpers-legacy-BDNPjUsI.js', './service-category.services-legacy-CPqOv5a4.js', './useQueryParamsHook-legacy-C0RsEtHL.js', './vendor_leaflet-legacy-aVamlEE1.js', './index-legacy-DzaXWAZQ.js', './vendor_firebase-legacy-BLL9XPHC.js'], function (exports, module) {
    'use strict';

    var parseISO, parse, addMinutes, isWithinInterval, differenceInMinutes, format, formatInTimeZone, reactExports, jsxRuntimeExports, SwiperSlide, addDays, useTranslation, React, startOfDay, toZonedTime, startOfMonth, useIonRouter, IonSpinner, IonIcon, cashOutline, chevronDownOutline, chevronUpOutline, useContentRefFunctions, SwiperWrapper, useGetFeWorkersQuery, activeLocation, urlPrefix, getAppTimezone, fromUtcHM, getUtcDateFormattedInTz, parseUtcDate, SceletonLoader, useGetFeWorkerWorkingShiftsByDaysQuery, useGetFeLocationReservationsQuery, generateWeek, isToday, BookingCalendarHeader, BookingWeekDays, AppointmentStatus, getReservationUrlWithSlot, useGetFeServiceCategoriesQuery, useQueryParamsHook;
    return {
      setters: [module => {
        parseISO = module.av;
        parse = module.bb;
