;
(function () {
  System.register(['./vendor_react-legacy-CSf8zLqi.js', './vendor_ionic-legacy-DvZl6sBE.js', './App-legacy-DtnUlzjS.js', './index-legacy-CFC1yKwU.js', './location-settings.data-legacy-CtJqrHWK.js', './usePendingImageUploads-legacy-Dc1oOwd6.js', './vendor_leaflet-legacy-DUCVU90d.js', './vendor_firebase-legacy-tNokQwyN.js'], function (exports, module) {
    'use strict';

    var O, w, useMap, reactExports, React, jsxRuntimeExports, MapContainer, TileLayer, t, Controller, create$3, create$5, create$7, create$6, useTranslation, create$2, IonModal, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonIcon, closeOutline, IonContent, IonItem, IonFooter, IonText, IonLabel, IonInput, informationCircleOutline, imagesOutline, locationOutline, settingsOutline, useIonRouter, IonSpinner, FieldType, useUser, useGetFeWorkersQuery, useShowNotification, useFormWithSchema, DynamicForm, SimpleFormStepperActions, photosArrayWithIdYup, StepIndicator, SimpleFormStepper, useGetFeLocationQuery, activeLocation, rzrApi, transformStandardResponseToCamelCase, TagType, getLocationEditSettingsFormFields, usePendingImageUploads, L;
    return {
      setters: [module => {
        O = module.aX;
        w = module.aY;
