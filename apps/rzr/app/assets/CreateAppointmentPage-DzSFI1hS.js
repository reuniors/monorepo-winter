import { e as reactExports, j as jsxRuntimeExports, af as SwiperSlide, aD as useTranslation, R as React, ay as format, aQ as startOfMonth, aR as endOfMonth, aS as startOfWeek, aT as addDays, aU as startOfDay, ax as toZonedTime, aV as subMonths, aW as addMonths, a4 as yup, aw as formatInTimeZone, av as parseISO, aJ as useLocation, aE as useHistory } from "./vendor_react-BF1Ucyx8.js";
import { g as useDefaultProps, h as useConfirmationAlert, S as SwiperWrapper, j as useGetFeWorkersQuery, k as activeLocation, l as SceletonLoader, m as getPathBySize, n as fromUtcHM, o as useContentRefFunctions, p as getAppTimezone, F as FieldType, b as useUser, q as useIsBigScreen, r as useFormWithSchema, f as urlPrefix, s as pushDuplicateAndNavigate, I as IonModalExtended, D as DynamicForm, t as toUtc, N as NotificationToast, v as useGetFeLocationQuery, w as useGetFeServiceCategoriesQuery, x as useGetFeServiceGroupsQuery, a as useAppDispatch, c as useAppSelector } from "./App-DRZn74Za.js";
import { F as IonList, q as IonItem, bb as IonAvatar, l as IonIcon, aH as peopleOutline, E as IonLabel, $ as chevronForwardOutline, d as IonButton, bc as checkmarkCircle, a6 as addOutline, O as trashOutline, bd as removeOutline, aX as IonCard, aY as IonCardContent, ac as IonToggle, be as IonAccordionGroup, bf as IonAccordion, ad as calendarOutline, c as IonText, n as IonSpinner, aj as useIonRouter, a9 as useIonToast, ag as IonLoading, h as IonHeader, i as IonToolbar, ae as timeOutline, b as IonContent, bg as cashOutline, b0 as IonBadge, o as IonFooter, m as closeOutline, bh as calendarClearOutline, bi as chevronDownOutline, bj as chevronUpOutline, bk as arrowBack, bl as arrowForward } from "./vendor_ionic-BiOFnPTY.js";
import { L as LazyLoadImgStandard, p as preloadCoverImg } from "./logo-square-DrbM83la.js";
import { u as useBookingCalendarContext, g as generateWeek, B as BookingCalendarHeader, a as BookingWeekDays, b as BookingCalendarProvider } from "./BookingWeekDays-BUbRv-3Z.js";
import { u as useCreateFeReservationMutation, a as useGetFePromoCodeDataQuery } from "./reservation.services-CEs9T-TA.js";
import { u as useGetFeClientDataQuery } from "./client.services-DWJYF9kM.js";
import { U as UserAvatar } from "./UserAvatar-DUegii-o.js";
import { u as useQueryParamsHook } from "./useQueryParamsHook-DsMdb8hx.js";
import { k as getDeviceData, l as setDeviceData } from "./index-DITQ5hEX.js";
import "./vendor_leaflet-BGtorNQ9.js";
import "./vendor_firebase-Z856UVCm.js";
import "./workingShift.fe-services-DZGhF3QW.js";
