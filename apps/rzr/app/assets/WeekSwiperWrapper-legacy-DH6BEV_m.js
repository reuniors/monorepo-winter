;
(function () {
  System.register(['./vendor_react-legacy-CKjKS6zA.js', './vendor_ionic-legacy-Br2UrGvg.js', './index-legacy-Cdf7FWKJ.js', './App-legacy-OqtQecgU.js', './workingShift.fe-services-legacy-D7STZbfC.js', './reservation.services-legacy-DPQXBFOM.js'], function (exports, module) {
    'use strict';

    var addDays, isToday$1, format, startOfMonth, endOfMonth, eachDayOfInterval, startOfDay, parseISO, addMinutes, toZonedTime, fromZonedTime, formatInTimeZone, reactExports, startOfWeek, endOfWeek, isSameDay, subMonths, addMonths, jsxRuntimeExports, parse, isWithinInterval, differenceInMinutes, isSameMonth, SwiperSlide, useTranslation, IonToolbar, IonButton, IonIcon, calendarOutline, IonSpinner, chevronUpOutline, chevronDownOutline, IonButtons, chevronBackOutline, chevronForwardOutline, rzrApi, TagType, transformStandardResponseToCamelCase, getAppTimezone, useUser, useGetFeWorkersQuery, reservationTimeInterval, getUtcDateFormattedInTz, parseUtcDate, SwiperWrapper, useContentRefFunctions, useGetFeWorkerWorkingShiftsByDaysQuery, useGetFeLocationReservationsQuery;
    return {
      setters: [module => {
        addDays = module.aS;
        isToday$1 = module.b0;
