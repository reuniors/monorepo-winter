;
(function () {
  System.register(['./vendor_ionic-legacy-kFTPXAWE.js', './vendor_react-legacy-CFXrDSu1.js', './index-legacy-D7f7Ap3o.js', './vendor_firebase-legacy-BISQ33kA.js'], function (exports, module) {
    'use strict';
    ...
    return {
      ...
      execute: function () {
        ...
        exports({
          ...
          b: useUser,
          g: useDefaultProps,
          j: useContentRefFunctions,
          k: useQueryParamsHook,
          w: useFormWithSchema
        });
        ...
        const transformPaginationResponseToCamelCase = exports("a0", response => humpsExports.camelizeKeys(response.data));
        ...
        var UserGroupCode = exports("a9", /* @__PURE__ */(UserGroupCode2 => {
        ...
        const convertEmptyStringToNull = exports("X", value => value === "" || lodashExports.isNumber(value) && isNaN(value) ? null : value);
        const generateSlugForValidation = exports("Y", text => {
        ...
        const getPathBySize = exports("r", img => {
          if (!img) {
            return "";
          }
          switch (true) {
        ...
        const getAppTimezone = exports("t", () => {
          return appTimezone;
        });
        ...
        const fromUtcHM = exports("s", (utcTimeString, tz) => {
          const timezone = getAppTimezone();
        ...
        const useIsBigScreen = exports("v", (breakpoint = 1024) => {
        ...
        const ListIonIcons = reactExports.lazy(() => __vitePreload(() => module.import('./ListIonIcons-legacy-DGmfJ_P2.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ShowLoading$1 = exports("a4", reactExports.memo(ShowLoading));
        ...
        const SceletonLoader = exports("q", reactExports.memo(SkeletonLoader));
        ...
        const SimpleFormStepper$1 = exports("P", reactExports.memo(reactExports.forwardRef(SimpleFormStepper)));
        function StepItem({
          step,
          index,
          isActive,
        ...
        exports("l", useGetFeLocationQuery);
        const HomePage = reactExports.lazy(() => __vitePreload(() => module.import('./HomePage-legacy-DJSAswHp.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const AppointmentPage = reactExports.lazy(() => __vitePreload(() => module.import('./AppointmentPage-legacy-DA9JyqxV.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ProfilePage = reactExports.lazy(() => __vitePreload(() => module.import('./ProfilePage-legacy-D694y-QC.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NotificationPage = reactExports.lazy(() => __vitePreload(() => module.import('./NotificationPage-legacy-CeXLGkzy.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        exports({
          o: useGetFeWorkersQuery,
          a6: useCreateWorkerMutation,
        ...
        const PrepareWorkingDaysShiftsPage = reactExports.lazy(() => __vitePreload(() => module.import('./PrepareWorkingDaysShiftsPage-legacy-Bw9x5c_0.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const getSettingsOptions = exports("a8", urlPrefix => [{
        ...
        const OwnerHomePage = reactExports.lazy(() => __vitePreload(() => module.import('./OwnerHomePage-legacy-TkPYUalq.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const OwnerAppointmentPage = reactExports.lazy(() => __vitePreload(() => module.import('./OwnerAppointmentPage-legacy-ClbVW82X.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const SettingsPage = reactExports.lazy(() => __vitePreload(() => module.import('./SettingsPage-legacy-BB0Jr8_e.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const pushDuplicateAndNavigate = exports("x", (router, destination, referrer) => {
        ...
        const CreateAppointmentPage = reactExports.lazy(() => __vitePreload(() => module.import('./CreateAppointmentPage-legacy-BhsPRgQE.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ConfirmReservationPage = reactExports.lazy(() => __vitePreload(() => module.import('./ConfirmReservationPage-legacy-BQKDH8yG.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const PublicProfilePage = reactExports.lazy(() => __vitePreload(() => module.import('./PublicProfilePage-legacy-4uriJErq.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NewsListPage = reactExports.lazy(() => __vitePreload(() => module.import('./NewsListPage-legacy-B761NXAj.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NewsCreatePage = reactExports.lazy(() => __vitePreload(() => module.import('./NewsCreatePage-legacy-BSLon_TX.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NewsEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./NewsEditPage-legacy-2QAQmCaO.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationWorkingTimePage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkingTimePage-legacy-BmdH4PBU.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationEditPage-legacy-i6FSVaYq.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationWorkersPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkersPage-legacy-CzuyhWVb.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationSettingsPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationSettingsPage-legacy-CQhT5sdv.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServicesPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServicesPage-legacy-Ddl_LZxw.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceCategoriesPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceCategoriesPage-legacy-CIXadFxW.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        exports({
          n: useGetFeServiceCategoriesQuery,
          R: useCreateServiceCategoryMutation,
          U: useUpdateServiceCategoryMutation,
          V: useDeleteServiceCategoryMutation
        });
        const ServiceCategoryEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceCategoryEditPage-legacy-CDkU9t8A.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceGroupEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceGroupEditPage-legacy-DCeC2IvE.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceEditPage-legacy-BU_fNO2O.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        exports({
          a1: useUpdateServiceGroupMutation,
          a2: useCreateServiceGroupMutation
        });
        ...
        exports("a3", useUpdateServiceMutation);
        ...
        const LocationWorkerCreatePage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkerCreatePage-legacy-Cte-ASJB.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const GoogleCalendarSettingsPage = reactExports.lazy(() => __vitePreload(() => module.import('./GoogleCalendarSettingsPage-legacy-DeLjhVrd.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const TestNotificationsPage = reactExports.lazy(() => __vitePreload(() => module.import('./TestNotificationsPage-legacy-BIozlsTC.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const UserDevicesPage = reactExports.lazy(() => __vitePreload(() => module.import('./UserDevicesPage-legacy-8yu39mJu.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const PrivateLocationLandingPage = reactExports.lazy(() => __vitePreload(() => module.import('./PrivateLocationLandingPage-legacy-DC2Jl7U_.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const Menu = reactExports.lazy(() => __vitePreload(() => module.import('./Menu-legacy-Dk0xgRG0.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const activeLocation = exports("m", preloadedLocationData?.slug ?? envActiveLocation);
