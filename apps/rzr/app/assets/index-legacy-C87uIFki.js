;
(function () {
  System.register(['./vendor_ionic-legacy-CuGnV08n.js', './vendor_react-legacy-C8AS9NmP.js', './vendor_leaflet-legacy-B9TijiPT.js'], function (exports, module) {
    'use strict';
    ...
    return {
      ...
      execute: function () {
        ...
        const App = reactExports.lazy(() => __vitePreload(() => module.import('./App-legacy-7GAegB_G.js').then(n => n.H), false              ? __VITE_PRELOAD__ : void 0));
