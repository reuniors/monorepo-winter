  ...
  System.register(['./vendor_ionic-legacy-BouRDOo5.js', './vendor_react-legacy-Dr5RK8rs.js', './index-legacy-BHIGnBEX.js', './vendor_firebase-legacy-DZHWzyZG.js'], function (exports, module) {
    ...
    return {
      setters: [module => {
        ...
        IonAvatar = module.aR;
        IonCard = module.aS;
        checkmarkCircle = module.aT;
        IonCardHeader = module.aU;
        IonCardTitle = module.aV;
        IonCardContent = module.aW;
        removeOutline = module.aX;
        IonAccordionGroup = module.aY;
        IonAccordion = module.aZ;
        IonBadge = module.a_;
        cashOutline = module.a$;
        calendarClearOutline = module.b0;
        arrowBack = module.b1;
        arrowForward = module.b2;
        useIonViewDidLeave = module.b3;
        ...
        isWithinInterval = module.aO;
        differenceInMinutes = module.aP;
        isSameWeek = module.aQ;
        useLocation = module.aR;
        useParams = module.aS;
        create$5 = module.aT;
        create$7 = module.aU;
        create$2 = module.aV;
      ...
      execute: function () {
        ...
        const transformPaginationResponseToCamelCase = exports("Y", response => humpsExports.camelizeKeys(response.data));
        ...
        const convertEmptyStringToNull = exports("P", value => value === "" || lodashExports.isNumber(value) && isNaN(value) ? null : value);
        const generateSlugForValidation = exports("Q", text => {
        ...
        const getAppTimezone = exports("a2", () => {
          return appTimezone;
        });
        ...
        const toUtc = exports("a1", (timeString, tz) => {
        ...
        const fromUtc = exports("a0", (utcTimeString, tz) => {
          const timezone = getAppTimezone();
        ...
        const parseUtcDate = exports("a6", (utcDateString, tz) => {
        ...
        const getUtcDateFormattedInTz = exports("a3", (utcDateString, tz) => {
          const timezone = getAppTimezone();
        ...
        const ionIconList = [];
        const ionIcons = {};
        const fetchIonIconsList = exports("a8", () => {
        ...
        const ListIonIcons = reactExports.lazy(() => __vitePreload(() => module.import('./ListIonIcons-legacy-CA9ccDfC.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        function useDeviceNotification({
          ...
          const handleConnectDevice = reactExports.useCallback(async enabled => {
            ...
            try {
              ...
              const registration = await Promise.race([navigator.serviceWorker.ready, new Promise(resolve => setTimeout(() => {
        ...
        function CommonNotificationWrapper({
          ...
          }, [deviceData.notificationsEnabled, deviceNotification, isOwnerOrWorker, userData]);
          return null;
        }
        ...
        const ShowLoading$1 = exports("N", reactExports.memo(ShowLoading));
        ...
        const HomePage = reactExports.lazy(() => __vitePreload(() => module.import('./HomePage-legacy-CzEvRZ71.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const AppointmentPage = reactExports.lazy(() => __vitePreload(() => module.import('./AppointmentPage-legacy-rNK_uMpK.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ProfilePage = reactExports.lazy(() => __vitePreload(() => module.import('./ProfilePage-legacy-BYAiI0hH.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NotificationPage = reactExports.lazy(() => __vitePreload(() => module.import('./NotificationPage-legacy-W28MWJRE.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const PrepareWorkingDaysShiftsPage = reactExports.lazy(() => __vitePreload(() => module.import('./PrepareWorkingDaysShiftsPage-legacy-BDtxhrR1.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const getSettingsOptions = exports("X", urlPrefix => [{
        ...
        const OwnerHomePage = reactExports.lazy(() => __vitePreload(() => module.import('./OwnerHomePage-legacy-BkDy9FCj.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const OwnerAppointmentPage = reactExports.lazy(() => __vitePreload(() => module.import('./OwnerAppointmentPage-legacy-GDuLhOMd.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const SettingsPage = reactExports.lazy(() => __vitePreload(() => module.import('./SettingsPage-legacy-BV222EuL.js'), false              ? __VITE_PRELOAD__ : void 0));
          ...
          const renderService = service => {
            ...
            return /* @__PURE__ */jsxRuntimeExports.jsx(IonCol, {
              ...
              children: /* @__PURE__ */jsxRuntimeExports.jsxs(IonCard, {
                ...
                }), /* @__PURE__ */jsxRuntimeExports.jsx(IonCardHeader, {
        ...
        exports("J", useGetFeServiceGroupsQuery);
        ...
        exports("H", useGetFeServiceCategoriesQuery);
        function SelectCategoryStep({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(IonCard, {
            children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonCardHeader, {
              ...
              children: /* @__PURE__ */jsxRuntimeExports.jsx(IonList, {
                children: categories.map(category => /* @__PURE__ */jsxRuntimeExports.jsx(IonItem, {
                  button: true,
                  detail: false,
                  onClick: () => onCategorySelect(category),
                  className: selectedCategory?.id === category.id ? "ion-activated" : "",
                  children: /* @__PURE__ */jsxRuntimeExports.jsxs(IonLabel, {
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx("h2", {
        ...
        const getTimeSlotsForTable = exports("a7", (locationReservations, date, timeFromUtc, timeToUtc, pauses, intervalMinutes = 30) => {
          const dateIso = parseISO(date);
        ...
        function useBookingCalendar({
          ...
          const startDate = reactExports.useMemo(() => format(currentWeek[0], "yyyy-MM-dd"), [currentWeek]);
          const endDate = reactExports.useMemo(() => format(currentWeek[6], "yyyy-MM-dd"), [currentWeek]);
          ...
          reactExports.useEffect(() => {
            if (weekSlotsData?.data) {
              ...
              const servicesDuration = selectedServices.reduce((total, group) => {
                return total + (group.services?.reduce((sum, service) => {
              ...
              Object.entries(shiftsByWorkerAndDate).forEach(([workerIdStr, shiftsByDate]) => {
                const workerId = parseInt(workerIdStr, 10);
                const worker2 = workersData?.[workerId];
                if (!worker2) return;
                Object.entries(shiftsByDate).forEach(([dateKey, dayShifts]) => {
                  const dayReservations = (reservationsByWorkerAndDate[workerId]?.[dateKey] || []).map(res => ({
                    dateUtc: res.dateUtc,
                    servicesDuration: res.servicesDuration
                  }));
                  dayShifts.forEach(shift => {
                    const pauses = (shift.pausesUtc || []).map(pause => ({
                      timeFromUtc: pause.timeFromUtc,
                      timeToUtc: pause.timeToUtc
                    }));
                    const slots = generateTimeSlots(dateKey, shift.timeFromUtc, shift.timeToUtc, reservationTimeInterval, roundedSlotInterval, dayReservations, servicesDuration, 30,
                    // delay
                    pauses);
                    ...
                    const existingWorkerSlot = slotsByDate[dateKey].find(ws => ws.worker.id === worker2.id);
                    if (existingWorkerSlot) {
                      existingWorkerSlot.slots = [...existingWorkerSlot.slots, ...timeSlots];
              ...
              currentWeek.forEach(date => {
                ...
                if (!slotsByDate[dateKey]) {
                  ...
                  allWorkers.forEach(w => {
                    const hasWorker = slotsByDate[dateKey].some(ws => ws.worker.id === w.id);
                    if (!hasWorker) {
                      slotsByDate[dateKey].push({
                        worker: w,
                        slots: [],
            ...
            children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs(IonButton, {
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonIcon, {
                  ...
                  slot: "start",
                  className: "mr-2"
                }), monthYearText, /* @__PURE__ */jsxRuntimeExports.jsx(IonIcon, {
        ...
        function BookingWeekDays({
          ...
          ${isSelected ? "bg-gray-900 text-white shadow-lg" : hasSlots ? "text-gray-200 hover:bg-gray-800" : "text-gray-500 cursor-not-allowed"}
          ${isTodayDate && !isSelected ? "ring-2 ring-gray-600" : ""}
        `,
              disabled: !hasSlots,
              children: [/* @__PURE__ */jsxRuntimeExports.jsx("span", {
              ...
              }), hasSlots && /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                className: `w-1.5 h-1.5 rounded-full mt-1 ${isSelected ? "bg-white" : "bg-emerald-400"}`
              })]
            }, dateStr);
          };
          return /* @__PURE__ */jsxRuntimeExports.jsx("div", {
        ...
        function EmptyWeekState({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
              ...
              children: t("Nema slobodnih mesta za izabranu nedelju")
            }), /* @__PURE__ */jsxRuntimeExports.jsx("p", {
        ...
        function BookingSlotsSwiper({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsx("div", {
            ...
            children: /* @__PURE__ */jsxRuntimeExports.jsx(SwiperWrapper$1, {
              ...
              children: daysWithSlots.map(([dateStr, workerSlots]) => /* @__PURE__ */jsxRuntimeExports.jsx(SwiperSlide, {
        ...
        exports({
          ...
          a5: useGetFeLocationReservationsQuery,
          Z: useGetFeLocationClientReservationsQuery
        });
        ...
        exports({
          ...
          _: useUpdateFeClientDataMutation,
        ...
        function CreateAppointmentSteps({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            children: [/* @__PURE__ */jsxRuntimeExports.jsx(FormStepper$1, {
              ...
              renderSteps: () => {
                const workerAndCategoryStep = /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  className: "flex flex-col gap-4",
                  children: [locationHasCategories && /* @__PURE__ */jsxRuntimeExports.jsx(SelectCategoryStep, {
                    categories,
                    selectedCategory,
                    onCategorySelect: setSelectedCategory
                  }), /* @__PURE__ */jsxRuntimeExports.jsx(SelectWorkerStep, {
                    selectedWorker,
                ...
                const serviceStep = serviceGroups && !serviceGroupsLoading ? /* @__PURE__ */jsxRuntimeExports.jsx(SelectAppointmentStep, {
        ...
        const ConfirmReservationPage = reactExports.lazy(() => __vitePreload(() => module.import('./ConfirmReservationPage-legacy-BbdRzqFK.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const PublicProfilePage = reactExports.lazy(() => __vitePreload(() => module.import('./PublicProfilePage-legacy-CxDk5jnf.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NewsListPage = reactExports.lazy(() => __vitePreload(() => module.import('./NewsListPage-legacy-9xdqra7-.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NewsCreatePage = reactExports.lazy(() => __vitePreload(() => module.import('./NewsCreatePage-legacy-QCY-W6nL.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NewsEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./NewsEditPage-legacy-CWxm-uF0.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationWorkingTimePage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkingTimePage-legacy-BLyxTbiL.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationEditPage-legacy-BaWhr593.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationWorkersPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkersPage-legacy-BXYZitaB.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationSettingsPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationSettingsPage-legacy-D_wqx_RN.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServicesPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServicesPage-legacy-DQsE3OA8.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceGroupEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceGroupEditPage-legacy-C-aU9RcW.js'), false              ? __VITE_PRELOAD__ : void 0));
        function ServiceGroupEditPageWrapper() {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsx(LayoutMainPage, {
            ...
            hasBackButton: true,
            backButtonUrl: `${urlPrefix}/podesavanja/usluge`,
            children: /* @__PURE__ */jsxRuntimeExports.jsx(ServiceGroupEditPage, {
              serviceGroupId: parseInt(serviceGroupId)
            })
          });
        }
        const ServiceEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceEditPage-legacy-BSq-PFvr.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        exports({
          R: useUpdateServiceGroupMutation,
          T: useCreateServiceGroupMutation
        });
        ...
        exports("K", useUpdateServiceMutation);
        ...
        const LocationWorkerCreatePage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkerCreatePage-legacy-N2oTWWzB.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const Menu = reactExports.lazy(() => __vitePreload(() => module.import('./Menu-legacy-CsKDTyOR.js'), false              ? __VITE_PRELOAD__ : void 0));
        setupIonicReact({
