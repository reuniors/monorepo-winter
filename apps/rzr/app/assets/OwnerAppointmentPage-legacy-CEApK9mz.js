;
(function () {
  System.register(['./vendor_react-legacy-3NN3kxAt.js', './WeekSwiperWrapper-legacy-URLjDa2h.js', './vendor_ionic-legacy-O-KkNIDb.js', './App-legacy-DGOCT5cL.js', './appointment.constants-legacy-DGLfwUGc.js', './reservation.helpers-legacy-BDNPjUsI.js', './vendor_leaflet-legacy-D7880HPH.js', './index-legacy-BCs5NMF5.js', './workingShift.fe-services-legacy-DRtBqMLp.js', './reservation.services-legacy-BgBJmtp5.js', './vendor_firebase-legacy-PP5vvGhm.js'], function (exports, module) {
    'use strict';

    var jsxRuntimeExports, reactExports, useTranslation, format, formatInTimeZone, parseISO, React, startOfMonth, endOfMonth, startOfWeek, addDays, useReservationCalendarContext, BookingCalendarHeader, BookingWeekDays, WeekSwiperWrapper, ReservationCalendarProvider, IonIcon, chevronDownOutline, chevronUpOutline, useIonRouter, IonSpinner, cashOutline, useGetFeWorkersQuery, activeLocation, urlPrefix, getAppTimezone, fromUtcHM, SceletonLoader, useQueryParamsHook, useGetFeServiceCategoriesQuery, AppointmentStatus, getReservationUrlWithSlot;
    return {
      setters: [module => {
      ...
      execute: function () {
        ...
        function TableOfReservationsV2() {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
            children: [/* @__PURE__ */jsxRuntimeExports.jsx(BookingCalendarHeader, {}), /* @__PURE__ */jsxRuntimeExports.jsx(BookingWeekDays, {}), /* @__PURE__ */jsxRuntimeExports.jsx(CalendarModeToggle, {
              isCalendarOpen,
