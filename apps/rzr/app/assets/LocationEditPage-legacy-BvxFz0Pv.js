;
(function () {
  System.register(['./vendor_react-legacy-8eT2sGuL.js', './vendor_ionic-legacy-Das9dW4a.js', './App-legacy-CaR2AK6H.js', './index-legacy-9UCQqk05.js', './SimpleFormStepperActions-legacy-DzeQwdli.js', './location-settings.data-legacy-DPsD4U0G.js', './usePendingImageUploads-legacy-BAw0rhN2.js', './vendor_leaflet-legacy-eQNkinhv.js', './vendor_firebase-legacy-BARrkZ1D.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        IonLabel = module.E;
        IonInput = module.r;
        informationCircleOutline = module.bl;
        imagesOutline = module.bm;
        locationOutline = module.bn;
