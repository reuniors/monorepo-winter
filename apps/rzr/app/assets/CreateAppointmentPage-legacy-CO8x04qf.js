  ...
  System.register(['./vendor_react-legacy-J-9YdXs8.js', './App-legacy-J1QG38FO.js', './vendor_ionic-legacy-qIZJoxql.js', './logo-square-legacy-DlFrQXHe.js', './WeekSwiperWrapper-legacy-BAvfZ1b3.js', './reservation.services-legacy-Cz9k_Ucr.js', './client.services-legacy-0HM2ct5Q.js', './UserAvatar-legacy-Ddq4uY2X.js', './vendor_leaflet-legacy-CcTkPRIU.js', './index-legacy-1AgAoADQ.js', './vendor_firebase-legacy-DUkuu2E4.js', './workingShift.fe-services-legacy-CHluRvez.js'], function (exports, module) {
    ...
    return {
      setters: [module => {
        ...
        IonButton = module.d;
        checkmarkCircle = module.bg;
        addOutline = module.a7;
        trashOutline = module.P;
        removeOutline = module.bh;
        IonCard = module.a$;
        IonCardContent = module.b0;
        IonToggle = module.ac;
        IonAccordionGroup = module.bi;
        IonAccordion = module.bj;
        ...
        IonContent = module.b;
        cashOutline = module.bk;
        IonBadge = module.b4;
        IonFooter = module.o;
        closeOutline = module.m;
        calendarClearOutline = module.bl;
        chevronDownOutline = module.bm;
        chevronUpOutline = module.bn;
        arrowBack = module.bo;
        arrowForward = module.bp;
      }, module => {
        ...
        function useStepEffects({
          ...
          reactExports.useEffect(() => {
            ...
            if (activeStep === void 0 || activeStep !== validStep) {
              if (queryWorkerId && validStep === 1) {
                const finalStep = 2;
                setActiveStep(finalStep);
                formRef.current?.handleSetStep(finalStep);
          ...
          }, [location.search, hasMultipleActivities, queryWorkerId, activeStep, setActiveStep, formRef, history, contentRefFunctions]);
        }
