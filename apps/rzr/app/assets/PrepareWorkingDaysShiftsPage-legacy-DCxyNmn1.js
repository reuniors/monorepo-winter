;
(function () {
  System.register(['./vendor_react-legacy-j-OXaHGn.js', './vendor_ionic-legacy-B27OJI2l.js', './App-legacy-C1PSXo8s.js', './workingShift.fe-services-legacy-HZ8rgG4j.js', './vendor_leaflet-legacy-aVamlEE1.js', './index-legacy-DzaXWAZQ.js', './vendor_firebase-legacy-BLL9XPHC.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        IonCol = module.C;
        IonIcon = module.l;
        closeCircle = module.bD;
        checkmarkCircle = module.b8;
        IonButton = module.d;
        notificationsOffOutline = module.bE;
