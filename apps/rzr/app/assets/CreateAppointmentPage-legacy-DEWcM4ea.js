;
(function () {
  System.register(['./vendor_react-legacy-BJQu1VnE.js', './App-legacy-DhSLasgw.js', './vendor_ionic-legacy-C5RSb9DR.js', './logo-square-legacy-lQvxJgCG.js', './WeekSwiperWrapper-legacy-BhDB-PLc.js', './reservation.services-legacy-DKhy1csD.js', './client.services-legacy-KjJZVa0w.js', './UserAvatar-legacy-CD8lUaAC.js', './vendor_leaflet-legacy-VV-trcYk.js', './index-legacy-CL_X7O6r.js', './vendor_firebase-legacy-BEYs4Jgn.js', './workingShift.fe-services-legacy-DvurHq5E.js'], function (exports, module) {
    'use strict';

    var reactExports, jsxRuntimeExports, SwiperSlide, useLocation, useHistory, useTranslation, React, format, startOfMonth, endOfMonth, startOfWeek, addDays, startOfDay, toZonedTime, yup, formatInTimeZone, parseISO, useDefaultProps, useConfirmationAlert, SwiperWrapper, useContentRefFunctions, useUser, useQueryParamsHook, useGetFeLocationQuery, activeLocation, useGetFeServiceCategoriesQuery, useGetFeWorkersQuery, SceletonLoader, getPathBySize, fromUtcHM, getAppTimezone, FieldType, useIsBigScreen, useFormWithSchema, urlPrefix, pushDuplicateAndNavigate, IonModalExtended, DynamicForm, NotificationToast, useGetFeServiceGroupsQuery, IonList, IonItem, IonAvatar, IonIcon, peopleOutline, IonLabel, chevronForwardOutline, IonButton, checkmarkCircle, addOutline, trashOutline, removeOutline, IonCard, IonCardContent, IonToggle, IonAccordionGroup, IonAccordion, calendarOutline, IonText, IonSpinner, useIonRouter, useIonToast, IonLoading, IonHeader, IonToolbar, timeOutline, IonContent, cashOutline, IonBadge, IonFooter, closeOutline, calendarClearOutline, chevronDownOutline, chevronUpOutline, arrowBack, arrowForward, LazyLoadImgStandard, preloadCoverImg, useBookingCalendarContext, WeekSwiperWrapper, BookingCalendarContext, SLOT_SEARCH_TOLERANCE_MINUTES, BookingCalendarHeader, BookingWeekDays, BookingCalendarProvider, useCreateFeReservationMutation, useGetFePromoCodeDataQuery, useGetFeClientDataQuery, UserAvatar;
    return {
      setters: [module => {
        ...
        useDefaultProps = module.g;
        useConfirmationAlert = module.h;
        SwiperWrapper = module.S;
        useContentRefFunctions = module.j;
        useUser = module.b;
        useQueryParamsHook = module.k;
        useGetFeLocationQuery = module.l;
        activeLocation = module.m;
        useGetFeServiceCategoriesQuery = module.n;
        useGetFeWorkersQuery = module.o;
        SceletonLoader = module.q;
        getPathBySize = module.r;
        fromUtcHM = module.s;
        getAppTimezone = module.t;
        FieldType = module.F;
        useIsBigScreen = module.v;
        useFormWithSchema = module.w;
        urlPrefix = module.f;
        pushDuplicateAndNavigate = module.x;
        ...
        IonButton = module.d;
        checkmarkCircle = module.bf;
        addOutline = module.a7;
        trashOutline = module.P;
        removeOutline = module.bg;
        IonCard = module.a_;
        IonCardContent = module.a$;
        IonToggle = module.ac;
        IonAccordionGroup = module.bh;
        IonAccordion = module.bi;
        ...
        IonContent = module.b;
        cashOutline = module.bj;
        IonBadge = module.b3;
        IonFooter = module.o;
        closeOutline = module.m;
        calendarClearOutline = module.bk;
        chevronDownOutline = module.bl;
        chevronUpOutline = module.bm;
        arrowBack = module.bn;
        arrowForward = module.bo;
      }, module => {
      ...
      execute: function () {
        ...
        function useStepNavigation({
          ...
          if (queryParams.get("step") === "1" && history.length <= 2) {
          ...
          const handleSetStep = reactExports.useCallback((step, options) => {
            ...
            if (replace || currentStepFromUrl === step && activeStep === void 0) {
              ...
              const calendarStep = hasMultipleActivities ? 3 : 2;
              const servicesStep = hasMultipleActivities ? 2 : 1;
          ...
          }, [activeStep, location.search, history, setActiveStep, formRef, contentRefFunctions, canGoToStep, hasMultipleActivities]);
          const forceSetStep = reactExports.useCallback(step => {
            ...
            formRef.current?.handleSetStep(step);
            contentRefFunctions?.scrollToTop(50);
          }, [location.search, history, setActiveStep, formRef, contentRefFunctions]);
          ...
          const handleBackStep = reactExports.useCallback(() => {
            ...
            if (activeStep === 1 && landedDirectlyOnStep1.current) {
              history.goBack();
            } else if (activeStep !== void 0 && activeStep > minStep) {
              handleSetStep(activeStep - 1, {
                bypassGuard: true
              });
            }
          }, [activeStep, hasMultipleActivities, history, handleSetStep]);
          return {
            handleSetStep,
            forceSetStep,
            handleNextStep,
        ...
        function useStepEffects({
          ...
          }, [queryWorkerId, workers, activeWorkers, selectedWorker, setSelectedWorker]);
          reactExports.useEffect(() => {
          ...
          }, [activeStep, queryWorkerId, selectedWorker, selectedCategory, handleSetStep, hasMultipleActivities]);
          reactExports.useEffect(() => {
            if (activeStep === void 0) return;
            const calendarStep = hasMultipleActivities ? 3 : 2;
          ...
          }, [activeStep, groupsSelectedServices, selectedCategory, forceSetStep, hasMultipleActivities]);
          reactExports.useEffect(() => {
          ...
          }, [queryWorkerId, selectedWorker, categories, selectedCategory, activeStep, forceSetStep, hasMultipleActivities, setSelectedCategory]);
          reactExports.useEffect(() => {
            const params = new URLSearchParams(location.search);
            const stepFromUrlParam = params.get("step");
            const minStep = hasMultipleActivities ? 0 : 1;
            let stepFromUrl = stepFromUrlParam ? parseInt(stepFromUrlParam, 10) : minStep;
            if (queryWorkerId && stepFromUrl >= 2) {
              if (stepFromUrl === 1) {
                stepFromUrl = 2;
              }
            }
          ...
          }, [location.search, hasMultipleActivities, queryWorkerId, activeStep, setActiveStep, formRef]);
        }
        function useCreateAppointmentSteps({
          ...
          const initialStepFromUrl = parseInt(queryParams["step"] ?? "0");
          const [activeStep, setActiveStep] = reactExports.useState(() => {
            if (queryWorkerId && initialStepFromUrl === 1) {
              return 2;
            }
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(IonModalExtended, {
            ...
            children: [createReservationResponse.isLoading && /* @__PURE__ */jsxRuntimeExports.jsx(IonLoading, {
              ...
              children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                ...
                /* @__PURE__ */
                jsxRuntimeExports.jsxs(SwiperWrapper, {
                  slidesPerView: "auto",
                  spaceBetween: 12,
                  className: "pb-4",
                  ...
                  }), selectedServices && selectedServices.length > 0 && selectedServices.map(service => /* @__PURE__ */jsxRuntimeExports.jsx(SwiperSlide, {
                    style: {
                      width: "auto"
                    },
                    children: /* @__PURE__ */jsxRuntimeExports.jsx("div", {
        ...
        function BookingCalendarStep({
          ...
          const activeSlots = isCalendarOpen ? monthSlots : weekSlots;
          const flattenedServices = reactExports.useMemo(() => selectedGroupServices.flatMap(group => group.services ?? []).filter(Boolean), [selectedGroupServices]);
        ...
        function CreateAppointmentStepsFooter({
          ...
          if (activeStep === void 0 || activeStep <= minStep) {
            return null;
          }
        ...
        function CreateAppointmentStepsContent() {
          ...
          const renderSteps = reactExports.useCallback(() => {
            ...
            const calendarStepNumber = hasMultipleActivities ? 3 : 2;
            const calendarStep = activeStep === calendarStepNumber || activeStep === void 0 ? /* @__PURE__ */jsxRuntimeExports.jsx(BookingCalendarProvider, {
              ...
              children: /* @__PURE__ */jsxRuntimeExports.jsx(BookingCalendarStep, {}, `datetime-${queryWorkerId || "all"}-${selectedWorker?.id || "none"}-${allWorkerIds.join(",")}`)
            }, `calendar-provider-${queryWorkerId || "all"}-${selectedWorker?.id || "none"}-${allWorkerIds.join(",")}`) : /* @__PURE__ */jsxRuntimeExports.jsx("div", {
              className: "flex items-center justify-center py-10",
              children: /* @__PURE__ */jsxRuntimeExports.jsx(IonText, {
                color: "medium",
