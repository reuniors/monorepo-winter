;
(function () {
  System.register(['./vendor_react-legacy-j-OXaHGn.js', './App-legacy-C1PSXo8s.js', './SimpleFormStepperActions-legacy-DGghVbL1.js'], function (exports, module) {
    'use strict';

    var create$3, create$5, create$7, create$6, t, useTranslation, jsxRuntimeExports, convertEmptyStringToNull, generateSlugForValidation, useUser, FieldType, useFormWithSchema, useUpdateServiceGroupMutation, useCreateServiceGroupMutation, useShowNotification, DynamicForm, activeLocation, SimpleFormStepperActions;
    return {
      setters: [module => {
        create$3 = module.a1;
        create$5 = module.aL;
        ...
        useUpdateServiceGroupMutation = module.R;
        useCreateServiceGroupMutation = module.T;
