  ...
  System.register(['./vendor_ionic-legacy-DYIGQWbn.js', './vendor_react-legacy-B0yst0tN.js', './index-legacy-ClYp8cKz.js', './vendor_firebase-legacy-Bicf26rb.js'], function (exports, module) {
    ...
    return {
      setters: [module => {
        ...
        useIonViewWillLeave = module.aK;
        businessOutline = module.aL;
        IonActionSheet = module.aM;
        IonTabs = module.aN;
        IonRouterOutlet = module.aO;
        IonTabBar = module.aP;
        IonTabButton = module.aQ;
        homeOutline = module.aR;
      ...
      execute: function () {
        ...
        const transformStandardResponseToCamelCase = exports("A", response => humpsExports.camelizeKeys(response));
        ...
        const photosArrayWithIdYup = exports("G", errorMsg => yup.array().nullable().defined().test("all-photos-have-id", "", function (value) {
        ...
        const getAppTimezone = exports("p", () => {
          return appTimezone;
        });
        ...
        const toUtc = exports("t", (timeString, tz) => {
        ...
        const fromUtc = exports("a8", (utcTimeString, tz) => {
          const timezone = getAppTimezone();
        ...
        const fromUtcDateTimeToTime = exports("y", (utcDateTime, tz) => {
          const timezone = getAppTimezone();
        ...
        const useShowNotification = exports("B", options => {
        ...
        const ListIonIcons = reactExports.lazy(() => __vitePreload(() => module.import('./ListIonIcons-legacy-BcrAR_ff.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const SimpleFormStepper$1 = exports("J", reactExports.memo(reactExports.forwardRef(SimpleFormStepper)));
        function StepItem({
          step,
          index,
          isActive,
        ...
        exports("v", useGetFeLocationQuery);
        const HomePage = reactExports.lazy(() => __vitePreload(() => module.import('./HomePage-legacy-Cr6y1JyY.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const AppointmentPage = reactExports.lazy(() => __vitePreload(() => module.import('./AppointmentPage-legacy-DfH2Q9xg.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ProfilePage = reactExports.lazy(() => __vitePreload(() => module.import('./ProfilePage-legacy-DaLhA33-.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NotificationPage = reactExports.lazy(() => __vitePreload(() => module.import('./NotificationPage-legacy-B7HYEtKs.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const PrepareWorkingDaysShiftsPage = reactExports.lazy(() => __vitePreload(() => module.import('./PrepareWorkingDaysShiftsPage-legacy-HxT9O_v_.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const OwnerHomePage = reactExports.lazy(() => __vitePreload(() => module.import('./OwnerHomePage-legacy-BnymLtDO.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const OwnerAppointmentPage = reactExports.lazy(() => __vitePreload(() => module.import('./OwnerAppointmentPage-legacy-B0j2c-4A.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const SettingsPage = reactExports.lazy(() => __vitePreload(() => module.import('./SettingsPage-legacy-DtZf1dpS.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const pushDuplicateAndNavigate = exports("s", (router, destination, referrer) => {
        ...
        const CreateAppointmentPage = reactExports.lazy(() => __vitePreload(() => module.import('./CreateAppointmentPage-legacy-B00KjRpa.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ConfirmReservationPage = reactExports.lazy(() => __vitePreload(() => module.import('./ConfirmReservationPage-legacy-B2s_jtQd.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const PublicProfilePage = reactExports.lazy(() => __vitePreload(() => module.import('./PublicProfilePage-legacy-D29t5X0V.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NewsListPage = reactExports.lazy(() => __vitePreload(() => module.import('./NewsListPage-legacy-BEx-qNIs.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NewsCreatePage = reactExports.lazy(() => __vitePreload(() => module.import('./NewsCreatePage-legacy-CByrmtbg.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NewsEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./NewsEditPage-legacy-DDojA3ob.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationWorkingTimePage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkingTimePage-legacy-CwUR-cQG.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationEditPage-legacy-DSHodlbq.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationWorkersPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkersPage-legacy-CNbr0kMv.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationSettingsPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationSettingsPage-legacy-DeV-YhyS.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServicesPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServicesPage-legacy-CfHveymO.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceCategoriesPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceCategoriesPage-legacy-B9BceLVa.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceCategoryEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceCategoryEditPage-legacy-yEG4xWaJ.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceGroupEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceGroupEditPage-legacy-Bq-vFALp.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceEditPage-legacy-oCUJcC4t.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        exports({
          Z: useUpdateServiceGroupMutation,
          _: useCreateServiceGroupMutation
        });
        ...
        exports("X", useUpdateServiceMutation);
        ...
        const LocationWorkerCreatePage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkerCreatePage-legacy-Bn-ZmKGq.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        exports({
          w: useGetFeServiceCategoriesQuery,
        ...
        const TestNotificationsPage = reactExports.lazy(() => __vitePreload(() => module.import('./TestNotificationsPage-legacy-CGL0W7E_.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const UserDevicesPage = reactExports.lazy(() => __vitePreload(() => module.import('./UserDevicesPage-legacy-BhDvUl6R.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const Menu = reactExports.lazy(() => __vitePreload(() => module.import('./Menu-legacy-Ccm6ws4e.js'), false              ? __VITE_PRELOAD__ : void 0));
        setupIonicReact({
        ...
        const preloadedLocationData = exports("K", getInitialData("locationData", true, true));
