;
(function () {
  System.register(['./vendor_react-legacy-j-OXaHGn.js', './vendor_ionic-legacy-B27OJI2l.js', './service-category.services-legacy-CPqOv5a4.js', './App-legacy-C1PSXo8s.js', './SimpleFormStepperActions-legacy-DGghVbL1.js', './usePendingImageUploads-legacy-DfrubukC.js', './ServiceGroupCreateModal-legacy-Dx6tjFVy.js', './vendor_leaflet-legacy-aVamlEE1.js', './index-legacy-DzaXWAZQ.js', './vendor_firebase-legacy-BLL9XPHC.js', './props-legacy-s4OYYZ4Y.js', './ServiceGroupBasicInfoStep-legacy-kgJzPGie.js'], function (exports, module) {
    'use strict';

    var t, create$3, create$7, create$6, useTranslation, React, jsxRuntimeExports, create$2, reactExports, useLocation, useHistory, informationCircleOutline, imageOutline, constructOutline, useIonRouter, IonList, IonItem, IonIcon, addOutline, IonLabel, IonText, IonCheckbox, IonButton, createOutline, IonSpinner, useUpdateServiceCategoryMutation, useGetFeServiceCategoriesQuery, FieldType, convertEmptyStringToNull, generateSlugForValidation, useFormWithSchema, generateSlug, useShowNotification, DynamicForm, useGetFeServiceGroupsQuery, activeLocation, urlPrefix, LayoutMainPage, mainHeaderClasses, pushDuplicateAndNavigate, SimpleFormStepperActions, usePendingImageUploads, StepIndicator, SimpleFormStepper, ServiceGroupCreateModal;
    return {
      setters: [module => {
        t = module.a0;
        create$3 = module.a1;
        ...
        informationCircleOutline = module.bp;
        imageOutline = module.bt;
        ...
        useUpdateServiceCategoryMutation = module.b;
        useGetFeServiceCategoriesQuery = module.u;
      }, module => {
        FieldType = module.F;
        convertEmptyStringToNull = module.J;
        generateSlugForValidation = module.K;
        useFormWithSchema = module.q;
        generateSlug = module.H;
