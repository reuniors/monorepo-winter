;
(function () {
  System.register(['./vendor_react-legacy-CSf8zLqi.js', './vendor_ionic-legacy-DvZl6sBE.js', './App-legacy-CRCzN3kk.js', './workingShift.fe-services-legacy-BYipkkLk.js', './index-legacy-CYMNsaJ2.js', './vendor_leaflet-legacy-DUCVU90d.js', './vendor_firebase-legacy-tNokQwyN.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        differenceInCalendarMonths = module.be;
        getMonth = module.bf;
        ...
        IonButton = module.d;
        notificationsOffOutline = module.bY;
