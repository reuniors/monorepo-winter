;
(function () {
  System.register(['./vendor_ionic-legacy-C5RSb9DR.js', './vendor_react-legacy-BJQu1VnE.js', './vendor_leaflet-legacy-VV-trcYk.js'], function (exports, module) {
    'use strict';
    ...
    return {
      ...
      execute: function () {
        ...
        const App = reactExports.lazy(() => __vitePreload(() => module.import('./App-legacy-DhSLasgw.js').then(n => n.ag), false              ? __VITE_PRELOAD__ : void 0));
        initializeTheme();
