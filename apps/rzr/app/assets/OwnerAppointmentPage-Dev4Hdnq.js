import { av as parseISO, bb as parse, aN as addMinutes, bc as isWithinInterval, bd as differenceInMinutes, ay as format, aw as formatInTimeZone, e as reactExports, j as jsxRuntimeExports, af as SwiperSlide, aK as addDays, aD as useTranslation, R as React, aM as startOfDay, ax as toZonedTime, aO as startOfMonth } from "./vendor_react-DUHraSvm.js";
import { a5 as useContentRefFunctions, l as SwiperWrapper, a6 as generateWeek, x as useGetFeWorkersQuery, h as activeLocation, f as urlPrefix, a3 as getAppTimezone, w as fromUtcHM, a7 as useGetFeLocationReservationsQuery, a4 as getUtcDateFormattedInTz, a8 as parseUtcDate, a9 as isToday, S as SceletonLoader, aa as BookingCalendarHeader, ab as BookingWeekDays, q as useQueryParamsHook, H as useGetFeServiceCategoriesQuery } from "./App-3ar7Cq0a.js";
import { d as useGetFeWorkerWorkingShiftsByDaysQuery } from "./workingShift.fe-services-q28PGSw5.js";
import { aj as useIonRouter, n as IonSpinner, l as IonIcon, b1 as cashOutline } from "./vendor_ionic-COxsUFYm.js";
      ...
      WeekSwiperWrapper,
      {
        ...
        children: (slide) => {
          ...
          if (slide.type === "empty-week") {
            return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-16 min-h-[320px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-6xl mb-4", children: "📅" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-semibold text-gray-700 dark:text-gray-300 mb-2", children: t("Nema termina za ovu nedelju") })
            ] }) });
          }
