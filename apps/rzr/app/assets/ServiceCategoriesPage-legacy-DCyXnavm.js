  ...
  System.register(['./vendor_react-legacy-CKjKS6zA.js', './vendor_ionic-legacy-Br2UrGvg.js', './App-legacy-OqtQecgU.js', './index-legacy-Cdf7FWKJ.js', './vendor_leaflet-legacy-Dzs4-G2p.js', './vendor_firebase-legacy-D-vUgmbk.js'], function (exports, module) {
    ...
    return {
      setters: [module => {
        ...
        useCreateServiceCategoryMutation = module.T;
        useShowNotification = module.J;
        generateSlug = module.V;
        activeLocation = module.n;
        useGetFeServiceCategoriesQuery = module.o;
        useUpdateServiceCategoryMutation = module.X;
        useDeleteServiceCategoryMutation = module.Y;
        urlPrefix = module.g;
      }, module => {
