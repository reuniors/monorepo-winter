  ...
  System.register(['./vendor_react-legacy-yeQ-Nqpl.js', './App-legacy-DRWtf8eI.js', './vendor_ionic-legacy-DdPNGOLm.js', './logo-square-legacy-r7uEZNLo.js', './BookingWeekDays-legacy-BlTy3yrr.js', './reservation.services-legacy-DqdYtBVh.js', './client.services-legacy-BKXONrn3.js', './UserAvatar-legacy-rdf0uvqP.js', './useQueryParamsHook-legacy-Bhnvau9I.js', './vendor_leaflet-legacy-Cr0PaNC7.js', './index-legacy-Bog12BrJ.js', './vendor_firebase-legacy-CPHztqRU.js', './workingShift.fe-services-legacy-rrzAqfKK.js'], function (exports, module) {
    ...
    return {
      setters: [module => {
        ...
        IonButton = module.d;
        checkmarkCircle = module.be;
        addOutline = module.a6;
        trashOutline = module.O;
        removeOutline = module.bf;
        IonCard = module.aY;
        IonCardContent = module.aZ;
        IonToggle = module.ac;
        IonAccordionGroup = module.bg;
        IonAccordion = module.bh;
        ...
        IonContent = module.b;
        cashOutline = module.bi;
        IonBadge = module.b1;
        IonFooter = module.o;
        closeOutline = module.m;
        calendarClearOutline = module.bj;
        chevronDownOutline = module.bk;
        chevronUpOutline = module.bl;
        arrowBack = module.bm;
        arrowForward = module.bn;
      }, module => {
