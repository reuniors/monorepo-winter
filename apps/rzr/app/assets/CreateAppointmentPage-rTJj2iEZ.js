...
import { u as useBookingCalendarContext, W as WeekSwiperWrapper, B as BookingCalendarContext, S as SLOT_SEARCH_TOLERANCE_MINUTES, a as BookingCalendarHeader, b as BookingWeekDays, c as BookingCalendarProvider } from "./WeekSwiperWrapper-CFwgxpBN.js";
import { u as useCreateFeReservationMutation, a as useGetFePromoCodeDataQuery } from "./reservation.services-o7CNV4r2.js";
import { u as useGetFeClientDataQuery } from "./client.services-B9HktvUK.js";
...
import "./workingShift.fe-services-sm7fQhbL.js";
  ...
  reactExports.useEffect(() => {
    ...
    if (activeStep === void 0 || activeStep !== validStep) {
      if (queryWorkerId && validStep === 1) {
        ...
        (_a = formRef.current) == null ? void 0 : _a.handleSetStep(finalStep);
        const newParams = new URLSearchParams(location.search);
        newParams.set("step", "2");
        history.replace({ search: newParams.toString() });
      } else {
        setActiveStep(validStep);
        (_b = formRef.current) == null ? void 0 : _b.handleSetStep(validStep);
      }
    }
  }, [
    location.search,
