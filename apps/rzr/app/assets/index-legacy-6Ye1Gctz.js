;
(function () {
  System.register(['./vendor_ionic-legacy-O-KkNIDb.js', './vendor_react-legacy-3NN3kxAt.js', './vendor_leaflet-legacy-D7880HPH.js'], function (exports, module) {
    'use strict';
    ...
    return {
      ...
      execute: function () {
        ...
        var TagType = exports("q", /* @__PURE__ */(TagType2 => {
          TagType2["LOCATION"] = "location";
        ...
        var TagId = exports("w", /* @__PURE__ */(TagId2 => {
          TagId2["LIST"] = "LIST";
          return TagId2;
        })(TagId || {}));
        ...
        const App = reactExports.lazy(() => __vitePreload(() => module.import('./App-legacy-CYjjD2vl.js').then(n => n.ag), false              ? __VITE_PRELOAD__ : void 0));
        initializeTheme();
