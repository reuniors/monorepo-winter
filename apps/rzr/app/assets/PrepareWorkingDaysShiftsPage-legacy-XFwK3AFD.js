;
(function () {
  System.register(['./vendor_react-legacy-xICptfoc.js', './vendor_ionic-legacy-BYtYhV2-.js', './App-legacy-B3_9n1No.js', './workingShift.fe-services-legacy-BSqy6pYo.js', './vendor_leaflet-legacy-D5znobiB.js', './index-legacy-D4YSxuaQ.js', './vendor_firebase-legacy-Bauk9ZJe.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        IonCol = module.C;
        IonIcon = module.l;
        closeCircle = module.bE;
        checkmarkCircle = module.bc;
        IonButton = module.d;
        notificationsOffOutline = module.bF;
