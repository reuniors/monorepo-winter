;
(function () {
  System.register(['./vendor_react-legacy-B0yst0tN.js', './vendor_ionic-legacy-DYIGQWbn.js', './App-legacy-D5D6TSxV.js', './test-notification.services-legacy-DOTXEZY9.js', './vendor_leaflet-legacy-DKuaEqMF.js', './index-legacy-D1XlU8IL.js', './vendor_firebase-legacy-Bicf26rb.js'], function (exports, module) {
    'use strict';
        ...
        function UserDevicesPage({
          ...
          const handleSendNotification = async formData => {
            ...
            try {
              ...
              presentToast({
                message: err?.data?.message || t("Greška pri slanju notifikacije"),
                duration: 3e3,
                color: "danger"
              });
            }
