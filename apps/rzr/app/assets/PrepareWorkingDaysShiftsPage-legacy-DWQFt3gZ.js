;
(function () {
  System.register(['./vendor_react-legacy-CX0h95NE.js', './vendor_ionic-legacy-CLGezsbs.js', './App-legacy-7OwS84rF.js', './workingShift.fe-services-legacy-CBNrhNiZ.js', './index-legacy-BIk86z2F.js', './vendor_leaflet-legacy-CiFv5lWM.js', './vendor_firebase-legacy-BCi9HsFn.js'], function (exports, module) {
    'use strict';

    var useTranslation, jsxRuntimeExports, SwiperSlide, V, reactExports, toZonedTime, differenceInCalendarMonths, getMonth, startOfMonth, addDays, endOfMonth, eachDayOfInterval, format, subMonths, addMonths, IonGrid, IonRow, IonCol, IonIcon, closeCircle, checkmarkCircle, IonButton, notificationsOffOutline, trashOutline, timeOutline, IonHeader, IonToolbar, IonTitle, IonButtons, closeOutline, IonContent, IonDatetime, IonList, IonItem, IonFooter, chevronBackOutline, IonSpinner, chevronForwardOutline, ConditionalComponent, SwiperWrapper, fromUtcHM, fromUtc, toUtc, activeLocation, getAppTimezone, getUtcDateFormattedInTz, useGetFeWorkingShiftsByDaysQuery, useGetWorkingHoursQuery, useSetFeWorkingDayShiftMutation, useDeleteFeWorkingDayShiftMutation, IonModalExtended;
    return {
      setters: [module => {
