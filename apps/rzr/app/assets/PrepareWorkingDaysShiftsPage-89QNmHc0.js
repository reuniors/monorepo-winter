import { M as useTranslation, j as jsxRuntimeExports, aj as SwiperSlide, al as V, e as reactExports, aB as toZonedTime, be as differenceInCalendarMonths, bf as getMonth, aP as startOfMonth, aS as addDays, aQ as endOfMonth, b1 as eachDayOfInterval, aC as format, b4 as subMonths, b5 as addMonths } from "./vendor_react-g1Lb8P9R.js";
import { C as IonGrid, D as IonRow, E as IonCol, b as IonIcon, bQ as closeCircle, bp as checkmarkCircle, d as IonButton, bR as notificationsOffOutline, S as trashOutline, ah as timeOutline, e as IonHeader, f as IonToolbar, h as IonTitle, i as IonButtons, j as closeOutline, k as IonContent, ae as IonDatetime, H as IonList, r as IonItem, p as IonFooter, av as chevronBackOutline, o as IonSpinner, a4 as chevronForwardOutline } from "./vendor_ionic-XqfGltiy.js";
import { C as ConditionalComponent, S as SwiperWrapper, t as fromUtcHM, ag as fromUtc, ah as toUtc, n as activeLocation, v as getAppTimezone, a1 as getUtcDateFormattedInTz } from "./App-BTZwZ6xb.js";
import { a as useGetFeWorkingShiftsByDaysQuery, b as useGetWorkingHoursQuery, c as useSetFeWorkingDayShiftMutation, d as useDeleteFeWorkingDayShiftMutation } from "./workingShift.fe-services-PxWiitbg.js";
...
function WorkingDaysPlanCustomTime({
  ...
  const handleDateChangeFrom = (event) => {
    var _a;
    const newTimeLocal = ((_a = event.detail.value) == null ? void 0 : _a.substring(0, 5)) || "";
    ...
    IonModalExtended,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(IonHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(IonToolbar, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(IonTitle, { children: t("Izaberite radno vreme") }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(IonContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(IonGrid, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(IonRow, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(IonCol, { style: { textAlign: "-webkit-center" }, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-gray-600 mt-2", children: timeFromLocal })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(IonCol, { style: { textAlign: "-webkit-center" }, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-gray-600 mt-2", children: timeToLocal })
            ] })
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(IonRow, { className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(IonCol, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-lg font-semibold text-gray-800 mb-2", children: t("Pauze") }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(IonList, { children: [
              pauses.map((pause, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(IonItem, { className: "mb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(IonGrid, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(IonRow, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(IonCol, { size: "4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-gray-600", children: t("Od") }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    IonDatetime,
                    {
                      itemType: "time",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-gray-600 mt-1", children: fromUtcHM(pause.timeFromUtc) })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(IonCol, { size: "4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-gray-600", children: t("Do") }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    IonDatetime,
                    {
                      itemType: "time",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-gray-600 mt-1", children: fromUtcHM(pause.timeToUtc) })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  IonCol,
                  {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(IonRow, { className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(IonCol, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-sm text-gray-600", children: t(
...
function WorkingDaysPlanList({ locationWorker }) {
    ...
    if (workingShiftsByDays) {
      ...
      if (shift) {
        return {
          ...
          pausesUtc: ((_a = shift.pausesUtc) == null ? void 0 : _a.map((pause) => ({
  ...
  const getWorkingHoursForDay = (date) => {
    ...
    return (workingHours == null ? void 0 : workingHours.data.filter(
      (workingHour) => {
        var _a;
        return (_a = workingHour.daysCodes) == null ? void 0 : _a.includes(dayOfWeek);
      }
    )) || [];
  };
  const isWorkingHourActive = (date, workingHour) => {
    ...
    const workingHourPauses = ((_a = workingHour.pausesUtc) == null ? void 0 : _a.filter((pause) => {
      var _a2;
      return (_a2 = pause.daysCodes) == null ? void 0 : _a2.includes(dayOfWeek);
    }).map((pause) => ({
      timeFromUtc: pause.timeFromUtc,
      timeToUtc: pause.timeToUtc
    }))) || [];
  ...
  const listOfDaysInSelectedMonth = reactExports.useMemo(() => {
    ...
    return eachDayOfInterval({ start, end }).map((day) => {
      ...
      return {
        name: t("weeks.".concat(format(day, "EEEE"))) + ", " + format(day, "d."),
  ...
  const formattedMonth = reactExports.useMemo(() => {
    return isCurrentYear ? t("months.".concat(format(currentDate, "MMMM"))) : format(currentDate, "MMMM yyyy");
  ...
  const handleSelectShift = (date, shift, isDisabled) => () => {
    ...
    const pausesForDay = ((_a = workingHour == null ? void 0 : workingHour.pausesUtc) == null ? void 0 : _a.filter((pause) => {
      var _a2;
      return (_a2 = pause.daysCodes) == null ? void 0 : _a2.includes(dayOfWeek);
    }).map((pause) => ({
      timeFromUtc: pause.timeFromUtc,
  ...
  const handleLongPressOnTimeSlot = (date, workingHour) => {
    var _a;
    const dayOfWeek = format(new Date(date), "EEE").toLowerCase();
    const pausesForDay = ((_a = workingHour.pausesUtc) == null ? void 0 : _a.filter((pause) => {
      var _a2;
      return (_a2 = pause.daysCodes) == null ? void 0 : _a2.includes(dayOfWeek);
    }).map((pause) => ({
      timeFromUtc: pause.timeFromUtc,
...
function PrepareWorkingDaysShiftsPage({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: selectedWorker && /* @__PURE__ */ jsxRuntimeExports.jsx(WorkingDaysPlanList, { locationWorker: selectedWorker }) });
}
export {
  PrepareWorkingDaysShiftsPage as default
};
