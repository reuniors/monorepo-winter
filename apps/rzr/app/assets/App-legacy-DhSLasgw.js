;
(function () {
  System.register(['./vendor_ionic-legacy-C5RSb9DR.js', './vendor_react-legacy-BJQu1VnE.js', './index-legacy-CL_X7O6r.js', './vendor_firebase-legacy-BEYs4Jgn.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        informationCircleOutline = module.aY;
        appsOutline = module.aZ;
        IonCard = module.a_;
        ...
        IonBadge = module.b3;
        logOutOutline = module.b4;
        IonApp = module.b5;
        IonReactRouter = module.b6;
        IonSplitPane = module.b7;
        setupIonicReact = module.b8;
      }, module => {
      ...
      execute: function () {
        ...
        const toUtc = exports("ae", (timeString, tz) => {
        ...
        const fromUtc = exports("ad", (utcTimeString, tz) => {
          const timezone = getAppTimezone();
        ...
        const isInstalled = exports("ab", isPlatform("capacitor"));
        ...
        const isWebView = exports("ac", window?.navigator && window?.navigator?.userAgent ? getIsWebview(window.navigator.userAgent) : true);
        const ionIconList = [];
        const ionIcons = {};
        const fetchIonIconsList = exports("af", () => {
        ...
        const ListIonIcons = reactExports.lazy(() => __vitePreload(() => module.import('./ListIonIcons-legacy-Ddo5HUuZ.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const HomePage = reactExports.lazy(() => __vitePreload(() => module.import('./HomePage-legacy-DyE2s1w3.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const AppointmentPage = reactExports.lazy(() => __vitePreload(() => module.import('./AppointmentPage-legacy-DibKmkZO.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ProfilePage = reactExports.lazy(() => __vitePreload(() => module.import('./ProfilePage-legacy-BRZJbtWW.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NotificationPage = reactExports.lazy(() => __vitePreload(() => module.import('./NotificationPage-legacy-DiyHD_fN.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const PrepareWorkingDaysShiftsPage = reactExports.lazy(() => __vitePreload(() => module.import('./PrepareWorkingDaysShiftsPage-legacy-C1QnH48A.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const OwnerHomePage = reactExports.lazy(() => __vitePreload(() => module.import('./OwnerHomePage-legacy-DnEwCly9.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const OwnerAppointmentPage = reactExports.lazy(() => __vitePreload(() => module.import('./OwnerAppointmentPage-legacy-CETkbNVh.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const SettingsPage = reactExports.lazy(() => __vitePreload(() => module.import('./SettingsPage-legacy-DgN6da9q.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const CreateAppointmentPage = reactExports.lazy(() => __vitePreload(() => module.import('./CreateAppointmentPage-legacy-DEWcM4ea.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ConfirmReservationPage = reactExports.lazy(() => __vitePreload(() => module.import('./ConfirmReservationPage-legacy-DjuuqJGg.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const PublicProfilePage = reactExports.lazy(() => __vitePreload(() => module.import('./PublicProfilePage-legacy-CV3_Mi4x.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NewsListPage = reactExports.lazy(() => __vitePreload(() => module.import('./NewsListPage-legacy-r0Ighsi_.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NewsCreatePage = reactExports.lazy(() => __vitePreload(() => module.import('./NewsCreatePage-legacy-DBUepXOK.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NewsEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./NewsEditPage-legacy-rca-Z5VP.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationWorkingTimePage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkingTimePage-legacy-DNPwFTj0.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationEditPage-legacy-IkeEEius.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationWorkersPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkersPage-legacy-D8XVVIBz.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationSettingsPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationSettingsPage-legacy-BAO14jmW.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServicesPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServicesPage-legacy-RPPUy6mx.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceCategoriesPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceCategoriesPage-legacy-B0H-49oK.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceCategoryEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceCategoryEditPage-legacy-h-HEA8-W.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceGroupEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceGroupEditPage-legacy-DrFyF7tM.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceEditPage-legacy-JVsHb0cY.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationWorkerCreatePage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkerCreatePage-legacy-C2wDdA2n.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const GoogleCalendarSettingsPage = reactExports.lazy(() => __vitePreload(() => module.import('./GoogleCalendarSettingsPage-legacy-BJV12KZW.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const TestNotificationsPage = reactExports.lazy(() => __vitePreload(() => module.import('./TestNotificationsPage-legacy-DeBZ34OA.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const UserDevicesPage = reactExports.lazy(() => __vitePreload(() => module.import('./UserDevicesPage-legacy-K-YUB874.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const PrivateLocationLandingPage = reactExports.lazy(() => __vitePreload(() => module.import('./PrivateLocationLandingPage-legacy-D0N6htpT.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const Menu = reactExports.lazy(() => __vitePreload(() => module.import('./Menu-legacy-CjGcbwwT.js'), false              ? __VITE_PRELOAD__ : void 0));
