import { M as useTranslation, e as reactExports, bc as useGoogleLogin, j as jsxRuntimeExports } from "./vendor_react-BAn6__hR.js";
import { o as IonSpinner, b2 as IonCard, b4 as IonCardHeader, b5 as IonCardTitle, b as IonIcon, ag as calendarOutline, b3 as IonCardContent, r as IonItem, G as IonLabel, d as IonButton, an as refreshOutline, af as IonToggle, m as IonText, aB as IonAlert } from "./vendor_ionic-BUXN7OTv.js";
import { t as rzrApi, v as TagType } from "./index-DDjfk2Xy.js";
...
const googleCalendarApi = rzrApi.injectEndpoints({
  endpoints: (builder) => ({
    getGoogleCalendarSettings: builder.query({
      ...
      providesTags: [{ type: TagType.USER, id: "google-calendar-settings" }]
    }),
    connectGoogleCalendar: builder.mutation({
      ...
      invalidatesTags: [{ type: TagType.USER, id: "google-calendar-settings" }]
    }),
    ...
    syncGoogleCalendar: builder.mutation({
      ...
      invalidatesTags: [
        ...
        { type: TagType.USER, id: "google-calendar-settings" }
      ]
    }),
    getGoogleCalendarEvents: builder.query({
      ...
      providesTags: [{ type: TagType.USER, id: "google-calendar-events" }]
    })
  })
});
const {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(IonCard, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(IonCardContent, { className: "ion-no-padding", children: [
        settings.googleEmail && /* @__PURE__ */ jsxRuntimeExports.jsx(IonItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(IonLabel, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: t("Status konekcije") }),
        ...
        !settings.isConnected && /* @__PURE__ */ jsxRuntimeExports.jsx(IonItem, { color: "warning", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(IonLabel, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: t("Google Calendar nije povezan") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: t("Molimo povežite vaš Google Calendar nalog da bi omogućili sinhronizaciju.") })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(IonItem, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(IonLabel, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: settings.isConnected ? t("Sinhronizacija sa Google Calendar") : t("Povezivanje sa Google Calendar") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: settings.isConnected ? t("Kliknite da sinhronizujete rezervacije sa Google Calendar") : t("Kliknite da povežete vaš Google Calendar nalog") })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(IonItem, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(IonLabel, { children: t("Sinhronizuj u kalendar") }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(IonItem, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(IonLabel, { children: t("Sinhronizuj iz kalendara") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            IonToggle,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(IonItem, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(IonLabel, { children: t("Blokiraj preklapajuće termine") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            IonToggle,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(IonItem, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(IonLabel, { children: t("Dozvoli preklapanje uz odobrenje") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            IonToggle,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ion-padding", children: /* @__PURE__ */ jsxRuntimeExports.jsx(IonText, { color: "medium", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: t("Ove opcije vam omogućavaju da kontrolišete kako se vaše rezervacije sinhronizuju sa Google Calendar.") }) }) }),
        settings.isConnected && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ion-padding", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(IonText, { color: "primary", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: t("Nedavni događaji iz Google Calendar") }) }),
          ...
          !isEventsLoading && ((_a = eventsResponse == null ? void 0 : eventsResponse.data) == null ? void 0 : _a.length) === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(IonText, { color: "medium", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: t("Nema događaja za prikaz") }) }),
          !isEventsLoading && (eventsResponse == null ? void 0 : eventsResponse.data) && eventsResponse.data.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: eventsResponse.data.map((e) => /* @__PURE__ */ jsxRuntimeExports.jsx(IonItem, { lines: "full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(IonLabel, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: e.summary || t("Bez naslova") }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "ion-color-medium", children: e.isExternal ? t("Eksterni događaj") : t("Rezervacija") })
          ] }) }, e.id)) })
        ] })
      ] })
    ] }),
...
export {
  GoogleCalendarSettingsPage as default
};
