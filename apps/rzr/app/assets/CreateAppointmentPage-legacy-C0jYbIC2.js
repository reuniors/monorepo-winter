;
(function () {
  System.register(['./vendor_react-legacy-DX-mYdP5.js', './App-legacy-D9i3zTWV.js', './vendor_ionic-legacy-DitOK8Rz.js', './logo-square-legacy-BYAGju9l.js', './WeekSwiperWrapper-legacy-CA52_m6n.js', './reservation.services-legacy-CxArC9AZ.js', './client.services-legacy-BBMybAj7.js', './UserAvatar-legacy-IkOtQzjt.js', './index-legacy-C1Nz3TCW.js', './vendor_leaflet-legacy-DW0hIt0g.js', './vendor_firebase-legacy-CM5O5LjC.js', './workingShift.fe-services-legacy-BfOAaRTH.js'], function (exports, module) {
    'use strict';

    var reactExports, jsxRuntimeExports, SwiperSlide, useLocation, useHistory, useTranslation, React, format, formatInTimeZone, startOfMonth, endOfMonth, startOfWeek, addDays, parseISO, toZonedTime, startOfDay, yup, Pagination, fromZonedTime, useDefaultProps, useConfirmationAlert, SwiperWrapper, useContentRefFunctions, useUser, useQueryParamsHook, useGetFeLocationQuery, activeLocation, useGetFeServiceCategoriesQuery, useGetFeWorkersQuery, SceletonLoader, getPathBySize, fromUtcHM, getAppTimezone, FieldType, DynamicForm, useIsBigScreen, useFormWithSchema, urlPrefix, pushDuplicateAndNavigate, useGetFeServiceGroupsQuery, NotificationToast, IonList, IonItem, IonAvatar, IonIcon, peopleOutline, IonLabel, chevronForwardOutline, IonButton, checkmarkCircle, addOutline, trashOutline, removeOutline, IonCard, IonCardContent, IonToggle, IonAccordionGroup, IonAccordion, calendarOutline, IonText, IonSpinner, IonHeader, IonToolbar, timeOutline, cashOutline, IonBadge, IonFooter, closeOutline, calendarClearOutline, useIonRouter, useIonToast, IonLoading, IonContent, chevronDownOutline, chevronUpOutline, arrowBack, arrowForward, LazyLoadImgStandard, preloadCoverImg, useBookingCalendarContext, WeekSwiperWrapper, BookingCalendarContext, SLOT_SEARCH_TOLERANCE_MINUTES, BookingCalendarHeader, BookingWeekDays, BookingCalendarProvider, useCreateFeReservationMutation, useGetFePromoCodeDataQuery, useGetFeClientDataQuery, UserAvatar, IonModalExtended;
    return {
      setters: [module => {
        ...
        yup = module.a3;
        Pagination = module.aU;
        fromZonedTime = module.aD;
      }, module => {
        useDefaultProps = module.h;
        useConfirmationAlert = module.j;
        ...
        urlPrefix = module.g;
        pushDuplicateAndNavigate = module.y;
        useGetFeServiceGroupsQuery = module.z;
        NotificationToast = module.N;
      }, module => {
        IonList = module.H;
        IonItem = module.r;
        IonAvatar = module.bo;
        ...
        IonButton = module.d;
        checkmarkCircle = module.bp;
        addOutline = module.aa;
        trashOutline = module.S;
        removeOutline = module.bq;
        IonCard = module.b5;
        IonCardContent = module.b6;
        IonToggle = module.af;
        IonAccordionGroup = module.br;
        IonAccordion = module.bs;
        ...
        cashOutline = module.bt;
        IonBadge = module.ba;
        IonFooter = module.p;
        closeOutline = module.j;
        calendarClearOutline = module.bu;
        useIonRouter = module.ao;
        useIonToast = module.u;
        IonLoading = module.al;
        IonContent = module.k;
        chevronDownOutline = module.bv;
        chevronUpOutline = module.bw;
        arrowBack = module.bi;
        arrowForward = module.bx;
      }, module => {
        LazyLoadImgStandard = module.L;
        preloadCoverImg = module.p;
      }, module => {
        useBookingCalendarContext = module.u;
        WeekSwiperWrapper = module.W;
        BookingCalendarContext = module.B;
        SLOT_SEARCH_TOLERANCE_MINUTES = module.S;
        BookingCalendarHeader = module.a;
        BookingWeekDays = module.b;
        BookingCalendarProvider = module.c;
      }, module => {
        useCreateFeReservationMutation = module.u;
        useGetFePromoCodeDataQuery = module.a;
      }, module => {
      ...
      execute: function () {
        exports("default", CreateAppointmentPage);
        ...
        function useStepNavigation({
          ...
          const handleSetStep = reactExports.useCallback((step, options) => {
            const {
              replace = false,
              bypassGuard = false
            } = options || {};
          ...
          }, [activeStep, location.search, history, setActiveStep, formRef, contentRefFunctions, canGoToStep, hasMultipleActivities, location.pathname]);
          const forceSetStep = reactExports.useCallback(step => {
            if (!location.pathname.includes("/zakazi-novo")) return;
            const params = new URLSearchParams(location.search);
            params.set("step", step.toString());
            history.replace({
            ...
            formRef.current?.handleSetStep(step);
            contentRefFunctions?.scrollToTop(50);
          }, [location.pathname, location.search, history, setActiveStep, formRef, contentRefFunctions]);
        ...
        function useStepValidation({
          ...
          const canGoToStep = reactExports.useMemo(() => step => {
            ...
            return true;
          }, [hasMultipleActivities, selectedCategory, selectedWorker, groupsSelectedServices]);
          const nextButtonDisabled = reactExports.useMemo(() => {
            ...
            return true;
          }, [activeStep, selectedWorker, selectedCategory, groupsSelectedServices, hasMultipleActivities]);
          return {
            canGoToStep,
            nextButtonDisabled
          };
        ...
        function useWorkerSelection({
          ...
          const handleSelectWorker = reactExports.useCallback(worker => {
        ...
        function useCategorySelection({
          ...
          const handleSelectCategory = reactExports.useCallback(category => {
            setSelectedCategory(category);
            if (category) {
              try {
                localStorage.setItem("rzr_last_selected_category", JSON.stringify(category));
              } catch (error) {
          ...
          }, [setSelectedCategory, hasMultipleActivities, activeStep, queryWorkerId, setSelectedWorker, handleSetStep]);
          return {
        ...
        function useServiceSelection({
          ...
          const handleSelectService = reactExports.useCallback((serviceGroup, service) => {
          ...
          const handleHasMultiplePersons = reactExports.useCallback(has => {
        ...
        function useStepEffects({
          ...
          }, [queryWorkerId, workers, activeWorkers, selectedWorker, setSelectedWorker, location.pathname]);
          reactExports.useEffect(() => {
            if (!location.pathname.includes("/zakazi-novo")) return;
          ...
          }, [activeStep, queryWorkerId, selectedWorker, selectedCategory, handleSetStep, hasMultipleActivities, location.search, location.pathname]);
          reactExports.useEffect(() => {
            if (!location.pathname.includes("/zakazi-novo")) return;
            if (activeStep === void 0) return;
            const calendarStep = 3;
          ...
          }, [activeStep, groupsSelectedServices, selectedCategory, forceSetStep, hasMultipleActivities, location.pathname]);
          reactExports.useEffect(() => {
            if (!location.pathname.includes("/zakazi-novo")) return;
            if (hasMultipleActivities && queryWorkerId && selectedWorker && categories.length > 0 && activeStep === 0) {
              const workerCategoryIds = selectedWorker.serviceCategories?.map(cat => cat.id) || [];
              const workerCategories = categories.filter(cat => workerCategoryIds.includes(cat.id));
          ...
          }, [queryWorkerId, selectedWorker, categories, selectedCategory, activeStep, forceSetStep, hasMultipleActivities, setSelectedCategory, location.pathname]);
          reactExports.useEffect(() => {
            if (!location.pathname.includes("/zakazi-novo")) return;
            const params = new URLSearchParams(location.search);
            ...
            if (activeStep === void 0 || activeStep !== validStep) {
              ...
              formRef.current?.handleSetStep(validStep);
              setTimeout(() => {
                contentRefFunctions?.scrollToTop(50);
              }, 0);
            }
          }, [location.search, hasMultipleActivities, activeStep, setActiveStep, formRef, contentRefFunctions, location.pathname]);
        }
        function useCreateAppointmentSteps({
          ...
          const {
            ...
            skip: !locationData?.serviceCategories?.length
          });
          const categories = reactExports.useMemo(() => {
            const cats = categoriesResult?.data || locationData?.serviceCategories || [];
            return [...cats].sort((a, b) => {
              if (a.sortOrder < b.sortOrder) return -1;
              if (a.sortOrder > b.sortOrder) return 1;
              return 0;
            });
          }, [categoriesResult?.data, locationData?.serviceCategories]);
        ...
        function CreateAppointmentProvider({
          ...
          const appointmentState = useCreateAppointmentSteps({
            appointment
          });
          return /* @__PURE__ */jsxRuntimeExports.jsx(CreateAppointmentContext.Provider, {
        ...
        function useCreateAppointmentContext() {
          ...
          if (context === void 0) {
            throw new Error("useCreateAppointmentContext must be used within CreateAppointmentProvider");
          }
          return context;
        }
        function SelectWorkerStep({
          ...
          const filteredWorkers = React.useMemo(() => {
            ...
            const syncedWorkers = activeWorkers.filter(worker => isWorkerSyncedCategory(worker));
            if (!selectedCategory) {
            ...
            const categoryWorkers = activeWorkers.filter(worker => {
              ...
              return worker.serviceCategories?.some(cat => cat.id === selectedCategory.id);
            });
            const allWorkers = [...syncedWorkers, ...categoryWorkers];
            const uniqueWorkers = allWorkers.filter((worker, index, self) => index === self.findIndex(w => w.id === worker.id));
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsx("h2", {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs(IonItem, {
              ...
              }), filteredWorkers.map(worker => /* @__PURE__ */jsxRuntimeExports.jsxs(IonItem, {
                button: true,
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonAvatar, {
                  ...
                  }), worker.maxDiscountPercent && worker.maxDiscountPercent > 0 && /* @__PURE__ */jsxRuntimeExports.jsxs("p", {
                    className: "text-sm font-bold text-green-600 mt-1",
                    children: ["Do ", worker.maxDiscountPercent, "% popusta"]
                  })]
                }), /* @__PURE__ */jsxRuntimeExports.jsx(IonIcon, {
                  slot: "end",
                  icon: chevronForwardOutline
        ...
        function SelectServiceListItem({
          ...
          const currencyLabel = reactExports.useMemo(() => service.currency === 1 ? "EUR" : "RSD", [service.currency]);
          const priceDisplay = reactExports.useMemo(() => {
            if (hasWorkerSelected) {
              return `${formatPriceSimple(effectivePrice)} ${currencyLabel}`;
            }
            if (service.minPrice && service.maxPrice && service.minPrice !== service.maxPrice) {
              return `od ${formatPriceSimple(service.minPrice)}+ ${currencyLabel}`;
            }
            return `${formatPriceSimple(effectivePrice)} ${currencyLabel}`;
          }, [hasWorkerSelected, effectivePrice, service.minPrice, service.maxPrice, currencyLabel]);
          const durationDisplay = reactExports.useMemo(() => {
            if (hasWorkerSelected) {
              return `${effectiveDuration} min`;
            }
            if (service.minDuration && service.maxDuration && service.minDuration !== service.maxDuration) {
              return `od ${service.minDuration}+ min`;
            }
            return `${effectiveDuration} min`;
          }, [hasWorkerSelected, effectiveDuration, service.minDuration, service.maxDuration]);
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
            ...
            }), isSelected && hasMultiplePersons && selectedService && /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
        ...
        function SelectCategorySwiper({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            className: "w-full",
            children: [showTitle && /* @__PURE__ */jsxRuntimeExports.jsx("h2", {
              className: "px-4 py-2 text-lg font-semibold",
              children: t("Izaberite delatnost")
            }), /* @__PURE__ */jsxRuntimeExports.jsx("div", {
              className: "pl-4",
                ...
                children: categories.map((category, index) => {
                  ...
                  return /* @__PURE__ */jsxRuntimeExports.jsx(SwiperSlide, {
                    ...
                    children: /* @__PURE__ */jsxRuntimeExports.jsx(IonCard, {
                      ...
                      className: `flex flex-col items-center cursor-pointer transition-all m-0 ${isSelected ? "bg-green-500/10 border-b border-b-green-500 border-l-4 border-l-green-500" : ""}`,
                      children: /* @__PURE__ */jsxRuntimeExports.jsxs(IonCardContent, {
                        className: "flex flex-col items-center p-3 relative",
                        children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                          className: "w-20 h-20 rounded-full overflow-hidden mb-2 bg-gray-700 dark:bg-gray-600 flex items-center justify-center text-white",
                          children: categoryImage ? /* @__PURE__ */jsxRuntimeExports.jsx(LazyLoadImgStandard, {
                            src: categoryImage,
                            preloadImg: preloadCoverImg,
                            alt: category.title,
                          ...
                          className: `text-sm font-medium text-center line-clamp-2 ${isSelected ? "text-gray-900 dark:text-white" : "text-gray-900 dark:text-gray-100"}`,
                          children: category.title
                        }), isSelected && /* @__PURE__ */jsxRuntimeExports.jsx(IonIcon, {
        ...
        function useAvailableWorkers({
          ...
          const selectedServiceIds = reactExports.useMemo(() => {
            return groupsSelectedServices.flatMap(group => group.services ?? []).map(service => service.id).filter(id => typeof id === "number");
          }, [groupsSelectedServices]);
          const availableWorkers = reactExports.useMemo(() => {
            ...
            const syncedWorkers = allActiveWorkers.filter(worker => worker.isSyncedService);
            ...
            const uniqueCommonWorkers = commonWorkers.filter((worker, index, self) => index === self.findIndex(w => w.id === worker.id));
            const allAvailableWorkers = [...uniqueCommonWorkers, ...syncedWorkers.filter(syncedWorker => !uniqueCommonWorkers.some(w => w.id === syncedWorker.id))];
        ...
        function SelectAppointmentStepV2({
          ...
          const filteredCategories = reactExports.useMemo(() => {
            ...
            const workerCategoryIds = selectedWorker.serviceCategories?.map(cat => cat.id) || [];
            return availableCategories.filter(cat => workerCategoryIds.includes(cat.id));
          ...
          const filteredServiceGroups = reactExports.useMemo(() => {
            ...
            if (selectedCategory) {
              filtered = filtered.filter(group => {
                return group.serviceCategories?.some(cat => cat.id === selectedCategory.id) ?? false;
              });
            }
            if (!selectedWorker) {
              return filtered;
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            className: "mb-[80px]",
            children: [selectedWorker && /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              className: "px-4 pt-4 pb-2",
              children: [/* @__PURE__ */jsxRuntimeExports.jsx("h2", {
                className: "text-lg font-semibold dark:text-gray-100",
                children: selectedWorker.fullName
              }), selectedWorker.maxDiscountPercent && selectedWorker.maxDiscountPercent > 0 && /* @__PURE__ */jsxRuntimeExports.jsxs("p", {
                className: "text-sm font-bold text-green-600 mt-1",
                children: [t("Do"), " ", selectedWorker.maxDiscountPercent, "% ", t("popusta")]
              })]
            }), showCategorySelection && /* @__PURE__ */jsxRuntimeExports.jsx("div", {
              className: "mb-4",
              children: /* @__PURE__ */jsxRuntimeExports.jsx(SelectCategorySwiper, {
              ...
              children: filteredServiceGroups.map(group => /* @__PURE__ */jsxRuntimeExports.jsxs(IonAccordion, {
                value: `group-${group.id}`,
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonItem, {
                  slot: "header",
                  className: "bg-gray-100 dark:bg-gray-800 border-l-4 border-l-blue-500",
                  children: /* @__PURE__ */jsxRuntimeExports.jsx(IonLabel, {
                    className: "text-center text-xl font-semibold text-gray-800 dark:text-gray-200 py-1 w-full",
                    children: group.title
                  })
                }), /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                  slot: "content",
                  className: "bg-white dark:bg-[var(--ion-background-color)]",
                  children: group.services.map(service => /* @__PURE__ */jsxRuntimeExports.jsx(SelectServiceListItem, {
                    service,
                    serviceGroup: group,
                    onSelectService,
                    groupsSelectedServices,
              ...
              children: /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                ...
                children: categories.map(category => {
                  ...
                  return /* @__PURE__ */jsxRuntimeExports.jsx(IonCard, {
                    ...
                    children: /* @__PURE__ */jsxRuntimeExports.jsxs(IonCardContent, {
                      className: "flex flex-col items-center p-3 relative w-full",
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                        className: "w-20 h-20 rounded-full overflow-hidden mb-2 bg-gray-700 dark:bg-gray-600 flex items-center justify-center text-white",
                        children: categoryImage ? /* @__PURE__ */jsxRuntimeExports.jsx(LazyLoadImgStandard, {
                          src: categoryImage,
        ...
        function EmptyWeekState({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
              ...
              className: "text-2xl font-bold text-center mb-2 text-gray-800 dark:text-gray-100",
              children: isMonthView ? t("Nema slobodnih termina za ovaj mesec") : t("Nema termina za ovu nedelju")
            }), !isMonthView && /* @__PURE__ */jsxRuntimeExports.jsx("p", {
              className: "text-gray-500 dark:text-gray-300 text-center",
              children: t("Pokušajte da izaberete drugu nedelju")
            }), firstAvailableDate && /* @__PURE__ */jsxRuntimeExports.jsx("div", {
              className: "mt-2 text-center",
              children: onFirstAvailableDateClick ? /* @__PURE__ */jsxRuntimeExports.jsxs("button", {
                onClick: onFirstAvailableDateClick,
                className: "text-sm text-blue-600 dark:text-blue-400 hover:underline cursor-pointer",
                children: [t("Prvi slobodan datum"), ":", " ", format(firstAvailableDate, "dd.MM.yyyy")]
              }) : /* @__PURE__ */jsxRuntimeExports.jsxs("p", {
                className: "text-sm text-gray-500 dark:text-gray-400",
                children: [t("Prvi slobodan datum"), ":", " ", format(firstAvailableDate, "dd.MM.yyyy")]
              })
            }), canGoNext && goToNext && /* @__PURE__ */jsxRuntimeExports.jsx("div", {
              className: "mt-6",
              children: /* @__PURE__ */jsxRuntimeExports.jsx(IonButton, {
                color: "primary",
                onClick: goToNext,
                children: isMonthView ? t("Idi na sledeći mesec") : t("Idi na sledeću nedelju")
              })
            })]
          });
        }
        function WorkerSlotsGrid({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsx("div", {
            ...
            children: slots.map(slot => {
              ...
              const isSelected = selectedSlot && selectedSlot.worker.id === worker.id && selectedSlot.date === dateFormatted && (selectedSlot.slot.time === slot.time || selectedSlot.slot.time === `-${slot.time}` || `-${selectedSlot.slot.time}` === slot.time);
              return /* @__PURE__ */jsxRuntimeExports.jsx(IonButton, {
                onClick: () => wrapUserLoginModal(() => onSelectSlot(slot, worker, dateFormatted))?.(),
                fill: "solid",
                size: "default",
        ...
        function DaySlotsContent({
          ...
          const dateDisplay = formatInTimeZone(date, timezone, "dd.MM.yyyy");
          const workersWithSlots = workerSlots.filter(ws => ws.hasSlots);
          const [expandedAccordions, setExpandedAccordions] = reactExports.useState([]);
          const hasInitialized = reactExports.useRef(false);
          reactExports.useEffect(() => {
            if (!hasInitialized.current && workersWithSlots.length > 0) {
              const allValues = workersWithSlots.map(workerSlot => `worker-${workerSlot.workerId}`);
          ...
          if (workersWithSlots.length === 0) {
            return /* @__PURE__ */jsxRuntimeExports.jsx("div", {
              ...
              children: /* @__PURE__ */jsxRuntimeExports.jsx("p", {
                ...
                children: t("Nema slobodnih slotova za ovaj dan")
              })
            });
          }
          return /* @__PURE__ */jsxRuntimeExports.jsx("div", {
            ...
            children: /* @__PURE__ */jsxRuntimeExports.jsx(IonAccordionGroup, {
              ...
              children: workersWithSlots.map(workerSlot => {
                const worker = workersById[workerSlot.workerId];
                if (!worker) return null;
                return /* @__PURE__ */jsxRuntimeExports.jsxs(IonAccordion, {
                  value: `worker-${workerSlot.workerId}`,
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonItem, {
                    slot: "header",
                    ...
                    children: /* @__PURE__ */jsxRuntimeExports.jsxs(IonLabel, {
                      children: [/* @__PURE__ */jsxRuntimeExports.jsxs("h3", {
                        ...
                        children: [dateDisplay, " - ", worker.fullName]
                      }), /* @__PURE__ */jsxRuntimeExports.jsxs("p", {
                        className: "text-sm text-gray-500 dark:text-gray-400",
                        children: [workerSlot.slots.length, " ", t("slobodnih termina")]
                      })]
                    })
                  }), /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                    slot: "content",
                    className: "p-4",
                    children: /* @__PURE__ */jsxRuntimeExports.jsx(WorkerSlotsGrid, {
        ...
        function BookingSlotsSwiper({
          ...
          const monthHasSlots = reactExports.useMemo(() => {
            ...
            return daysWithSlots.some(([dateStr]) => {
              ...
              const dateInAppTz = toZonedTime(date, timezone);
              return dateInAppTz >= calendarStart && dateInAppTz <= calendarEnd;
            });
          ...
          const slides = reactExports.useMemo(() => {
            ...
            if (isCalendarOpen && currentMonth) {
              ...
              const daysInMonthWithSlots = daysWithSlots.filter(([dateStr]) => {
                const date = parseISO(`${dateStr}T00:00:00`);
                const dateInAppTz = toZonedTime(date, timezone2);
                return dateInAppTz >= calendarStart && dateInAppTz <= calendarEnd;
              });
              if (daysInMonthWithSlots.length > 0) {
                daysInMonthWithSlots.forEach(([dateStr]) => {
                  const date = parseISO(`${dateStr}T00:00:00`);
                  const dateObj = toZonedTime(date, timezone2);
                  slidesList.push({
                    type: "day",
                    date: dateStr,
                    dateObj
              ...
              const weekDateStrs = currentWeek.map(d => formatInTimeZone(d, timezone, "yyyy-MM-dd"));
              const daysInWeekWithSlots = daysWithSlots.filter(([dateStr]) => weekDateStrs.includes(dateStr));
            ...
            return slidesList;
          }, [daysWithSlots, hasAnySlots, isCalendarOpen, currentMonth, currentWeek, monthHasSlots, isFirstWeek, today, maxPreparedDate]);
          ...
          const computedFirstAvailableDate = reactExports.useMemo(() => {
            ...
            const entries = Object.entries(activeSlots).filter(([_, slots]) => slots.some(ws => ws.hasSlots));
            if (entries.length === 0) return null;
            const sorted = entries.sort(([a], [b]) => a.localeCompare(b));
            const date = parseISO(`${sorted[0][0]}T00:00:00`);
            return toZonedTime(date, timezone);
          }, [activeSlots, firstAvailableDate, timezone]);
          reactExports.useEffect(() => {
          ...
          if (errorMessage) {
            return /* @__PURE__ */jsxRuntimeExports.jsx("div", {
              className: "min-h-[320px] flex items-center justify-center px-6 text-center",
          ...
          const swiperKey = isCalendarOpen ? `month-${currentMonth?.toISOString()}` : `week-${currentWeek[0].toISOString()}`;
          return /* @__PURE__ */jsxRuntimeExports.jsx("div", {
            ...
            children: /* @__PURE__ */jsxRuntimeExports.jsx(WeekSwiperWrapper, {
              ...
              children: slide => {
                ...
                if (slide.type === "empty-week" || slide.type === "empty-month") {
                  ...
                  return /* @__PURE__ */jsxRuntimeExports.jsx(EmptyWeekState, {
                    currentWeek,
                ...
                if (slide.type === "day" && slide.date && slide.dateObj) {
                  ...
                  return /* @__PURE__ */jsxRuntimeExports.jsx(DaySlotsContent, {
                    date: slide.dateObj,
                    workerSlots,
                    workersById,
                    onSelectSlot,
        ...
        function ReservationModalHeader({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsx(IonHeader, {
            className: isBigScreen ? "px-0" : "px-1",
            color: "warning",
        ...
        function ReservationModalWorkerInfo({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            ...
            children: [worker.avatar?.pathByResolution ? /* @__PURE__ */jsxRuntimeExports.jsx(IonAvatar, {
              ...
              children: /* @__PURE__ */jsxRuntimeExports.jsx(UserAvatar, {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                ...
                className: "text-sm font-medium",
                children: [hasDiscount ? /* @__PURE__ */jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("s", {
                    className: "px-1 opacity-75",
                    children: /* @__PURE__ */jsxRuntimeExports.jsx("span", {
                      children: cost
                    })
                  }), getPriceWithDiscount()]
            ...
            }), selectedServices && selectedServices.length > 0 && /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              className: "flex items-center justify-between",
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                className: "flex items-center gap-2",
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonIcon, {
                ...
                children: selectedServices.map(service => /* @__PURE__ */jsxRuntimeExports.jsx(IonBadge, {
                  color: "warning",
                  className: "text-black whitespace-nowrap flex-shrink-0",
                  children: /* @__PURE__ */jsxRuntimeExports.jsxs(IonLabel, {
                    className: "text-xs font-medium",
                    children: [service.title, service.quantity && service.quantity > 1 ? ` x${service.quantity}` : ""]
                  })
                }, `service-${service.id}`))
              })]
            })]
        ...
        function ReservationModalInfoSwiper({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(SwiperWrapper, {
            slidesPerView: "auto",
            spaceBetween: 12,
            className: "pb-4",
            pagination: {
            ...
            }), selectedServices && selectedServices.length > 0 && selectedServices.map((service, index) => /* @__PURE__ */jsxRuntimeExports.jsx(SwiperSlide, {
              style: {
                width: "auto"
              },
              children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                className: "flex items-center justify-center py-4",
                children: [index === 0 && /* @__PURE__ */jsxRuntimeExports.jsxs("span", {
        ...
        function CreateReservationModal({
          ...
          const handleInputFocus = async () => {
            const currentBreakpoint2 = (await modalRef?.current?.getCurrentBreakpoint()) ?? 0;
            !isBigScreen && currentBreakpoint2 < 0.8 && modalRef?.current?.setCurrentBreakpoint(0.8);
          };
          reactExports.useEffect(() => {
          ...
          const footerClassName = isBigScreen ? void 0 : `fixed left-0 w-full z-[100] ${footerBottomClass}`;
          return /* @__PURE__ */jsxRuntimeExports.jsxs(IonModalExtended, {
            ...
            }), /* @__PURE__ */jsxRuntimeExports.jsx(ReservationModalHeader, {
              formattedDate,
              timeLocal,
              isBigScreen
            }), /* @__PURE__ */jsxRuntimeExports.jsx(IonContent, {
              className: isBigScreen ? "ion-padding" : "",
              children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                className: isBigScreen ? "max-w-2xl mx-auto py-4" : "px-4 py-4",
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(ReservationModalWorkerInfo, {
                  worker
                }), /* @__PURE__ */jsxRuntimeExports.jsx(ReservationModalForm, {
                  form,
                  formFields,
                  onInputFocus: handleInputFocus,
                  isBigScreen
                }), isModalBigScreen || isBigScreen ? /* @__PURE__ */jsxRuntimeExports.jsx(ReservationModalInfoList, {
                  duration,
                  cost,
                  hasDiscount,
                  getPriceWithDiscount,
                  selectedServices
                }) : /* @__PURE__ */jsxRuntimeExports.jsx(ReservationModalInfoSwiper, {
                  duration,
                  cost,
                  hasDiscount,
                  getPriceWithDiscount,
            ...
            }), /* @__PURE__ */jsxRuntimeExports.jsx(ReservationModalFooter, {
        ...
        function BookingCalendarStep({
          ...
          const flattenedServices = reactExports.useMemo(() => {
            const services = selectedGroupServices.flatMap(group => group.services ?? []).filter(Boolean);
            if (selectedSlot?.worker && serviceGroups.length > 0) {
              return services.map(service => {
                ...
                if (originalService?.locationWorkers) {
                  const workerData = originalService.locationWorkers.find(w => w.id === selectedSlot.worker.id);
                  if (workerData?.pivot) {
            ...
            return services;
          }, [selectedGroupServices, selectedSlot?.worker?.id, serviceGroups]);
          const firstAvailableDate = reactExports.useMemo(() => {
            const entries = Object.entries(activeSlots).filter(([_, slots]) => slots.some(ws => ws.hasSlots));
            if (entries.length === 0) return null;
            const timezone = getAppTimezone();
            const todayStr = formatInTimeZone(/* @__PURE__ */new Date(), timezone, "yyyy-MM-dd");
            const sorted = entries.sort(([a], [b]) => a.localeCompare(b));
          ...
          reactExports.useMemo(() => {
            const timezone = getAppTimezone();
            const weekDateStrs = currentWeek.map(d => {
              const dateInUtc = fromZonedTime(d, timezone);
              return formatInTimeZone(dateInUtc, timezone, "yyyy-MM-dd");
            });
          ...
          reactExports.useEffect(() => {
            ...
            const urlDateNormalized = new Date(urlDate.getFullYear(), urlDate.getMonth(), urlDate.getDate());
          ...
          }, [isActive, queryParams.date, isCalendarOpen, currentWeek, canGoNext, goToNext, hasNavigatedToQueryDate]);
          reactExports.useEffect(() => {
          ...
          }, [hasNavigatedToQueryDate, isActive, isLoadingSlots, queryParams.slot, queryParams.date, activeSlots, daysWithSlots, setSelectedDate, handleSelectSlot, workersById]);
          return /* @__PURE__ */jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
            children: [/* @__PURE__ */jsxRuntimeExports.jsx(BookingCalendarHeader, {}), /* @__PURE__ */jsxRuntimeExports.jsx(BookingWeekDays, {}), !isCalendarOpen && /* @__PURE__ */jsxRuntimeExports.jsx("div", {
              ...
              className: "mb-[80px] px-2 py-4",
              children: /* @__PURE__ */jsxRuntimeExports.jsx(BookingSlotsSwiper, {
                onSelectSlot: handleSelectSlot,
                selectedSlot,
                firstAvailableDate
              }, currentWeek[0].toISOString())
            }), selectedSlot && /* @__PURE__ */jsxRuntimeExports.jsx(CreateReservationModal$1, {
              isOpen: isModalOpen,
        ...
        function CreateAppointmentStepsFooter({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(IonFooter, {
            className: "ion-no-border fixed bottom-2 left-0 right-0 space-y-2 bg-black/50 backdrop-blur-sm z-50",
            children: [activeStep === maxStep && allSelectedServices.length > 0 && /* @__PURE__ */jsxRuntimeExports.jsx("div", {
              className: "px-4 py-2 flex gap-2 overflow-x-auto",
              children: allSelectedServices.map(service => /* @__PURE__ */jsxRuntimeExports.jsx(IonBadge, {
                color: "warning",
                className: "text-black whitespace-nowrap flex-shrink-0",
                children: /* @__PURE__ */jsxRuntimeExports.jsxs(IonLabel, {
                  className: "text-xs font-medium",
              ...
              }), activeStep < maxStep && /* @__PURE__ */jsxRuntimeExports.jsxs(IonButton, {
        ...
        function CreateAppointmentStepsContent() {
          ...
          const renderSteps = reactExports.useCallback(() => {
            const categoryStep = hasMultipleActivities ? categoriesLoading || categoriesFetching ? /* @__PURE__ */jsxRuntimeExports.jsx("div", {
              className: "flex items-center justify-center py-10",
              children: /* @__PURE__ */jsxRuntimeExports.jsx(IonSpinner, {})
            }, "category-loading") : /* @__PURE__ */jsxRuntimeExports.jsx(SelectCategoryStep, {
              categories,
              selectedCategory,
              onCategorySelect: handleSelectCategory
            }, "category") : null;
            const workerStep = /* @__PURE__ */jsxRuntimeExports.jsx(SelectWorkerStep, {
              selectedWorker,
            ...
            const serviceStep = serviceGroups && !serviceGroupsLoading ? /* @__PURE__ */jsxRuntimeExports.jsx(SelectAppointmentStepV2, {
              ...
              queryWorkerId
            }, "service") : /* @__PURE__ */jsxRuntimeExports.jsx("div", {
              className: "flex items-center justify-center py-10",
              children: /* @__PURE__ */jsxRuntimeExports.jsx(IonSpinner, {})
            }, "service-loading");
            const workerForCalendar = null;
            const calendarStepNumber = 3;
            const calendarStep = activeStep === calendarStepNumber || activeStep === void 0 ? /* @__PURE__ */jsxRuntimeExports.jsx(BookingCalendarProvider, {
              locationSlug: activeLocation,
              ...
              children: /* @__PURE__ */jsxRuntimeExports.jsx(BookingCalendarStep, {}, `datetime-${queryWorkerId || "all"}-${selectedWorker?.id || "none"}-${allWorkerIds?.join(",") || "all"}`)
            }, `calendar-provider-${queryWorkerId || "all"}-${selectedWorker?.id || "none"}-${allWorkerIds?.join(",") || "all"}`) : /* @__PURE__ */jsxRuntimeExports.jsx("div", {
              className: "flex items-center justify-center py-10",
              children: /* @__PURE__ */jsxRuntimeExports.jsx(IonText, {
                color: "medium",
                children: t("Odaberite radnika kako biste nastavili")
              })
            ...
            calendarStep];
            return steps;
          }, [hasMultipleActivities, categories, categoriesLoading, categoriesFetching, selectedCategory, handleSelectCategory, selectedWorker, handleSelectWorker, queryWorkerId, activeWorkers.length, serviceGroups, serviceGroupsLoading, handleBackStep, handleNextStep, groupsSelectedServices, handleSelectService, hasMultiplePersons, handleHasMultiplePersons, activeLocation, activeStep, allWorkerIds, t]);
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            children: [/* @__PURE__ */jsxRuntimeExports.jsx(FormStepper$1, {
            ...
            }), /* @__PURE__ */jsxRuntimeExports.jsx(CreateAppointmentStepsFooter, {
              activeStep,
              minStep,
              maxStep,
              nextButtonDisabled,
        ...
        function CreateAppointmentSteps({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsx(CreateAppointmentProvider, {
            appointment,
            children: /* @__PURE__ */jsxRuntimeExports.jsx(CreateAppointmentStepsContent, {})
          });
        }
