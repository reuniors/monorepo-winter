;
(function () {
  System.register(['./vendor_react-legacy-VZwyi0Js.js', './vendor_ionic-legacy-DGRHWrdu.js', './App-legacy-6ilZbwqB.js', './index-legacy-Blp5H0fR.js', './location-settings.data-legacy-B1BC2xYE.js', './usePendingImageUploads-legacy-B2DAFkk6.js', './vendor_leaflet-legacy-CfYyL1ry.js', './vendor_firebase-legacy-BVpRmQ4X.js'], function (exports, module) {
    'use strict';

    var O, w, useMap, reactExports, React, jsxRuntimeExports, MapContainer, TileLayer, t, Controller, create$3, create$7, create$6, useTranslation, create$5, create$2, IonModal, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonIcon, closeOutline, IonContent, IonItem, IonFooter, IonText, IonLabel, IonInput, informationCircleOutline, imagesOutline, locationOutline, settingsOutline, useIonRouter, IonSpinner, useUser, FieldType, transformStandardResponseToCamelCase, useShowNotification, useFormWithSchema, DynamicForm, SimpleFormStepperActions, photosArrayWithIdYup, StepIndicator, SimpleFormStepper, useGetFeLocationQuery, activeLocation, preloadedLocationData, rzrApi, TagType, getLocationEditSettingsFormFields, usePendingImageUploads, L;
    return {
      setters: [module => {
        O = module.a$;
        w = module.b0;
        ...
        imagesOutline = module.bt;
        locationOutline = module.bu;
        ...
        useShowNotification = module.G;
        useFormWithSchema = module.s;
        DynamicForm = module.D;
        SimpleFormStepperActions = module.H;
        photosArrayWithIdYup = module.J;
        StepIndicator = module.K;
