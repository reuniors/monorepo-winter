;
(function () {
  System.register(['./vendor_ionic-legacy-DitOK8Rz.js', './vendor_react-legacy-DX-mYdP5.js', './vendor_leaflet-legacy-DW0hIt0g.js'], function (exports, module) {
    'use strict';

    var IonModal, IonIcon, alertCircleOutline, IonButton, IonHeader, IonToolbar, IonTitle, IonButtons, closeOutline, IonContent, IonPage, IonText, __vitePreload, defineCustomElements, instance, Backend, Browser, initReactI18next, fetchBaseQuery, gBase64, createApi, createAction, createSlice, reactExports, useHistory, jsxRuntimeExports, humpsExports, isRejectedWithValue, combineReducers, configureStore, useTranslation, persistStore, persistReducer, FLUSH, REHYDRATE, PAUSE, PERSIST, PURGE, REGISTER, storage, clientExports, Provider, PersistGate, ErrorBoundary;
    return {
      setters: [module => {
        IonModal = module.I;
        IonIcon = module.b;
      ...
      execute: function () {
        ...
        exports({
          y: setLocationSettings,
          x: setLocationHash
        });
        const getActiveLocation = exports("z", state => state.locationSettings.activeLocation);
        const getLocationSettings = exports("A", state => state.locationSettings.settings);
        const getLocationHash = exports("w", state => state.locationSettings.locationHash);
        const getPauseBetweenReservations = exports("H", state => state.locationSettings.settings?.pauseBetweenReservations ?? 0);
        ...
        var TagType = exports("v", /* @__PURE__ */(TagType2 => {
          TagType2["LOCATION"] = "location";
        ...
        var TagId = exports("G", /* @__PURE__ */(TagId2 => {
          TagId2["LIST"] = "LIST";
          return TagId2;
        })(TagId || {}));
        const apiUrl$1 = getInitialData("rzrApiUrl") ?? "/api/v1/rzr";
        const rzrApi = exports("t", createApi({
        ...
        const administrationApi = createApi({
          ...
          endpoints: builder => ({
            ...
            getLocationDetails: builder.query({
              query: id => `/api/v1/admin/locations/${id}`,
        ...
        exports("B", useGetAdminStatsQuery);
        const persistConfig = {
          key: "root",
          storage,
        ...
        const App = reactExports.lazy(() => __vitePreload(() => module.import('./App-legacy-D9i3zTWV.js').then(n => n.aj), false              ? __VITE_PRELOAD__ : void 0));
        initializeTheme();
