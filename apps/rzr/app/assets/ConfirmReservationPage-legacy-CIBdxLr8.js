;
(function () {
  System.register(['./vendor_react-legacy-BZeT-WEv.js', './App-legacy-D_TQFFiD.js', './vendor_ionic-legacy-FEPq4Efg.js', './appointment.constants-legacy-DGLfwUGc.js', './ClientDataModal-legacy-DnVO9GBr.js', './vendor_leaflet-legacy-_lyC0eWM.js', './index-legacy-yzMe94ue.js', './vendor_firebase-legacy-_Nh6fmKA.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        pricetagOutline = module.bh;
        IonTitle = module.j;
        IonBadge = module.b0;
        alertCircleOutline = module.bi;
        hourglassOutline = module.bj;
        helpOutline = module.bk;
        IonButton = module.d;
        IonFooter = module.o;
