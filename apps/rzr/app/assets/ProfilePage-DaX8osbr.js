import { e as reactExports, M as useTranslation, j as jsxRuntimeExports, az as parseISO, aC as format } from "./vendor_react-BAn6__hR.js";
import { U as UserAvatar } from "./UserAvatar-TcZpY00i.js";
import { o as IonSpinner, b2 as IonCard, b4 as IonCardHeader, b5 as IonCardTitle, b3 as IonCardContent, r as IonItem, b as IonIcon, ag as calendarOutline, G as IonLabel, m as IonText, b6 as checkmarkCircleOutline, bw as closeCircleOutline, ah as timeOutline, bE as walletOutline, d as IonButton, an as refreshOutline, bl as IonAccordionGroup, bm as IonAccordion, H as IonList, aj as mailOutline, by as callOutline, a_ as personOutline, af as IonToggle, y as IonSelect, z as IonSelectOption, Q as useIonAlert, u as useIonToast, bJ as pencilOutline } from "./vendor_ionic-BUXN7OTv.js";
import { u as useClipboard, b as useGetClientProfilesQuery, C as ClientStatistics } from "./client-profile.fe-services-BV0waa7F.js";
import { u as useGetFeClientDataQuery, b as useUpdateFeClientDataMutation } from "./client.services-36pN8gwV.js";
import { n as activeLocation, g as urlPrefix, P as Pagination, b as useUser, a as useAppDispatch, c as useAppSelector, d as useRemoveConnectedDeviceMutation, ac as useDeviceNotification, i as isPwa, ad as isInstalled, ae as isWebView, C as ConditionalComponent } from "./App-FZ41U8hJ.js";
import { C as ClientDataModal } from "./ClientDataModal-DOBtZdXA.js";
import { a as useGetWorkerStatisticsQuery } from "./statistics.fe-services-BZQN40MK.js";
import { m as getDeviceData, l as setShowLoginModal, x as getSavedTheme, n as setDeviceData, A as saveTheme, y as applyTheme } from "./index-7S9lYcjM.js";
