;
(function () {
  System.register(['./vendor_react-legacy-B0yst0tN.js', './App-legacy-D5D6TSxV.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        useUpdateServiceGroupMutation = module.Z;
        useCreateServiceGroupMutation = module._;
