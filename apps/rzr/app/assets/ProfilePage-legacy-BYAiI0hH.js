;
(function () {
  System.register(['./vendor_react-legacy-Dr5RK8rs.js', './client-profile.fe-services-legacy-55xgpxDn.js', './vendor_ionic-legacy-BouRDOo5.js', './App-legacy-COHPHKDC.js', './ClientDataModal-legacy-BoCwdbxM.js', './statistics.fe-services-legacy-aRt2oOEJ.js', './Pagination-legacy-DSjEne2Z.js', './index-legacy-BHIGnBEX.js', './vendor_leaflet-legacy-5Hsu9Ykl.js', './vendor_firebase-legacy-DZHWzyZG.js'], function (exports, module) {
    'use strict';

    var reactExports, useTranslation, jsxRuntimeExports, parseISO, format, useClipboard, useGetClientProfilesQuery, UserAvatar, ClientStatistics, IonSpinner, IonCard, IonCardHeader, IonCardTitle, IonCardContent, IonItem, IonIcon, calendarOutline, IonLabel, IonText, checkmarkCircleOutline, closeCircleOutline, timeOutline, walletOutline, IonButton, refreshOutline, IonAccordionGroup, IonAccordion, IonList, mailOutline, callOutline, personOutline, pencilOutline, activeLocation, urlPrefix, useUser, useAppDispatch, useGetFeClientDataQuery, useUpdateFeClientDataMutation, ConditionalComponent, ClientDataModal, useGetWorkerStatisticsQuery, Pagination, setShowLoginModal;
    return {
      setters: [module => {
        ...
        useUpdateFeClientDataMutation = module._;
