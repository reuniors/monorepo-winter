;
(function () {
  System.register(['./vendor_react-legacy-CKjKS6zA.js', './reservation.services-legacy-BdQjb8he.js', './App-legacy-C2qWpZlu.js', './vendor_ionic-legacy-Br2UrGvg.js', './appointment.constants-legacy-DGLfwUGc.js', './logo-square-legacy-CpO8vD1Z.js', './client.services-legacy-BYv-Ls2y.js', './ClientDataModal-legacy-BllrOZx8.js', './vendor_leaflet-legacy-Dzs4-G2p.js', './index-legacy-Dp27OhLW.js', './vendor_firebase-legacy-D-vUgmbk.js'], function (exports, module) {
    'use strict';

    var reactExports, useTranslation, jsxRuntimeExports, parseISO, format, SwiperSlide, t, yup, isPast, addMinutes, useGetOneFeReservationQuery, useUpdateFeReservationMutation, activeLocation, SceletonLoader, fromUtcDateTimeToTime, getPathBySize, SwiperWrapper, useFormWithSchema, DynamicForm, useUser, urlPrefix, ConditionalComponent, IonAlertConfirmation, useQueryParamsHook, LayoutMainPage, IonItem, IonGrid, IonRow, IonCol, IonIcon, calendarClearOutline, calendarOutline, timeOutline, pricetagOutline, IonTitle, IonBadge, alertCircleOutline, hourglassOutline, helpOutline, IonButton, IonFooter, IonToolbar, personOutline, closeCircleOutline, personRemoveOutline, checkmarkCircleOutline, useIonToast, useIonRouter, APPOINTMENT_STATUS_LABELS, AppointmentStatus, LazyLoadImgStandard, preloadCoverImg, useGetFeLocationClientsQuery, useGetFeClientDataQuery, getClientFormFields, getAdministrationClientFormFields, ClientDataModal;
    return {
      setters: [module => {
        ...
        fromUtcDateTimeToTime = module.A;
        ...
        pricetagOutline = module.bt;
        IonTitle = module.h;
        IonBadge = module.b7;
        alertCircleOutline = module.c;
        hourglassOutline = module.bu;
        helpOutline = module.bv;
        IonButton = module.d;
        IonFooter = module.p;
        IonToolbar = module.f;
        personOutline = module.a_;
        closeCircleOutline = module.bw;
        personRemoveOutline = module.bx;
        ...
        function ReservationFooter({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsx(IonFooter, {
            children: /* @__PURE__ */jsxRuntimeExports.jsxs(IonToolbar, {
              color: "light",
              children: [client && client.id ? /* @__PURE__ */jsxRuntimeExports.jsxs(IonButton, {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx(ConditionalComponent, {
                    ...
                    render: () => /* @__PURE__ */jsxRuntimeExports.jsxs(IonButton, {
                      ...
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonIcon, {
                        ...
                        className: "mr-2"
                      }), reservationStatus === AppointmentStatus.DRAFT ? t("Potvrda rezervacije") : t("Potvrdi")]
                    })
                  })]
                })
              })]
        ...
        function ConfirmReservationPage({
          ...
          const handleConfirm = reactExports.useCallback(async () => {
            ...
            try {
              ...
              showSuccessToast({
                message: t("Greška pri potvrdi rezervacije"),
                duration: 3e3,
                color: "danger"
              });
            } finally {
          ...
          }, [clientData, isProcessing, updateReservation, activeLocation, hash, isOwnerOrWorker, refetchReservation, showSuccessToast, t]);
          ...
          const handleClientModalSave = reactExports.useCallback(async data => {
            if (isProcessing) {
              return;
            }
            setIsProcessing(true);
          ...
          }, [isProcessing, isOwnerOrWorker, updateReservation, activeLocation, hash, refetchReservation, showSuccessToast, t]);
          return /* @__PURE__ */jsxRuntimeExports.jsxs(LayoutMainPage, {
            ...
            showLoadingMessage: updateReservationResult.isLoading || isProcessing,
