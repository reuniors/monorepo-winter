;
(function () {
  System.register(['./vendor_react-legacy-BvXhJo_m.js', './vendor_ionic-legacy-dqJd8vxA.js', './App-legacy-6uxV_yyL.js', './workingShift.fe-services-legacy-D9RExapt.js', './vendor_leaflet-legacy-DGSDSOBP.js', './index-legacy-BNd-0eI_.js', './vendor_firebase-legacy-G_df00wk.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        IonCol = module.C;
        IonIcon = module.l;
        closeCircle = module.bH;
        checkmarkCircle = module.bd;
        IonButton = module.d;
        notificationsOffOutline = module.bI;
