import { av as parseISO, bb as parse, aQ as addMinutes, bc as isWithinInterval, bd as differenceInMinutes, ay as format, aw as formatInTimeZone, e as reactExports, j as jsxRuntimeExports, af as SwiperSlide, aU as addDays, aD as useTranslation, R as React, aY as startOfDay, ax as toZonedTime, aR as startOfMonth } from "./vendor_react-DSVIR5Ln.js";
import { aj as useIonRouter, n as IonSpinner, l as IonIcon, bc as cashOutline, be as chevronDownOutline, bf as chevronUpOutline } from "./vendor_ionic-DMW4l-HL.js";
import { o as useContentRefFunctions, S as SwiperWrapper, h as useGetFeWorkersQuery, j as activeLocation, f as urlPrefix, m as getAppTimezone, n as fromUtcHM, _ as getUtcDateFormattedInTz, $ as parseUtcDate, k as SceletonLoader } from "./App-DmsCuVFw.js";
import { d as useGetFeWorkerWorkingShiftsByDaysQuery } from "./workingShift.fe-services-BtncF0Ie.js";
import { e as useGetFeLocationReservationsQuery } from "./reservation.services-dVmxAOB6.js";
import { g as generateWeek, i as isToday, B as BookingCalendarHeader, b as BookingWeekDays } from "./BookingWeekDays-DcRXSDJW.js";
...
function TableOfReservationsV2({
  ...
  reactExports.useEffect(() => {
    if (!isCalendarOpen && timeSlots && timeSlots.length > 0 && !hasWeekSlots) {
      setIsCalendarOpen(true);
      setCurrentMonth(startOfMonth(selectedDate));
    }
  }, [isCalendarOpen, timeSlots, hasWeekSlots, selectedDate]);
