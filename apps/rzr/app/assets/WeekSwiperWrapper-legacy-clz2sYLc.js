;
(function () {
  System.register(['./vendor_react-legacy-BaDeiZwt.js', './vendor_ionic-legacy-SgrmjcUd.js', './index-legacy-C6EIpnD8.js', './App-legacy-JMmm2B38.js', './workingShift.fe-services-legacy-DM52KikF.js', './reservation.services-legacy-UefSX0Q4.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        reservationTimeInterval = module.X;
        getUtcDateFormattedInTz = module.Y;
        parseUtcDate = module.Z;
      ...
      execute: function () {
        ...
        function generateSlotsInGap(gapStart, gapEnd, totalServiceDuration, pauseBetweenReservations, slotInterval, slots, originalGapStart) {
          ...
          const gapStartMinutes = currentSlot.getMinutes();
          if (gapStartMinutes % 5 !== 0) {
            const roundedMinutes = Math.ceil(gapStartMinutes / 5) * 5;
