;
(function () {
  System.register(['./vendor_react-legacy-J-9YdXs8.js', './reservation.services-legacy-Cz9k_Ucr.js', './App-legacy-J1QG38FO.js', './vendor_ionic-legacy-qIZJoxql.js', './appointment.constants-legacy-DGLfwUGc.js', './logo-square-legacy-DlFrQXHe.js', './client.services-legacy-0HM2ct5Q.js', './ClientDataModal-legacy-CaFfNItY.js', './vendor_leaflet-legacy-CcTkPRIU.js', './index-legacy-1AgAoADQ.js', './vendor_firebase-legacy-DUkuu2E4.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        pricetagOutline = module.bq;
        IonTitle = module.j;
        IonBadge = module.b4;
        alertCircleOutline = module.br;
        hourglassOutline = module.bs;
        helpOutline = module.bt;
        IonButton = module.d;
        IonFooter = module.o;
        IonToolbar = module.i;
        personOutline = module.aX;
        closeCircleOutline = module.bu;
        personRemoveOutline = module.bv;
