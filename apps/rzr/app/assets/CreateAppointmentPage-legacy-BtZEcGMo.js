;
(function () {
  System.register(['./vendor_react-legacy-CSf8zLqi.js', './App-legacy-CRCzN3kk.js', './vendor_ionic-legacy-DvZl6sBE.js', './logo-square-legacy-CNLw0Iju.js', './WeekSwiperWrapper-legacy-C3kE3u9U.js', './reservation.services-legacy-CldIEcKG.js', './client.services-legacy-Ch6ABiwa.js', './UserAvatar-legacy-C_StkUBM.js', './index-legacy-CYMNsaJ2.js', './vendor_leaflet-legacy-DUCVU90d.js', './vendor_firebase-legacy-tNokQwyN.js', './workingShift.fe-services-legacy-BYipkkLk.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        IonButton = module.d;
        checkmarkCircle = module.bw;
        addOutline = module.aa;
        trashOutline = module.S;
        removeOutline = module.bx;
        IonCard = module.b5;
        IonCardContent = module.b6;
        IonToggle = module.af;
        IonAccordionGroup = module.by;
        IonAccordion = module.bz;
        ...
        cashOutline = module.bA;
        IonBadge = module.ba;
        IonFooter = module.p;
        closeOutline = module.j;
        calendarClearOutline = module.bB;
        useIonRouter = module.ao;
        useIonToast = module.u;
        IonLoading = module.al;
        IonContent = module.k;
        chevronDownOutline = module.bC;
        chevronUpOutline = module.bD;
        arrowBack = module.bc;
        arrowForward = module.bE;
      }, module => {
