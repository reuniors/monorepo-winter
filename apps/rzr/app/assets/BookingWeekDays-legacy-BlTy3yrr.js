;
(function () {
  System.register(['./vendor_react-legacy-yeQ-Nqpl.js', './vendor_ionic-legacy-DdPNGOLm.js', './index-legacy-Bog12BrJ.js', './App-legacy-DRWtf8eI.js', './workingShift.fe-services-legacy-rrzAqfKK.js', './reservation.services-legacy-DqdYtBVh.js'], function (exports, module) {
    'use strict';

    var addDays, isToday$1, startOfDay, parseISO, addMinutes, toZonedTime, fromZonedTime, formatInTimeZone, reactExports, startOfMonth, startOfWeek, endOfWeek, format, isSameDay, subMonths, addMonths, endOfMonth, jsxRuntimeExports, parse, isWithinInterval, differenceInMinutes, isSameMonth, SwiperSlide, useTranslation, IonToolbar, IonButton, IonIcon, calendarOutline, IonSpinner, chevronUpOutline, chevronDownOutline, IonButtons, chevronBackOutline, chevronForwardOutline, rzrApi, TagType, transformStandardResponseToCamelCase, getAppTimezone, useGetFeWorkersQuery, reservationTimeInterval, getUtcDateFormattedInTz, parseUtcDate, SwiperWrapper, useGetFeWorkerWorkingShiftsByDaysQuery, useGetFeLocationReservationsQuery;
    return {
      setters: [module => {
        addDays = module.aT;
        isToday$1 = module.b2;
      ...
      execute: function () {
        exports({
          ...
          a: BookingWeekDays,
          b: BookingCalendarProvider,
          c: useReservationCalendarContext,
          g: generateWeek,
        ...
        function useBookingCalendar({
          ...
          reactExports.useEffect(() => {
            if (!isCalendarOpen || !currentMonth || !selectedDate) return;
            const selectedDateMonth = startOfMonth(selectedDate);
            const currentMonthStart = startOfMonth(currentMonth);
            if (selectedDateMonth.getFullYear() !== currentMonthStart.getFullYear() || selectedDateMonth.getMonth() !== currentMonthStart.getMonth()) {
              const monthStart = startOfMonth(currentMonth);
          ...
          }, [isCalendarOpen, currentMonth, selectedDate, daysWithSlots]);
          return {
            // State
            currentWeek,
            currentMonth,
                ...
                return /* @__PURE__ */jsxRuntimeExports.jsx(SwiperSlide, {
                  children: /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                    ...
                    children: monthWeeks.map((week, weekIndex) => /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                      ...
                      children: week.map((date, dayIndex) => date ? /* @__PURE__ */jsxRuntimeExports.jsx(DayButton, {
                        date,
                        selectedDate,
                        daysWithSlots,
                        currentMonth,
                        ...
                        isMonthView: true,
                        onSelectDate: onSelectDate || (() => {})
                      }, date.toISOString()) : /* @__PURE__ */jsxRuntimeExports.jsx("div", {
