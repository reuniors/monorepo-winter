;
(function () {
  System.register(['./vendor_react-legacy-j-OXaHGn.js', './reservation.services-legacy-aHhYDCMQ.js', './App-legacy-C1PSXo8s.js', './vendor_ionic-legacy-B27OJI2l.js', './appointment.constants-legacy-DGLfwUGc.js', './logo-square-legacy-CgijpkVK.js', './client.services-legacy-CgH53VbP.js', './ClientDataModal-legacy-Bt4gOYOl.js', './useQueryParamsHook-legacy-C0RsEtHL.js', './vendor_leaflet-legacy-aVamlEE1.js', './index-legacy-DzaXWAZQ.js', './vendor_firebase-legacy-BLL9XPHC.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        pricetagOutline = module.bi;
        IonTitle = module.j;
        IonBadge = module.aY;
        alertCircleOutline = module.bj;
        hourglassOutline = module.bk;
        helpOutline = module.bl;
        IonButton = module.d;
        IonFooter = module.o;
