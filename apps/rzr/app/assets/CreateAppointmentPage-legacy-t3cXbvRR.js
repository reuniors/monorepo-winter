;
(function () {
  System.register(['./vendor_react-legacy-VZwyi0Js.js', './App-legacy-6ilZbwqB.js', './vendor_ionic-legacy-DGRHWrdu.js', './logo-square-legacy-CMF14YsM.js', './BookingWeekDays-legacy-BmhNNQZt.js', './index-legacy-Blp5H0fR.js', './reservation.services-legacy-BEpz_6mz.js', './client.services-legacy-BlJqajpF.js', './UserAvatar-legacy-BnhNXGU_.js', './useQueryParamsHook-legacy-DUnWRYhF.js', './vendor_leaflet-legacy-CfYyL1ry.js', './vendor_firebase-legacy-BVpRmQ4X.js'], function (exports, module) {
    'use strict';

    var reactExports, jsxRuntimeExports, SwiperSlide, useTranslation, React, parseISO, addMinutes, toZonedTime, fromZonedTime, formatInTimeZone, startOfMonth, startOfWeek, endOfMonth, addDays, format, startOfDay, isSameDay, subMonths, addMonths, isSameMonth, yup, useLocation, useHistory, useDefaultProps, useConfirmationAlert, SwiperWrapper, useGetFeWorkersQuery, activeLocation, SceletonLoader, getPathBySize, transformStandardResponseToCamelCase, getAppTimezone, reservationTimeInterval, fromUtcHM, useContentRefFunctions, FieldType, useUser, useIsBigScreen, useFormWithSchema, urlPrefix, pushDuplicateAndNavigate, IonModalExtended, DynamicForm, ConditionalComponent, toUtc, NotificationToast, useGetFeLocationQuery, preloadedLocationData, useGetFeServiceCategoriesQuery, useGetFeServiceGroupsQuery, useAppDispatch, useAppSelector, IonList, IonItem, IonAvatar, IonIcon, peopleOutline, IonLabel, chevronForwardOutline, IonButton, checkmarkCircle, addOutline, trashOutline, removeOutline, IonCard, IonCardContent, IonToggle, IonAccordionGroup, IonAccordion, calendarOutline, IonText, IonSpinner, useIonRouter, useIonToast, IonLoading, IonHeader, IonToolbar, IonTitle, IonContent, IonGrid, IonRow, IonCol, IonBadge, timeOutline, cashOutline, IonFooter, closeOutline, calendarClearOutline, chevronDownOutline, chevronUpOutline, arrowBack, arrowForward, useIonViewDidLeave, LazyLoadImgStandard, preloadCoverImg, generateWeek, hasAnySlotsInWeek, getDaysWithSlotsSet, BookingCalendarHeader, BookingWeekDays, rzrApi, TagType, getDeviceData, setDeviceData, useCreateFeReservationMutation, useGetFePromoCodeDataQuery, useGetFeClientDataQuery, UserAvatar, useQueryParamsHook;
    return {
      setters: [module => {
        ...
        reservationTimeInterval = module.r;
        fromUtcHM = module.o;
        ...
        urlPrefix = module.f;
        pushDuplicateAndNavigate = module.v;
        ...
        IonButton = module.d;
        checkmarkCircle = module.bc;
        addOutline = module.a6;
        trashOutline = module.O;
        removeOutline = module.bd;
        IonCard = module.aX;
        ...
        calendarClearOutline = module.bh;
        chevronDownOutline = module.bi;
        chevronUpOutline = module.bj;
        arrowBack = module.bk;
        arrowForward = module.bl;
        useIonViewDidLeave = module.aU;
      }, module => {
        LazyLoadImgStandard = module.L;
        preloadCoverImg = module.p;
      }, module => {
        generateWeek = module.g;
        hasAnySlotsInWeek = module.h;
        getDaysWithSlotsSet = module.a;
      ...
      execute: function () {
                    ...
                    children: /* @__PURE__ */jsxRuntimeExports.jsx(IonCard, {
                      ...
                      children: /* @__PURE__ */jsxRuntimeExports.jsxs(IonCardContent, {
                        ...
                        children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                          ...
                          className: `text-sm font-medium text-center line-clamp-2 ${isSelected ? "text-white" : ""}`,
        ...
        function SelectAppointmentStepV2({
          ...
          reactExports.useEffect(() => {
            const allValues = filteredServiceGroups.map(g => `group-${g.id}`);
            ...
            children: [selectedWorker && /* @__PURE__ */jsxRuntimeExports.jsx("h2", {
              ...
              children: filteredServiceGroups.map(group => /* @__PURE__ */jsxRuntimeExports.jsxs(IonAccordion, {
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonItem, {
                  ...
                  children: /* @__PURE__ */jsxRuntimeExports.jsx(IonLabel, {
                    className: "text-base font-semibold text-gray-800 dark:text-gray-200 py-1",
        ...
        function SelectCategoryAndWorkerStep({
          ...
          const filteredCategories = reactExports.useMemo(() => {
            if (predefinedWorker) {
              ...
              const workerCategoryIds = predefinedWorker.serviceCategories?.map(cat => cat.id) || [];
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            className: "w-full",
            children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
              className: showWorkerSelection ? "mb-6" : "",
              children: /* @__PURE__ */jsxRuntimeExports.jsx(SelectCategorySwiper, {
                categories: filteredCategories,
                selectedCategory,
                onCategorySelect,
            ...
            }), showWorkerSelection && /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              children: [/* @__PURE__ */jsxRuntimeExports.jsx("h2", {
                className: "px-4 py-2 text-lg font-semibold",
                children: t("Izaberite radnika")
              }), /* @__PURE__ */jsxRuntimeExports.jsxs(IonList, {
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs(IonItem, {
                  ...
                  disabled: activeWorkersCount === 1,
                  lines: "none",
                  className: `mb-2 ${selectedWorker === null ? "bg-green-500/10 border-b border-b-green-500 border-l-4 border-l-green-500" : "border-b border-b-gray-600/60 dark:border-b-gray-600/70 border-l-4 border-l-gray-500 dark:border-l-gray-500"}`,
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonAvatar, {
                    slot: "start",
                    className: "w-14 h-14 rounded-full",
                    children: /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                  ...
                  }), selectedWorker === null ? /* @__PURE__ */jsxRuntimeExports.jsx(IonIcon, {
                    slot: "end",
                    icon: checkmarkCircle,
                    className: "text-3xl",
                    style: {
                ...
                }), filteredWorkers.length === 0 ? /* @__PURE__ */jsxRuntimeExports.jsx(IonItem, {
                  children: /* @__PURE__ */jsxRuntimeExports.jsx(IonLabel, {
                    children: /* @__PURE__ */jsxRuntimeExports.jsx("p", {
                      className: "text-gray-500",
                      children: t("Nema radnika za izabranu delatnost")
                    })
                  })
                }) : filteredWorkers.map(worker => {
                  const isWorkerSelected = selectedWorker?.id === worker.id;
                  return /* @__PURE__ */jsxRuntimeExports.jsxs(IonItem, {
                    button: true,
                    onClick: handleSelectWorker(worker),
                    detail: false,
                    lines: "none",
                    className: `mb-2 ${isWorkerSelected ? "bg-green-500/10 border-b border-b-green-500 border-l-4 border-l-green-500" : "border-b border-b-gray-600/60 dark:border-b-gray-600/70 border-l-4 border-l-gray-500 dark:border-l-gray-500"}`,
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonAvatar, {
                      slot: "start",
                      className: "w-14 h-14 rounded-full",
                      children: /* @__PURE__ */jsxRuntimeExports.jsx(LazyLoadImgStandard, {
                    ...
                    }), isWorkerSelected ? /* @__PURE__ */jsxRuntimeExports.jsx(IonIcon, {
                      slot: "end",
                      icon: checkmarkCircle,
                      className: "text-3xl",
                      style: {
        ...
        function useBookingCalendar({
            ...
            if (gapsData?.data) {
              ...
              datesToProcess.forEach(date => {
                ...
                Object.entries(gapsByWorker).forEach(([workerIdStr, workerGaps]) => {
                  ...
                  const slots = generateSlotsFromGaps(gapsToUse, selectedServices, reservationTimeInterval, void 0,
                  // Use default pause
                  30
                  // delay in minutes
                  );
                ...
                if (workersData?.data) {
                  workersData.data.forEach(worker2 => {
                    const hasWorker = workerSlots.some(ws => ws.worker.id === worker2.id);
                    if (!hasWorker) {
                      workerSlots.push({
                        worker: worker2,
                        slots: [],
          ...
          }, [gapsData, selectedServices, datesToProcess, workersById, workersData, isCalendarOpen, currentMonth]);
          const hasAnySlots = reactExports.useMemo(() => hasAnySlotsInWeek(weekSlots), [weekSlots]);
          const daysWithSlots = reactExports.useMemo(() => getDaysWithSlotsSet(weekSlots), [weekSlots]);
          ...
          reactExports.useEffect(() => {
            ...
            if (!hasSlots) {
              ...
              const entries = Object.entries(weekSlots).filter(([_, slots]) => slots.some(ws => ws.hasSlots));
        ...
        function DaySlotsContent({
          ...
          const accordionValues = workersWithSlots.map(workerSlot => `worker-${workerSlot.worker.id}`);
          return /* @__PURE__ */jsxRuntimeExports.jsx("div", {
            className: "px-2",
        ...
        function BookingSlotsSwiper({
          ...
          const isChangingMonthOrWeekRef = reactExports.useRef(false);
          const isFirstWeek = reactExports.useMemo(() => {
          ...
          const slides = reactExports.useMemo(() => {
            ...
            return slidesList;
          }, [daysWithSlots, isFirstWeek, hasAnySlots, isCalendarOpen, currentMonth, monthHasSlots]);
          const selectedDateStr = format(selectedDate, "yyyy-MM-dd");
          const activeSlideIndex = reactExports.useMemo(() => {
            if (isCalendarOpen && currentMonth) {
              if (!monthHasSlots) {
                const emptyWeekIndex = slides.findIndex(slide => slide.type === "empty-week");
                return emptyWeekIndex >= 0 ? emptyWeekIndex : 0;
              }
          ...
          }, [slides, selectedDateStr, isFirstWeek, hasAnySlots, isCalendarOpen, currentMonth, monthHasSlots, daysWithSlots]);
          ...
          const prevActiveSlideIndexRef = reactExports.useRef(activeSlideIndex);
          const prevCurrentMonthRef = reactExports.useRef(currentMonth);
          const prevIsCalendarOpenRef = reactExports.useRef(isCalendarOpen);
          reactExports.useEffect(() => {
            if (!swiperRef.current?.swiper) return;
            const activeSlideIndexChanged = prevActiveSlideIndexRef.current !== activeSlideIndex;
            const monthChanged = prevCurrentMonthRef.current !== currentMonth;
            const modeChanged = prevIsCalendarOpenRef.current !== isCalendarOpen;
            prevActiveSlideIndexRef.current = activeSlideIndex;
            prevCurrentMonthRef.current = currentMonth;
            prevIsCalendarOpenRef.current = isCalendarOpen;
            if (!activeSlideIndexChanged && !monthChanged && !modeChanged) {
              return;
            }
          ...
          }, [activeSlideIndex, currentWeek, currentMonth, isCalendarOpen, slides.length]);
          ...
          const handleSlideChange = swiper => {
            if (isChangingMonthOrWeekRef.current) {
              return;
            }
            ...
            if (isCalendarOpen && currentMonth) {
              if (activeSlide.type === "prev-month") {
                const today = startOfDay(toZonedTime(/* @__PURE__ */new Date(), timezone));
                const todayMonth = startOfMonth(today);
                const currentMonthStart = startOfMonth(currentMonth);
                if (currentMonthStart <= todayMonth) {
                  requestAnimationFrame(() => {
                    if (swiperRef.current?.swiper) {
                      const firstDayIndex = slides.findIndex(slide => slide.type === "day" || slide.type === "empty-week");
                      if (firstDayIndex >= 0) {
                        swiper.slideTo(firstDayIndex, 0);
                      }
                    }
                  });
                  return;
                ...
                if (onMonthChange) {
                  isChangingMonthOrWeekRef.current = true;
                  const prevMonth = startOfMonth(subMonths(currentMonth));
                  onMonthChange(prevMonth);
                  setTimeout(() => {
                    scrollToTopIfNeeded();
                    isChangingMonthOrWeekRef.current = false;
                  }, 300);
                }
                return;
              }
              if (activeSlide.type === "next-month") {
                if (onMonthChange) {
                  isChangingMonthOrWeekRef.current = true;
          ...
          const handleSlideChangeTransitionEnd = swiper => {
            ...
            if (currentSlide && (currentSlide.type === "prev-month" || currentSlide.type === "next-month")) {
              const targetIndex = monthHasSlots ? slides.findIndex(slide => slide.type === "day") : slides.findIndex(slide => slide.type === "empty-week");
            ...
            children: /* @__PURE__ */jsxRuntimeExports.jsx(SwiperWrapper, {
              ...
              children: slides.map((slide, index) => {
                ...
                if (slide.type === "empty-week") {
                  const handleFirstAvailableDateClick = computedFirstAvailableDate ? () => {
                    if (onDateChange && computedFirstAvailableDate) {
                      ...
                      setTimeout(() => {
                        const dateStr = format(computedFirstAvailableDate, "yyyy-MM-dd");
                        const targetIndex = slides.findIndex(s => s.type === "day" && s.date === dateStr);
                        if (targetIndex >= 0 && swiperRef.current?.swiper) {
                  ...
                  return /* @__PURE__ */jsxRuntimeExports.jsx(SwiperSlide, {
                    children: /* @__PURE__ */jsxRuntimeExports.jsx(EmptyWeekState, {
                      currentWeek,
                ...
                if (slide.type === "day" && slide.date) {
                  ...
                  return /* @__PURE__ */jsxRuntimeExports.jsx(SwiperSlide, {
                    children: /* @__PURE__ */jsxRuntimeExports.jsx(DaySlotsContent, {
                      date: slide.dateObj,
                      workerSlots,
                      onSelectSlot,
                      selectedServices,
        ...
        function CreateReservationModal({
          ...
          const handleInputFocus = () => {
            !isBigScreen && modalRef?.current?.setCurrentBreakpoint(0.8);
          };
          reactExports.useEffect(() => {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(IonModalExtended, {
            ...
            children: [createReservationResponse.isLoading && /* @__PURE__ */jsxRuntimeExports.jsx(IonLoading, {
              ...
              children: /* @__PURE__ */jsxRuntimeExports.jsx(IonToolbar, {
                ...
                children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [worker.avatar?.pathByResolution ? /* @__PURE__ */jsxRuntimeExports.jsx(IonAvatar, {
                    ...
                    className: `${isBigScreen ? "text-xl font-semibold" : ""} flex-1`,
                    children: worker.fullName
                  })]
                })
              })
              ...
              children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                className: isBigScreen ? "max-w-2xl mx-auto py-4" : "",
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs("h3", {
                  className: "text-2xl font-semibold mb-4",
                  children: [formattedDate, " ", timeLocal]
                  ...
                  children: /* @__PURE__ */jsxRuntimeExports.jsxs(IonRow, {
                    className: isBigScreen ? "gap-4" : "",
                    children: [/* @__PURE__ */jsxRuntimeExports.jsxs(IonCol, {
                      size: isModalBigScreen ? "12" : "6",
                      className: `flex items-center ${isBigScreen ? "justify-start gap-3" : isModalBigScreen ? "justify-between" : "justify-between"}`,
                      children: [isBigScreen && /* @__PURE__ */jsxRuntimeExports.jsxs("span", {
                      ...
                      size: isModalBigScreen ? "12" : "6",
                      className: `flex items-center ${isBigScreen ? "justify-start gap-3" : isModalBigScreen ? "justify-between" : "justify-end"}`,
                      children: [isBigScreen && /* @__PURE__ */jsxRuntimeExports.jsxs("span", {
                        className: "text-sm font-medium",
                        children: [t("Cena"), ":"]
                      }), /* @__PURE__ */jsxRuntimeExports.jsx(ConditionalComponent, {
        ...
        function BookingCalendarStep({
          ...
          }, [locationWorker?.id, workerIds, selectedCategory?.id]);
          reactExports.useEffect(() => {
          ...
          }, [isCalendarOpen, isFirstWeek, isLoadingSlots, weekSlots, hasWeekSlots, toggleCalendar, selectedDate, handleMonthChange]);
          ...
          }, [isActive, isLoadingSlots, queryParams.slot, queryParams.date, weekSlots, daysWithSlots, setSelectedDate, handleSelectSlot, deleteQueryParams]);
          return /* @__PURE__ */jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
        ...
        function CreateAppointmentSteps({
          ...
          const nextButtonDisabled = reactExports.useMemo(() => {
            ...
            return true;
          }, [activeStep, selectedWorker, selectedCategory, groupsSelectedServices, locationHasCategories]);
          ...
          }, [locationHasCategories, queryWorkerId, selectedWorker, categories, selectedCategory, activeStep, forceSetStep]);
          reactExports.useEffect(() => {
            const params = new URLSearchParams(location.search);
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            children: [/* @__PURE__ */jsxRuntimeExports.jsx(FormStepper$1, {
              ...
              renderSteps: () => {
                const categoryAndWorkerStep = locationHasCategories ? /* @__PURE__ */jsxRuntimeExports.jsx(SelectCategoryAndWorkerStep, {
                  categories,
                  selectedCategory,
                ...
                }, "category-worker") : /* @__PURE__ */jsxRuntimeExports.jsx(SelectWorkerStep, {
                  selectedWorker,
                  setSelectedWorker: handleSelectWorker,
                  workerId: selectedWorker ? void 0 : queryWorkerId,
                  activeWorkersCount: activeWorkers.length,
                ...
                const calendarStep = /* @__PURE__ */jsxRuntimeExports.jsx(BookingCalendarStep, {
                  locationWorker: workerForCalendar,
                  workerIds: allWorkerIds,
                  selectedGroupServices: groupsSelectedServices,
                  selectedCategory,
                  isActive: activeStep === 2
                }, `datetime-${queryWorkerId || "all"}-${selectedWorker?.id || "none"}`);
                /* @__PURE__ */
            ...
            }), activeStep !== void 0 && activeStep > 0 && /* @__PURE__ */jsxRuntimeExports.jsxs(IonFooter, {
              className: "ion-no-border fixed bottom-2 left-0 right-0 space-y-2",
              children: [activeStep === 2 && allSelectedServices.length > 0 && /* @__PURE__ */jsxRuntimeExports.jsx("div", {
