;
(function () {
  System.register(['./vendor_react-legacy-C8AS9NmP.js', './vendor_ionic-legacy-CuGnV08n.js', './App-legacy-7GAegB_G.js', './index-legacy-C87uIFki.js', './vendor_leaflet-legacy-B9TijiPT.js', './vendor_firebase-legacy-CxYHnyKv.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        fromUtcHM = module.l;
        FieldType = module.F;
        useGetFeWorkersQuery = module.m;
        IonModalExtended = module.I;
        DynamicForm = module.D;
        ModalActionButtons = module.M;
