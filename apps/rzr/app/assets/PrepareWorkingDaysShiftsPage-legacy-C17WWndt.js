;
(function () {
  System.register(['./vendor_react-legacy-BZeT-WEv.js', './vendor_ionic-legacy-FEPq4Efg.js', './App-legacy-D_TQFFiD.js', './workingShift.fe-services-legacy-BlW288Ca.js', './vendor_leaflet-legacy-_lyC0eWM.js', './index-legacy-yzMe94ue.js', './vendor_firebase-legacy-_Nh6fmKA.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        differenceInCalendarMonths = module.b8;
        getMonth = module.b9;
        startOfMonth = module.aO;
        addDays = module.aK;
        endOfMonth = module.aQ;
        eachDayOfInterval = module.ba;
        format = module.ay;
        subMonths = module.aR;
        addMonths = module.aS;
      }, module => {
        ...
        IonCol = module.C;
        IonIcon = module.l;
        closeCircle = module.bB;
        checkmarkCircle = module.aS;
        IonButton = module.d;
        notificationsOffOutline = module.bC;
