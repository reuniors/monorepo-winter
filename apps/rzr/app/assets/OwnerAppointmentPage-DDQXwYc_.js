import { j as jsxRuntimeExports, aC as format, e as reactExports, M as useTranslation, aA as formatInTimeZone, az as parseISO, R as React, aP as startOfMonth, aQ as endOfMonth, aR as startOfWeek, aS as addDays } from "./vendor_react-BAn6__hR.js";
import { d as useReservationCalendarContext, a as BookingCalendarHeader, b as BookingWeekDays, W as WeekSwiperWrapper, R as ReservationCalendarProvider } from "./WeekSwiperWrapper-Da6ysi6v.js";
import { b as IonIcon, bp as chevronDownOutline, bq as chevronUpOutline, ao as useIonRouter, o as IonSpinner, bn as cashOutline } from "./vendor_ionic-BUXN7OTv.js";
import { q as useGetFeWorkersQuery, n as activeLocation, g as urlPrefix, v as getAppTimezone, t as fromUtcHM, r as SceletonLoader, l as useQueryParamsHook, o as useGetFeServiceCategoriesQuery } from "./App-DgEFOGIF.js";
import { a as AppointmentStatus } from "./appointment.constants-BtYyqQzh.js";
import { a as getReservationUrlWithSlot } from "./reservation.helpers-CjZfzeFf.js";
import "./vendor_leaflet-DChmu6Ei.js";
import "./index-C-Ek-ef-.js";
import "./workingShift.fe-services-DMIcJqUW.js";
import "./reservation.services-CvtFItmK.js";
...
function CalendarModeToggle({
  ...
  if (!isCalendarOpen) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-center justify-center pb-1", children: [
      formattedDate && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-4 text-xs text-gray-500 dark:text-gray-400", children: formattedDate }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full px-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-gray-200 dark:divide-gray-700 relative", children: selectedDateSlots.map((timeSlotInfo, index) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(React.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "py-2 transition-colors duration-200 relative ".concat(reservation ? "hover:bg-gray-50 dark:hover:bg-gray-800" : timeSlotInfo.isPause ? "bg-gray-100 dark:bg-gray-800 border-l-4 border-gray-400 dark:border-gray-500" : "hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer"),
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between px-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-4 w-full", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 w-full", children: reservation ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                ReservationItem$1,
                {
                  reservation,
                  heightStyle: getStyleFromReservation(actualTime)
                }
              ) : timeSlotInfo.isPause ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
...
function ReservationSlideContent({
  ...
  if (slide.type === "day" && slide.date && slide.dateObj) {
    const dayIndex = slideTimeSlots.findIndex(
    ...
    if (isCalendarOpen && currentMonth) {
      ...
      if (!monthHasSlots) {
        const emptyIndex = slides.findIndex(
          (slide) => slide.type === "empty-week" || slide.type === "empty-month"
        );
...
function TableOfReservationsV2() {
  ...
  const displayDate = reactExports.useMemo(() => {
    ...
    if ((activeSlide == null ? void 0 : activeSlide.type) === "day" && activeSlide.dateObj) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(BookingWeekDays, { selectedDate: displayDate }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      CalendarModeToggle,
      {
        isCalendarOpen,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pb-4 min-h-[400px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      WeekSwiperWrapper,
      {
        currentWeek,
        ...
        slides,
        activeSlideIndex,
        children: (slide) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      isCalendarOpen ? "month-".concat(currentMonth == null ? void 0 : currentMonth.toISOString()) : "week-".concat(currentWeek[0].toISOString())
    ) })
  ] });
}
