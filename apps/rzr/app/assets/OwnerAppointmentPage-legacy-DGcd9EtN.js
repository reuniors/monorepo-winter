;
(function () {
  System.register(['./vendor_react-legacy-DonFScn3.js', './vendor_ionic-legacy-mZi8EIkK.js', './WeekSwiperWrapper-legacy-CkX3aIht.js', './App-legacy-CxwuunNq.js', './appointment.constants-legacy-DGLfwUGc.js', './reservation.helpers-legacy-BDNPjUsI.js', './vendor_leaflet-legacy-CSx1IcTV.js', './index-legacy-B6X2T6eC.js', './workingShift.fe-services-legacy-BSEOE1rh.js', './reservation.services-legacy-cv8qPPPU.js', './vendor_firebase-legacy-BNHQcAgT.js'], function (exports, module) {
    'use strict';

    var reactExports, useTranslation, jsxRuntimeExports, format, formatInTimeZone, parseISO, React, startOfMonth, endOfMonth, startOfWeek, addDays, useIonRouter, IonSpinner, IonIcon, cashOutline, chevronDownOutline, chevronUpOutline, useReservationCalendarContext, BookingCalendarHeader, BookingWeekDays, WeekSwiperWrapper, ReservationCalendarProvider, useGetFeWorkersQuery, activeLocation, urlPrefix, getAppTimezone, fromUtcHM, useContentRefFunctions, SceletonLoader, useQueryParamsHook, useGetFeServiceCategoriesQuery, AppointmentStatus, getReservationUrlWithSlot;
    return {
      setters: [module => {
