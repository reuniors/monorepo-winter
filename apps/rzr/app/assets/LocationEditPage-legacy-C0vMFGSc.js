;
(function () {
  System.register(['./vendor_react-legacy-DonFScn3.js', './vendor_ionic-legacy-mZi8EIkK.js', './App-legacy-CxwuunNq.js', './index-legacy-B6X2T6eC.js', './location-settings.data-legacy-8_BWvfCv.js', './usePendingImageUploads-legacy-DFYNlU9w.js', './vendor_leaflet-legacy-CSx1IcTV.js', './vendor_firebase-legacy-BNHQcAgT.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        imagesOutline = module.bw;
        locationOutline = module.bx;
