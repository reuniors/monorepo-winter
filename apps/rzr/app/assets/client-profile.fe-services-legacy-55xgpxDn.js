;
(function () {
  System.register(['./vendor_react-legacy-Dr5RK8rs.js', './vendor_ionic-legacy-BouRDOo5.js', './statistics.fe-services-legacy-aRt2oOEJ.js', './index-legacy-BHIGnBEX.js', './App-legacy-COHPHKDC.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        transformPaginationResponseToCamelCase = module.Y;
      }],
      execute: function () {
        exports({
          C: ClientStatistics,
