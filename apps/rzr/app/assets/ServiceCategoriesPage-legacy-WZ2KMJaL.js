;
(function () {
  System.register(['./vendor_react-legacy-j-OXaHGn.js', './vendor_ionic-legacy-B27OJI2l.js', './service-category.services-legacy-CPqOv5a4.js', './App-legacy-C1PSXo8s.js', './vendor_leaflet-legacy-aVamlEE1.js', './index-legacy-DzaXWAZQ.js', './vendor_firebase-legacy-BLL9XPHC.js'], function (exports, module) {
    'use strict';

    var useTranslation, reactExports, jsxRuntimeExports, IonModal, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonIcon, closeOutline, IonContent, IonItem, IonLabel, IonInput, IonTextarea, IonToggle, IonSpinner, checkmarkOutline, useIonRouter, useIonAlert, IonText, IonCard, IonCardHeader, IonCardTitle, businessOutline, swapVerticalOutline, addOutline, IonCardContent, IonReorderGroup, IonReorder, createOutline, trashOutline, useCreateServiceCategoryMutation, useGetFeServiceCategoriesQuery, useUpdateServiceCategoryMutation, useDeleteServiceCategoryMutation, useShowNotification, generateSlug, activeLocation, urlPrefix;
    return {
      setters: [module => {
        ...
        useCreateServiceCategoryMutation = module.a;
        useGetFeServiceCategoriesQuery = module.u;
        useUpdateServiceCategoryMutation = module.b;
        useDeleteServiceCategoryMutation = module.c;
      }, module => {
      ...
      execute: function () {
        ...
        function ServiceCategoriesPage() {
          ...
          const handleEditCategory = category => {
            router.push(`${urlPrefix}/podesavanja/delatnosti/${category.id}`);
          };
          ...
          const handleCreateSuccess = categoryId => {
            ...
            refetch().then(() => {
              if (categoryId) {
                router.push(`${urlPrefix}/podesavanja/delatnosti/${categoryId}`);
              }
            });
          };
          if (isLoading) {
