  ...
  System.register(['./vendor_ionic-legacy-qIZJoxql.js', './vendor_react-legacy-J-9YdXs8.js', './index-legacy-1AgAoADQ.js', './vendor_firebase-legacy-DUkuu2E4.js'], function (exports, module) {
    ...
    return {
      setters: [module => {
        ...
        IonText = module.c;
        IonSelect = module.x;
        IonSelectOption = module.y;
        videocam = module.z;
        videocamOff = module.A;
        IonGrid = module.B;
        IonRow = module.C;
        IonCol = module.D;
        IonSearchbar = module.E;
        IonLabel = module.F;
        IonList = module.G;
        IonCheckbox = module.H;
        arrowUndoOutline = module.J;
        IonPage = module.I;
        createAnimation = module.K;
        useIonModal = module.L;
        useIonLoading = module.M;
        useIonAlert = module.N;
        useIonActionSheet = module.O;
        trashOutline = module.P;
        IonImg = module.Q;
        cropOutline = module.R;
        optionsOutline = module.S;
        cloudUploadOutline = module.T;
        funnelOutline = module.U;
        listCircleSharp = module.V;
        checkmarkOutline = module.W;
        IonItemSliding = module.X;
        IonItemOptions = module.Y;
        IonThumbnail = module.Z;
        IonReorder = module.$;
        menuOutline = module.a0;
        chevronForwardOutline = module.a1;
        IonItemOption = module.a2;
        constructOutline = module.a3;
        checkboxOutline = module.a4;
        squareOutline = module.a5;
        IonReorderGroup = module.a6;
        addOutline = module.a7;
        isPlatform = module.a8;
        icons = module.a9;
        ...
        keyOutline = module.ah;
        IonLoading = module.ai;
        IonToast = module.aj;
        refreshOutline = module.ak;
        useIonRouter = module.al;
        IonListHeader = module.am;
        IonSkeletonText = module.an;
        exitOutline = module.ao;
        logoApple = module.ap;
        logoAndroid = module.aq;
        IonMenuButton = module.ar;
        chevronBackOutline = module.as;
        ellipsisVertical = module.at;
        ellipsisHorizontal = module.au;
        IonRefresher = module.av;
        IonRefresherContent = module.aw;
        IonPopover = module.ax;
        IonAlert = module.ay;
        arrowBackOutline = module.az;
        arrowForwardOutline = module.aA;
        lockClosedOutline = module.aB;
        logInOutline = module.aC;
        useIonViewWillEnter = module.aD;
        useIonViewWillLeave = module.aE;
        setupConfig = module.aF;
        IonSegment = module.aG;
        IonSegmentButton = module.aH;
        createOutline = module.aI;
        gitNetworkOutline = module.aJ;
        giftOutline = module.aK;
        settingsOutline = module.aL;
        peopleOutline = module.aM;
        megaphoneOutline = module.aN;
        notificationsOutline = module.aO;
        businessOutline = module.aP;
        IonActionSheet = module.aQ;
        IonTabs = module.aR;
        IonRouterOutlet = module.aS;
        IonTabBar = module.aT;
        IonTabButton = module.aU;
        homeOutline = module.aV;
        alarmOutline = module.aW;
        personOutline = module.aX;
        useIonViewDidLeave = module.aY;
        informationCircleOutline = module.aZ;
        appsOutline = module.a_;
        IonCard = module.a$;
        ...
        IonBadge = module.b4;
        logOutOutline = module.b5;
        IonApp = module.b6;
        IonReactRouter = module.b7;
        IonSplitPane = module.b8;
        setupIonicReact = module.b9;
      }, module => {
        ...
        useDispatch = module.a4;
        reactExports = module.e;
        useGoogleLogin = module.a5;
        create$3 = module.a6;
        create$6 = module.a7;
        React = module.R;
        Controller = module.a8;
        lodashExports = module.a9;
        useWatch = module.aa;
        DraftExports = module.ab;
        reactDraftWysiwygExports = module.ac;
        draftToHtml = module.ad;
        qr = module.ae;
        Swiper = module.af;
      ...
      execute: function () {
        ...
        exports({
          B: IonAlertConfirmation,
          D: DynamicForm,
          G: WorkingHoursForm,
          L: LayoutMainPage,
          M: SimpleFormStepperActions,
          P: StepIndicator,
          W: WorkingHoursList,
          a7: ServiceEditForm,
        ...
        const transformStandardResponseToCamelCase = exports("J", response => humpsExports.camelizeKeys(response));
        ...
        const photosArrayWithIdYup = exports("O", errorMsg => yup.array().nullable().defined().test("all-photos-have-id", "", function (value) {
        ...
        const useShowNotification = exports("K", options => {
        ...
        const ListIonIcons = reactExports.lazy(() => __vitePreload(() => module.import('./ListIonIcons-legacy-D-B3lsjt.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const HomePage = reactExports.lazy(() => __vitePreload(() => module.import('./HomePage-legacy-1YQV5vee.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const AppointmentPage = reactExports.lazy(() => __vitePreload(() => module.import('./AppointmentPage-legacy-0abb8c7Q.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ProfilePage = reactExports.lazy(() => __vitePreload(() => module.import('./ProfilePage-legacy-0UeHddKh.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NotificationPage = reactExports.lazy(() => __vitePreload(() => module.import('./NotificationPage-legacy-D3PwhqLT.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const PrepareWorkingDaysShiftsPage = reactExports.lazy(() => __vitePreload(() => module.import('./PrepareWorkingDaysShiftsPage-legacy-Cz_HqjwR.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const OwnerHomePage = reactExports.lazy(() => __vitePreload(() => module.import('./OwnerHomePage-legacy-ccYKAEI3.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const OwnerAppointmentPage = reactExports.lazy(() => __vitePreload(() => module.import('./OwnerAppointmentPage-legacy-BbbU-LoU.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const SettingsPage = reactExports.lazy(() => __vitePreload(() => module.import('./SettingsPage-legacy-CmGE7b62.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const CreateAppointmentPage = reactExports.lazy(() => __vitePreload(() => module.import('./CreateAppointmentPage-legacy-CO8x04qf.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ConfirmReservationPage = reactExports.lazy(() => __vitePreload(() => module.import('./ConfirmReservationPage-legacy-v_67dA7n.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const PublicProfilePage = reactExports.lazy(() => __vitePreload(() => module.import('./PublicProfilePage-legacy-Bk70zhW9.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NewsListPage = reactExports.lazy(() => __vitePreload(() => module.import('./NewsListPage-legacy-QZJpBcP-.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NewsCreatePage = reactExports.lazy(() => __vitePreload(() => module.import('./NewsCreatePage-legacy-BA3z9muS.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const NewsEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./NewsEditPage-legacy-IQ_sPgFw.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationWorkingTimePage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkingTimePage-legacy-BaEzz_Og.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationEditPage-legacy-B6_5nWEc.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationWorkersPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkersPage-legacy-DuluMvlq.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationSettingsPage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationSettingsPage-legacy-CkKddOjt.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServicesPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServicesPage-legacy-DmdnmRjH.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceCategoriesPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceCategoriesPage-legacy-X2n_xbzb.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceCategoryEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceCategoryEditPage-legacy-ByU_FIMc.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceGroupEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceGroupEditPage-legacy-RIMw-by3.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const ServiceEditPage = reactExports.lazy(() => __vitePreload(() => module.import('./ServiceEditPage-legacy-BiGfvwUu.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const LocationWorkerCreatePage = reactExports.lazy(() => __vitePreload(() => module.import('./LocationWorkerCreatePage-legacy-e6MnUftQ.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        exports({
          E: useGetLocationWorkingHoursQuery,
          H: useGetWorkerWorkingHoursQuery
        });
        const DAYS_OF_WEEK = [{
          code: "mon",
          name: "Ponedeljak",
        ...
        const GoogleCalendarSettingsPage = reactExports.lazy(() => __vitePreload(() => module.import('./GoogleCalendarSettingsPage-legacy-CynNc6ah.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const TestNotificationsPage = reactExports.lazy(() => __vitePreload(() => module.import('./TestNotificationsPage-legacy-BaJLp_Zw.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const UserDevicesPage = reactExports.lazy(() => __vitePreload(() => module.import('./UserDevicesPage-legacy-CvzJFAPM.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const PrivateLocationLandingPage = reactExports.lazy(() => __vitePreload(() => module.import('./PrivateLocationLandingPage-legacy-DiaU5_Q-.js'), false              ? __VITE_PRELOAD__ : void 0));
        ...
        const Menu = reactExports.lazy(() => __vitePreload(() => module.import('./Menu-legacy-BP55h1zW.js'), false              ? __VITE_PRELOAD__ : void 0));
