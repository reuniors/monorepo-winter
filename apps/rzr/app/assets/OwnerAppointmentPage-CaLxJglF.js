import { j as jsxRuntimeExports, e as reactExports, ai as useTranslation, aA as format, ay as formatInTimeZone, ax as parseISO, R as React, aP as startOfMonth, aQ as endOfMonth, aR as startOfWeek, aS as addDays } from "./vendor_react-BVRDO8z9.js";
import { d as useReservationCalendarContext, a as BookingCalendarHeader, b as BookingWeekDays, W as WeekSwiperWrapper, R as ReservationCalendarProvider } from "./WeekSwiperWrapper-CR4TdAbB.js";
import { l as IonIcon, bl as chevronDownOutline, bm as chevronUpOutline, al as useIonRouter, n as IonSpinner, bj as cashOutline } from "./vendor_ionic-CnFg9owC.js";
import { j as useGetFeWorkersQuery, k as activeLocation, f as urlPrefix, q as getAppTimezone, n as fromUtcHM, l as SceletonLoader, v as useQueryParamsHook, x as useGetFeServiceCategoriesQuery } from "./App-Bv-Um4fR.js";
...
import "./workingShift.fe-services-vLFgg65H.js";
import "./reservation.services-Cp09QfsE.js";
...
function CalendarModeToggle({
  ...
  if (!isCalendarOpen) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center pb-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        onClick: onToggle,
