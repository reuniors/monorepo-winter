;
(function () {
  System.register(['./vendor_ionic-legacy-E6_G7KHN.js', './vendor_react-legacy-DV1SlEeb.js', './vendor_leaflet-legacy-DEZLfQ5q.js'], function (exports, module) {
    'use strict';
    ...
    return {
      ...
      execute: function () {
        ...
        const App = reactExports.lazy(() => __vitePreload(() => module.import('./App-legacy-BnlytqpB.js').then(n => n.H), false              ? __VITE_PRELOAD__ : void 0));
