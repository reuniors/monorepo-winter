import { e as reactExports, ai as useTranslation, j as jsxRuntimeExports, ax as parseISO, aA as format } from "./vendor_react-Dl-vfqHg.js";
import { U as UserAvatar } from "./UserAvatar-DIV0DA5E.js";
import { n as IonSpinner, a_ as IonCard, b0 as IonCardHeader, b1 as IonCardTitle, a$ as IonCardContent, q as IonItem, l as IonIcon, ad as calendarOutline, E as IonLabel, c as IonText, b2 as checkmarkCircleOutline, bv as closeCircleOutline, ae as timeOutline, bA as walletOutline, d as IonButton, ak as refreshOutline, bh as IonAccordionGroup, bi as IonAccordion, F as IonList, ah as mailOutline, bt as callOutline, aX as personOutline, ac as IonToggle, w as IonSelect, x as IonSelectOption, M as useIonAlert, a9 as useIonToast, bH as pencilOutline } from "./vendor_ionic-DT63KrXZ.js";
import { u as useClipboard, b as useGetClientProfilesQuery, C as ClientStatistics } from "./client-profile.fe-services-CIyF0KXX.js";
import { u as useGetFeClientDataQuery, b as useUpdateFeClientDataMutation } from "./client.services-Cft6Liut.js";
import { k as activeLocation, f as urlPrefix, b as useUser, a as useAppDispatch, c as useAppSelector, d as useRemoveConnectedDeviceMutation, a7 as useDeviceNotification, i as isPwa, a8 as isInstalled, a9 as isWebView, C as ConditionalComponent } from "./App-Ryha8Grr.js";
import { C as ClientDataModal } from "./ClientDataModal-avwLxcPe.js";
import { a as useGetWorkerStatisticsQuery } from "./statistics.fe-services-C92Tzbnw.js";
import { P as Pagination } from "./Pagination-WZCKHWIo.js";
import { m as getDeviceData, l as setShowLoginModal, u as getSavedTheme, n as setDeviceData, x as saveTheme, v as applyTheme } from "./index-DhtA5eBI.js";
