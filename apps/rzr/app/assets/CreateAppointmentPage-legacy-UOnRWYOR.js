;
(function () {
  System.register(['./vendor_react-legacy-B0yst0tN.js', './App-legacy-BkSRAxSE.js', './vendor_ionic-legacy-DYIGQWbn.js', './logo-square-legacy-C4FuUdfc.js', './BookingWeekDays-legacy-BTdTjbbB.js', './reservation.services-legacy-BsRgrYN2.js', './client.services-legacy-lNHxfACE.js', './UserAvatar-legacy-Bjm_RLIS.js', './useQueryParamsHook-legacy-DPzDNXio.js', './index-legacy-y1QaFv1F.js', './vendor_leaflet-legacy-DKuaEqMF.js', './vendor_firebase-legacy-Bicf26rb.js', './workingShift.fe-services-legacy-CowYOv_5.js'], function (exports, module) {
    'use strict';

    var reactExports, jsxRuntimeExports, SwiperSlide, useTranslation, React, format, startOfMonth, endOfMonth, startOfWeek, addDays, startOfDay, toZonedTime, subMonths, addMonths, yup, formatInTimeZone, parseISO, useLocation, useHistory, useDefaultProps, useConfirmationAlert, SwiperWrapper, useGetFeWorkersQuery, activeLocation, SceletonLoader, getPathBySize, fromUtcHM, useContentRefFunctions, getAppTimezone, FieldType, useUser, useIsBigScreen, useFormWithSchema, urlPrefix, pushDuplicateAndNavigate, IonModalExtended, DynamicForm, toUtc, NotificationToast, useGetFeLocationQuery, useGetFeServiceCategoriesQuery, useGetFeServiceGroupsQuery, useAppDispatch, useAppSelector, IonList, IonItem, IonAvatar, IonIcon, peopleOutline, IonLabel, chevronForwardOutline, IonButton, checkmarkCircle, addOutline, trashOutline, removeOutline, IonCard, IonCardContent, IonToggle, IonAccordionGroup, IonAccordion, calendarOutline, IonText, IonSpinner, useIonRouter, useIonToast, IonLoading, IonHeader, IonToolbar, timeOutline, IonContent, cashOutline, IonBadge, IonFooter, closeOutline, calendarClearOutline, chevronDownOutline, chevronUpOutline, arrowBack, arrowForward, LazyLoadImgStandard, preloadCoverImg, useBookingCalendarContext, generateWeek, BookingCalendarHeader, BookingWeekDays, BookingCalendarProvider, useCreateFeReservationMutation, useGetFePromoCodeDataQuery, useGetFeClientDataQuery, UserAvatar, useQueryParamsHook, getDeviceData, setDeviceData;
    return {
      setters: [module => {
        ...
        BookingWeekDays = module.a;
        BookingCalendarProvider = module.b;
      }, module => {
      ...
      execute: function () {
        ...
        function BookingSlotsSwiper({
          ...
          const activeSlideIndex = reactExports.useMemo(() => {
            ...
            const firstContentIndex = slides.findIndex(slide => slide.type === "day" || slide.type === "empty-week");
          ...
          const handleSlideChange = reactExports.useCallback(swiper => {
          ...
          }, [slides, isCalendarOpen, currentMonth, currentWeek, changeMonth, changeWeek, onDateChange, scrollToTopIfNeeded]);
          reactExports.useEffect(() => {
          ...
          const handleSlideChangeTransitionStart = reactExports.useCallback(async swiper => {
            scrollToTopIfNeeded();
          }, [scrollToTopIfNeeded]);
          if (errorMessage) {
            return /* @__PURE__ */jsxRuntimeExports.jsx("div", {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            children: [/* @__PURE__ */jsxRuntimeExports.jsx(FormStepper$1, {
              ...
              renderSteps: () => {
                ...
                const calendarStep = /* @__PURE__ */jsxRuntimeExports.jsx(BookingCalendarProvider, {
                  locationSlug: activeLocation,
                ...
                }, `calendar-provider-${queryWorkerId || "all"}-${selectedWorker?.id || "none"}-${allWorkerIds.join(",")}`);
                /* @__PURE__ */
