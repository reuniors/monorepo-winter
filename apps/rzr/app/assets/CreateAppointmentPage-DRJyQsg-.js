import { e as reactExports, j as jsxRuntimeExports, af as SwiperSlide, aD as useTranslation, av as parseISO, aQ as addMinutes, ax as toZonedTime, az as fromZonedTime, aw as formatInTimeZone, aR as startOfMonth, aS as startOfWeek, aT as endOfMonth, aU as addDays, ay as format, aV as subMonths, aW as addMonths, aX as isSameMonth, aY as startOfDay, aZ as isSameDay, a4 as yup, aJ as useLocation, aE as useHistory } from "./vendor_react-DSVIR5Ln.js";
import { g as useConfirmationAlert, S as SwiperWrapper, h as useGetFeWorkersQuery, j as activeLocation, k as SceletonLoader, l as getPathBySize, t as transformStandardResponseToCamelCase, m as getAppTimezone, r as reservationTimeInterval, n as fromUtcHM, o as useContentRefFunctions, F as FieldType, b as useUser, p as useIsBigScreen, q as useFormWithSchema, f as urlPrefix, s as pushDuplicateAndNavigate, I as IonModalExtended, D as DynamicForm, C as ConditionalComponent, v as toUtc, N as NotificationToast, w as useGetFeLocationQuery, x as preloadedLocationData, y as useGetFeServiceGroupsQuery, a as useAppDispatch, c as useAppSelector } from "./App-DmsCuVFw.js";
import { F as IonList, q as IonItem, b7 as IonAvatar, l as IonIcon, aF as peopleOutline, E as IonLabel, $ as chevronForwardOutline, d as IonButton, b8 as checkmarkCircle, a6 as addOutline, O as trashOutline, b9 as removeOutline, ac as IonToggle, ba as IonAccordionGroup, bb as IonAccordion, aT as IonCard, aW as IonCardHeader, aX as IonCardTitle, aU as IonCardContent, ad as calendarOutline, c as IonText, n as IonSpinner, aj as useIonRouter, a9 as useIonToast, ag as IonLoading, h as IonHeader, i as IonToolbar, j as IonTitle, b as IonContent, A as IonGrid, B as IonRow, C as IonCol, aY as IonBadge, ae as timeOutline, bc as cashOutline, o as IonFooter, m as closeOutline, bd as calendarClearOutline, be as chevronDownOutline, bf as chevronUpOutline, bg as arrowBack, bh as arrowForward } from "./vendor_ionic-DMW4l-HL.js";
import { L as LazyLoadImgStandard, p as preloadCoverImg } from "./logo-square-Dps1ZDrv.js";
import { u as useGetFeServiceCategoriesQuery } from "./service-category.services-CdkmikRp.js";
import { g as generateWeek, h as hasAnySlotsInWeek, a as getDaysWithSlotsSet, B as BookingCalendarHeader, b as BookingWeekDays } from "./BookingWeekDays-DcRXSDJW.js";
import { r as rzrApi, o as TagType, k as getDeviceData, l as setDeviceData } from "./index-CnRQbzop.js";
import { u as useCreateFeReservationMutation, a as useGetFePromoCodeDataQuery } from "./reservation.services-dVmxAOB6.js";
import { u as useGetFeClientDataQuery } from "./client.services-BUnCPLlk.js";
import { U as UserAvatar } from "./UserAvatar-D0GpKWbV.js";
import { u as useQueryParamsHook } from "./useQueryParamsHook-ufosSD_P.js";
...
function SelectCategoryStep({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(IonCard, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(IonCardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(IonCardTitle, { children: t("Izaberite delatnost") }) }),
...
function EmptyWeekState({ currentWeek, firstAvailableDate }) {
  const { t } = useTranslation();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-16 px-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold text-center mb-2 text-gray-800 dark:text-gray-100", children: t("Nema slobodnih mesta za izabranu nedelju") }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 dark:text-gray-300 text-center", children: t("Pokušajte da izaberete drugu nedelju") }),
    firstAvailableDate && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-gray-500 dark:text-gray-400 text-center mt-2", children: [
    ...
    SwiperWrapper,
    {
      ...
      children: slides.map((slide, index) => {
        ...
        if (slide.type === "next-week") {
          return /* @__PURE__ */ jsxRuntimeExports.jsx(SwiperSlide, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-16 min-h-[320px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 dark:text-gray-500 text-sm", children: "Sledeća nedelja..." }) }) }, "next-week");
        }
...
function CreateAppointmentSteps({ appointment }) {
  ...
  const { data: locationResponse } = useGetFeLocationQuery(
    ...
    { skip: !!((_b = preloadedLocationData) == null ? void 0 : _b.id) }
  );
  const locationData = (_c = preloadedLocationData) != null ? _c : locationResponse == null ? void 0 : locationResponse.data;
  const { data: categoriesResult } = useGetFeServiceCategoriesQuery(
    {
      locationSlug: activeLocation,
      active: true
    },
    { skip: !((_d = locationData == null ? void 0 : locationData.serviceCategories) == null ? void 0 : _d.length) }
  );
