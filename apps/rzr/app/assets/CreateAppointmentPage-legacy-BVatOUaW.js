;
(function () {
  System.register(['./vendor_react-legacy-3NN3kxAt.js', './App-legacy-DGOCT5cL.js', './vendor_ionic-legacy-O-KkNIDb.js', './logo-square-legacy-uWtx8nc1.js', './WeekSwiperWrapper-legacy-URLjDa2h.js', './reservation.services-legacy-BgBJmtp5.js', './client.services-legacy-DK0pqtfq.js', './UserAvatar-legacy-uHxl9MA-.js', './vendor_leaflet-legacy-D7880HPH.js', './index-legacy-BCs5NMF5.js', './vendor_firebase-legacy-PP5vvGhm.js', './workingShift.fe-services-legacy-DRtBqMLp.js'], function (exports, module) {
    'use strict';

    var reactExports, jsxRuntimeExports, SwiperSlide, useTranslation, React, format, startOfMonth, endOfMonth, startOfWeek, addDays, startOfDay, toZonedTime, yup, formatInTimeZone, parseISO, useLocation, useHistory, useDefaultProps, useConfirmationAlert, SwiperWrapper, useGetFeWorkersQuery, activeLocation, SceletonLoader, getPathBySize, fromUtcHM, useContentRefFunctions, getAppTimezone, FieldType, useUser, useIsBigScreen, useFormWithSchema, urlPrefix, pushDuplicateAndNavigate, IonModalExtended, DynamicForm, useQueryParamsHook, NotificationToast, useGetFeLocationQuery, useGetFeServiceCategoriesQuery, useGetFeServiceGroupsQuery, IonList, IonItem, IonAvatar, IonIcon, peopleOutline, IonLabel, chevronForwardOutline, IonButton, checkmarkCircle, addOutline, trashOutline, removeOutline, IonCard, IonCardContent, IonToggle, IonAccordionGroup, IonAccordion, calendarOutline, IonText, IonSpinner, useIonRouter, useIonToast, IonLoading, IonHeader, IonToolbar, timeOutline, IonContent, cashOutline, IonBadge, IonFooter, closeOutline, calendarClearOutline, chevronDownOutline, chevronUpOutline, arrowBack, arrowForward, LazyLoadImgStandard, preloadCoverImg, useBookingCalendarContext, WeekSwiperWrapper, BookingCalendarContext, SLOT_SEARCH_TOLERANCE_MINUTES, BookingCalendarHeader, BookingWeekDays, BookingCalendarProvider, useCreateFeReservationMutation, useGetFePromoCodeDataQuery, useGetFeClientDataQuery, UserAvatar;
    return {
      setters: [module => {
        ...
        fromUtcHM = module.n;
        useContentRefFunctions = module.o;
        getAppTimezone = module.q;
        FieldType = module.F;
        useUser = module.b;
      ...
      execute: function () {
        ...
        function CreateAppointmentSteps({
          ...
          }, [activeStep, queryWorkerId, selectedWorker, locationHasCategories, selectedCategory, handleSetStep]);
          reactExports.useEffect(() => {
            if (activeStep === void 0) return;
          ...
          }, [activeStep, groupsSelectedServices, locationHasCategories, selectedCategory, forceSetStep]);
          reactExports.useEffect(() => {
          ...
          const renderSteps = reactExports.useCallback(() => {
            ...
            const calendarStep = activeStep === 2 || activeStep === void 0 ? /* @__PURE__ */jsxRuntimeExports.jsx(BookingCalendarProvider, {
              locationSlug: activeLocation,
