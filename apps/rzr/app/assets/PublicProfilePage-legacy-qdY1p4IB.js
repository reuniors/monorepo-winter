;
(function () {
  System.register(['./vendor_react-legacy-BZeT-WEv.js', './vendor_ionic-legacy-FEPq4Efg.js', './App-legacy-D_TQFFiD.js', './client-profile.fe-services-legacy-DGfxYmBC.js', './vendor_leaflet-legacy-_lyC0eWM.js', './index-legacy-yzMe94ue.js', './vendor_firebase-legacy-_Nh6fmKA.js', './statistics.fe-services-legacy-Bcx1dJ3d.js'], function (exports, module) {
    'use strict';

    var useTranslation, useParams, jsxRuntimeExports, IonCard, IonCardContent, IonSpinner, IonCardHeader, IonCardTitle, IonList, IonItem, IonIcon, mailOutline, IonLabel, callOutline, calendarOutline, personOutline, useUser, activeLocation, UserAvatar, ConditionalComponent, isWebPlatform, useClipboard, useGetWorkerClientDataQuery, ClientStatistics;
    return {
      setters: [module => {
