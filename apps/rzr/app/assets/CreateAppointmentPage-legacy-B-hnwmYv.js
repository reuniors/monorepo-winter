;
(function () {
  System.register(['./vendor_react-legacy-xICptfoc.js', './App-legacy-1Ax7LQ4a.js', './vendor_ionic-legacy-BYtYhV2-.js', './logo-square-legacy-CpD5OC8l.js', './BookingWeekDays-legacy-ClN2eS27.js', './reservation.services-legacy-DmLongJv.js', './client.services-legacy-hxB-4xri.js', './UserAvatar-legacy-BcJgJRHS.js', './useQueryParamsHook-legacy-C8A_cE8e.js', './index-legacy-Cim4I-VS.js', './vendor_leaflet-legacy-D5znobiB.js', './vendor_firebase-legacy-Bauk9ZJe.js', './workingShift.fe-services-legacy-CvDXMWF0.js'], function (exports, module) {
    'use strict';

    var reactExports, jsxRuntimeExports, SwiperSlide, useTranslation, React, format, startOfMonth, endOfMonth, startOfWeek, addDays, startOfDay, toZonedTime, subMonths, addMonths, yup, formatInTimeZone, parseISO, useLocation, useHistory, useDefaultProps, useConfirmationAlert, SwiperWrapper, useGetFeWorkersQuery, activeLocation, SceletonLoader, getPathBySize, fromUtcHM, useContentRefFunctions, getAppTimezone, FieldType, useUser, useIsBigScreen, useFormWithSchema, urlPrefix, pushDuplicateAndNavigate, IonModalExtended, DynamicForm, ConditionalComponent, toUtc, NotificationToast, useGetFeLocationQuery, useGetFeServiceCategoriesQuery, useGetFeServiceGroupsQuery, useAppDispatch, useAppSelector, IonList, IonItem, IonAvatar, IonIcon, peopleOutline, IonLabel, chevronForwardOutline, IonButton, checkmarkCircle, addOutline, trashOutline, removeOutline, IonCard, IonCardContent, IonToggle, IonAccordionGroup, IonAccordion, calendarOutline, IonText, IonSpinner, useIonRouter, useIonToast, IonLoading, IonHeader, IonToolbar, IonTitle, IonContent, IonGrid, IonRow, IonCol, IonBadge, timeOutline, cashOutline, IonFooter, closeOutline, calendarClearOutline, chevronDownOutline, chevronUpOutline, arrowBack, arrowForward, LazyLoadImgStandard, preloadCoverImg, useBookingCalendarContext, generateWeek, BookingCalendarHeader, BookingWeekDays, BookingCalendarProvider, useCreateFeReservationMutation, useGetFePromoCodeDataQuery, useGetFeClientDataQuery, UserAvatar, useQueryParamsHook, getDeviceData, setDeviceData;
    return {
      setters: [module => {
