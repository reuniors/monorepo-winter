;
(function () {
  System.register(['./vendor_react-legacy-CKjKS6zA.js', './App-legacy-BEzc__N_.js', './vendor_ionic-legacy-Br2UrGvg.js', './logo-square-legacy-CpO8vD1Z.js', './WeekSwiperWrapper-legacy-Dl29zMNV.js', './reservation.services-legacy-HuRdI-l8.js', './client.services-legacy-Te8N68Z9.js', './UserAvatar-legacy-B9dimSj3.js', './index-legacy-BVEqw4ar.js', './vendor_leaflet-legacy-Dzs4-G2p.js', './vendor_firebase-legacy-D-vUgmbk.js', './workingShift.fe-services-legacy-CxJm2tXg.js'], function (exports, module) {
    'use strict';
    ...
    return {
      ...
      execute: function () {
        ...
        function DaySlotsContent({
          ...
          reactExports.useEffect(() => {
            if (!hasInitialized.current && workersWithSlots.length > 0) {
              const allValues = workersWithSlots.map(workerSlot => `worker-${workerSlot.worker.id}`);
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsx("div", {
            ...
            children: /* @__PURE__ */jsxRuntimeExports.jsx(IonAccordionGroup, {
              ...
              children: workersWithSlots.map(workerSlot => /* @__PURE__ */jsxRuntimeExports.jsxs(IonAccordion, {
                value: `worker-${workerSlot.worker.id}`,
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonItem, {
                  slot: "header",
                  ...
                  children: /* @__PURE__ */jsxRuntimeExports.jsxs(IonLabel, {
                    children: [/* @__PURE__ */jsxRuntimeExports.jsxs("h3", {
                      ...
                      children: [dateDisplay, " - ", workerSlot.worker.fullName]
                    }), /* @__PURE__ */jsxRuntimeExports.jsxs("p", {
                      className: "text-sm text-gray-500 dark:text-gray-400",
        ...
        function BookingCalendarStep({
          ...
          }, [hasNavigatedToQueryDate, isActive, isLoadingSlots, queryParams.slot, queryParams.date, activeSlots, daysWithSlots, setSelectedDate, handleSelectSlot]);
          return /* @__PURE__ */jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
