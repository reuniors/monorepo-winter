;
(function () {
  System.register(['./vendor_react-legacy-BJQu1VnE.js', './reservation.services-legacy-DuEye7o0.js', './App-legacy-CeIZSQzJ.js', './vendor_ionic-legacy-C5RSb9DR.js', './appointment.constants-legacy-DGLfwUGc.js', './logo-square-legacy-lQvxJgCG.js', './client.services-legacy-DgpKSMzK.js', './ClientDataModal-legacy-CNGbuPbt.js', './vendor_leaflet-legacy-VV-trcYk.js', './index-legacy-SMp-2h98.js', './vendor_firebase-legacy-BEYs4Jgn.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        pricetagOutline = module.bp;
        IonTitle = module.j;
        IonBadge = module.b3;
        alertCircleOutline = module.bq;
        hourglassOutline = module.br;
        helpOutline = module.bs;
        IonButton = module.d;
        IonFooter = module.o;
        IonToolbar = module.i;
        personOutline = module.aX;
        closeCircleOutline = module.bt;
        personRemoveOutline = module.bu;
