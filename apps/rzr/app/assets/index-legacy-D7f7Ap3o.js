;
(function () {
  System.register(['./vendor_ionic-legacy-kFTPXAWE.js', './vendor_react-legacy-CFXrDSu1.js', './vendor_leaflet-legacy-DzrMDhpu.js'], function (exports, module) {
    'use strict';
    ...
    return {
      ...
      execute: function () {
        ...
        const App = reactExports.lazy(() => __vitePreload(() => module.import('./App-legacy-DT3CUYN8.js').then(n => n.ah), false              ? __VITE_PRELOAD__ : void 0));
        initializeTheme();
