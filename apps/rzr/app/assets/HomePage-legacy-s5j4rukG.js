;
(function () {
  System.register(['./vendor_react-legacy-BZeT-WEv.js', './App-legacy-D_TQFFiD.js', './vendor_ionic-legacy-FEPq4Efg.js', './reservation.helpers-legacy-BDNPjUsI.js', './NewsChyron-legacy-B5kNQtXH.js', './vendor_leaflet-legacy-_lyC0eWM.js', './index-legacy-yzMe94ue.js', './vendor_firebase-legacy-_Nh6fmKA.js', './news.fe-services-legacy-1A22Tjiv.js'], function (exports, module) {
    'use strict';

    var reactExports, useTranslation, jsxRuntimeExports, SwiperSlide, ConditionalComponent, LazyLoadImgStandard, preloadCoverImg$1, getPathBySize, useGetFeWorkersQuery, SceletonLoader, SwiperWrapper, useGetFeLocationQuery, activeLocation, preloadedLocationData, useIonRouter, IonCard, IonCardHeader, IonCardContent, IonButton, IonLabel, getReservationUrlWithParams, NewsChyron;
    return {
      setters: [module => {
