import { aU as addDays, b5 as isToday$1, aV as startOfDay, aR as startOfMonth, ay as format, j as jsxRuntimeExports, aD as useTranslation, e as reactExports, aT as endOfMonth, aS as startOfWeek, b6 as isSameWeek, aY as addMonths, aZ as isSameMonth, af as SwiperSlide } from "./vendor_react-CcaSbe82.js";
import { i as IonToolbar, d as IonButton, l as IonIcon, ad as calendarOutline, n as IonSpinner, bj as chevronUpOutline, bi as chevronDownOutline, k as IonButtons, ar as chevronBackOutline, $ as chevronForwardOutline } from "./vendor_ionic-CzUq-n1w.js";
import { S as SwiperWrapper } from "./App-Mqz5oeDp.js";
...
function BookingWeekDays({
  ...
  reactExports.useEffect(() => {
    ...
    if (!isMonthView && swiperRef.current && currentWeekIndex >= 0) {
      (_a = swiperRef.current.swiper) == null ? void 0 : _a.slideTo(currentWeekIndex);
    }
  ...
  reactExports.useEffect(() => {
    if (isMonthView && monthSwiperRef.current && currentMonthIndex >= 0) {
      requestAnimationFrame(() => {
        var _a;
        if ((_a = monthSwiperRef.current) == null ? void 0 : _a.swiper) {
...
export {
  ...
  getDaysWithSlotsSet as a,
  BookingWeekDays as b,
  generateWeek as g,
  hasAnySlotsInWeek as h,
  isToday as i
};
