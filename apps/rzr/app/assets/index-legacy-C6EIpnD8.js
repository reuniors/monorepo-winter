;
(function () {
  System.register(['./vendor_ionic-legacy-SgrmjcUd.js', './vendor_react-legacy-BaDeiZwt.js', './vendor_leaflet-legacy-Copy5_ZC.js'], function (exports, module) {
    'use strict';
    ...
    return {
      ...
      execute: function () {
        ...
        const App = reactExports.lazy(() => __vitePreload(() => module.import('./App-legacy-JMmm2B38.js').then(n => n.ad), false              ? __VITE_PRELOAD__ : void 0));
        initializeTheme();
