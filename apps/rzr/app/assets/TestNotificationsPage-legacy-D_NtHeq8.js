;
(function () {
  System.register(['./vendor_react-legacy-B0yst0tN.js', './vendor_ionic-legacy-DYIGQWbn.js', './App-legacy-BkSRAxSE.js', './test-notification.services-legacy-TWr0pDAc.js', './Pagination-legacy-DGU8NEfe.js', './vendor_leaflet-legacy-DKuaEqMF.js', './index-legacy-y1QaFv1F.js', './vendor_firebase-legacy-Bicf26rb.js'], function (exports, module) {
    'use strict';

    var jsxRuntimeExports, useTranslation, reactExports, IonItem, IonAvatar, IonLabel, IonBadge, IonIcon, chevronForwardOutline, useIonRouter, IonSearchbar, IonSpinner, IonText, IonList, activeLocation, urlPrefix, useGetAdminUsersQuery, Pagination;
    return {
      setters: [module => {
      ...
      execute: function () {
        ...
        function TestNotificationsPage() {
          ...
          console.log("🔍 Test Notifications Debug:", {
            activeLocation,
            currentPage,
            perPage,
            searchText,
