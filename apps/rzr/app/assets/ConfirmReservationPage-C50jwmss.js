import { e as reactExports, ai as useTranslation, j as jsxRuntimeExports, ax as parseISO, aA as format, af as SwiperSlide, a0 as t, a4 as yup, aV as isPast, aW as addMinutes } from "./vendor_react-Dl-vfqHg.js";
import { b as useGetOneFeReservationQuery, c as useUpdateFeReservationMutation } from "./reservation.services-DAu1Mupq.js";
import { k as activeLocation, l as SceletonLoader, z as fromUtcDateTimeToTime, m as getPathBySize, S as SwiperWrapper, s as useFormWithSchema, D as DynamicForm, b as useUser, f as urlPrefix, C as ConditionalComponent, A as IonAlertConfirmation, v as useQueryParamsHook, L as LayoutMainPage } from "./App-Ryha8Grr.js";
import { q as IonItem, A as IonGrid, B as IonRow, C as IonCol, l as IonIcon, bk as calendarClearOutline, ad as calendarOutline, ae as timeOutline, bp as pricetagOutline, j as IonTitle, b3 as IonBadge, bq as alertCircleOutline, br as hourglassOutline, bs as helpOutline, d as IonButton, o as IonFooter, i as IonToolbar, aX as personOutline, a9 as useIonToast, al as useIonRouter } from "./vendor_ionic-DT63KrXZ.js";
import { A as APPOINTMENT_STATUS_LABELS, a as AppointmentStatus } from "./appointment.constants-BtYyqQzh.js";
import { L as LazyLoadImgStandard, p as preloadCoverImg } from "./logo-square-B8YimWLq.js";
import { a as useGetFeLocationClientsQuery, u as useGetFeClientDataQuery } from "./client.services-Cft6Liut.js";
import { g as getClientFormFields, a as getAdministrationClientFormFields, C as ClientDataModal } from "./ClientDataModal-avwLxcPe.js";
