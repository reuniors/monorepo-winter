;
(function () {
  System.register(['./vendor_react-legacy-8eT2sGuL.js', './vendor_ionic-legacy-Das9dW4a.js', './App-legacy-CaR2AK6H.js', './ServiceGroupBasicInfoStep-legacy-BPYNLP_a.js', './vendor_leaflet-legacy-eQNkinhv.js', './index-legacy-9UCQqk05.js', './vendor_firebase-legacy-BARrkZ1D.js', './SimpleFormStepperActions-legacy-DzeQwdli.js'], function (exports, module) {
    'use strict';

    var useTranslation, jsxRuntimeExports, reactExports, useIonRouter, IonModal, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonIcon, closeOutline, IonContent, IonSpinner, IonText, IonCard, IonCardContent, IonItem, IonLabel, IonSelect, IonSelectOption, IonCardHeader, IonCardTitle, constructOutline, addOutline, IonAccordionGroup, IonAccordion, IonList, createOutline, useShowNotification, urlPrefix, useGetFeLocationQuery, activeLocation, preloadedLocationData, useGetFeServiceCategoriesQuery, useGetFeServiceGroupsQuery, ServiceGroupBasicInfoStep;
    return {
      setters: [module => {
        ...
        useGetFeServiceGroupsQuery = module.J;
      }, module => {
