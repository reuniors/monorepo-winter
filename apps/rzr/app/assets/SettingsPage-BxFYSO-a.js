import { aD as useTranslation, j as jsxRuntimeExports, e as reactExports } from "./vendor_react-CcaSbe82.js";
import { F as IonList, q as IonItem, l as IonIcon, E as IonLabel, aK as businessOutline, aX as IonCard, aZ as IonCardHeader, a_ as IonCardTitle, aG as settingsOutline, aY as IonCardContent, bA as colorPaletteOutline, w as IonSelect, x as IonSelectOption } from "./vendor_ionic-CzUq-n1w.js";
import { x as useGetFeLocationQuery, k as activeLocation, O as preloadedLocationData, a4 as getSettingsOptions, f as urlPrefix } from "./App-DPcICXng.js";
import { q as getSavedTheme, v as saveTheme, t as applyTheme } from "./index-B7fjdNWw.js";
...
function SettingsPage() {
  ...
  const settingsOptions = reactExports.useMemo(() => {
    ...
    console.log("🔍 Final settingsOptions:", {
      ...
      options: baseOptions.map((opt) => ({ title: opt.title, path: opt.path }))
    });
    return baseOptions;
  }, [
    urlPrefix,
