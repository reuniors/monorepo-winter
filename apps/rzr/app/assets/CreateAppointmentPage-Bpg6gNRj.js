import { e as reactExports, j as jsxRuntimeExports, af as SwiperSlide, aD as useTranslation, av as parseISO, aQ as addMinutes, ax as toZonedTime, az as fromZonedTime, aw as formatInTimeZone, aR as startOfMonth, aS as startOfWeek, aT as endOfMonth, aU as addDays, ay as format, aV as startOfDay, aW as isSameDay, aX as subMonths, aY as addMonths, aZ as isSameMonth, a_ as eachDayOfInterval, a4 as yup, aJ as useLocation, aE as useHistory } from "./vendor_react-Be2cnnNd.js";
import { g as useConfirmationAlert, S as SwiperWrapper, h as useGetFeWorkersQuery, j as activeLocation, k as SceletonLoader, l as getPathBySize, t as transformStandardResponseToCamelCase, m as getAppTimezone, r as reservationTimeInterval, n as fromUtcHM, o as useContentRefFunctions, F as FieldType, b as useUser, p as useIsBigScreen, q as useFormWithSchema, f as urlPrefix, s as pushDuplicateAndNavigate, I as IonModalExtended, D as DynamicForm, C as ConditionalComponent, v as toUtc, N as NotificationToast, w as useGetFeLocationQuery, x as preloadedLocationData, y as useGetFeServiceGroupsQuery, a as useAppDispatch, c as useAppSelector } from "./App-DeWcIyVH.js";
import { F as IonList, q as IonItem, b7 as IonAvatar, l as IonIcon, aF as peopleOutline, E as IonLabel, $ as chevronForwardOutline, d as IonButton, b8 as checkmarkCircle, a6 as addOutline, O as trashOutline, b9 as removeOutline, ac as IonToggle, ba as IonAccordionGroup, bb as IonAccordion, aT as IonCard, aW as IonCardHeader, aX as IonCardTitle, aU as IonCardContent, ad as calendarOutline, c as IonText, n as IonSpinner, aj as useIonRouter, a9 as useIonToast, ag as IonLoading, h as IonHeader, i as IonToolbar, j as IonTitle, b as IonContent, A as IonGrid, B as IonRow, C as IonCol, aY as IonBadge, ae as timeOutline, bc as cashOutline, o as IonFooter, m as closeOutline, bd as calendarClearOutline, be as chevronDownOutline, bf as chevronUpOutline, bg as arrowBack, bh as arrowForward } from "./vendor_ionic-CEbfXmBJ.js";
import { L as LazyLoadImgStandard, p as preloadCoverImg } from "./logo-square-Cf0b9Fwq.js";
import { u as useGetFeServiceCategoriesQuery } from "./service-category.services-I1d17RRX.js";
import { g as generateWeek, h as hasAnySlotsInWeek, a as getDaysWithSlotsSet, B as BookingCalendarHeader, b as BookingWeekDays } from "./BookingWeekDays-C6Wp6fvm.js";
import { r as rzrApi, o as TagType, k as getDeviceData, l as setDeviceData } from "./index-gP-eEdFZ.js";
import { u as useCreateFeReservationMutation, a as useGetFePromoCodeDataQuery } from "./reservation.services-BhUMx9Xx.js";
import { u as useGetFeClientDataQuery } from "./client.services-ROnhqGH2.js";
import { U as UserAvatar } from "./UserAvatar-CATz-7-6.js";
import { u as useQueryParamsHook } from "./useQueryParamsHook-Dpm-SZqc.js";
...
function BookingSlotsSwiper({
  ...
  const activeSlideIndex = reactExports.useMemo(() => {
    if (isCalendarOpen && currentMonth) {
      ...
      const selectedDateHasSlots = daysWithSlots.some(
      ...
      const firstDayWithSlotsIndex = slides.findIndex(
        (slide) => slide.type === "day" && slide.date && daysWithSlots.some(([dateStr]) => dateStr === slide.date)
      );
  ...
  const handleSlideChange = (swiper) => {
    ...
    if (isCalendarOpen && currentMonth) {
      ...
      if (activeSlide.type === "day" && activeSlide.date && onDateChange) {
        ...
        const hasSlots = daysWithSlots.some(
          ([dateStrWithSlots]) => dateStrWithSlots === dateStr
        );
        if (hasSlots) {
