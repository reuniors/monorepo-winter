;
(function () {
  System.register(['./vendor_react-legacy-HHx4U8Zg.js', './App-legacy-DfjKzIk2.js', './vendor_ionic-legacy-DTzAUkB1.js', './logo-square-legacy-cCNr-tW4.js', './service-category.services-legacy-D7sYO7aj.js', './BookingWeekDays-legacy-C5wpbIqn.js', './index-legacy-kz2gdOez.js', './reservation.services-legacy-B46Sq3Cs.js', './client.services-legacy-8P1Bwn9V.js', './UserAvatar-legacy-6zQxwKqq.js', './useQueryParamsHook-legacy-DSvnMZrC.js', './props-legacy-s4OYYZ4Y.js', './vendor_leaflet-legacy-DzBkCEej.js', './vendor_firebase-legacy-ByYi5ToB.js'], function (exports, module) {
    'use strict';

    var reactExports, jsxRuntimeExports, SwiperSlide, useTranslation, parseISO, addMinutes, toZonedTime, fromZonedTime, formatInTimeZone, startOfMonth, startOfWeek, endOfMonth, addDays, format, startOfDay, isSameDay, subMonths, addMonths, isSameMonth, eachDayOfInterval, yup, useLocation, useHistory, useConfirmationAlert, SwiperWrapper, useGetFeWorkersQuery, activeLocation, SceletonLoader, getPathBySize, transformStandardResponseToCamelCase, getAppTimezone, reservationTimeInterval, fromUtcHM, useContentRefFunctions, FieldType, useUser, useIsBigScreen, useFormWithSchema, urlPrefix, pushDuplicateAndNavigate, IonModalExtended, DynamicForm, ConditionalComponent, toUtc, NotificationToast, useGetFeLocationQuery, preloadedLocationData, useGetFeServiceGroupsQuery, useAppDispatch, useAppSelector, IonList, IonItem, IonAvatar, IonIcon, peopleOutline, IonLabel, chevronForwardOutline, IonButton, checkmarkCircle, addOutline, trashOutline, removeOutline, IonToggle, IonAccordionGroup, IonAccordion, IonCard, IonCardHeader, IonCardTitle, IonCardContent, calendarOutline, IonText, IonSpinner, useIonRouter, useIonToast, IonLoading, IonHeader, IonToolbar, IonTitle, IonContent, IonGrid, IonRow, IonCol, IonBadge, timeOutline, cashOutline, IonFooter, closeOutline, calendarClearOutline, chevronDownOutline, chevronUpOutline, arrowBack, arrowForward, LazyLoadImgStandard, preloadCoverImg, useGetFeServiceCategoriesQuery, generateWeek, hasAnySlotsInWeek, getDaysWithSlotsSet, BookingCalendarHeader, BookingWeekDays, rzrApi, TagType, getDeviceData, setDeviceData, useCreateFeReservationMutation, useGetFePromoCodeDataQuery, useGetFeClientDataQuery, UserAvatar, useQueryParamsHook, useDefaultProps;
    return {
      setters: [module => {
        ...
        preloadedLocationData = module.x;
        ...
        IonButton = module.d;
        checkmarkCircle = module.b8;
        addOutline = module.a6;
        trashOutline = module.O;
        removeOutline = module.b9;
        IonToggle = module.ac;
        IonAccordionGroup = module.ba;
        IonAccordion = module.bb;
        IonCard = module.aT;
        ...
        cashOutline = module.bc;
        IonFooter = module.o;
        closeOutline = module.m;
        calendarClearOutline = module.bd;
        chevronDownOutline = module.be;
        chevronUpOutline = module.bf;
        arrowBack = module.bg;
        arrowForward = module.bh;
      }, module => {
        LazyLoadImgStandard = module.L;
        preloadCoverImg = module.p;
      }, module => {
        useGetFeServiceCategoriesQuery = module.u;
      }, module => {
      ...
      execute: function () {
        ...
        function BookingSlotsSwiper({
          ...
          const slides = reactExports.useMemo(() => {
            ...
            if (isCalendarOpen && currentMonth) {
              ...
              const todayMonth = startOfMonth(today);
              const canGoPreviousMonth = currentMonth > todayMonth;
              if (!monthHasSlots) {
          ...
          const activeSlideIndex = reactExports.useMemo(() => {
            if (isCalendarOpen && currentMonth) {
              ...
              const selectedDateHasSlots = daysWithSlots.some(([dateStr]) => dateStr === selectedDateStr);
              ...
              const firstDayWithSlotsIndex = slides.findIndex(slide => slide.type === "day" && slide.date && daysWithSlots.some(([dateStr]) => dateStr === slide.date));
          ...
          }, [activeSlideIndex, currentWeek, currentMonth, isCalendarOpen]);
          ...
          const handleSlideChange = swiper => {
            ...
            if (isCalendarOpen && currentMonth) {
              ...
              if (activeSlide.type === "day" && activeSlide.date && onDateChange) {
                const dateStr = activeSlide.date;
                const hasSlots = daysWithSlots.some(([dateStrWithSlots]) => dateStrWithSlots === dateStr);
                if (hasSlots) {
        ...
        function BookingCalendarStep({
          ...
          reactExports.useEffect(() => {
            if (!isCalendarOpen && isFirstWeek && !isLoadingSlots && Object.keys(weekSlots).length > 0 && !hasAnySlots) {
              toggleCalendar();
            }
          }, [isCalendarOpen, isFirstWeek, isLoadingSlots, weekSlots, hasAnySlots, toggleCalendar]);
