;
(function () {
  System.register(['./vendor_react-legacy-3NN3kxAt.js', './vendor_ionic-legacy-O-KkNIDb.js', './index-legacy-C1Ac2ckm.js', './App-legacy-TNpJykv7.js', './workingShift.fe-services-legacy-Ck1jFx_n.js', './reservation.services-legacy-1PQt-dnt.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        parse = module.b4;
        isWithinInterval = module.b5;
        differenceInMinutes = module.b6;
        isSameMonth = module.b7;
        ...
        reservationTimeInterval = module.Z;
        getUtcDateFormattedInTz = module._;
        parseUtcDate = module.$;
