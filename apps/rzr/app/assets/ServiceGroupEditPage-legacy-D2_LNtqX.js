;
(function () {
  System.register(['./vendor_react-legacy-DonFScn3.js', './vendor_ionic-legacy-mZi8EIkK.js', './App-legacy-CxwuunNq.js', './ServiceGroupBasicInfoStep-legacy-DVTZr7LM.js', './usePendingImageUploads-legacy-DFYNlU9w.js', './vendor_leaflet-legacy-CSx1IcTV.js', './index-legacy-B6X2T6eC.js', './vendor_firebase-legacy-BNHQcAgT.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        useUpdateServiceMutation = module.a0;
        ShowLoading = module.a1;
        urlPrefix = module.f;
