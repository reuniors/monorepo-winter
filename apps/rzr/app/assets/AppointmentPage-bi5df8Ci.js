import { e as reactExports, j as jsxRuntimeExports, aC as format, az as parseISO, a3 as useTranslation } from "./vendor_react-LOGlbA9o.js";
import { e as useGetFeLocationClientReservationsQuery } from "./reservation.services-BSmw0TgZ.js";
import { f as urlPrefix, b as useUser, m as activeLocation, o as useGetFeWorkersQuery, q as SceletonLoader } from "./App-Byz-BlJA.js";
import { q as IonItem, l as IonIcon, bI as cutOutline, F as IonLabel, ad as calendarOutline, d as IonButton, G as IonList } from "./vendor_ionic-D94VuZ44.js";
...
function AppointmentItem({ reservation, workersById }) {
  ...
  const workerName = ((_a = workersById == null ? void 0 : workersById[reservation.locationWorkerId]) == null ? void 0 : _a.fullName) || "Nepoznat radnik";
