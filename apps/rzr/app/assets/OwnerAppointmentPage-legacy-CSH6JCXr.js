;
(function () {
  System.register(['./vendor_react-legacy-BvXhJo_m.js', './vendor_ionic-legacy-dqJd8vxA.js', './BookingWeekDays-legacy-DpHknNGb.js', './App-legacy-DEKKHFah.js', './appointment.constants-legacy-DGLfwUGc.js', './reservation.helpers-legacy-BDNPjUsI.js', './useQueryParamsHook-legacy-IGoM7uue.js', './vendor_leaflet-legacy-DGSDSOBP.js', './index-legacy-UeGmmatO.js', './workingShift.fe-services-legacy-fs8UXQA1.js', './reservation.services-legacy-QdhBt-_E.js', './vendor_firebase-legacy-G_df00wk.js'], function (exports, module) {
    'use strict';

    var reactExports, jsxRuntimeExports, SwiperSlide, startOfMonth, subMonths, addMonths, addDays, useTranslation, format, formatInTimeZone, parseISO, React, endOfMonth, startOfWeek, useIonRouter, IonSpinner, IonIcon, cashOutline, chevronDownOutline, chevronUpOutline, generateWeek, useReservationCalendarContext, BookingCalendarHeader, BookingWeekDays, ReservationCalendarProvider, useContentRefFunctions, SwiperWrapper, useGetFeWorkersQuery, activeLocation, urlPrefix, getAppTimezone, fromUtcHM, SceletonLoader, useGetFeServiceCategoriesQuery, AppointmentStatus, getReservationUrlWithSlot, useQueryParamsHook;
    return {
      setters: [module => {
        ...
        useReservationCalendarContext = module.c;
        ...
        function TableOfReservationsV2() {
          ...
          reactExports.useEffect(() => {
            if (timeSlots && timeSlots.length > 0) {
              ...
              const todaySlide = timeSlots.find(slot => slot.dateFormatted === todayStr);
