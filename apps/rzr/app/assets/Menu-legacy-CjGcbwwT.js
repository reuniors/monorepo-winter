;
(function () {
  System.register(['./vendor_react-legacy-BJQu1VnE.js', './vendor_ionic-legacy-C5RSb9DR.js', './App-legacy-DhSLasgw.js', './index-legacy-CL_X7O6r.js', './vendor_leaflet-legacy-VV-trcYk.js', './vendor_firebase-legacy-BEYs4Jgn.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        IonMenuToggle = module.bb;
        IonItem = module.q;
        logInOutline = module.aC;
        powerOutline = module.bc;
        IonFooter = module.o;
        IonLabel = module.F;
        home = module.bd;
