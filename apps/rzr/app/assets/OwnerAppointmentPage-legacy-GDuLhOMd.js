;
(function () {
  System.register(['./vendor_react-legacy-Dr5RK8rs.js', './vendor_ionic-legacy-BouRDOo5.js', './App-legacy-COHPHKDC.js', './workingShift.fe-services-legacy-CF1fhSIP.js', './appointment.constants-legacy-DGLfwUGc.js', './reservation.helpers-legacy-BDNPjUsI.js', './vendor_leaflet-legacy-5Hsu9Ykl.js', './index-legacy-BHIGnBEX.js', './vendor_firebase-legacy-DZHWzyZG.js'], function (exports, module) {
    'use strict';

    var reactExports, useTranslation, jsxRuntimeExports, format, formatInTimeZone, parseISO, React, SwiperSlide, useIonRouter, IonSpinner, IonIcon, cashOutline, IonItem, IonHeader, IonToolbar, IonButtons, IonButton, chevronBackOutline, IonTitle, chevronForwardOutline, useGetFeWorkersQuery, activeLocation, urlPrefix, getAppTimezone, fromUtcHM, useContentRefFunctions, useGetFeLocationReservationsQuery, getUtcDateFormattedInTz, parseUtcDate, getTimeSlotsForTable, SceletonLoader, SwiperWrapper, useQueryParamsHook, useGetFeServiceCategoriesQuery, useGetFeWorkerWorkingShiftsByDaysQuery, AppointmentStatus, getReservationUrlWithSlot;
    return {
      setters: [module => {
        ...
        fromUtcHM = module.w;
        useContentRefFunctions = module.a4;
        useGetFeLocationReservationsQuery = module.a5;
        getUtcDateFormattedInTz = module.a3;
        parseUtcDate = module.a6;
        getTimeSlotsForTable = module.a7;
                ...
                children: /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                  ...
                  children: selectedDateSlots.map((timeSlotInfo, index) => {
                    ...
                    return /* @__PURE__ */jsxRuntimeExports.jsxs(React.Fragment, {
                      children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                        className: `py-2 transition-colors duration-200 relative ${timeSlotInfo.isPause ? "bg-gray-700 border-l-4 border-gray-500" : reservation ? "hover:bg-gray-800" : "hover:bg-gray-800 cursor-pointer"}`,
