;
(function () {
  System.register(['./vendor_react-legacy-CndWC4n9.js', './App-legacy-BZWqGSgH.js', './vendor_ionic-legacy-DaXnMmdX.js', './appointment.constants-legacy-DGLfwUGc.js', './ClientDataModal-legacy-BBsbq4Yc.js', './vendor_leaflet-legacy-BBJO0vvi.js', './index-legacy-DkVF9sGh.js', './vendor_firebase-legacy-xyFeamUN.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        pricetagOutline = module.bb;
        IonTitle = module.j;
        IonBadge = module.aX;
        alertCircleOutline = module.bc;
        hourglassOutline = module.bd;
        helpOutline = module.be;
        IonButton = module.d;
        IonFooter = module.o;
