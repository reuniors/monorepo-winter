import { e as reactExports, M as useTranslation, j as jsxRuntimeExports, az as parseISO, aC as format } from "./vendor_react-CZodnfjS.js";
import { U as UserAvatar } from "./UserAvatar-4SoXBEJN.js";
import { o as IonSpinner, b5 as IonCard, b7 as IonCardHeader, b8 as IonCardTitle, b6 as IonCardContent, r as IonItem, b as IonIcon, ag as calendarOutline, G as IonLabel, m as IonText, b9 as checkmarkCircleOutline, bI as closeCircleOutline, ah as timeOutline, bP as walletOutline, d as IonButton, an as refreshOutline, by as IonAccordionGroup, bz as IonAccordion, H as IonList, aj as mailOutline, bK as callOutline, b1 as personOutline, af as IonToggle, y as IonSelect, z as IonSelectOption, Q as useIonAlert, u as useIonToast, bV as pencilOutline } from "./vendor_ionic-DAnbjjdE.js";
import { u as useClipboard, b as useGetClientProfilesQuery, C as ClientStatistics } from "./client-profile.fe-services-IwllFEMS.js";
import { u as useGetFeClientDataQuery, b as useUpdateFeClientDataMutation } from "./client.services-D-3V8BVK.js";
import { n as activeLocation, g as urlPrefix, P as Pagination, b as useUser, a as useAppDispatch, c as useAppSelector, d as useRemoveConnectedDeviceMutation, ab as useDeviceNotification, i as isPwa, ac as isInstalled, ad as isWebView, C as ConditionalComponent } from "./App-kfoom-0N.js";
import { C as ClientDataModal } from "./ClientDataModal-BmciQe73.js";
import { a as useGetWorkerStatisticsQuery } from "./statistics.fe-services-ChNTbzPf.js";
import { m as getDeviceData, l as setShowLoginModal, K as getSavedTheme, n as setDeviceData, O as saveTheme, L as applyTheme } from "./index-DZE_gcZd.js";
...
function ClientSettingsCard({
  ...
  const { t } = useTranslation();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(IonCard, { className: "mt-4 settings-card-black-bg", children: [
