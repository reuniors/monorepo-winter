;
(function () {
  System.register(['./vendor_ionic-legacy-dqJd8vxA.js', './vendor_react-legacy-BvXhJo_m.js', './vendor_leaflet-legacy-DGSDSOBP.js'], function (exports, module) {
    'use strict';
    ...
    return {
      ...
      execute: function () {
        ...
        const App = reactExports.lazy(() => __vitePreload(() => module.import('./App-legacy-CvwW-QEB.js').then(n => n.ac), false              ? __VITE_PRELOAD__ : void 0));
        initializeTheme();
