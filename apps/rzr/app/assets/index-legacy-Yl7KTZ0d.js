;
(function () {
  System.register(['./vendor_ionic-legacy-DHCFIBri.js', './vendor_react-legacy-B8lcDdWC.js', './vendor_leaflet-legacy-CM2JtPiy.js'], function (exports, module) {
    'use strict';
    ...
    return {
      ...
      execute: function () {
        ...
        const App = reactExports.lazy(() => __vitePreload(() => module.import('./App-legacy-Dxsizkch.js').then(n => n.a9), false              ? __VITE_PRELOAD__ : void 0));
        initializeTheme();
