import { e as reactExports, a3 as useTranslation, j as jsxRuntimeExports, az as parseISO, aC as format } from "./vendor_react-B3gTLzrh.js";
import { U as UserAvatar } from "./UserAvatar-yUfK4Qhb.js";
import { n as IonSpinner, a_ as IonCard, b0 as IonCardHeader, b1 as IonCardTitle, a$ as IonCardContent, q as IonItem, l as IonIcon, ad as calendarOutline, F as IonLabel, c as IonText, b2 as checkmarkCircleOutline, bt as closeCircleOutline, ae as timeOutline, bB as walletOutline, d as IonButton, ak as refreshOutline, bh as IonAccordionGroup, bi as IonAccordion, G as IonList, ag as mailOutline, bv as callOutline, aX as personOutline, ac as IonToggle, x as IonSelect, y as IonSelectOption, N as useIonAlert, u as useIonToast, bI as pencilOutline } from "./vendor_ionic-Bk4xGa1M.js";
import { u as useClipboard, b as useGetClientProfilesQuery, C as ClientStatistics } from "./client-profile.fe-services-p6eS0yPx.js";
import { u as useGetFeClientDataQuery, b as useUpdateFeClientDataMutation } from "./client.services-B9HktvUK.js";
import { m as activeLocation, f as urlPrefix, b as useUser, a as useAppDispatch, c as useAppSelector, d as useRemoveConnectedDeviceMutation, aa as useDeviceNotification, i as isPwa, ab as isInstalled, ac as isWebView, C as ConditionalComponent } from "./App-Zs0gdlX8.js";
import { C as ClientDataModal } from "./ClientDataModal-DXzAMN6W.js";
import { a as useGetWorkerStatisticsQuery } from "./statistics.fe-services-DM711z0l.js";
import { P as Pagination } from "./Pagination-VueKNBeE.js";
import { m as getDeviceData, l as setShowLoginModal, x as getSavedTheme, n as setDeviceData, A as saveTheme, y as applyTheme } from "./index-B1uhtDiW.js";
