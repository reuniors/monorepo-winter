  ...
  System.register(['./vendor_ionic-legacy-Br2UrGvg.js', './vendor_react-legacy-CKjKS6zA.js', './vendor_leaflet-legacy-Dzs4-G2p.js'], function (exports, module) {
    ...
    return {
      ...
      execute: function () {
        ...
        var TagId = exports("z", /* @__PURE__ */(TagId2 => {
          TagId2["LIST"] = "LIST";
          return TagId2;
        })(TagId || {}));
        ...
        const App = reactExports.lazy(() => __vitePreload(() => module.import('./App-legacy-B4qymwvx.js').then(n => n.ai), false              ? __VITE_PRELOAD__ : void 0));
        initializeTheme();
