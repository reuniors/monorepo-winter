;
(function () {
  System.register(['./vendor_react-legacy-J-9YdXs8.js', './reservation.services-legacy-Cz9k_Ucr.js', './App-legacy-J1QG38FO.js', './vendor_ionic-legacy-qIZJoxql.js', './appointment.constants-legacy-DGLfwUGc.js', './Pagination-legacy-CBXCbH4V.js', './NewsChyron-legacy-DwWktvRb.js', './vendor_leaflet-legacy-CcTkPRIU.js', './index-legacy-1AgAoADQ.js', './vendor_firebase-legacy-DUkuu2E4.js', './news.fe-services-legacy-BJ6m--8q.js'], function (exports, module) {
    'use strict';

    var useTranslation, reactExports, jsxRuntimeExports, format, parseISO, useGetFeLocationClientReservationsQuery, urlPrefix, useUser, activeLocation, useGetFeWorkersQuery, SceletonLoader, IonItem, IonIcon, cutOutline, IonLabel, calendarOutline, IonButton, IonList, AppointmentStatus, Pagination, NewsChyron;
    return {
      setters: [module => {
