;
(function () {
  System.register(['./vendor_ionic-legacy-CLGezsbs.js', './vendor_react-legacy-CX0h95NE.js', './vendor_leaflet-legacy-CiFv5lWM.js'], function (exports, module) {
    'use strict';
    ...
    return {
      ...
      execute: function () {
        ...
        const App = reactExports.lazy(() => __vitePreload(() => module.import('./App-legacy-7OwS84rF.js').then(n => n.ai), false              ? __VITE_PRELOAD__ : void 0));
        initializeTheme();
