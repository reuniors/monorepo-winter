;
(function () {
  System.register(['./vendor_react-legacy-BZeT-WEv.js', './App-legacy-D_TQFFiD.js', './workingShift.fe-services-legacy-BlW288Ca.js', './vendor_ionic-legacy-FEPq4Efg.js', './appointment.constants-legacy-DGLfwUGc.js', './reservation.helpers-legacy-BDNPjUsI.js', './vendor_leaflet-legacy-_lyC0eWM.js', './index-legacy-yzMe94ue.js', './vendor_firebase-legacy-_Nh6fmKA.js'], function (exports, module) {
    'use strict';

    var parseISO, parse, addMinutes, isWithinInterval, differenceInMinutes, format, formatInTimeZone, reactExports, jsxRuntimeExports, SwiperSlide, addDays, useTranslation, React, startOfDay, toZonedTime, startOfMonth, useContentRefFunctions, SwiperWrapper, generateWeek, useGetFeWorkersQuery, activeLocation, urlPrefix, getAppTimezone, fromUtcHM, useGetFeLocationReservationsQuery, getUtcDateFormattedInTz, parseUtcDate, isToday, SceletonLoader, BookingCalendarHeader, BookingWeekDays, useQueryParamsHook, useGetFeServiceCategoriesQuery, useGetFeWorkerWorkingShiftsByDaysQuery, useIonRouter, IonSpinner, IonIcon, cashOutline, AppointmentStatus, getReservationUrlWithSlot;
    return {
      setters: [module => {
        parseISO = module.av;
        parse = module.bb;
        ...
        useContentRefFunctions = module.a5;
        SwiperWrapper = module.l;
        generateWeek = module.a6;
        useGetFeWorkersQuery = module.x;
        activeLocation = module.h;
        urlPrefix = module.f;
        getAppTimezone = module.a3;
        fromUtcHM = module.w;
        useGetFeLocationReservationsQuery = module.a7;
        getUtcDateFormattedInTz = module.a4;
        parseUtcDate = module.a8;
        isToday = module.a9;
        SceletonLoader = module.S;
        BookingCalendarHeader = module.aa;
        BookingWeekDays = module.ab;
        useQueryParamsHook = module.q;
        useGetFeServiceCategoriesQuery = module.H;
      }, module => {
