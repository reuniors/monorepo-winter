;
(function () {
  System.register(['./vendor_react-legacy-HHx4U8Zg.js', './vendor_ionic-legacy-DTzAUkB1.js', './App-legacy-DfjKzIk2.js', './ServiceGroupCreateModal-legacy-DUDIw7Cq.js', './service-category.services-legacy-D7sYO7aj.js', './vendor_leaflet-legacy-DzBkCEej.js', './index-legacy-kz2gdOez.js', './vendor_firebase-legacy-ByYi5ToB.js', './ServiceGroupBasicInfoStep-legacy-DzIIhMpn.js', './SimpleFormStepperActions-legacy-8ZwMElzQ.js'], function (exports, module) {
    'use strict';

    var useTranslation, reactExports, jsxRuntimeExports, useIonRouter, IonSpinner, IonText, IonCard, IonCardContent, IonItem, IonLabel, IonSelect, IonSelectOption, IonCardHeader, IonCardTitle, IonIcon, constructOutline, IonButton, addOutline, IonAccordionGroup, IonAccordion, IonList, createOutline, useGetFeLocationQuery, activeLocation, preloadedLocationData, useGetFeServiceGroupsQuery, urlPrefix, ServiceGroupCreateModal, useGetFeServiceCategoriesQuery;
    return {
      setters: [module => {
