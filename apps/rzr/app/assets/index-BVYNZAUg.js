const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/App-BTZwZ6xb.js","assets/vendor_react-g1Lb8P9R.js","assets/vendor_ionic-XqfGltiy.js","assets/vendor_ionic-D7N1wSx9.css","assets/vendor_leaflet-BPPv1iLj.js","assets/vendor_leaflet-Bvr-Ab8i.css","assets/vendor_react-Z09ODb1v.css","assets/vendor_firebase-DofBCW2C.js","assets/App-DMfkgWdX.css"])))=>i.map(i=>d[i]);
...
;
import { I as IonModal, b as IonIcon, c as alertCircleOutline, d as IonButton, e as IonHeader, f as IonToolbar, h as IonTitle, i as IonButtons, j as closeOutline, k as IonContent, l as IonPage, m as IonText, _ as __vitePreload, n as defineCustomElements } from "./vendor_ionic-XqfGltiy.js";
import { v as instance, x as Backend, y as Browser, z as initReactI18next, A as fetchBaseQuery, C as gBase64, D as createApi, E as createAction, F as createSlice, e as reactExports, G as useHistory, j as jsxRuntimeExports, I as humpsExports, J as isRejectedWithValue, K as combineReducers, L as configureStore, M as useTranslation, N as persistStore, O as persistReducer, P as FLUSH, Q as REHYDRATE, S as PAUSE, T as PERSIST, U as PURGE, V as REGISTER, W as storage, X as clientExports, Y as Provider, Z as PersistGate, $ as ErrorBoundary } from "./vendor_react-g1Lb8P9R.js";
...
const unauthorizedMiddleware = (store2) => (next) => (action) => {
  ...
  if (isRejectedWithValue(action)) {
    ...
    if (((_a2 = state.user.user) == null ? void 0 : _a2.id) && (payload == null ? void 0 : payload.status) === 403 && ((_b2 = payload == null ? void 0 : payload.data) == null ? void 0 : _b2.data) === "invalid token: permission denied") {
...
const getPauseBetweenReservations = (state) => {
  var _a2, _b2;
  return (_b2 = (_a2 = state.locationSettings.settings) == null ? void 0 : _a2.pauseBetweenReservations) != null ? _b2 : 0;
};
...
const apiUrl = (_b = getInitialData("rzrApiUrl")) != null ? _b : "/api/v1/rzr";
const administrationApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getUserDetails: builder.query({
      query: (id) => "/api/v1/admin/users/".concat(id),
...
const App = reactExports.lazy(() => __vitePreload(() => import("./App-BTZwZ6xb.js").then((n) => n.aj), true ? __vite__mapDeps([0,1,2,3,4,5,6,7,8]) : void 0));
initializeTheme();
...
export {
  getLocationSettings as A,
  useGetAdminStatsQuery as B,
  getInitialData as C,
  getSavedTheme as D,
  ErrorDisplay as E,
  applyTheme as F,
  TagId as G,
  getPauseBetweenReservations as H,
  ...
  updateUserData as u,
  TagType as v,
  getLocationHash as w,
  setLocationHash as x,
  setLocationSettings as y,
  getActiveLocation as z
};
