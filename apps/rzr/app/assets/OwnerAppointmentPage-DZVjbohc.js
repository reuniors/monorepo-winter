import { av as parseISO, bb as parse, aQ as addMinutes, bc as isWithinInterval, bd as differenceInMinutes, ay as format, aw as formatInTimeZone, e as reactExports, j as jsxRuntimeExports, af as SwiperSlide, aR as startOfMonth, aX as subMonths, aY as addMonths, aU as addDays, aD as useTranslation, R as React, aV as startOfDay, ax as toZonedTime, aT as endOfMonth, aS as startOfWeek } from "./vendor_react-CDpfJxnK.js";
import { aj as useIonRouter, n as IonSpinner, l as IonIcon, bg as cashOutline, bi as chevronDownOutline, bj as chevronUpOutline } from "./vendor_ionic-ZVUk9kYn.js";
import { p as useContentRefFunctions, S as SwiperWrapper, j as useGetFeWorkersQuery, k as activeLocation, f as urlPrefix, n as getAppTimezone, o as fromUtcHM, a6 as getUtcDateFormattedInTz, a7 as parseUtcDate, l as SceletonLoader, z as useGetFeServiceCategoriesQuery } from "./App-o16pXKXA.js";
import { d as useGetFeWorkerWorkingShiftsByDaysQuery } from "./workingShift.fe-services-WyIL2KJJ.js";
import { e as useGetFeLocationReservationsQuery } from "./reservation.services-BbzrhFaR.js";
import { g as generateWeek, i as isToday, B as BookingCalendarHeader, b as BookingWeekDays } from "./BookingWeekDays-B3YS0Zf2.js";
      ...
      if (activeSlide.type === "prev-month") {
        ...
        if (currentMonthStart <= todayMonth) {
          requestAnimationFrame(() => {
            var _a;
            if ((_a = swiperRef.current) == null ? void 0 : _a.swiper) {
...
function TableOfReservationList({
  ...
  const isToday2 = selectedDateFormatted === formatInTimeZone(currentTime, getAppTimezone(), "yyyy-MM-dd");
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full px-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-gray-200 dark:divide-gray-700 relative", children: selectedDateSlots.map((timeSlotInfo, index) => {
    ...
    const isWithinSlot = isToday2 && currentMinutesFromMidnight >= slotStartMinutes && currentMinutesFromMidnight < slotEndMinutes;
    ...
    const isAfterSlot = isToday2 && currentMinutesFromMidnight >= slotEndMinutes && (!nextSlotTime || currentTimeUtc < nextSlotTime);
...
function TableOfReservationsV2({
  ...
  const handleWeekChange = (newWeek) => {
    ...
    const firstDayWithSlots = timeSlots == null ? void 0 : timeSlots.find(
      (slot) => weekDateStrs.includes(slot.dateFormatted)
    );
  ...
  reactExports.useEffect(() => {
    ...
    if (!hasSlots) {
      ...
      if (todayHasSlots) {
        const todaySlot = timeSlots.find(
      ...
      const firstDayWithSlots = timeSlots.find(
        (slot) => daysWithSlots.has(slot.dateFormatted)
      );
      if (firstDayWithSlots) {
        setSelectedDate(firstDayWithSlots.date);
      }
      ...
      WeekSwiperWrapper,
      {
        ...
        children: (slide) => {
          if (slide.type === "prev-week" || slide.type === "prev-month") {
            return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-16 min-h-[320px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 dark:text-gray-500 text-sm", children: slide.type === "prev-month" ? "Prethodni mesec..." : "Prethodna nedelja..." }) });
          }
          if (slide.type === "next-week" || slide.type === "next-month") {
            return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-16 min-h-[320px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 dark:text-gray-500 text-sm", children: slide.type === "next-month" ? "Sledeći mesec..." : "Sledeća nedelja..." }) });
          }
