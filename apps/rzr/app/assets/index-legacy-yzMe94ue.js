;
(function () {
  System.register(['./vendor_ionic-legacy-FEPq4Efg.js', './vendor_react-legacy-BZeT-WEv.js', './vendor_leaflet-legacy-_lyC0eWM.js'], function (exports, module) {
    'use strict';
    ...
    return {
      ...
      execute: function () {
        ...
        const App = reactExports.lazy(() => __vitePreload(() => module.import('./App-legacy-D_TQFFiD.js').then(n => n.ad), false              ? __VITE_PRELOAD__ : void 0));
        initializeTheme();
