;
(function () {
  System.register(['./vendor_react-legacy-CSf8zLqi.js', './vendor_ionic-legacy-DvZl6sBE.js', './App-legacy-CRCzN3kk.js', './index-legacy-CYMNsaJ2.js', './vendor_leaflet-legacy-DUCVU90d.js', './vendor_firebase-legacy-tNokQwyN.js'], function (exports, module) {
    'use strict';

    var useTranslation, instance, jsxRuntimeExports, withRouter, useLocation, reactExports, IonIcon, globe, IonSelect, IonSelectOption, home, alarmOutline, settingsOutline, IonMenu, IonContent, IonList, IonListHeader, IonMenuToggle, IonItem, shieldCheckmarkOutline, IonLabel, logInOutline, powerOutline, IonFooter, personOutline, notificationsOutline, useAppDispatch, useAppDispatch$1, useUser, useAppSelector, useRemoveConnectedDeviceMutation, UserGroupCode, userHasRoles, isPwa, isIos, urlPrefix, sharedApi, TagType, getDeviceData, rzrApi, TagType$1, setShowLoginModal;
    return {
      setters: [module => {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(IonMenu, {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsxs(IonContent, {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                ...
                inset: false,
                className: "mt-0 pt-0",
                children: renderListItems(filteredAppPages)
              }), isAdmin && /* @__PURE__ */jsxRuntimeExports.jsxs(IonList, {
                lines: "none",
                inset: false,
                className: "mt-2",
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(IonListHeader, {
                  children: "Admin"
                }), /* @__PURE__ */jsxRuntimeExports.jsx(IonMenuToggle, {
                  "auto-hide": "false",
                  children: /* @__PURE__ */jsxRuntimeExports.jsxs(IonItem, {
                    detail: false,
                    button: true,
